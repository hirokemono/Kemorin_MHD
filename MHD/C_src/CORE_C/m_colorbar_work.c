...
void set_colorbar_text_image(const char minlabel[], const char maxlabel[], 
	...
	YsGlWriteStringToRGBA8Bitmap(minlabel, 191, 191, 191, 191, cbar_wk->numBMP, IWIDTH_TXT, 3*IHIGHT_TXT,
	...
	YsGlWriteStringToRGBA8Bitmap(minlabel, 255, 255, 255, 255, cbar_wk->numBMP, IWIDTH_TXT, 3*IHIGHT_TXT,
								 0, 1, YsFont12x16, 14, 16);

	YsGlWriteStringToRGBA8Bitmap(maxlabel, 191, 191, 191, 191, cbar_wk->numBMP, IWIDTH_TXT, 3*IHIGHT_TXT,
	...
	YsGlWriteStringToRGBA8Bitmap(maxlabel, 255, 255, 255, 255, cbar_wk->numBMP, IWIDTH_TXT, 3*IHIGHT_TXT, 
								 0, 1+IHIGHT_TXT, YsFont12x16, 14, 16);

	if(cbar_wk->iflag_zero == 1){
		YsGlWriteStringToRGBA8Bitmap(zerolabel, 191, 191, 191, 191, cbar_wk->numBMP, IWIDTH_TXT, 3*IHIGHT_TXT,
									 0, 2*IHIGHT_TXT, YsFont12x16, 14, 16);
		YsGlWriteStringToRGBA8Bitmap(zerolabel, 191, 191, 191, 191, cbar_wk->numBMP, IWIDTH_TXT, 3*IHIGHT_TXT,
		...
		YsGlWriteStringToRGBA8Bitmap(zerolabel, 255, 255, 255, 255, cbar_wk->numBMP, IWIDTH_TXT, 3*IHIGHT_TXT,

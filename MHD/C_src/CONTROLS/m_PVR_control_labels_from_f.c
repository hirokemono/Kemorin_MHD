...
struct pvr_control_labels * init_pvr_control_labels(){
	...
	pvr_ctl_labls->label_pvr_movie
			= init_control_labels_f(num_label_pvr_movie_f, 
									set_label_pvr_movie_f);
	
	pvr_ctl_labls->label_pvr_dirs
			= init_control_labels_f(num_label_psf_dirs_f, 
									set_label_psf_dirs_f);
	pvr_ctl_labls->flag_pvr_movie_mode
			= init_control_labels_f(num_flag_pvr_movie_mode_f, 
									set_flag_pvr_movie_mode_f);
...
void dealloc_pvr_control_labels(struct pvr_control_labels *pvr_ctl_labls){
	...
	dealloc_control_labels_f(pvr_ctl_labls->flag_pvr_movie_mode);
...
void check_pvr_control_labels(struct pvr_control_labels *pvr_ctl_labls){
	...
	printf("Check pvr_ctl_labls->flag_pvr_movie_mode\n");
	check_control_labels_f(pvr_ctl_labls->flag_pvr_movie_mode);

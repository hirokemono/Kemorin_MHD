...
const char label_time_data_ctl[NLBL_TIME_DATA_CTL][KCHARA_C] = {
    ...
    /*[ 9]*/    {"i_step_map_projection_ctl"},
    /*[10]*/    {"i_step_pvr_ctl"},
    /*[11]*/    {"i_step_fline_ctl"},
    /*[12]*/    {"i_step_LIC_ctl"},
    
    /*[13]*/    {"i_step_field_ctl"},
    /*[14]*/    {"i_step_snapshot_ctl"},
    /*[15]*/    {"i_step_monitor_ctl"},
    /*[16]*/    {"i_step_sgs_coefs_ctl"},
    /*[17]*/    {"i_step_boundary_ctl"},
    /*[18]*/    {"i_diff_steps_ctl"},
    ...
    /*[21]*/    {"min_delta_t_ctl"},
    /*[22]*/    {"max_delta_t_ctl"},
    /*[23]*/    {"min_eps_to_expand_ctl"},
    /*[24]*/    {"max_eps_to_shrink_ctl"},
    
    /*[25]*/    {"start_rst_step_ctl"},
    /*[26]*/    {"end_rst_step_ctl"},

    /*[27]*/    {"delta_t_check_ctl"},
    /*[28]*/    {"delta_t_rst_ctl"},
    /*[29]*/    {"delta_t_psf_ctl"},
    /*[30]*/    {"delta_t_iso_ctl"},
    /*[31]*/    {"delta_t_map_projection_ctl"},
    /*[32]*/    {"delta_t_pvr_ctl"},
...
struct time_data_control_c * init_time_data_control_c(){
    ...
    tctl->i_step_map_c =   init_int_ctl_item_c();
    ...
    tctl->delta_t_map_c =       init_real_ctl_item_c();
...
void read_time_data_control_c(FILE *fp, char buf[LENGTHBUF], const char *label,
    ...
    while(find_control_end_flag_c(buf, label) == 0){
        ...
        read_integer_ctl_item_c(buf, label_time_data_ctl[13], tctl->i_step_ucd_c);
        ...
        read_integer_ctl_item_c(buf, label_time_data_ctl[9], tctl->i_step_map_c);
        read_integer_ctl_item_c(buf, label_time_data_ctl[10], tctl->i_step_pvr_c);
        read_integer_ctl_item_c(buf, label_time_data_ctl[11], tctl->i_step_fline_c);
        read_integer_ctl_item_c(buf, label_time_data_ctl[12], tctl->i_step_lic_c);
        
        read_integer_ctl_item_c(buf, label_time_data_ctl[14], tctl->i_step_ucd_c);
        read_integer_ctl_item_c(buf, label_time_data_ctl[39], tctl->i_step_psf_c);
        read_integer_ctl_item_c(buf, label_time_data_ctl[40], tctl->i_step_iso_c);
        
        read_integer_ctl_item_c(buf, label_time_data_ctl[15], tctl->i_step_monitor_c);
        read_integer_ctl_item_c(buf, label_time_data_ctl[16], tctl->i_step_sgs_coefs_c);
        read_integer_ctl_item_c(buf, label_time_data_ctl[17], tctl->i_step_boundary_c);
        read_integer_ctl_item_c(buf, label_time_data_ctl[18], tctl->i_diff_steps_c);
        
        read_real_ctl_item_c(buf, label_time_data_ctl[19], tctl->dt_c);
        read_real_ctl_item_c(buf, label_time_data_ctl[20], tctl->time_init_c);
        
        read_integer_ctl_item_c(buf, label_time_data_ctl[25], tctl->start_rst_step_c);
        read_integer_ctl_item_c(buf, label_time_data_ctl[26], tctl->end_rst_step_c);
        
        read_real_ctl_item_c(buf, label_time_data_ctl[21], tctl->min_delta_t_c);
        read_real_ctl_item_c(buf, label_time_data_ctl[22], tctl->max_delta_t_c);
        read_real_ctl_item_c(buf, label_time_data_ctl[23], tctl->min_eps_to_expand_c);
        read_real_ctl_item_c(buf, label_time_data_ctl[24], tctl->max_eps_to_shrink_c);
        
        read_real_ctl_item_c(buf, label_time_data_ctl[27], tctl->delta_t_check_c);
        read_real_ctl_item_c(buf, label_time_data_ctl[28], tctl->delta_t_rst_c);
        read_real_ctl_item_c(buf, label_time_data_ctl[35], tctl->delta_t_field_c);
        read_real_ctl_item_c(buf, label_time_data_ctl[29], tctl->delta_t_psf_c);
        read_real_ctl_item_c(buf, label_time_data_ctl[30], tctl->delta_t_iso_c);
        read_real_ctl_item_c(buf, label_time_data_ctl[31], tctl->delta_t_map_c);
...
int write_time_data_control_c(FILE *fp, int level, const char *label, 
    ...
    write_integer_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[13], tctl->i_step_ucd_c);
    ...
    write_integer_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[9], tctl->i_step_map_c);
    write_integer_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[10], tctl->i_step_pvr_c);
    write_integer_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[11], tctl->i_step_fline_c);
    write_integer_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[12], tctl->i_step_lic_c);
    
    write_integer_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[15], tctl->i_step_monitor_c);
    write_integer_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[16], tctl->i_step_sgs_coefs_c);
    write_integer_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[17], tctl->i_step_boundary_c);
    write_integer_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[18], tctl->i_diff_steps_c);
    
    write_real_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[19], tctl->dt_c);
    write_real_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[20], tctl->time_init_c);
    
    write_integer_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[25], tctl->start_rst_step_c);
    write_integer_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[26], tctl->end_rst_step_c);
    
    write_real_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[21], tctl->min_delta_t_c);
    write_real_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[22], tctl->max_delta_t_c);
    write_real_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[23], tctl->min_eps_to_expand_c);
    write_real_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[24], tctl->max_eps_to_shrink_c);
    
    write_real_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[27], tctl->delta_t_check_c);
    write_real_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[28], tctl->delta_t_rst_c);
    write_real_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[35], tctl->delta_t_field_c);
    write_real_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[29], tctl->delta_t_psf_c);
    write_real_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[30], tctl->delta_t_iso_c);
    write_real_ctl_item_c(fp, level, tctl->maxlen, label_time_data_ctl[31], tctl->delta_t_map_c);

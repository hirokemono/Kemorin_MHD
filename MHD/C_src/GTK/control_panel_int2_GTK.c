...
static void add_i2_list_items_cb(GtkButton *button, gpointer user_data){
	...
	i2_vws->index_bc = add_i2_list_items(GTK_TREE_VIEW(i2_vws->i2_tree_view), i2_clist_gtk);
...
static void delete_i2_list_items_cb(GtkButton *button, gpointer user_data){
    struct i2_clist_view *i2_vws = (struct i2_clist_view *) user_data;
	struct int2_clist *i2_clist_gtk = (struct int2_clist *) g_object_get_data(G_OBJECT(button), "int2_clist");
	delete_i2_list_items(GTK_TREE_VIEW(i2_vws->i2_tree_view), i2_clist_gtk);
	reflesh_f_ctl_i2_array_by_r_list(i2_clist_gtk);
};
...
static void i2_tree_value1_edited_cb(GtkCellRenderer *cell, gchar *path_str,
    ...
    i2_tree_value1_edited(path_str, new_text, GTK_TREE_VIEW(i2_vws->i2_tree_view), i2_clist_gtk);
			...
			gchar *new_text, gpointer user_data)
{
    struct i2_clist_view *i2_vws = (struct i2_clist_view *) user_data;
	struct int2_clist *i2_clist_gtk = (struct int2_clist *) g_object_get_data(G_OBJECT(cell), "int2_clist");
    i2_tree_value2_edited(path_str, new_text, GTK_TREE_VIEW(i2_vws->i2_tree_view), i2_clist_gtk);
	update_f_ctl_i2_array_by_r_list(i2_clist_gtk);
};


static GtkWidget *hbox_with_i2_array_checkbox(struct int2_clist *i2_clist_gtk, struct i2_clist_view *i2_vws){
...
static void init_i2_tree_view(struct int2_clist *i2_clist_gtk, struct i2_clist_view *i2_vws){
	...
	create_i2_tree_view(GTK_TREE_VIEW(i2_vws->i2_tree_view), i2_clist_gtk, 
                           renderer_value1, renderer_value2);
	
	i2_vws->index_bc = append_i2_list_from_ctl(i2_vws->index_bc,
				&i2_clist_gtk->i2_item_head, GTK_TREE_VIEW(i2_vws->i2_tree_view));
};

GtkWidget *  add_i2_list_box_w_addbottun(struct int2_clist *i2_clist_gtk, struct i2_clist_view *i2_vws){
	GtkWidget *vbox = gtk_box_new(GTK_ORIENTATION_VERTICAL, 5);
	init_i2_tree_view(i2_clist_gtk, i2_vws);
	
    GtkWidget *button_add = gtk_button_new_with_label("Add");
    GtkWidget *button_delete = gtk_button_new_with_label("Remove");
	
	GtkWidget * hbox1 = hbox_with_i2_array_checkbox(i2_clist_gtk, i2_vws);
	...
	GtkWidget *expander = i2_list_box_expander(i2_clist_gtk->clist_name, i2_vws->i2_tree_view,

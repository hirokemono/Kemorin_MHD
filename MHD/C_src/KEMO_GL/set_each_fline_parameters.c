...
void set_fline_linear_colormap(double minvalue, int i_min_digit, 
    ...
    set_linear_colormap(fline_m->cmap_fline_comp[fline_m->icomp_draw_fline], 
...
void set_fline_constant_opacity(struct fline_data *fline_d,
	...
	set_constant_opacitymap(fline_m->cmap_fline_comp[fline_m->icomp_draw_fline],
...
void set_fline_color_data(struct fline_menu_val *fline_m, 
    ...
    set_each_color_point_s(fline_m->cmap_fline_comp[fline_m->icomp_draw_fline],
                           i_point, value, color);
}
void set_fline_opacity_data(struct fline_menu_val *fline_m,
			int i_point, double value, double opacity){
    set_each_opacity_point_s(fline_m->cmap_fline_comp[fline_m->icomp_draw_fline],
                             i_point, value, opacity);
}

void set_fline_color_mode_id(struct fline_menu_val *fline_m, int isel){
	set_color_mode_by_id(fline_m->cmap_fline_comp[fline_m->icomp_draw_fline], isel);
}

double get_fline_min_color(struct fline_menu_val *fline_m){
	double d, c;
    get_color_table_items_s(fline_m->cmap_fline_comp[fline_m->icomp_draw_fline],
                            0, &d, &c);
	return d;
}
double get_fline_max_color(struct fline_menu_val *fline_m){
	double d, c;
	int n = get_color_table_num_s(fline_m->cmap_fline_comp[fline_m->icomp_draw_fline]);
    get_color_table_items_s(fline_m->cmap_fline_comp[fline_m->icomp_draw_fline],
                            n-1, &d, &c);
	return d;
}
double get_fline_min_opacity(struct fline_menu_val *fline_m){
	return get_minimum_opacity_s(fline_m->cmap_fline_comp[fline_m->icomp_draw_fline]);
};
double get_fline_max_opacity(struct fline_menu_val *fline_m){
	return get_maximum_opacity_s(fline_m->cmap_fline_comp[fline_m->icomp_draw_fline]);
};

int get_fline_color_num(struct fline_menu_val *fline_m){
	return get_color_table_num_s(fline_m->cmap_fline_comp[fline_m->icomp_draw_fline]);
};
int get_fline_opacity_num(struct fline_menu_val *fline_m){
	return get_opacity_table_num_s(fline_m->cmap_fline_comp[fline_m->icomp_draw_fline]);
};
...
void get_fline_opacity_item(struct fline_menu_val *fline_m,
                            int i_point, double *value, double *opacity){
    get_opacity_table_items_s(fline_m->cmap_fline_comp[fline_m->icomp_draw_fline],
                              i_point, value, opacity);
}
...
void get_fline_colormap_tables(struct fline_menu_val *fline_m, int *id_cmap, int *num_cmap, int *num_alpha,
    ...
    get_colormap_to_tables(fline_m->cmap_fline_comp[fline_m->icomp_draw_fline],
...
void write_fline_colormap_file(struct kv_string *filename, const int iflag_draw_axis,
	...
	write_colormap_control_file_s(filename->string, fline_m->iflag_draw_time, iflag_draw_axis,
                                  0, fline_m->cmap_fline_comp[fline_m->icomp_draw_fline]);
}
void read_fline_colormap_file(struct kv_string *filename, struct fline_menu_val *fline_m){
	read_colormap_control_file_s(filename->string, fline_m->cmap_fline_comp[fline_m->icomp_draw_fline]);
}

...
struct kemoviewer_type{
	...
	struct VAO_ids *psf_texture_VAO;
	struct VAO_ids *psf_trans_tex_VAO;
	struct VAO_ids *psf_isoline_VAO;
	struct VAO_ids *psf_griph_VAO;
...
void kemoview_allocate_pointers(){
	...
	kemo_sgl->psf_solid_VAO =     (struct VAO_ids *) malloc(sizeof(struct VAO_ids));
	kemo_sgl->psf_trans_VAO =     (struct VAO_ids *) malloc(sizeof(struct VAO_ids));
	kemo_sgl->psf_texture_VAO =   (struct VAO_ids *) malloc(sizeof(struct VAO_ids));
	kemo_sgl->psf_trans_tex_VAO = (struct VAO_ids *) malloc(sizeof(struct VAO_ids));
	kemo_sgl->psf_isoline_VAO =   (struct VAO_ids *) malloc(sizeof(struct VAO_ids));
	kemo_sgl->psf_griph_VAO =     (struct VAO_ids *) malloc(sizeof(struct VAO_ids));
...
void kemoview_draw_objects_c(){
	...
	draw_objects(kemo_sgl->mesh_d, kemo_sgl->psf_d, kemo_sgl->fline_d, kemo_sgl->mesh_m, 
				...
				kemo_sgl->psf_texture_VAO, kemo_sgl->psf_trans_tex_VAO, 
				kemo_sgl->psf_isoline_VAO, kemo_sgl->psf_griph_VAO, kemo_sgl->kemo_shaders);
	return;
};

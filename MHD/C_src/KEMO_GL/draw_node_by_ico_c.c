...
void node_ico_VBO(struct view_element *view_s, 
	...
	int num_patch = count_mesh_node_ico_to_buf(istack_grp, mesh_s, iflag_domain);
	...
	set_mesh_node_ico_to_buf(IZERO, num_grp, igrp, istack_grp, item_grp, mesh_s, node_diam,

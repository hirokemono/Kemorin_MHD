...
static void set_kemoview_color_mode_CB(GtkComboBox *combobox_cmap, gpointer user_data)
{
    ...
    kemoview_set_colormap_param(color_vws->iflag_current_model, ISET_COLORMAP,
...
static void add_kemoview_cmap_list_box(struct colormap_view *color_vws,
...
GtkWidget * init_kemoview_colormap_list_vbox(struct kemoviewer_gl_type *kemo_gl,
	...
	add_kemoview_cmap_list_box(color_vws,
                               color_vws->vbox_cmap,
                               dummy_enty);
	add_kemoview_omap_list_box(color_vws,
                               color_vws->vbox_cmap,
                               dummy_enty);

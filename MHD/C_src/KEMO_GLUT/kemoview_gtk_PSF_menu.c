...
static GtkWidget * init_gtk_psf_colormap_expander(struct kemoviewer_gl_type *kemo_gl,
                                                  GtkWidget *window,
...
void init_psf_menu_hbox(struct kemoviewer_gl_type *kemo_gl,
                        struct psf_gtk_menu *psf_gmenu,
                        GtkWidget *window){
    psf_gmenu->expander_iso = init_isoline_menu_expander(kemo_gl, window,
                                                         psf_gmenu->psf_isoline_menu);
    psf_gmenu->expander_surf = init_gtk_psf_surface_menu_expander(kemo_gl, window,
                                                                  psf_gmenu->color_vws,
                                                                  psf_gmenu->psf_surface_menu);
    psf_gmenu->expander_color = init_gtk_psf_colormap_expander(kemo_gl, window,
                                                               psf_gmenu->color_vws);
    ...
    psf_gmenu->expander_vect = make_gtk_psf_vector_menu(kemo_gl, window,

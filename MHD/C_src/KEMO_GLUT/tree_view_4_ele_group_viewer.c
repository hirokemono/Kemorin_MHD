...
void create_element_group_columns(struct ci3_clist_view *ele_grp_vws)
{
    ...
    /* Forth row */
	column_4th = create_each_field_column(ele_grp_vws->tree_view,
    ...
    /* Fifth row */
	column_5th = create_each_field_column(ele_grp_vws->tree_view,

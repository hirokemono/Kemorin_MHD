...
static void set_surf_group_draw_box(struct group_gtk_menu *surf_group_gmenu){
	int iflag_color = kemoview_get_mesh_color_flag(SURF_GRP_FLAG, SURFSOLID_TOGGLE);
...
GtkWidget * init_surf_group_draw_expander(GtkWidget *window, struct group_gtk_menu *surf_group_gmenu){
	...
	g_signal_connect(G_OBJECT(surf_group_gmenu->combobox_patch_color), "changed", 
				G_CALLBACK(surf_grp_patch_colormode_CB), (gpointer) window);
	...
	g_signal_connect(G_OBJECT(surf_group_gmenu->combobox_grid_color), "changed", 
				G_CALLBACK(surf_grp_grid_colormode_CB), (gpointer) window);
	...
	g_signal_connect(G_OBJECT(surf_group_gmenu->combobox_node_color), "changed", 
				G_CALLBACK(surf_grp_node_colormode_CB), (gpointer) window);

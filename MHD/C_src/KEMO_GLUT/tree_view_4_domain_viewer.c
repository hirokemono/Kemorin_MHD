...
static void toggle_draw_domain_patch_CB(GtkTreeViewColumn *renderer, 
	...
	int index_grp = toggle_draw_patch_switch(path_str, domain_vws, &index1_for_toggle);
...
static void toggle_draw_domain_grid_CB(GtkTreeViewColumn *renderer, 
	...
	int index_grp = toggle_draw_grid_switch(path_str, domain_vws, &index2_for_toggle);
...
static void toggle_draw_domain_node_CB(GtkTreeViewColumn *renderer, gchar *path_str, gpointer user_data){
	...
	int index_grp = toggle_draw_node_switch(path_str, domain_vws, &index3_for_toggle);
...
static void draw_all_domain_patch_CB(GtkButton *button, gpointer user_data)
{
	...
	struct mesh_menu_val *mesh_m 
			= (struct mesh_menu_val *) g_object_get_data(G_OBJECT(user_data), "mesh_menu");
	int i;
	int num = set_all_draw_flags(IONE, COLUMN_MESH_THIRD, domain_vws);
	for(i=0;i<num;i++){
...
static void draw_all_domain_grids_CB(GtkButton *button, gpointer user_data)
{
	...
	struct mesh_menu_val *mesh_m 
			= (struct mesh_menu_val *) g_object_get_data(G_OBJECT(user_data), "mesh_menu");
	int i;
	int num = set_all_draw_flags(IONE, COLUMN_MESH_FORTH, domain_vws);
	for(i=0;i<num;i++){
...
static void draw_all_domain_nodes_CB(GtkButton *button, gpointer user_data)
{
	...
	struct mesh_menu_val *mesh_m 
			= (struct mesh_menu_val *) g_object_get_data(G_OBJECT(user_data), "mesh_menu");
	int i;
	int num = set_all_draw_flags(IONE, COLUMN_MESH_FIFTH, domain_vws);
	for(i=0;i<num;i++){
...
static void hide_all_domain_patch_CB(GtkButton *button, gpointer user_data)
{
	...
	struct mesh_menu_val *mesh_m 
			= (struct mesh_menu_val *) g_object_get_data(G_OBJECT(user_data), "mesh_menu");
	int i;
	int num = set_all_draw_flags(IZERO, COLUMN_MESH_THIRD, domain_vws);
	for(i=0;i<num;i++){
...
static void hide_all_domain_grids_CB(GtkButton *button, gpointer user_data)
{
	...
	struct mesh_menu_val *mesh_m 
			= (struct mesh_menu_val *) g_object_get_data(G_OBJECT(user_data), "mesh_menu");
	int i;
	int num = set_all_draw_flags(IZERO, COLUMN_MESH_FORTH, domain_vws);
	for(i=0;i<num;i++){
...
static void hide_all_domain_nodes_CB(GtkButton *button, gpointer user_data)
{
	...
	struct mesh_menu_val *mesh_m 
			= (struct mesh_menu_val *) g_object_get_data(G_OBJECT(user_data), "mesh_menu");
	int i;
	int num = set_all_draw_flags(IZERO, COLUMN_MESH_FIFTH, domain_vws);
	for(i=0;i<num;i++){
...
static void create_domain_group_columns(struct mesh_menu_val *mesh_m, struct ci3_clist_view *domain_vws, 
										GtkWidget *window_mesh)
{
	...
	g_object_set_data(G_OBJECT(entry), "domain_view", (gpointer) domain_vws);
	...
	g_signal_connect(G_OBJECT(toggleRenderer1), "toggled", 
				G_CALLBACK(toggle_draw_domain_patch_CB), (gpointer) entry);
	...
	g_signal_connect(G_OBJECT(toggleRenderer2), "toggled",
				G_CALLBACK(toggle_draw_domain_grid_CB), (gpointer) entry);
	...
	g_signal_connect(G_OBJECT(toggleRenderer3), "toggled",
				G_CALLBACK(toggle_draw_domain_node_CB), (gpointer) entry);
};

static void create_domain_group_view(struct mesh_menu_val *mesh_m, struct ci3_clist_view *domain_vws,
									 GtkWidget *window_mesh)
{
    int i;
    GtkTreeModel *model;
	...
	create_domain_group_columns(mesh_m, domain_vws, window_mesh);
			...
			GtkWidget *window_mesh, GtkWidget *vbox)
{
	...
	create_domain_group_view(mesh_m, domain_vws, window_mesh);
	...
	g_signal_connect(G_OBJECT(combobox_patch_color), "changed", 
				G_CALLBACK(domain_patch_colormode_CB), (gpointer) entry);
	...
	g_signal_connect(G_OBJECT(combobox_grid_color), "changed", 
				G_CALLBACK(domain_grid_colormode_CB), (gpointer) entry);
	...
	g_signal_connect(G_OBJECT(combobox_node_color), "changed", 
				G_CALLBACK(domain_node_colormode_CB), (gpointer) entry);
    ...
    g_signal_connect(G_OBJECT(button_grid_color), "clicked", 
				G_CALLBACK(set_single_domain_grids_color_CB), (gpointer) entry);
    ...
    g_signal_connect(G_OBJECT(button_node_color), "clicked", 
				G_CALLBACK(set_single_domain_nodes_color_CB), (gpointer) entry);

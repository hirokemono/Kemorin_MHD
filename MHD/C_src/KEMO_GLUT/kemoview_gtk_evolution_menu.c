...
void add_evoluaiton_menu_box(int istep, GtkWidget *window_main, struct evolution_gtk_menu *evo_gmenu){
	...
	adj_evo_start = gtk_adjustment_new(evo_gmenu->istart_evo, 0, evo_gmenu->istart_evo*1000, 1, 1, 0.0);
	...
	adj_evo_end = gtk_adjustment_new(evo_gmenu->iend_evo, 0.00, evo_gmenu->iend_evo*1000, 1, 1, 0.0);
	...
	adj_evo_increment = gtk_adjustment_new(evo_gmenu->inc_evo, 0, evo_gmenu->iend_evo*100, 1, 1, 0.0);
	...
	gtk_box_pack_start(GTK_BOX(evo_gmenu->evo_box), hbox_evo_start, FALSE, TRUE, 0);
	gtk_box_pack_start(GTK_BOX(evo_gmenu->evo_box), hbox_evo_end, FALSE, TRUE, 0);
	gtk_box_pack_start(GTK_BOX(evo_gmenu->evo_box), hbox_evo_increment, FALSE, TRUE, 0);
	gtk_box_pack_start(GTK_BOX(evo_gmenu->evo_box), hbox_evo_filename, FALSE, TRUE, 0);
	gtk_box_pack_start(GTK_BOX(evo_gmenu->evo_box), hbox_evo_fileformat, FALSE, TRUE, 0);
	gtk_box_pack_start(GTK_BOX(evo_gmenu->evo_box), hbox_evo_save, FALSE, TRUE, 0);
	return;
}

...
!!     &         (nnod_4_ele, nnod_4_edge, view_mesh, zbuf)
!!        type(viewer_mesh_data), intent(inout) :: view_mesh
!!        type(buffer_4_gzip), intent(inout) :: zbuf
!!
...
!
     ...
     &   (num_pe_write, mgd_view_mesh%inod_sf_stack(1), zbuf)
      call write_gz_multi_int_8i16                                      &
     &   (num_pe_write, mgd_view_mesh%isurf_sf_stack(1), zbuf)
      call write_gz_multi_int_8i16                                      &
     &   (num_pe_write, mgd_view_mesh%iedge_sf_stack(1), zbuf)
!
...
!
!
      call skip_gz_comment_int(num_pe_read, zbuf)
!
      call alloc_num_mesh_sf(int(num_pe_read), mgd_view_mesh)
!
      call read_gz_multi_int                                            &
     &   (num_pe_read, mgd_view_mesh%inod_sf_stack, zbuf)
      call read_gz_multi_int                                            &
     &   (num_pe_read, mgd_view_mesh%isurf_sf_stack, zbuf)
      call read_gz_multi_int                                            &
     &   (num_pe_read, mgd_view_mesh%iedge_sf_stack, zbuf)
!
...
!
     ...
     &                    (num, view_mesh%surftyp_viewer(ist+1), zbuf)
      end do
!
...
!
      call read_gz_multi_int                                            &
     &   (view_mesh%nsurf_viewer, view_mesh%surftyp_viewer, zbuf)
!

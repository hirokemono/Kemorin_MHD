...
!
     ...
     &                        char(10), char(0)
      call gz_write_textbuf_no_lf(FPz_f, zbuf_cor)
...
!
      call skip_gz_comment_int(FPz_f, ltr_cor_IO, zbuf_cor)
      call allocate_int_sph_cor_IO
!
      j1 = 2
      call skip_gz_comment_int(FPz_f, itmp, zbuf_cor)
      read(zbuf_cor%fixbuf(1),*) itmp, jgl_kcor_IO(1,1,j1), itmp,       &
     &                gk_cor_IO(1,1,j1)
      call get_one_line_text_from_gz(FPz_f, zbuf_cor)

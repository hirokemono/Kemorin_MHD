...
!!      subroutine check_vpol_evo7_mat_sph(id_file, sph_rj)
...
!
!
      write(id_file,'(a)') 'poisson matrix for poloidal velocity'
      call check_radial_5band_mat                                       &
     &   (id_file, sph_rj%nidx_rj(1), sph_rj%nidx_rj(2),                &
     &    sph_rj%idx_gl_1d_rj_j, sph_rj%radius_1d_rj_r,                 &
     &    vs_poisson5_mat)
!
      write(id_file,'(a)') 'crank matrix for poloidal velocity'

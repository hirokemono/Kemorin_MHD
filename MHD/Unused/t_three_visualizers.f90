...
!!
!!@verbatim
!!      subroutine init_three_visualize(elps_VIZ, viz_step,             &
!!     &          geofem, nod_fld, VIZ_DAT, viz3_ctls, vizs, m_SR)
!!      subroutine visualize_three(elps_VIZ, viz_step, time_d, geofem,  &
...
!
     ...
     &    geofem, VIZ_DAT%edge_comm, nod_fld, viz3_ctls%psf_ctls,       &
...
!
     ...
     &           call start_elapsed_time(elps_VIZ%ist_elapsed_V+7)
      call PVR_initialize(viz_step%PVR_t%increment, elps_VIZ%elps_PVR,  &

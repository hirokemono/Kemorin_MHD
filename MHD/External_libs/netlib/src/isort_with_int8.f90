...
!C***DESCRIPTION
!C
!C   ISORT_W_I8 sorts array IX and optionally makes the same interchanges in
!C   array I8Y.  The array IX may be sorted in increasing order or
!C   decreasing order.  A slightly modified quicksort algorithm is used.
!C
!C   Description of Parameters
!C      IX - integer array of values to be sorted
!C      I8Y - integer array to be (optionally) carried along
!C      N  - number of values in integer array IX to be sorted
!C      KFLAG - control parameter
!C            =  2  means sort IX in increasing order and carry I8Y along.
!C            =  1  means sort IX in increasing order (ignoring I8Y)
!C            = -1  means sort IX in decreasing order (ignoring I8Y)
!C            = -2  means sort IX in decreasing order and carry I8Y along.
!C
...
!C   901012  Declared all variables; changed X,Y to IX,I8Y. (M. McClain)
...
!-----------------------------------------------------------------------
!
      SUBROUTINE ISORT_W_I8 (IX, I8Y, N, KFLAG)
!
      implicit none
!
!C     .. Scalar Arguments ..
...
!C     .. Intrinsic Functions ..
      INTRINSIC ABS, INT
!C***FIRST EXECUTABLE STATEMENT  ISORT_W_I8
      NN = N
      IF (NN .LT. 1) THEN
!         CALL XERMSG ('SLATEC', 'ISORT_W_I8',

...
LC0:
	...
	vmulpd %ymm14,%ymm12,%ymm15 # Q1*G1R
	vaddpd %ymm3,%ymm15,%ymm3 # SD2R=SD2R+Q1*G1R
	vmulpd %ymm14,%ymm13,%ymm15 # Q2*G1R
	vaddpd %ymm9,%ymm15,%ymm9 # SD4R=SD4R+Q2*G1R
	
	vmovapd 128(%rax),%ymm14 # G2R
	vmulpd %ymm14,%ymm12,%ymm15 # Q1*G2R
	vaddpd %ymm0,%ymm15,%ymm0 # SD1R=SD1R+Q1*G2R
	vmulpd %ymm14,%ymm13,%ymm15 # Q2*G2R	
	vaddpd %ymm6,%ymm15,%ymm6 # SD3R=SD3R+Q2*G2R	
	
	vmovapd 160(%rax),%ymm14 # G1I	
	vmulpd %ymm14,%ymm12,%ymm15 # Q1*G1I
	vaddpd %ymm4,%ymm15,%ymm4 # SD2I=SD2I+Q1*G1I
	vmulpd %ymm14,%ymm13,%ymm15 # Q2*G1I
	vaddpd %ymm10,%ymm15,%ymm10 # SD4I=SD4I+Q2*G1I
	
	vmovapd 192(%rax),%ymm14 # G2I	
	vmulpd %ymm14,%ymm12,%ymm15 # Q1*G2I
	vaddpd %ymm1,%ymm15,%ymm1 # SD1I=SD1I+Q1*G2I
	vmulpd %ymm14,%ymm13,%ymm15 # Q2*G2I	
	vaddpd %ymm7,%ymm15,%ymm7 # SD3I=SD3I+Q2*G2I
	
	vmovapd 224(%rax),%ymm14 # G1A
	vmulpd %ymm14,%ymm12,%ymm15 # Q1*G1A
	vaddpd %ymm5,%ymm15,%ymm5 # SD2A=SD2A+Q1*G1A
	vmulpd %ymm14,%ymm13,%ymm15 # Q2*G1A
	vaddpd %ymm11,%ymm15,%ymm11 # SD4A=SD4A+Q2*G1A
	
	vmovapd 256(%rax),%ymm14 # G2A
	vmulpd %ymm14,%ymm12,%ymm15 # Q1*G2A
	vaddpd %ymm2,%ymm15,%ymm2 # SD1A=SD1A+Q1*G2A
	vmulpd %ymm14,%ymm13,%ymm15 # Q2*G2A
	vaddpd %ymm8,%ymm15,%ymm8 # SD3A=SD3A+Q2*G2A
...
LD0:
	...
	vmovapd 288(%rax),%ymm14 # G1B
	vmulpd %ymm14,%ymm12,%ymm15 # Q1*G1B
	vaddpd %ymm1,%ymm15,%ymm1 # SD2B=SD2B+Q1*G1B
	vmulpd %ymm14,%ymm13,%ymm15 # Q2*G2A
	vaddpd %ymm3,%ymm15,%ymm3 # SD4B=SD4B+Q2*G1B

	vmovapd 320(%rax),%ymm14 # G2B
	vmulpd %ymm14,%ymm12,%ymm15 # Q1*G2B
	vaddpd %ymm0,%ymm15,%ymm0 # SD1B=SD1B+Q1*G2B
	vmulpd %ymm14,%ymm13,%ymm15 # Q2*G2B
	vaddpd %ymm2,%ymm15,%ymm2 # SD3B=SD3B+Q2*G2B
...
LC50:
	...
	vaddpd %ymm4,%ymm15,%ymm4 # SD2R=SD2R+Q1*G1R
	...
	vaddpd %ymm1,%ymm15,%ymm1 # SD1I=SD1I+Q1*G2I	
	vmulpd 224(%rax),%ymm12,%ymm15 # Q1*G1A
	vaddpd %ymm6,%ymm15,%ymm6 # SD2A=SD2A+Q1*G1A
	vmulpd 256(%rax),%ymm12,%ymm15 # Q1*G2A
	vaddpd %ymm2,%ymm15,%ymm2 # SD1A=SD1A+Q1*G2A
	vmulpd 288(%rax),%ymm12,%ymm15 # Q1*G1B
	vaddpd %ymm7,%ymm15,%ymm7 # SD2B=SD2B+Q1*G1B
	vmulpd 320(%rax),%ymm12,%ymm15 # Q1*G2B
	vaddpd %ymm3,%ymm15,%ymm3 # SD1B=SD1B+Q1*G2B

...
************************************************************************
************************************************************************
*     浅水方程式の保存量のチェック                            2001/07/23
************************************************************************
      SUBROUTINE P2SWCK(LM,KM,JM,IM,R,AVT,DIV,PHI,AENE,AENS,
     &  WS,WG,ITJ,TJ,ITI,TI)
      ...
      CALL P2S2GA(LM,KM,JM,IM,PHI,WG(1,2),WG,ITJ,TJ,ITI,TI)
      CALL P2S2GA(LM,KM,JM,IM,AVT,WG(1,3),WG,ITJ,TJ,ITI,TI)
      ...
      CALL P2S2GA(LM,KM,JM,IM,WS,WG(1,3),WG,ITJ,TJ,ITI,TI)
      ...
      CALL P2S2GA(LM,KM,JM,IM,WS,WG(1,4),WG,ITJ,TJ,ITI,TI)

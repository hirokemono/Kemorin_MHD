...
*     (若干高速化を図った版)
*     (MPIによる安直並列化)                                   2002/05/19
************************************************************************
      SUBROUTINE SPMWNW(MM,IM,ID,JM,JD,OMEGA,BARPHI,DNU,ALPHA,
...
*/ 実際の操作 */
      ...
      ELSE
        CALL SPMWSW(MAXDIM,MM,IM,ID,JM,JD,OMEGA,BARPHI,DNU,ALPHA,
...
*/ 回転系に戻るために以下の変換が必要
      ...
      END
************************************************************************
      SUBROUTINE SPMWSW(MAXDIM,MM,IM,ID,JM,JD,OMEGA,BARPHI,DNU,ALPHA,

...
************************************************************************
      SUBROUTINE SPMWHW(MM,IM,ID,JM,JD,OMEGA,BARPHI,DNU,ALPHA,LEV,
...
*/ 実際の操作 */
      ...
      ELSE
        CALL SPMWHS(MAXDIM,MM,IM,ID,JM,JD,OMEGA,BARPHI,DNU,ALPHA,
...
*/ 回転系に戻るために以下の変換が必要
      ...
      END
************************************************************************
      SUBROUTINE SPMWHS(MAXDIM,MM,IM,ID,JM,JD,OMEGA,BARPHI,DNU,ALPHA,

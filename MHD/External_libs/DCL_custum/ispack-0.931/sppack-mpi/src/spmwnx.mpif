...
************************************************************************
      SUBROUTINE SPMWNX(MM,IM,ID,JM,JD,OMEGA,BARPHI,DNU,
...
*/ 実際の操作 */
      ...
      ELSE
        CALL SPMWSX(MAXDIM,MM,IM,ID,JM,JD,OMEGA,BARPHI,DNU,
...
*/ 回転系に戻るために以下の変換が必要
      ...
      END
************************************************************************
      SUBROUTINE SPMWSX(MAXDIM,MM,IM,ID,JM,JD,OMEGA,BARPHI,DNU,

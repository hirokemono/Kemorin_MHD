...
************************************************************************
************************************************************************
*     TRANSFORM GRID TO SPECTRA                               2004/08/26
************************************************************************
      SUBROUTINE U2G2SA(LM,KM,JM,IM,G,S,W,ITJ,TJ,ITI,TI)
      ...
      DO L=1,LM
        DO K=-KM,KM
          S( L,K)= 2*(-1)**L*(TJ(L,5)*W(K,2*L  )+TJ(L,6)*W(K,2*L+1))
          S(-L,K)=-2*(-1)**L*(TJ(L,5)*W(K,2*L+1)-TJ(L,6)*W(K,2*L))
        END DO
      END DO

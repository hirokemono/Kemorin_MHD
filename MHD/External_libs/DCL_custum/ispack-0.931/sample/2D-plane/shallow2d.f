...
************************************************************************
***********************************************************************
*   shallow2d.f: n2packを使ってf平面浅水方程式を解くプログラム
*
*                                                 2000/10/28 K.Ishioka
***********************************************************************
...
*      PARAMETER(BARPHI=0.05D0)  ! 平均水深      
      ...
      DIMENSION WS(-LM:LM,-KM:KM,4)   !作業領域
      DIMENSION WG(0:JM-1,0:IM-1,5)   !作業領域
...
* それをN2G2SAを使ってスペクトル係数に変換して, それをZの初期値と
* している
     ...
     &              +EXP(-((X-X2)**2+(Y-Y2)**2)/(2*SIGMA**2))
      ...
      CALL N2G2SA(LM,KM,JM,IM,WG,VAR,WG(0,0,3),ITJ,TJ,ITI,TI)

      VAR(0,0,1)=F
      
* 傾度風バランスによる初期値化をするとき
      CALL N2SWBL(LM,KM,JM,IM,BARPHI,VAR(-LM,-KM,1),VAR(-LM,-KM,3),
     &  WS,WG,ITJ,TJ,ITI,TI)
...
* 渦度場            
      ...
      CALL N2S2GA(LM,KM,JM,IM,VAR(-LM,-KM,1),
...
* 発散場                  
      ...
      CALL N2S2GA(LM,KM,JM,IM,VAR(-LM,-KM,2),
     &  WG,WG(0,0,2),ITJ,TJ,ITI,TI)
      DO I=0,IM-1
        DO J=0,JM-1
          RG(I,J)=WG(J,I,1)
...
* ジオポテンシャル場                  
      ...
      CALL N2S2GA(LM,KM,JM,IM,VAR(-LM,-KM,3),
     &  WG,WG(0,0,2),ITJ,TJ,ITI,TI)
      DO I=0,IM-1
        DO J=0,JM-1
          RG(I,J)=WG(J,I,1)

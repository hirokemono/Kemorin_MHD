...
************************************************************************
***********************************************************************
*     非線形浅水方程式のサンプルプログラム(回転なし)         2004/08/31
***********************************************************************
...
************************************************************************
      ...
      CALL U2INIT(JM,IM,ITJ,TJ,ITI,TI,Y,R)
...
*-----------------------------------------------------------------------
      ...
      CALL U2S2GA(LM,KM,JM,IM,VAR(-LM,-KM,1),U,W,ITJ,TJ,ITI,TI)
      CALL U2S2GX(LM,KM,JM,IM,VAR(-LM,-KM,1),UX,W,ITJ,TJ,ITI,TI)
      CALL U2S2GY(LM,KM,JM,IM,VAR(-LM,-KM,1),UY,W,ITJ,TJ,ITI,TI,Y,R)
      CALL U2S2GA(LM,KM,JM,IM,VAR(-LM,-KM,2),V,W,ITJ,TJ,ITI,TI)
      CALL U2S2GX(LM,KM,JM,IM,VAR(-LM,-KM,2),VX,W,ITJ,TJ,ITI,TI)
      CALL U2S2GY(LM,KM,JM,IM,VAR(-LM,-KM,2),VY,W,ITJ,TJ,ITI,TI,Y,R)      
      CALL U2S2GA(LM,KM,JM,IM,VAR(-LM,-KM,3),H,W,ITJ,TJ,ITI,TI)
      CALL U2S2GX(LM,KM,JM,IM,VAR(-LM,-KM,3),HX,W,ITJ,TJ,ITI,TI)
      CALL U2S2GY(LM,KM,JM,IM,VAR(-LM,-KM,3),HY,W,ITJ,TJ,ITI,TI,Y,R)      
     ...
     &      -HX(J,I)
        END DO
      END DO
      CALL U2G2SA(LM,KM,JM,IM,G,DVAR(-LM,-KM,1),W,ITJ,TJ,ITI,TI)
      ...
      DO I=0,IM-1
        ...
        END DO
      END DO
      CALL U2G2SA(LM,KM,JM,IM,G,DVAR(-LM,-KM,2),W,ITJ,TJ,ITI,TI)
     ...
     &           -(HBAR+H(J,I))*(UX(J,I)+VY(J,I))
        END DO
      END DO
      CALL U2G2SA(LM,KM,JM,IM,G,DVAR(-LM,-KM,3),W,ITJ,TJ,ITI,TI)
...
*-----------------------------------------------------------------------
      ...
      CALL U2G2SA(LM,KM,JM,IM,G,VAR(-LM,-KM,2),W,ITJ,TJ,ITI,TI)

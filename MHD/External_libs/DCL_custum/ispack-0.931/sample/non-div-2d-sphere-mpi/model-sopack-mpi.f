...
************************************************************************
      ...
      CALL SNMINI(MM+1,IM,JM,JC,IT,T,Y,IP,P,R,IA,A)
      ...
      IF(JC.GT.0) THEN
        CALL SNKINI(MM+1,JC,2,IP,P,R,IP2,P2,R2)
      END IF
...
*-----------------------------------------------------------------------
      ...
      CALL SOMDNL(MM,IM,ID,JC,JDD,
     &    PSI,DAVT,IT,T,Y,IP2,P2,R2,IA,A,IB,B,Q,WS,WW,W)
...
*     / DISTURBANCE FIELD /
      ...
      CALL SNTGMS(MM+1,IM,ID,JC,JDD,1,

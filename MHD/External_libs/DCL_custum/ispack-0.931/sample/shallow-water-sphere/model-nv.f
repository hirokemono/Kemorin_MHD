...
************************************************************************
***********************************************************************
*     浅水方程式をsppackで解くためのサンプルプログラム       2000/04/05
*     (角運動量を保存する散逸項を使う)
***********************************************************************
      PROGRAM MODEL
...
************************************************************************
      SUBROUTINE SBOPEN(DNUD,ALPHAD,NDV,DT)
...
*      DIMENSION WW(JW*IW),WS(8*JW*IW)
      DIMENSION WW(JW*IW*8),WS(8*JW*IW)      
      SAVE
...
*      CALL SPSWNX(MM,IM,ID,JM,JD,OMEGA,BARPHI,DNU,
*      CALL SPSWNV(MM,IM,ID,JM,JD,OMEGA,BARPHI,DNU,ALPHA,
      CALL SPSWNW(MM,IM,ID,JM,JD,OMEGA,BARPHI,DNU,ALPHA,      

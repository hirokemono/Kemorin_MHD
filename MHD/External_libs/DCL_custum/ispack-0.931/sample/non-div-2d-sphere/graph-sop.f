...
************************************************************************
***********************************************************************
*     GRAPHIC PROGRAM FOR MODEL                              1999/03/24
***********************************************************************
      PROGRAM GRAPHM
...
***********************************************************************
      ...
      DIMENSION AVT(LM),AVTD(LM),IPOINT(LM),RPOINT(LM)
...
*----------------------------------------------------------------------
      ...
      CALL FHUJMP(10,I*LM*4)
      CALL FEGETR(10,LM,AVTD)

      DO L=1,LM
        AVT(IPOINT(L))=RPOINT(L)*AVTD(L)
      END DO

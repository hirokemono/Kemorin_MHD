...
!************************************************************************
      ...
      IF(N.LE.0) THEN
        CALL s_FTDMSG('E','FTTZLI','N MUST BE .GT. 0')
      END IF
   ...
   20 CONTINUE
      ...
      IF(J.NE.1) THEN
        CALL s_FTDMSG('E','FTTZLI','N.NE.(2**P)*(3**Q)*(5**R)')
      END IF

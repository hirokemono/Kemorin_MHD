...
!************************************************************************
!
!      SUBROUTINE FTTSMI0(N,IT,T)
!      SUBROUTINE FTTSMF0(M,N,X,Y,IT,T)
!      SUBROUTINE FTTSMB0(M,N,X,Y,IT,T)
!
      module ftsm
!
      use ftr0

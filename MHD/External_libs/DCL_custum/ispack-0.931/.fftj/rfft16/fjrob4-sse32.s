...
#      movl	4(%esp), %eax
      ...
      movaps    (%ecx), %xmm6 # Z(0)       
      movaps  64(%ecx), %xmm7 # Z(4)
      movaps  16(%ecx), %xmm0 # Z(1)
      movaps  80(%ecx), %xmm1 # Z(5)              
      movaps  48(%ecx), %xmm2 # Z(3)       
      movaps 112(%ecx), %xmm3 # Z(7)
      ...
      movaps 32(%ecx), %xmm4 # Z(2)
      movaps 96(%ecx), %xmm5 # Z(6)              
      movaps %xmm6, (%ecx)              

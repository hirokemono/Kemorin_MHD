...
#  rfft のための前処理
      ...
      movq $2048,%r11  # %r11 に (N/2)*16 が入る
      addq %rdi,%r11   # %r11 = %edi + (N/2)*16
...
#-----------------------------------------------------
# fft 128 out-of-place backward (16x8 type)
#.text
#.globl fjcob7_
#fjcob7_:

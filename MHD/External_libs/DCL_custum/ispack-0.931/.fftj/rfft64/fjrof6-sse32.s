...
#-------------------------------------------------------------
       ...
       movaps  %xmm0, (%esi)   # ZA1o -> ZD(1) # ZD(0)
       ...
       subpd %xmm7,%xmm3  
       addpd %xmm0,%xmm7  
       movaps  %xmm3, 112(%esi)   # ZA1e-ZA4e -> ZD(23) # ZD(7)
       movaps  %xmm7,  64(%esi)   # ZA1e+ZA4e -> ZD(7) # ZD(4)

       movaps %xmm1,%xmm0
       subpd %xmm5,%xmm1
       addpd %xmm0,%xmm5
       movaps  %xmm1,  80(%esi)   # ZB1e-ZB4e -> ZD(25) # ZD(5)
       movaps  %xmm5,  96(%esi)   # ZB1e+ZB4e -> ZD(9) # ZD(6)
       ...
       movaps  %xmm2, 32(%esi)   # ZD(15) # ZD(2)
       movaps  %xmm5, 16(%esi)   # ZD(31) # ZD(1)
       
       movaps  (%esi), %xmm0    # ZD(1) # ZD(0) -> ZA1o 
       ...
       movaps  %xmm0,48(%esi)   # ZD(17) # ZD(3)
       movaps  %xmm5, (%esi)   # ZD(1) # ZD(0)
...
#---------------------------------------
       ...
       movaps  %xmm0, 128(%esi)   # ZA2o -> ZD(3) # ZD(8)
       ...
       subpd %xmm7,%xmm3  
       addpd %xmm0,%xmm7  
       movaps  %xmm3, 240(%esi)   # ZA2e-ZA3e -> ZD(21) # ZD(15)
       movaps  %xmm7, 192(%esi)   # ZA2e+ZA3e -> ZD(5) # ZD(12)

       movaps %xmm1,%xmm0
       subpd %xmm5,%xmm1
       addpd %xmm0,%xmm5
       movaps  %xmm1, 208(%esi)   # ZB2e-ZB3e -> ZD(27) # ZD(13)
       movaps  %xmm5, 224(%esi)   # ZB2e+ZB3e -> ZD(11) # ZD(14)
       ...
       movaps  %xmm2, 160(%esi)   # ZD(13) # ZD(10)
       movaps  %xmm5, 144(%esi)   # ZD(29) # ZD(9)
       
       movaps 128(%esi), %xmm0    # ZD(3) # ZD(8) -> ZA2o
       ...
       movaps  %xmm0,176(%esi)   # ZD(19) # ZD(11)
       movaps  %xmm5, 128(%esi)   # ZD(3) # ZD(8)
...
#---------------------------------------
       ...
       movaps %xmm4,272(%esi)  # -> ZD(16) # ZD(17)
       movaps %xmm0,256(%esi)  # -> ZD(0)  # ZD(16)
       ...
       movaps %xmm4, 304(%esi)  # -> ZD(24) # ZD(19)
       movaps %xmm2, 288(%esi)  # -> ZD(8) # ZD(18)
       ...
       movaps %xmm1,368(%esi)  # -> ZD(28) # ZD(23)
       movaps %xmm5,352(%esi)  # -> ZD(12) # ZD(22)
       movaps %xmm6,336(%esi)  # -> ZD(20) # ZD(21)
       movaps %xmm3,320(%esi)  # -> ZD(4) # ZD(20)       
...
#-------------------------------------------------------------
       ...
       movaps  %xmm0, 384(%esi)   # ZC1o -> ZD(2) # ZD(24)
       ...
       addpd %xmm0,%xmm7
       movaps  %xmm7, 448(%esi)   # ZC1e+ZC3e -> ZD(6) # ZD(28)

       movaps %xmm1,%xmm0
       subpd %xmm5,%xmm1
       addpd %xmm0,%xmm5 # ZD1e+ZD3e 
       movaps  %xmm1, 464(%esi)   # ZD1e-ZD3e -> ZD(26) # ZD(29)
       
       movaps .C4, %xmm0
       mulpd %xmm0,%xmm3
       mulpd %xmm0,%xmm5       
       movaps  %xmm3, 496(%esi)   # -> ZD(22) # ZD(31)
       movaps  %xmm5, 480(%esi)   # -> ZD(10) # ZD(30)
       ...
       movaps  %xmm2, 416(%esi)   # ZD(14) # ZD(26)
       movaps  %xmm5, 400(%esi)   # ZD(30) # ZD(25)
       
       movaps  384(%esi), %xmm0    # ZD(2)  # ZD(24)-> ZC1o
       ...
       movaps  %xmm0,432(%esi)   # ZD(18) # ZD(27)
       movaps  %xmm5,384(%esi)   # ZD(2) # ZD(24)

#-------------------------------------------------------------
# K=0

       movaps  64(%esi), %xmm0  # ZD(7) # ZD(4)
       movaps 192(%esi), %xmm1  # ZD(5) # ZD(12)       
       
       addpd %xmm1,%xmm0 # ZA

       movaps 320(%esi), %xmm1  # ZD(4) # ZD(20)
       movaps 448(%esi), %xmm3  # ZD(6) # ZD(28)
...
# K=1
       ...
       movaps 128(%esi), %xmm0  # ZD(3) # ZD(8)
       movaps 176(%esi), %xmm1  # ZD(19) # ZD(11)       
       movaps 144(%esi), %xmm2  # ZD(29) # ZD(9)
       movaps 160(%esi), %xmm3  # ZD(13) # ZD(10)
       ...
       movaps  (%esi), %xmm1  # ZD(1) # ZD(0)
       movaps 32(%esi), %xmm3  # ZD(15) # ZD(2)
       ...
       movaps 256(%esi), %xmm0  # ZD(0) # ZD(16)
       movaps 384(%esi), %xmm2  # ZD(2) # ZD(24)
       
       addpd %xmm2,%xmm0     # ZC

       movaps 416(%esi), %xmm2  # ZD(14) # ZD(26)
       movaps 288(%esi), %xmm4  # ZD(8) # ZD(18)
...
# K=2
       ...
       movaps 112(%esi), %xmm0  # ZD(23) # ZD(7)
       movaps 240(%esi), %xmm1  # ZD(21) # ZD(15)
       movaps  96(%esi), %xmm2  # ZD(9) # ZD(6)       
       movaps 224(%esi), %xmm3  # ZD(11) # ZD(14)       
       ...
       movaps  352(%esi), %xmm1  # ZD(12) # ZD(22)
       movaps  496(%esi), %xmm3  # ZD(22) # ZD(31)
       addpd %xmm3,%xmm1 # ZC

       movaps  368(%esi), %xmm4  # ZD(28) # ZD(23)
       movaps  480(%esi), %xmm3  # ZD(10) # ZD(30)
       addpd %xmm4,%xmm3
       shufpd $1,%xmm3,%xmm3
       xorpd %xmm7,%xmm3 # ZD
...
# K=3
       ...
       movaps 48(%esi), %xmm0  # ZD(17) # ZD(3)
       movaps  (%esi), %xmm1  # ZD(1) # ZD(0)
       movaps  16(%esi), %xmm2  # ZD(31) # ZD(1)
       movaps  32(%esi), %xmm3  # ZD(15) # ZD(2)       
       ...
       movaps 144(%esi), %xmm3  # ZD(29) # ZD(9)
       movaps 176(%esi), %xmm0  # ZD(19) # ZD(11)
       ...
       movaps 272(%esi), %xmm0  # ZD(16) # ZD(17)
       movaps 432(%esi), %xmm2  # ZD(18) # ZD(27)
       
       addpd %xmm2,%xmm0     # ZC

       movaps 304(%esi), %xmm4  # ZD(24) # ZD(19)
       movaps 400(%esi), %xmm2  # ZD(30) # ZD(25)
...
# K=4
       ...
       movaps  64(%esi), %xmm0  # ZD(7) # ZD(4)
       movaps 192(%esi), %xmm1  # ZD(5) # ZD(12)       
       movaps  80(%esi), %xmm2  # ZD(25) # ZD(5)       
       movaps 208(%esi), %xmm3  # ZD(27) # ZD(13)
       ...
       movaps  464(%esi), %xmm1  # ZD(26) # ZD(29)
       movaps  336(%esi), %xmm3  # ZD(20) # ZD(21)=ZC
       shufpd $1,%xmm1,%xmm1
       xorpd %xmm7,%xmm1 # ZD
...
# K=7
       ...
       movaps 48(%esi), %xmm1  # ZD(17) # ZD(3)
       movaps 16(%esi), %xmm3  # ZD(31) # ZD(1)

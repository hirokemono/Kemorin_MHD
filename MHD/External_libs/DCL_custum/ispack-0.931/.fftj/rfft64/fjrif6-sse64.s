...
#---------------------------------------
       ...
       movaps %xmm4,272(%rsi)  # -> ZD(16) # ZD(17)
       movaps %xmm0,256(%rsi)  # -> ZD(0)  # ZD(16)
       ...
       movaps %xmm4, 304(%rsi)  # -> ZD(24) # ZD(19)
       movaps %xmm2, 288(%rsi)  # -> ZD(8) # ZD(18)
       ...
       movaps %xmm1,368(%rsi)  # -> ZD(28) # ZD(23)
       movaps %xmm5,352(%rsi)  # -> ZD(12) # ZD(22)
       movaps %xmm6,336(%rsi)  # -> ZD(20) # ZD(21)
       movaps %xmm3,320(%rsi)  # -> ZD(4) # ZD(20)       
...
##       movaps  %xmm0, 384(%rsi)   # ZC1o -> ZD(2) # ZD(24)
##    xmm0-> xmm8
       ...
       addpd %xmm8,%xmm7
       movaps  %xmm7, 448(%rsi)   # ZC1e+ZC3e -> ZD(6) # ZD(28)

       movaps %xmm1,%xmm8
       subpd %xmm5,%xmm1
       addpd %xmm8,%xmm5 # ZD1e+ZD3e 
       movaps  %xmm1, 464(%rsi)   # ZD1e-ZD3e -> ZD(26) # ZD(29)
       
       movaps .C4, %xmm8
       mulpd %xmm8,%xmm3
       mulpd %xmm8,%xmm5       
       movaps  %xmm3, 496(%rsi)   # -> ZD(22) # ZD(31)
       movaps  %xmm5, 480(%rsi)   # -> ZD(10) # ZD(30)
       ...
       movaps  %xmm2, 416(%rsi)   # ZD(14) # ZD(26)
       movaps  %xmm5, 400(%rsi)   # ZD(30) # ZD(25)
       
##       movaps  384(%rsi), %xmm0    # ZD(2)  # ZD(24)-> ZC1o
       ...
       movaps  %xmm0,432(%rsi)   # ZD(18) # ZD(27)
       movaps  %xmm5,384(%rsi)   # ZD(2) # ZD(24)
...
#       movaps  %xmm15, 128(%rsi)   # ZA2o -> ZD(3) # ZD(8)
#     xmm15-> xmm8
       ...
       subpd %xmm7,%xmm3  
       addpd %xmm8,%xmm7  
       movaps  %xmm3, 240(%rsi)   # ZA2e-ZA3e -> ZD(21) # ZD(15)
       movaps  %xmm7, 192(%rsi)   # ZA2e+ZA3e -> ZD(5) # ZD(12)

       movaps %xmm1,%xmm8
       subpd %xmm5,%xmm1
       addpd %xmm8,%xmm5
       movaps  %xmm1, 208(%rsi)   # ZB2e-ZB3e -> ZD(27) # ZD(13)
       movaps  %xmm5, 224(%rsi)   # ZB2e+ZB3e -> ZD(11) # ZD(14)
...
#       movaps  %xmm14, 160(%rsi)   # ZD(13) # ZD(10)
#       movaps  %xmm13, 144(%rsi)   # ZD(29) # ZD(9)
       
#       movaps 128(%rsi), %xmm15    # ZD(3) # ZD(8) -> ZA2o
...
#       movaps  %xmm15,176(%rsi)   # ZD(19) # ZD(11)
#       movaps  %xmm12, 128(%rsi)   # ZD(3) # ZD(8)
...
##       movaps  %xmm11, (%rsi)   # ZA1o -> ZD(1) # ZD(0)
##     xmm11 -> xmm8   
       ...
       subpd %xmm7,%xmm3  
       addpd %xmm8,%xmm7  
       movaps  %xmm3, 112(%rsi)   # ZA1e-ZA4e -> ZD(23) # ZD(7)
       movaps  %xmm7,  64(%rsi)   # ZA1e+ZA4e -> ZD(7) # ZD(4)

       movaps %xmm1,%xmm8
       subpd %xmm5,%xmm1
       addpd %xmm8,%xmm5
       movaps  %xmm1,  80(%rsi)   # ZB1e-ZB4e -> ZD(25) # ZD(5)
       movaps  %xmm5,  96(%rsi)   # ZB1e+ZB4e -> ZD(9) # ZD(6)
...
#       movaps  %xmm10, 32(%rsi)   # ZD(15) # ZD(2)
#       movaps  %xmm9, 16(%rsi)   # ZD(31) # ZD(1)
       
##       movaps  (%rsi), %xmm11    # ZD(1) # ZD(0) -> ZA1o 
...
#       movaps  %xmm11,48(%rsi)   # ZD(17) # ZD(3)
#       movaps  %xmm8, (%rsi)   # ZD(1) # ZD(0)

#-------------------------------------------------------------
# K=0

       movaps  64(%rsi), %xmm0  # ZD(7) # ZD(4)
       movaps 192(%rsi), %xmm1  # ZD(5) # ZD(12)       
       
       addpd %xmm1,%xmm0 # ZA

       movaps 320(%rsi), %xmm1  # ZD(4) # ZD(20)
       movaps 448(%rsi), %xmm3  # ZD(6) # ZD(28)
...
#       movaps 128(%rsi), %xmm0  # ZD(3) # ZD(8)
       movaps %xmm12, %xmm0  # ZD(3) # ZD(8)
#       movaps 176(%rsi), %xmm1  # ZD(19) # ZD(11)       
       movaps %xmm15, %xmm1  # ZD(19) # ZD(11)       
#       movaps 144(%rsi), %xmm2  # ZD(29) # ZD(9)
       movaps %xmm13, %xmm2  # ZD(29) # ZD(9)
#       movaps 160(%rsi), %xmm3  # ZD(13) # ZD(10)
...
#       movaps  (%rsi), %xmm1  # ZD(1) # ZD(0)
       movaps %xmm8, %xmm1  # ZD(1) # ZD(0)
#       movaps 32(%rsi), %xmm3  # ZD(15) # ZD(2)
       ...
       movaps 256(%rsi), %xmm0  # ZD(0) # ZD(16)
       movaps 384(%rsi), %xmm2  # ZD(2) # ZD(24)
       
       addpd %xmm2,%xmm0     # ZC

       movaps 416(%rsi), %xmm2  # ZD(14) # ZD(26)
       movaps 288(%rsi), %xmm4  # ZD(8) # ZD(18)
       ...
       movaps %xmm1, 496(%rdi)   # Z(31)
       movaps %xmm2,  16(%rdi)   # Z(1)
       movaps %xmm0, 272(%rdi)   # Z(17)
       movaps %xmm3, 240(%rdi)   # Z(15)       
...
# K=2
       ...
       movaps 112(%rsi), %xmm0  # ZD(23) # ZD(7)
       movaps 240(%rsi), %xmm1  # ZD(21) # ZD(15)
       movaps  96(%rsi), %xmm2  # ZD(9) # ZD(6)       
       movaps 224(%rsi), %xmm3  # ZD(11) # ZD(14)       
       ...
       movaps  352(%rsi), %xmm1  # ZD(12) # ZD(22)
       movaps  496(%rsi), %xmm3  # ZD(22) # ZD(31)
       addpd %xmm3,%xmm1 # ZC

       movaps  368(%rsi), %xmm4  # ZD(28) # ZD(23)
       movaps  480(%rsi), %xmm3  # ZD(10) # ZD(30)
       addpd %xmm4,%xmm3
       shufpd $1,%xmm3,%xmm3
       xorpd %xmm7,%xmm3 # ZD
       ...
       movaps %xmm0, 480(%rdi)   # Z(30)
       movaps %xmm3,  32(%rdi)   # Z(2)       
       movaps %xmm1, 288(%rdi)   # Z(18)       
       movaps %xmm2, 224(%rdi)   # Z(14)

#-------------------------------------------------------------
# K=3
       movaps .C4, %xmm6

#       movaps 48(%rsi), %xmm0  # ZD(17) # ZD(3)
       movaps %xmm11, %xmm0  # ZD(17) # ZD(3)
#       movaps  (%rsi), %xmm1  # ZD(1) # ZD(0)
       movaps  %xmm8, %xmm1  # ZD(1) # ZD(0)
#       movaps  16(%rsi), %xmm2  # ZD(31) # ZD(1)
...
#       movaps 144(%rsi), %xmm3  # ZD(29) # ZD(9)
       movaps %xmm13, %xmm3  # ZD(29) # ZD(9)
#       movaps 176(%rsi), %xmm0  # ZD(19) # ZD(11)
       ...
       movaps 272(%rsi), %xmm0  # ZD(16) # ZD(17)
       movaps 432(%rsi), %xmm2  # ZD(18) # ZD(27)
       
       addpd %xmm2,%xmm0     # ZC

       movaps 304(%rsi), %xmm4  # ZD(24) # ZD(19)
       movaps 400(%rsi), %xmm2  # ZD(30) # ZD(25)
       ...
       movaps %xmm1, 464(%rdi)   # Z(29)       
       movaps %xmm2,  48(%rdi)   # Z(3)
       movaps %xmm0, 304(%rdi)   # Z(19)       
       movaps %xmm3, 208(%rdi)   # Z(13)
...
# K=4
       ...
       movaps  64(%rsi), %xmm0  # ZD(7) # ZD(4)
       movaps 192(%rsi), %xmm1  # ZD(5) # ZD(12)       
       movaps  80(%rsi), %xmm2  # ZD(25) # ZD(5)       
       movaps 208(%rsi), %xmm3  # ZD(27) # ZD(13)
       ...
       movaps  464(%rsi), %xmm1  # ZD(26) # ZD(29)
       movaps  336(%rsi), %xmm3  # ZD(20) # ZD(21)=ZC
       shufpd $1,%xmm1,%xmm1
       xorpd %xmm7,%xmm1 # ZD
       ...
       movaps %xmm0, 448(%rdi)   # Z(28)       
       movaps %xmm1,  64(%rdi)   # Z(4)
       movaps %xmm3, 320(%rdi)   # Z(20)
       movaps %xmm2, 192(%rdi)   # Z(12)       
...
#       movaps 160(%rsi), %xmm3  # ZD(13) # ZD(10)
       ...
       movaps %xmm8, 432(%rdi)   # Z(27)
       movaps %xmm2,  80(%rdi)   # Z(5)
       movaps %xmm0, 336(%rdi)   # Z(21)       
       movaps %xmm3, 176(%rdi)   # Z(11)
...
#       movaps .C2,%xmm5
       ...
       movaps %xmm0, 416(%rdi)   # Z(26)       
       movaps %xmm3,  96(%rdi)   # Z(6)
       movaps %xmm1, 352(%rdi)   # Z(22)
       movaps %xmm2, 160(%rdi)   # Z(10)       
...
#       movaps 48(%rsi), %xmm1  # ZD(17) # ZD(3)
#       movaps %xmm11, %xmm1  # ZD(17) # ZD(3)
#       movaps 16(%rsi), %xmm3  # ZD(31) # ZD(1)
#       movaps %xmm9, %xmm3  # ZD(31) # ZD(1)
       ...
       movaps %xmm11, 400(%rdi)   # Z(25)
       movaps %xmm2, 112(%rdi)   # Z(7)
       movaps %xmm0, 368(%rdi)   # Z(23)       
       movaps %xmm9, 144(%rdi)   # Z(9)
...
# K=8
       ...
       movaps %xmm1, 384(%rdi)   # Z(24)       
       movaps %xmm2, 128(%rdi)   # Z(8)       

#-------------------------------------------------------------       
#  rfft のための後処理

      addq $1024,%r10
      movq $512,%r9  # %r9 に (N/2)*16 が入る

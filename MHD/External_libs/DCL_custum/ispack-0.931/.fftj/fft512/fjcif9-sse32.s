...
# 02110-1301 USA.
########################################################################
# fft 512 in-place forward (16x32 type)
.text
.globl fjcif9_
fjcif9_:
...
# K=1
       ...
       movaps %xmm2,  256(%eax)   # Z(1) !
       movaps %xmm1, 7936(%eax)   # Z(31) !
       movaps %xmm3, 3840(%eax)   # Z(15) !
       movaps %xmm0, 4352(%eax)   # Z(17) !
...
# K=7
       ...
       movaps %xmm2, 1792(%eax)   # Z(7) !
       movaps %xmm1, 6400(%eax)   # Z(25) !
       movaps %xmm3, 2304(%eax)   # Z(9) !
       movaps %xmm0, 5888(%eax)   # Z(23) !
...
# K=3
       ...
       movaps %xmm2,  768(%eax)   # Z(3) !
       movaps %xmm1, 7424(%eax)   # Z(29) !
       movaps %xmm3, 3328(%eax)   # Z(13) !
       movaps %xmm0, 4864(%eax)   # Z(19) !
...
# K=5
       ...
       movaps %xmm2,  1280(%eax)   # Z(5) !
       movaps %xmm1,  6912(%eax)   # Z(27) !
       movaps %xmm3,  2816(%eax)   # Z(11) !
       movaps %xmm0,  5376(%eax)   # Z(21) !
...
# K=0,8
       ...
       movaps %xmm0,      (%eax)   # Z(0) !
       movaps %xmm3,  4096(%eax)   # Z(16) !
       movaps %xmm2,  2048(%eax)   # Z(8) !
       movaps %xmm1,  6144(%eax)   # Z(24) !
...
# K=4
       ...
       movaps %xmm1,  1024(%eax)   # Z(4) !
       movaps %xmm0,  7168(%eax)   # Z(28) !
       movaps %xmm2,  3072(%eax)   # Z(12) !
       movaps %xmm3,  5120(%eax)   # Z(20) !
...
# K=2
       ...
       movaps %xmm3,  512(%eax)   # Z(2) !
       movaps %xmm0, 7680(%eax)   # Z(30) !
       movaps %xmm2, 3584(%eax)   # Z(14) !
       movaps %xmm1, 4608(%eax)   # Z(18) !
...
# K=6
       ...
       movaps %xmm3,  1536(%eax)   # Z(6) !
       movaps %xmm0,  6656(%eax)   # Z(26) !
       movaps %xmm2,  2560(%eax)   # Z(10) !
       movaps %xmm1,  5632(%eax)   # Z(22) !
...
.align 16
.C1D:
      .long 0xcff75cb0,0x3fef6297,0xcff75cb0,0xbfef6297
.align 16
.S1:
      .long 0x3c69a60b,0x3fc8f8b8,0x3c69a60b,0x3fc8f8b8
.align 16
.S1D:
      .long 0x3c69a60b,0x3fc8f8b8,0x3c69a60b,0xbfc8f8b8
.align 16
.C2:
      .long 0xcf328d46,0x3fed906b,0xcf328d46,0x3fed906b
.align 16
.C2D:
      .long 0xcf328d46,0x3fed906b,0xcf328d46,0xbfed906b
.align 16
.S2:
      .long 0xa6aea963,0x3fd87de2,0xa6aea963,0x3fd87de2
.align 16
.S2D:
      .long 0xa6aea963,0x3fd87de2,0xa6aea963,0xbfd87de2
.align 16
.C3:
      .long 0x290ea1a3,0x3fea9b66,0x290ea1a3,0x3fea9b66
.align 16
.C3D:
      .long 0x290ea1a3,0x3fea9b66,0x290ea1a3,0xbfea9b66
.align 16
.S3:
      .long 0x39ae68c8,0x3fe1c73b,0x39ae68c8,0x3fe1c73b
.align 16
.S3D:
      .long 0x39ae68c8,0x3fe1c73b,0x39ae68c8,0xbfe1c73b
.align 16
.C4:

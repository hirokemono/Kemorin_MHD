...
************************************************************************
************************************************************************
* rfft 2048 out-of-place backward
*-----------------------------------------------------------------------
      SUBROUTINE FJROBB(Z,ZD,ZDD,ZT)
...
*-----------------------------------------------------------------------
      ...
      DO K=1,511
        ZTMP1=(Z(K)-CONJG(Z(1024-K)))*ZT(1024+K)
        ZTMP0=Z(K)+CONJG(Z(1024-K))
        ZDD(K)=ZTMP0+ZTMP1
        ZDD(1024-K)=CONJG(ZTMP0-ZTMP1)
      END DO
      ZDD(512)=2*CONJG(Z(512))

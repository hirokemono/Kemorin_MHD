...
#-----------------------------------
       ...
       movaps %xmm12,512(%rdi)
       movaps %xmm3,1536(%rdi)
       movaps %xmm9,2560(%rdi)
       movaps %xmm1,3584(%rdi)       
...
#-----------------------------------       
       ...
       movaps %xmm13,256(%rdi)
       movaps %xmm6,1792(%rdi)
       movaps %xmm5,2304(%rdi)
       movaps %xmm0,3840(%rdi)       
       
#-----------------------------------

       movaps (%rdi), %xmm6
       movaps 1024(%rdi), %xmm0
       movaps 3072(%rdi), %xmm13
       ...
       movaps %xmm4,(%rdi)
       movaps %xmm1,1024(%rdi)
       movaps %xmm8,2048(%rdi)       
       movaps %xmm6,3072(%rdi)
...
#-----------------------------------       
       ...
       movaps %xmm7,768(%rdi)
       movaps %xmm13,1280(%rdi)
       movaps %xmm0,2816(%rdi)
       movaps %xmm10,3328(%rdi)              
...
.L2:
       movaps      (%rdi),%xmm0
       movaps  4096(%rdi),%xmm1
       movaps  8192(%rdi),%xmm2
       movaps 12288(%rdi),%xmm3       
       ...
       movaps %xmm4, 8192(%rdi)
       movaps %xmm5,12288(%rdi)

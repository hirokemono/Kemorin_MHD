...
************************************************************************
************************************************************************
*     initialize table for rfft2048 (for sse32) (backward)
*-----------------------------------------------------------------------
      SUBROUTINE FJRTBB(XT)
      ...
      DO K=0,511
        XT(1,1,1024+K)=-SIN(2*PI*K/2048)
        XT(2,1,1024+K)=-SIN(2*PI*K/2048)
        XT(1,2,1024+K)=-COS(2*PI*K/2048)
        XT(2,2,1024+K)= COS(2*PI*K/2048)
      END DO

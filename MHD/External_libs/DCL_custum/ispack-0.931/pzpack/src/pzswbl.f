...
************************************************************************
************************************************************************
*     浅水方程式の初期値化                                    2009/05/25
************************************************************************
      SUBROUTINE PZSWBL(LM,KM,JM,IM,R,BARPHI,AVT,PHI,
     &  WS,WG,ITJ,TJ,ITI,TI)
...
* U=WG(1,2), V=WG(1,3)      
      ...
      CALL PZS2GA(LM,KM,JM,IM,WS,WG(1,2),WG,ITJ,TJ,ITI,TI)
      CALL PZS2GA(LM,KM,JM,IM,PHI,WG(1,3),WG,ITJ,TJ,ITI,TI)
...
* -(U*U+V*V)/2 --> PHI
      ...
      CALL PZG2SA(LM,KM,JM,IM,WG(1,4),PHI,WG,ITJ,TJ,ITI,TI)      

...
L1:	vsubpd %zmm1,%zmm1,%zmm1
	vsubpd %zmm3,%zmm3,%zmm3
	vsubpd %zmm5,%zmm5,%zmm5
	vsubpd %zmm7,%zmm7,%zmm7
	vsubpd %zmm9,%zmm9,%zmm9	

	vmovapd   (%rsi,%rax), %zmm0 # X(1,0)
	vsubpd 64(%rsi,%rax), %zmm1, %zmm1 # X(2,0)
	vmovapd   (%rdx,%rax), %zmm2 # X(1,1)
	vsubpd 64(%rdx,%rax), %zmm3, %zmm3 # X(2,1)
	vmovapd   (%r8, %rax), %zmm4 # X(1,2)
	vsubpd 64(%r8, %rax), %zmm5, %zmm5 # X(2,2)
	vmovapd   (%r9, %rax), %zmm6 # X(1,3)
	vsubpd 64(%r9, %rax), %zmm7, %zmm7 # X(2,3)
	vmovapd   (%r10,%rax), %zmm8 # X(1,4)
	vsubpd 64(%r10,%rax), %zmm9, %zmm9 # X(2,4)

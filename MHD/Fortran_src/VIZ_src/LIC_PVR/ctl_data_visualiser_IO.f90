...
!
     ...
     &                            viz_ctls%psf_ctls, c_buf, error_file)
        if(error_file) return
...
!
     ...
     &                            viz_ctls%iso_ctls, c_buf, error_file)
        if(error_file) return

...
!!     &         (istep_pvr, time, mesh, group, lic_param, field_lic,   &
!!     &          pvr_rgb, pvr_param, pvr_proj)
!!      subroutine anaglyph_lic_rendering_w_rot                         &
!!     &         (istep_pvr, time, viz_fem, field_lic, lic_param,       &
!!     &          pvr_rgb, pvr_param, pvr_proj)
...
!
     ...
     &      lic_param, field_lic, pvr_param, pvr_proj,                  &
...
!    Left eye
     ...
     &      lic_param, field_lic, pvr_param, pvr_proj(1),               &
     &      rot_imgs1%rot_pvr_rgb(i_rot))
...
!    Right eye
        call rendering_lic_at_once                                      &
     &     (istep_pvr, time, viz_fem%mesh, viz_fem%group,               &
     &      lic_param, field_lic, pvr_param, pvr_proj(2),               &
     &      rot_imgs1%rot_pvr_rgb(i_rot))

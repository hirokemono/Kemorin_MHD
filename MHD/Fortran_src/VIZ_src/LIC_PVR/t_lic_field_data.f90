...
!
!
      field_lic%nnod_lic = node%numnod
      allocate(field_lic%d_lic(field_lic%nnod_lic))
      allocate(field_lic%v_lic(field_lic%nnod_lic,3))
      if(field_lic%nnod_lic .gt. 0) then
!$omp parallel workshare
        field_lic%d_lic(1:field_lic%nnod_lic) =   0.0d0
        field_lic%v_lic(1:field_lic%nnod_lic,1) = 0.0d0
        field_lic%v_lic(1:field_lic%nnod_lic,2) = 0.0d0
        field_lic%v_lic(1:field_lic%nnod_lic,3) = 0.0d0
!$omp end parallel workshare
      end if
!
      field_lic%num_mask = num_masking
      allocate(field_lic%s_lic(field_lic%nnod_lic,field_lic%num_mask))
      if(field_lic%nnod_lic*num_masking .gt. 0) then
!$omp parallel workshare
        field_lic%s_lic(1:field_lic%nnod_lic,1:field_lic%num_mask)      &
     &      = 0.0d0
!$omp end parallel workshare
      end if
!

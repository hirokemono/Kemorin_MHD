...
!
      call gz_read_geometry_info(FPz_p, id_rank, particle_IO%node,      &
     &                           zbuf_p, ierr)
...
!
     ...
     &                            particle_IO%sfed, zbuf_p)
!
      call read_gz_step_data(FPz_p, t_IO%i_time_step, t_IO%time,        &
     &                       t_IO%dt, zbuf_p, ierr)
...
!
     ...
     &                                particle_IO%sfed, zbuf_p)
!
      call write_gz_step_data(FPz_p, t_IO%i_time_step, t_IO%time,       &
     &                        t_IO%dt, zbuf_p)
      call close_gzfile_a(FPz_p, zbuf_p)
!

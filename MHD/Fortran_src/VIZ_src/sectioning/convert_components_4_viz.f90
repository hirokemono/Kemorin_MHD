...
!
     ...
     &        dat_xyz(1,1), dat_viz(1,1), xx, sph_r, a_r)
...
!
     ...
     &        dat_xyz(1,1), dat_viz(1,1), xx, sph_r, cyl_s, a_r)
!
...
!
     ...
     &        dat_xyz(1,1), dat_viz(1,1), xx, sph_r, cyl_s, a_s)
!
!

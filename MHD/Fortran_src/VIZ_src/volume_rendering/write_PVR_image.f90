...
!!     &          pvr_start, rgba_real_gl, pvr_img, pvr_rgb)
...
!  ---------------------------------------------------------------------
!
      subroutine composit_by_segmentad_image                            &
     &         (istep_pvr, pvr_start, pvr_stencil, pvr_img, pvr_rgb)
!
      use m_elapsed_labels_4_VIZ
      use t_pvr_image_array
...
!
     ...
     &   (pvr_stencil, pvr_img, pvr_rgb, rgba_gl)
      deallocate(rgba_gl)
!
      end subroutine composit_by_segmentad_image
!
!  ---------------------------------------------------------------------
!

...
!!     &          pvr_section_p, pvr_isos_p, color_param,               &
...
!
     ...
     &       viewpoint_vec, field_pvr, draw_param, pvr_section_p,       &
...
!
     ...
     &        draw_param, pvr_section_p, num_isosurf, pvr_iso_p,        &
     &        color_param, ray_vec4, iflag_check, isurf_org,            &
     &        screen4_st, xx4_st, xi, rgba_ray, icount_line,            &
     &        iflag_comm)
!
...
!
      ...
      real(kind = kreal) :: grad_tgt(3), xx4_tgt(4), rflag, rflag2, ratio
...
!
     ...
     &            c_mid(1), grad_tgt, pvr_iso_p(i_iso)%iso_opacity,     &

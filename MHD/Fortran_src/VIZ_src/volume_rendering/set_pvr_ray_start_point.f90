...
!
      integer(kind = kint) :: inum, icou, iele, k1, isurf, iflag
      integer(kind = kint) :: ist_pix, ied_pix, jst_pix, jed_pix
...
!
!
!$omp parallel do private(inum,icou,iele,k1,isurf,x_surf,ipix,jpix,     &
!$omp&                    ist_pix,ied_pix,jst_pix,jed_pix,id_pixel,     &
!$omp&                    iflag,x_pix,xi)
      do inum = 1, num_pvr_surf

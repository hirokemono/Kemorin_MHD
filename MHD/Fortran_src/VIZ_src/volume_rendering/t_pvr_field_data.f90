...
!
!
      field_pvr%numnod = nnod
      field_pvr%numele = nele
      allocate(field_pvr%d_pvr(field_pvr%numnod))
      allocate(field_pvr%grad_ele(field_pvr%numele,3))
!
      if(field_pvr%numnod .gt. 0) field_pvr%d_pvr =    0.0d0
      if(field_pvr%numele .gt. 0) field_pvr%grad_ele = 0.0d0
!

...
!
     ...
     &    VIZ_DAT%inod_dbl, VIZ_DAT%iele_dbl, VIZ_DAT%isurf_dbl, VIZ_DAT%next_tbl,         &
     &    VIZ_DAT%para_surf%isf_4_ele_dbl,   &
     &    VIZ_DAT%para_surf%iele_4_surf_dbl, nod_fld, vizs%fline)

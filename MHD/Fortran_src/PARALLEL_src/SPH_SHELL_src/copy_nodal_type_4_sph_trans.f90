...
!
     ...
     &    node%numnod, node%internal_node, node%xx, ncomp_trans,        &
     &    i_trns, d_rtp, i_field, nod_fld%ntot_phys, nod_fld%d_fld)
!
...
!
     ...
     &    node%theta, node%phi, ncomp_trans, i_trns, d_rtp,             &
...
!
     ...
     &    node%numnod, node%internal_node, node%xx, node%rr,            &
     &    node%ss, node%a_r, node%a_s, ncomp_trans, i_trns, d_rtp,      &
     &    i_field, nod_fld%ntot_phys, nod_fld%d_fld)
!

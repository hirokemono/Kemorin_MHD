...
!
      ...
      call sum_sph_layerd_pwr(sph_params%l_truncation, sph_rj, ipol,    &
     &                        rj_fld, leg%g_sph_rj, pwr, WK_pwr)
!,
...
!
     ...
     &    rj_fld1, rj_fld2, leg%g_sph_rj, cor, WK_pwr)
!
      if(iflag_debug .gt. 0) write(*,*) 'global_sum_sph_layerd_square'
      call global_sum_sph_layerd_square                                 &
...
!
     ...
     &     (pwr%nri_rms, pwr%ntot_comp_sq, pwr%r_4_rms, pwr%shl_sq)
        call surf_ave_4_sph_rms                                         &
     &     (pwr%nri_rms, pwr%ntot_comp_sq, pwr%r_4_rms, pwr%shl_m0)
!
...
!
     ...
     &      pwr%nri_rms, pwr%ntot_comp_sq, pwr%r_4_rms, pwr%shl_m)
      end if
      if(my_rank .eq. pwr%irank_l) then
        call surf_ave_4_sph_rms_int(sph_params%l_truncation,            &
     &      pwr%nri_rms, pwr%ntot_comp_sq, pwr%r_4_rms, pwr%shl_l)
      end if
      if(my_rank .eq. pwr%irank_lm) then
        call surf_ave_4_sph_rms_int(sph_params%l_truncation,            &
     &      pwr%nri_rms, pwr%ntot_comp_sq, pwr%r_4_rms, pwr%shl_lm)
      end if
!

!>@file   sph_rtp_domain_real_rocFFT.f90
!!@brief  module sph_rtp_domain_real_rocFFT
!!
!!@author H. Matsui
...
!!@verbatim
!! ------------------------------------------------------------------
!!      subroutine rtp_dmn_fwd_real_rocFFT_to_send                      &
...
!!      subroutine rtp_dmn_bwd_real_rocFFT_fm_recv(sph_rtp, comm_rtp,   &
...
!!@endverbatim
!!
      module sph_rtp_domain_real_rocFFT
!
      use iso_c_binding
!
      use m_precision
...
!   normalization
        ...
        call pout_real_rocFFT_dmn_to_send                               &
     &     (nd, sph_rtp%istack_rtp_rt_smp(np_smp),                      &
     &      int(WK_rocFFT%Nfft_r), ncomp_fwd, WK_rocFFT%X_rocFFT(1),    &
     &      comm_sph_rocFFT, n_WS, WS)
        if(iflag_FFT_time) call end_elapsed_time(ist_elapsed_FFT+6)
      end do
!
      end subroutine rtp_dmn_fwd_real_rocFFT_to_send
!
! ------------------------------------------------------------------
!
      subroutine rtp_dmn_bwd_real_rocFFT_fm_recv(sph_rtp, comm_rtp,     &
...
!
      do nd = 1, ncomp_bwd
        ...
        call pout_real_rocFFT_dmn_from_recv                             &
     &     (nd, sph_rtp%istack_rtp_rt_smp(np_smp), sph_rtp%nnod_rtp,    &
     &      ncomp_bwd, n_WR, comm_rtp%irev_sr, WR(1),                   &
     &      int(WK_rocFFT%Nfft_r), WK_rocFFT%X_rocFFT(1))
        if(iflag_FFT_time) call end_elapsed_time(ist_elapsed_FFT+1)
!
        if(iflag_FFT_time) call start_elapsed_time(ist_elapsed_FFT+2)
        call calypso_backward_rocFFT_r2r(rocFFT_bwd%rocFFT_plan,        &
...
!
      end subroutine rtp_dmn_bwd_real_rocFFT_fm_recv
!
! ------------------------------------------------------------------
!
      end module sph_rtp_domain_real_rocFFT

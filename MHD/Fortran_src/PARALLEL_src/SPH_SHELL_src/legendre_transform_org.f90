...
!!      subroutine leg_bwd_trans_grad_org(nb)
...
!!      subroutine leg_fwd_trans_grad_org(nb)
...
!
      call clear_b_trans_vector(nb)
      call legendre_b_trans_grad_org(nb)
!
      end subroutine leg_bwd_trans_grad_org
!
! -----------------------------------------------------------------------
! -----------------------------------------------------------------------
!
...
!
      ...
      call legendre_f_trans_grad_org(nb)
!
...
!
      ...
      call legendre_f_trans_grad_org(nb)
!
      end subroutine leg_fwd_trans_grad_org
!
! -----------------------------------------------------------------------
!

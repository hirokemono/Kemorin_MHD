...
!!      subroutine leg_bwd_trans_grad_krin(nb)
...
!!      subroutine leg_fwd_trans_grad_krin(nb)
...
!
!
      call order_b_trans_grad_krin(nb)
      call clear_b_trans_vector_krin(nb)
!
      call legendre_b_trans_grad_krin(nb)
!
      call back_b_trans_vector_krin(nb)
!
      end subroutine leg_bwd_trans_grad_krin
!
! ----------------------------------------------------------------------! ! -----------------------------------------------------------------------
!
      subroutine leg_fwd_trans_vector_krin(nb)
...
!
      call order_f_trans_vector_krin(nb)
      call clear_f_trans_grad_krin(nb)
!
      call legendre_f_trans_grad_krin(nb)
!
      call back_f_trans_grad_krin(nb)
!
      end subroutine leg_fwd_trans_grad_krin
!
! -----------------------------------------------------------------------
!

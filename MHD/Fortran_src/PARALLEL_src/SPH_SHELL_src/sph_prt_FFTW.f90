...
!
      ...
      integer(kind = 4) :: howmany_bwd, howmany_fwd
!
...
!
     ...
     &           - sph_rtp%istack_rtp_rt_smp(ip-1))
        howmany_bwd = ncomp_bwd * howmany
        howmany_fwd = ncomp_fwd * howmany
...
!
     ...
     &      IONE_4, int(FFTW_f%Nfft_r), howmany_fwd,                    &
     ...
     &      IONE_4, int(FFTW_f%Nfft_r), howmany_bwd,                    &
     &      FFTW_f%C(ist_c+1), inembed, istride, idist_c,               &
     &      FFTW_f%X(ist_r+1), inembed, istride, idist_r,               &
     &      FFTW_ESTIMATE)
      end do

!>@file   sph_prt_OMP_FFTW_selector.F90
!!@brief  module sph_prt_OMP_FFTW_selector
!!
!!@author H. Matsui
...
!!
!!@verbatim
!!      subroutine sel_init_prt_OMP_FFTW(id_rank, iflag_size,           &
!!     &          sph_rtp, comm_rtp, ncomp_bwd, ncomp_fwd,              &
!!     &          sph_fld_FFTW, flag_FFT)
!!      subroutine sel_finalize_prt_OMP_FFTW(iflag_size,                &
!!     &                                     sph_fld_FFTW, flag_FFT)
!!      subroutine sel_verify_prt_OMP_FFTW                              &
...
!! ------------------------------------------------------------------
!!
!!      subroutine sel_prt_fwd_OMP_FFTW_to_send(iflag_size,             &
...
!! ------------------------------------------------------------------
!!
!!      subroutine sel_prt_bwd_OMP_FFTW_from_recv(iflag_size,           &
...
!
      module sph_prt_OMP_FFTW_selector
!
      use m_precision
...
!
      end subroutine sel_init_prt_OMP_FFTW
!
! ------------------------------------------------------------------
!
      subroutine sel_finalize_prt_OMP_FFTW(iflag_size,                  &
...
!
      end subroutine sel_verify_prt_OMP_FFTW
!
! ------------------------------------------------------------------
! ------------------------------------------------------------------
!
...
!
      end subroutine sel_prt_fwd_OMP_FFTW_to_send
!
! ------------------------------------------------------------------
!
      subroutine sel_prt_bwd_OMP_FFTW_from_recv(iflag_size,             &
...
!
      end subroutine sel_prt_bwd_OMP_FFTW_from_recv
!
! ------------------------------------------------------------------
!
      end module sph_prt_OMP_FFTW_selector

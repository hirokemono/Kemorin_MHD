!>@file   sph_prt_real_rocFFT.f90
!!@brief  module sph_prt_real_rocFFT
!!
!!@author H. Matsui
...
!!@verbatim
!! ------------------------------------------------------------------
!!      subroutine prt_fwd_real_rocFFT_to_send(sph_rtp, comm_sph_rocFFT,&
...
!!      subroutine prt_bwd_real_rocFFT_from_recv(sph_rtp, comm_rtp,     &
...
!
      ...
      call pin_real_rocFFT_all_from_recv                                &
...
!
      end subroutine prt_bwd_real_rocFFT_from_recv
!
! ------------------------------------------------------------------
!
      end module sph_prt_real_rocFFT

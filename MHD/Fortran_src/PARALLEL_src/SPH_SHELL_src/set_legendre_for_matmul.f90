...
!!     &          Pg3_je, dPdt_je, Pgv_je, Pg3_jo, dPdt_jo, Pgv_jo)
...
!
      ...
      real(kind = kreal), intent(inout) :: Pgv_jo(num_lj)
!
...
!   even l-m
      do jj = 1, n_jk_e
        ...
        do lp_rtm = 1, nl_rtm
          ...
          Pg3_je(i_lj) =  P_jl(j_rlm,lp_rtm) * g_sph_rlm(j_rlm,3)
          dPdt_je(i_lj) = dPdt_jl(j_rlm,lp_rtm)
          Pgv_je(i_lj) = -P_jl(j_rlm,lp_rtm)                            &
     &                     * dble(idx_gl_1d_rlm_j(j_rlm,3))             &
     &                      *asin_theta_1d_rtm(lp_rtm)
        end do
      end do
!   odd l-m
      do jj = 1, n_jk_o
        ...
        do lp_rtm = 1, nl_rtm
          i_lj = lp_rtm + (jj-1) * nl_rtm
          Pg3_jo(i_lj) = P_jl(j_rlm,lp_rtm) * g_sph_rlm(j_rlm,3)
          dPdt_jo(i_lj) = dPdt_jl(j_rlm,lp_rtm)
          Pgv_jo(i_lj) = -P_jl(j_rlm,lp_rtm)                            &
     &                     * dble(idx_gl_1d_rlm_j(j_rlm,3))             &
     &                      *asin_theta_1d_rtm(lp_rtm)
        end do
      end do

...
!$omp end parallel
!
      end subroutine sph_back_trans_4_grad
!
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
!
...
!
      ...
      use copy_sph_field_4_sph_trans
!
      integer(kind = kint), intent(in)  :: is_fld, irtp_fld, is_grad
!
!
      if( (is_fld*is_grad*irtp_fld) .gt. 0) return
!
...
!$omp end parallel
!
      call sph_f_trans_grad_v(ione)
!
!$omp parallel
      call copy_grad_spec_from_trans(ione, is_fld, is_grad, ione)
!$omp end parallel
!
      end subroutine sph_forward_trans_4_grad
!
!-----------------------------------------------------------------------
!

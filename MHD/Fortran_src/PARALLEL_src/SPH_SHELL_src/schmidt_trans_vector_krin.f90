!schmidt_trans_vector_krin.f90
!      module schmidt_trans_vector_krin
!
!     Written by H. Matsui on Aug., 2007
!
!      subroutine schmidt_b_trans_vector_krin(nb)
!      subroutine schmidt_b_trans_vector_1(nb)
!        Input:  sp_rlm_1   (Order: poloidal,diff_poloidal,toroidal)
!        Output: vr_rtm_1   (Order: radius,theta,phi)
!
!      subroutine schmidt_f_trans_vector_krin(nb)
!      subroutine schmidt_f_trans_vector_1(nb)
...
!
      implicit none
!
      private :: schmidt_b_trans_vector_1, schmidt_f_trans_vector_1
!
! -----------------------------------------------------------------------
!
      contains
...
!
!
      call order_b_trans_vector_1(nb)
      call clear_b_trans_vector_1(nb)
!
      call schmidt_b_trans_vector_1(nb)
!
      call back_b_trans_vector_1(nb)
!
      end subroutine schmidt_b_trans_vector_krin
!
! -----------------------------------------------------------------------
!
      subroutine schmidt_f_trans_vector_krin(nb)
...
!
      ...
      call clear_f_trans_vector_1(nb)
!
      call schmidt_f_trans_vector_1(nb)
!
      call back_f_trans_vector_1(nb)
!
      end subroutine schmidt_f_trans_vector_krin
!
! -----------------------------------------------------------------------
! -----------------------------------------------------------------------
!
...
!cdir nodep
     ...
     &                     + sp_rlm_1(kr_nd,j_rlm,2) * dp_tmp
              vr_rtm_1(kr_nd,ip_rtm_1,3) = vr_rtm_1(kr_nd,ip_rtm_1,3)   &
     &                     - sp_rlm_1(kr_nd,j_rlm,3) * dp_tmp
            end do
          end do
!
        end do
...
!cdir nodep
            do kr_nd = 1, nb_nri
!
              vr_rtm_1(kr_nd,in_rtm_1,2) = vr_rtm_1(kr_nd,in_rtm_1,2)   &
     &                       + sp_rlm_1(kr_nd,j_rlm,3) * pg_tmp
              vr_rtm_1(kr_nd,in_rtm_1,3) = vr_rtm_1(kr_nd,in_rtm_1,3)   &
     &                       + sp_rlm_1(kr_nd,j_rlm,2) * pg_tmp
            end do
          end do
!
        end do
...
!$omp end parallel do
!
      end subroutine schmidt_b_trans_vector_1
!
! -----------------------------------------------------------------------
!
      subroutine schmidt_f_trans_vector_1(nb)
...
!cdir nodep
     ...
     &                   - vr_rtm_1(kr_nd,in_rtm_1,3) * pgwt_tmp)
              sp_rlm_1(kr_nd,j_rlm,3) = sp_rlm_1(kr_nd,j_rlm,3)         &
     &                 - ( vr_rtm_1(kr_nd,in_rtm_1,2) * pgwt_tmp        &
     &                   + vr_rtm_1(kr_nd,ip_rtm_1,3) * dpwt_tmp)
            end do
          end do
!
!        do k_rtm = 1, nidx_rtm(1)
...
!$omp end parallel do
!
      end subroutine schmidt_f_trans_vector_1
!
! -----------------------------------------------------------------------
!
      end module schmidt_trans_vector_krin

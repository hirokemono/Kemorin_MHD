!>@file   sph_prt_OpenMP_rocFFT.f90
!!@brief  module sph_prt_OpenMP_rocFFT
!!
!!@author H. Matsui
...
!!@verbatim
!! ------------------------------------------------------------------
!!      subroutine prt_fwd_OMP_rocFFT_to_send(sph_rtp, comm_sph_rocFFT, &
...
!!      subroutine prt_bwd_OMP_rocFFT_from_recv(sph_rtp, comm_rtp,      &
...
!
      end subroutine prt_fwd_OMP_rocFFT_to_send
!
! ------------------------------------------------------------------
!
      subroutine prt_bwd_OMP_rocFFT_from_recv(sph_rtp, comm_rtp,        &
...
! ------------------------------------------------------------------
!
      end module sph_prt_OpenMP_rocFFT

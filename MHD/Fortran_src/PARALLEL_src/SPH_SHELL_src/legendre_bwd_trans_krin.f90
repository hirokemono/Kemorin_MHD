...
!!        Input:  vr_rtm_krin
!!        Output: sp_rlm_krin
!!      subroutine legendre_b_trans_grad_krin(nb)
!!        Input:  vr_rtm_krin   (Order: radius,theta,phi)
!!        Output: sp_rlm_krin   (Order: poloidal,diff_poloidal)
!!@endverbatim
!!
...
!
              vr_rtm_krin(kr_nd,ip_rtm_1,1)                             &
     &              = vr_rtm_krin(kr_nd,ip_rtm_1,1)                     &
     &               + sp_rlm_krin(kr_nd,j_rlm,2) * P_rtm(l_rtm,j_rlm)
              vr_rtm_krin(kr_nd,ip_rtm_1,2)                             &
     &              = vr_rtm_krin(kr_nd,ip_rtm_1,2)                     &
     &               + sp_rlm_krin(kr_nd,j_rlm,1) * dp_tmp
              vr_rtm_krin(kr_nd,in_rtm_1,3)                             &
     &              = vr_rtm_krin(kr_nd,in_rtm_1,3)                     &
     &               + sp_rlm_krin(kr_nd,j_rlm,1) * pg_tmp
            end do
...
!$omp end parallel do
!
      end subroutine legendre_b_trans_grad_krin
!
! -----------------------------------------------------------------------
!

!>@file   radial_int_for_sph_spec_old.f90
!!@brief  module radial_int_for_sph_spec_old
!!
!!@author H. Matsui
...
!!
!!@verbatim
!!      subroutine radial_integration_old(jmax, nri, kg_st, kg_ed, radius,  &
...
!
      module radial_int_for_sph_spec_old
!
      use m_precision
      use m_constants
!
...
!      end if
!
      end subroutine radial_integration_old
!
! -----------------------------------------------------------------------
! -----------------------------------------------------------------------
!
...
! -----------------------------------------------------------------------
!
      end module radial_int_for_sph_spec_old

!>@file   sph_prt_domain_cplx_rocFFT.f90
!!@brief  module sph_prt_domain_cplx_rocFFT
!!
!!@author H. Matsui
...
!!@verbatim
!! ------------------------------------------------------------------
!!      subroutine prt_dmn_fwd_cplx_rocFFT_to_send                      &
!!     &         (sph_rtp, comm_sph_rocFFT, rocFFT_fwd,                 &
!!     &          ncomp_fwd, n_WS, X_rtp, WS, WK_rocFFT, flag_FFT)
...
!!      subroutine prt_dmn_bwd_c_rocFFT_from_recv                       &
...
!!@endverbatim
!!
      module sph_prt_domain_cplx_rocFFT
!
      use iso_c_binding
!
      use m_precision
...
!
     ...
     &     (int(rocFFT_fwd%Ncomp), int(rocFFT_fwd%Nfft), X_rtp(1,nd),   &
...
!
     ...
     &      WK_rocFFT%X_rocFFT, int(rocFFT_bwd%Nfft), X_rtp(1,nd))
...
! ------------------------------------------------------------------
!
      end module sph_prt_domain_cplx_rocFFT

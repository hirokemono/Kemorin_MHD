!>@file   sph_rtp_domain_OMP_rocFFT.f90
!!@brief  module sph_rtp_domain_OMP_rocFFT
!!
!!@author H. Matsui
...
!!@verbatim
!! ------------------------------------------------------------------
!!      subroutine rtp_dmn_fwd_OMP_rocFFT_fm_recv                       &
...
!!      subroutine rtp_dmn_bwd_OMP_rocFFT_fm_recv(sph_rtp, comm_rtp,    &
...
!!@endverbatim
!!
      module sph_rtp_domain_OMP_rocFFT
!
      use iso_c_binding
!
      use m_precision
...
!
      end subroutine rtp_dmn_fwd_OMP_rocFFT_fm_recv
!
! ------------------------------------------------------------------
!
      subroutine rtp_dmn_bwd_OMP_rocFFT_fm_recv(sph_rtp, comm_rtp,      &
...
!
      end subroutine rtp_dmn_bwd_OMP_rocFFT_fm_recv
!
! ------------------------------------------------------------------
!
      end module sph_rtp_domain_OMP_rocFFT

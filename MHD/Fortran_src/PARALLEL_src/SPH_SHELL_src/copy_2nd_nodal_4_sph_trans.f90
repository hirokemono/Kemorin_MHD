...
!     &          i_field)
!      subroutine copy_2nd_tsr_from_trans_wpole(ntensor_trans, i_trns,  &
!     &         i_field)
!
...
!     &          i_field)
!      subroutine copy_2nd_tsr_from_sph_trans(ntensor_trans, i_trns,    &
!     &          i_field)
!
!      subroutine copy_2nd_scl_to_sph_trans(nscalar_trans, i_trns,      &
!     &          i_field)
!      subroutine copy_2nd_vec_to_sph_trans(nvector_trans, i_trns,      &
!     &          i_field)
!      subroutine copy_2nd_tsr_to_sph_trans(ntensor_trans, i_trns,      &
!     &          i_field)
!
      module copy_2nd_nodal_4_sph_trans
!
...
!
     ...
     &    a_radius_2nd, a_s_cyl_2nd, ntensor_trans, i_trns, i_field,    &
     &    ntot_nod_phys_2nd, d_nod_2nd)
!
...
!
     ...
     &    ntensor_trans, i_trns, i_field, ntot_nod_phys_2nd, d_nod_2nd)
!

...
!     &           * sph1%sph_rj%a_r_1d_rj_r(kr_in)**2
!
...
!     &          * sph1%sph_rj%a_r_1d_rj_r(kr_out)**2
!
     ...
     &    / ( r_CMB_Nu - r_ICB_Nu )
!
!      dTdr_diff_ICB = - c2 * sph1%sph_rj%a_r_1d_rj_r(kr_in)**2
!      dTdr_diff_CMB = - c2 * sph1%sph_rj%a_r_1d_rj_r(kr_out)**2

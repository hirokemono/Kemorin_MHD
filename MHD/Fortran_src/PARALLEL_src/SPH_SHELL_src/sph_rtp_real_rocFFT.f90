!>@file   sph_rtp_real_rocFFT.f90
!!@brief  module sph_rtp_real_rocFFT
!!
!!@author H. Matsui
...
!!@verbatim
!! ------------------------------------------------------------------
!!      subroutine rtp_fwd_real_rocFFT_to_send(sph_rtp, comm_sph_rocFFT,&
...
!!      subroutine rtp_bwd_real_rocFFT_from_recv(sph_rtp, comm_rtp,     &
...
!
      end subroutine rtp_fwd_real_rocFFT_to_send
!
! ------------------------------------------------------------------
!
      subroutine rtp_bwd_real_rocFFT_from_recv(sph_rtp, comm_rtp,       &
...
!
      end subroutine rtp_bwd_real_rocFFT_from_recv
!
! ------------------------------------------------------------------
!
      end module sph_rtp_real_rocFFT

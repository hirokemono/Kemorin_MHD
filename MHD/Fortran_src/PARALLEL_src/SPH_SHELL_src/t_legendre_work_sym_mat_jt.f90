...
!
      private :: dealloc_sym_leg_omp_matrices
!
      private :: init_each_sym_leg_omp_mat_jt
      private :: dealloc_each_sym_leg_omp_mat
      private :: alloc_each_sym_leg_omp_mat_jt
      private :: set_each_sym_leg_omp_mat_jt
      private :: count_size_of_field_mat_omp
      private :: alloc_field_mat_omp, dealloc_field_mat_omp
      private :: alloc_spectr_mat_omp, dealloc_spectr_mat_omp
!
! -----------------------------------------------------------------------
!
      contains
...
! -----------------------------------------------------------------------
!
      subroutine dealloc_sym_leg_omp_matrices(WK_l_tsp)
!
      type(leg_trns_theta_omp_work), intent(inout) :: WK_l_tsp
!
...
!
      do mp_rlm = 1, WK_l_tsp%mphi_rtm
        do ip = 1, np_smp
          call dealloc_each_sym_leg_omp_mat(WK_l_tsp%Pmat(mp_rlm,ip))
        end do
      end do
!
      end subroutine dealloc_sym_leg_omp_matrices
!
! -----------------------------------------------------------------------
! -----------------------------------------------------------------------
!
...
! -----------------------------------------------------------------------
!
      subroutine dealloc_each_sym_leg_omp_mat(Pmat)
!
      type(leg_omp_matrix), intent(inout) :: Pmat
!
!
...
!
      end subroutine dealloc_each_sym_leg_omp_mat
!
! -----------------------------------------------------------------------
!
...
!
!
      call dealloc_sym_leg_omp_matrices(WK_l_tsp)

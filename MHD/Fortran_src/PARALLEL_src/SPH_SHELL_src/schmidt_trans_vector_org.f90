!schmidt_trans_vector_org.f90
!      module schmidt_trans_vector_org
!
!     Written by H. Matsui on Aug., 2007
!
!      subroutine schmidt_b_trans_vector_org(nb)
!      subroutine schmidt_b_trans_vector_0(nb)
!        Input:  sp_rlm   (Order: poloidal,diff_poloidal,toroidal)
!        Output: vr_rtm   (Order: radius,theta,phi)
!
!      subroutine schmidt_f_trans_vector_org(nb)
!      subroutine schmidt_f_trans_vector_0(nb)
...
!
      implicit none
!
      private :: schmidt_b_trans_vector_0, schmidt_f_trans_vector_0
!
! -----------------------------------------------------------------------
!
      contains
...
!
      ...
      call schmidt_b_trans_vector_0(nb)
!
      end subroutine schmidt_b_trans_vector_org
!
! -----------------------------------------------------------------------
!
      subroutine schmidt_f_trans_vector_org(nb)
...
!
      ...
      call schmidt_f_trans_vector_0(nb)
!
      end subroutine schmidt_f_trans_vector_org
!
! -----------------------------------------------------------------------
! -----------------------------------------------------------------------
!
...
!$omp end parallel do
!
      end subroutine schmidt_b_trans_vector_0
!
! -----------------------------------------------------------------------
!
      subroutine schmidt_f_trans_vector_0(nb)
...
!$omp end parallel do
!
      end subroutine schmidt_f_trans_vector_0
!
! -----------------------------------------------------------------------
!
      end module schmidt_trans_vector_org

!>@file   sph_prt_complex_rocFFT.f90
!!@brief  module sph_prt_complex_rocFFT
!!
!!@author H. Matsui
...
!!@verbatim
!! ------------------------------------------------------------------
!!      subroutine prt_fwd_cplx_rocFFT_to_send                          &
...
!     &    WK_rocFFT%Nfft_c, WK_rocFFT%C_rocFFT(1), n_WS, WS)
...
!
     ...
     &    WK_rocFFT%X_rocFFT(1), int(rocFFT_bwd%Nfft), X_rtp(1,1))
...
! ------------------------------------------------------------------
!
      end module sph_prt_complex_rocFFT

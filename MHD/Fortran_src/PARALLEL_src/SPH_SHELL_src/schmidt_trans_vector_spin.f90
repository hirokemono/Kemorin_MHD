!schmidt_trans_vector_spin.f90
!      module schmidt_trans_vector_spin
!
!     Written by H. Matsui on Aug., 2007
!
!      subroutine schmidt_b_trans_vector_spin(nb)
!      subroutine schmidt_b_trans_vector_2(nb)
!        Input:  sp_rlm_2   (Order: poloidal,diff_poloidal,toroidal)
!        Output: vr_rtm_2   (Order: radius,theta,phi)
!
!      subroutine schmidt_f_trans_vector_spin(nb)
!      subroutine schmidt_f_trans_vector_2(nb)
...
!
      implicit none
!
      private :: schmidt_b_trans_vector_2, schmidt_f_trans_vector_2
!
! -----------------------------------------------------------------------
!
      contains
...
!
!
      call order_b_trans_vector_2(nb)
      call clear_b_trans_vector_2(nb)
!
      call schmidt_b_trans_vector_2(nb)
!
      call back_b_trans_vector_2(nb)
!
      end subroutine schmidt_b_trans_vector_spin
!
! -----------------------------------------------------------------------
!
      subroutine schmidt_f_trans_vector_spin(nb)
...
!
      ...
      call clear_f_trans_vector_2(nb)
!
      call schmidt_f_trans_vector_2(nb)
!
      call back_f_trans_vector_2(nb)
!
      end subroutine schmidt_f_trans_vector_spin
!
! -----------------------------------------------------------------------
! -----------------------------------------------------------------------
!
...
!
     ...
     &                     = vr_rtm_2(l_rtm,mp_rlm,kr_nd,1)             &
     &                     + sp_rlm_2(j_rlm,kr_nd,1) * pg_tmp
!
              vr_rtm_2(l_rtm,mp_rlm,kr_nd,2)                            &
     &                     = vr_rtm_2(l_rtm,mp_rlm,kr_nd,2)             &
     &                     + sp_rlm_2(j_rlm,kr_nd,2) * dp_tmp
!
              vr_rtm_2(l_rtm,mp_rlm,kr_nd,3)                            &
     &                     = vr_rtm_2(l_rtm,mp_rlm,kr_nd,3)             &
     &                     - sp_rlm_2(j_rlm,kr_nd,3) * dp_tmp
!
            end do
!
!cdir nodep
...
!
              vr_rtm_2(l_rtm,mn_rlm,kr_nd,2)                            &
     &                     = vr_rtm_2(l_rtm,mn_rlm,kr_nd,2)             &
     &                       + sp_rlm_2(j_rlm,kr_nd,3) * pg_tmp
!
...
!$omp end parallel do
!
      end subroutine schmidt_b_trans_vector_2
!
! -----------------------------------------------------------------------
!
      subroutine schmidt_f_trans_vector_2(nb)
...
!
              sp_rlm_2(j_rlm,kr_nd,3) = sp_rlm_2(j_rlm,kr_nd,3)         &
     &                 - ( vr_rtm_2(l_rtm,mn_rlm,kr_nd,2) * pgwt_tmp    &
     &                   + vr_rtm_2(l_rtm,mp_rlm,kr_nd,3) * dpwt_tmp )
            end do
          end do
        end do
      end do
...
!$omp end parallel do
!
      end subroutine schmidt_f_trans_vector_2
!
! -----------------------------------------------------------------------
!
      end module schmidt_trans_vector_spin

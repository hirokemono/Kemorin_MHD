...
!$omp&  private(j_rlm,l_rtm,nd,i_rlm,a2r_1d_rlm_r)
...
!
!$omp parallel do schedule(static)                                      &
!$omp&            private(j_rlm,l_rtm,nd,ip_rtm,in_rtm,i_rlm,jst,jed,   &
...
!
!$omp parallel do schedule(static)                                      &
!$omp& private(j_rlm,l_rtm,nd,ip_rtm,i_rlm,mp_rlm,jst,jed,vr1,P_j)
      do mp_rlm = 1, nidx_rtm(3)
        jst = lstack_rlm(mp_rlm-1) + 1
        jed = lstack_rlm(mp_rlm)
        do k_rtm = 1,  nidx_rtm(1)

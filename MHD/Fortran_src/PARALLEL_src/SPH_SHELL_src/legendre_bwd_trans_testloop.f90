...
!          st_elapsed = MPI_WTIME()
     ...
     &        nkr(ip), jst(ip), n_jk_e(ip), n_jk_o(ip),        &
...
!          st_elapsed = MPI_WTIME()
     ...
     &       (sph_rtm%nnod_rtm, sph_rtm%nidx_rtm, sph_rtm%istep_rtm,    &
     &        sph_rlm%nidx_rlm, nkr(ip), mp_rlm, nl_rtm,       &
...
!
     ...
     &         (nnod_rlm, nidx_rlm, istep_rlm, nkr, jst,           &

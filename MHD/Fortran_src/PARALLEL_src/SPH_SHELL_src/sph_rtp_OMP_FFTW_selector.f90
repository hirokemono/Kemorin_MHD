!>@file   sph_rtp_OMP_FFTW_selector.F90
!!@brief  module sph_rtp_OMP_FFTW_selector
!!
!!@author H. Matsui
...
!!
!!@verbatim
!!      subroutine sel_init_rtp_OMP_FFTW(id_rank, iflag_size,           &
!!     &          sph_rtp, comm_rtp, ncomp_bwd, ncomp_fwd,              &
!!     &          sph_OMP_FFTW, sph_domain_OMP_FFTW, flag_FFT)
!!      subroutine sel_finalize_rtp_OMP_FFTW(iflag_size,                &
!!     &          sph_OMP_FFTW, sph_domain_OMP_FFTW, flag_FFT)
!!      subroutine sel_verify_rtp_OMP_FFTW                              &
...
!
      module sph_rtp_OMP_FFTW_selector
!
      use m_precision
...
!
      end subroutine sel_init_rtp_OMP_FFTW
!
! ------------------------------------------------------------------
!
      subroutine sel_finalize_rtp_OMP_FFTW(iflag_size,                  &
...
!
     ...
     &        'Finalize at once OpenMP FFTW'
        call finalize_rtp_OMP_FFTW(sph_OMP_FFTW, flag_fft)
      else if(iflag_size .eq. iflag_domain_once) then
        if(iflag_debug .eq. 0) write(*,*)                               &
     &        'Finalize rtp OpenMP FFTW for domain'
        call finalize_sph_domain_OMP_FFTW(sph_domain_OMP_FFTW,          &
     &                                    flag_fft)
      end if
!
...
!
     ...
     &      ncomp_bwd, ncomp_fwd, sph_OMP_FFTW, flag_fft)
      else if(iflag_size .eq. iflag_domain_once) then
        if(iflag_debug .gt. 0) write(*,*)                               &
...
!
      end subroutine sel_verify_rtp_OMP_FFTW
!
! ------------------------------------------------------------------
! ------------------------------------------------------------------
!
...
! ------------------------------------------------------------------
!
      end module sph_rtp_OMP_FFTW_selector

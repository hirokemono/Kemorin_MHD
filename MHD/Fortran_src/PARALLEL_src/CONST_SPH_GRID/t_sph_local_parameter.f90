...
!
      ...
      allocate(sph_lcp%nidx_local_rtp_r(num))
      num = s3d_ranks%ndomain_rtp(2)
      allocate(sph_lcp%nidx_local_rtp_t(num))
      num = s3d_ranks%ndomain_rtp(3)
      allocate(sph_lcp%nidx_local_rtp_p(num))
!
      num = s3d_ranks%ndomain_rtm(1)
      allocate(sph_lcp%nidx_local_rtm_r(num))
      num = s3d_ranks%ndomain_rtm(2)
      allocate(sph_lcp%nidx_local_rtm_t(num))
      num = s3d_ranks%ndomain_rtm(3)
      allocate(sph_lcp%nidx_local_rtm_m(num))
!
      num = s3d_ranks%ndomain_rlm(1)
      allocate(sph_lcp%nidx_local_rlm_r(num))
      num = s3d_ranks%ndomain_rlm(2)
      allocate(sph_lcp%nidx_local_rlm_j(num))
!
      num = s3d_ranks%ndomain_rj(1)
      allocate(sph_lcp%nidx_local_rj_r(num))
      num = s3d_ranks%ndomain_rj(2)
      allocate(sph_lcp%nidx_local_rj_j(num))
!
      sph_lcp%nidx_local_rtp_r = 0
      sph_lcp%nidx_local_rtp_t = 0
      sph_lcp%nidx_local_rtp_p = 0
      sph_lcp%nidx_local_rtm_r = 0
      sph_lcp%nidx_local_rtm_t = 0
      sph_lcp%nidx_local_rtm_m = 0
      sph_lcp%nidx_local_rlm_r = 0
      sph_lcp%nidx_local_rlm_j = 0
      sph_lcp%nidx_local_rj_r =  0
      sph_lcp%nidx_local_rj_j =  0
!
...
!
!
      deallocate(sph_lcp%nidx_local_rtp_r, sph_lcp%nidx_local_rtp_t)
      deallocate(sph_lcp%nidx_local_rtp_p)
      deallocate(sph_lcp%nidx_local_rtm_r, sph_lcp%nidx_local_rtm_t)
      deallocate(sph_lcp%nidx_local_rtm_m)
      deallocate(sph_lcp%nidx_local_rlm_r, sph_lcp%nidx_local_rlm_j)
      deallocate(sph_lcp%nidx_local_rj_r, sph_lcp%nidx_local_rj_j)
!
...
!
!
      write(ip_rank+50,*) 'nidx_local_rtp_r', sph_lcp%nidx_local_rtp_r
      write(ip_rank+50,*) 'nidx_local_rtp_t', sph_lcp%nidx_local_rtp_t
      write(ip_rank+50,*) 'nidx_local_rtp_p', sph_lcp%nidx_local_rtp_p
!
      write(ip_rank+50,*) 'nidx_local_rtm_r', sph_lcp%nidx_local_rtm_r
      write(ip_rank+50,*) 'nidx_local_rtm_t', sph_lcp%nidx_local_rtm_t
      write(ip_rank+50,*) 'nidx_local_rtm_m', sph_lcp%nidx_local_rtm_m
!
      write(ip_rank+50,*) 'nidx_local_rlm_r', sph_lcp%nidx_local_rlm_r
      write(ip_rank+50,*) 'nidx_local_rlm_j', sph_lcp%nidx_local_rlm_j
!
      write(ip_rank+50,*) 'nidx_local_rj_r', sph_lcp%nidx_local_rj_r
      write(ip_rank+50,*) 'nidx_local_rj_j', sph_lcp%nidx_local_rj_j
!

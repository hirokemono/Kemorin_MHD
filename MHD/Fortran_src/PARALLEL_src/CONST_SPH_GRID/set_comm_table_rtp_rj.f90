...
!
     ...
     &   comm_rlm_mul, s3d_ranks, sph_lcp, stk_lc1d, sph_gl1d, stbl,    &
...
!
     ...
     &   comm_rtm_mul, s3d_ranks, sph_lcp, stk_lc1d, sph_gl1d, stbl,    &
...
!
     ...
     &     (id_org_rank, s3d_ranks, sph_lcp, stk_lc1d, sph_gl1d, stbl,  &
     &      sph_rlm, comm_rlm_lc)
!

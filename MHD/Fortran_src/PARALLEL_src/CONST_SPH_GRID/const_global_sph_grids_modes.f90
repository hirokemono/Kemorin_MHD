...
!
     ...
     &    s2d_tbl%mdx_ispack, sph_dbc, stk_lc1d, sph_gl1d)
...
!
     ...
     &          sph_lc1, sph_lcp, sph_dbc, stk_lc1d)
!
      use m_spheric_global_ranks
!
      type(sph_shell_parameters), intent(in) :: sph_params
...
!
     ...
     &         (sph_rj, sph_lc1, sph_lcp, stk_lc1d, s2d_tbl)
!
      use m_spheric_global_ranks
      use set_sph_tranform_ordering
!
...
!
     ...
     &          sph_lc1, sph_lcp, stk_lc1d, s2d_tbl)
!
      use m_spheric_global_ranks
      use set_sph_tranform_ordering
!

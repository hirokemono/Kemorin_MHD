...
!!
!!      subroutine mpi_gen_sph_rj_modes(comm_rlm_mul, added_radial_grp, &
!!     &          s3d_ranks, s3d_radius, sph_lcp, stk_lc1d, sph_gl1d,   &
...
!
     ...
     &   (my_rank, s3d_ranks, s3d_radius, sph_lcp, stk_lc1d, sph_gl1d,  &
     &    sph_rlm, comm_rlm_lc)
...
!
     ...
     &   (my_rank, nprocs, comm_rlm_mul, added_radial_grp,              &
     &    s3d_ranks, s3d_radius, sph_lcp, stk_lc1d, sph_gl1d,           &

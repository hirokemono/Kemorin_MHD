...
!
      call dealloc_double_numbering(org_iele_dbl)
      call dealloc_double_numbering(new_inod_dbl)
!
      end subroutine const_repart_ele_connect_by_tbl
!
! ----------------------------------------------------------------------
! ----------------------------------------------------------------------
!
...
! ----------------------------------------------------------------------
!
      subroutine const_ele_connect_by_trans_tbl                         &
     &         (ele, ele_tbl, new_ids_on_org, org_iele_dbl,             &
...
!
     ...
     &    new_comm, new_node, new_ele_comm, new_ele, SR_sig, SR_i)
      deallocate(ie_newnod, ie_newdomain)
!
      end subroutine const_ele_connect_by_trans_tbl
!
! ----------------------------------------------------------------------
!

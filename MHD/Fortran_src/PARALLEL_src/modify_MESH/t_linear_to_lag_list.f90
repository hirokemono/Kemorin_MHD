...
!!     &          numnod_l, internal_node_l, l_to_lag)
...
!
      subroutine init_linear_to_lag_list                                &
     &         (mesh_q, ele_comm_q, surf_comm_q, edge_comm_q,           &
     &          numnod_l, internal_node_l, l_to_lag)
!
      type(mesh_geometry), intent(in) :: mesh_q
      type(communication_table), intent(in) :: ele_comm_q
...
!
     ...
     &   (mesh_q%node, mesh_q%ele, mesh_q%surf, mesh_q%edge, l_to_lag)
      call set_linear_to_lag_list                                       &
     &   (mesh_q%node, mesh_q%ele, mesh_q%surf, mesh_q%edge,            &
     &    mesh_q%nod_comm, ele_comm_q, surf_comm_q, edge_comm_q,        &
     &    numnod_l, internal_node_l, l_to_lag)
!
...
!
!
      icou = node%numnod + edge%numedge + surf%numsurf + ele%numele

...
!
     ...
     &                       * ( dnx(iele,k2,ix,2) * vect_1(iele,3)     &
     &                         - dnx(iele,k2,ix,3) * vect_1(iele,2) )   &
     &                        * xjac(iele,ix)*owe3d(ix)
              sk_v(iele,2,k1) = sk_v(iele,2,k1) + an(k1,ix)             &
     &                       * ( dnx(iele,k2,ix,3) * vect_1(iele,1)     &
     &                         - dnx(iele,k2,ix,1) * vect_1(iele,3) )   &
     &                        * xjac(iele,ix)*owe3d(ix)
              sk_v(iele,3,k1) = sk_v(iele,3,k1) + an(k1,ix)             &
     &                       * ( dnx(iele,k2,ix,1) * vect_1(iele,2)     &
     &                         - dnx(iele,k2,ix,2) * vect_1(iele,1) )   &
     &                        * xjac(iele,ix)*owe3d(ix)
            end do
          end do
!
...
!$omp end parallel do
!
      end subroutine fem_skv_grp_rot
!
!-----------------------------------------------------------------------
!
      end module fem_skv_rot

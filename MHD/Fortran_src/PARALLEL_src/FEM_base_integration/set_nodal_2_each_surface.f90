!set_nodal_2_each_surface.f90
!      module set_nodal_2_each_surface
!
!      Written by H. Matsui on Sep., 2005
!
!      subroutine scalar_phys_2_each_sf(np_smp, numnod, numele,         &
!     &          nnod_4_ele, ie, nnod_4_surf, node_on_sf, num_surf_bc,  &
!     &          surf_item, num_surf_smp, isurf_grp_smp_stack, igrp,    &
!     &          k2, i_scalar, ntot_comp, d_nod, scalar_sf)
!        Input:  d_nod(1,i_scalar), Output:  scalar_sf
!      subroutine vector_phys_2_each_sf(np_smp, numnod, numele,         &
!     &          nnod_4_ele, ie, nnod_4_surf, node_on_sf, num_surf_bc,  &
!     &          surf_item, num_surf_smp, isurf_grp_smp_stack, igrp,    &
!     &          k2, i_vector, ntot_comp, d_nod, vector_sf)
!        Input:  d_nod(1,i_vector), Output:  vector_sf
!      subroutine tensor_phys_2_each_sf(np_smp, numnod, numele,         &
!     &          nnod_4_ele, ie, nnod_4_surf, node_on_sf, num_surf_bc,  &
!     &          surf_item, num_surf_smp, isurf_grp_smp_stack, igrp,    &
!     &          k2, i_tensor, ntot_comp, d_nod, tensor_sf)
...
!$omp end parallel do
!
      end subroutine scalar_phys_2_each_sf
!
! ----------------------------------------------------------------------
!
      subroutine vector_phys_2_each_sf(np_smp, numnod, numele,          &
...
!$omp end parallel do
!
      end subroutine vector_phys_2_each_sf
!
! ----------------------------------------------------------------------
!
      subroutine tensor_phys_2_each_sf(np_smp, numnod, numele,          &
...
!$omp end parallel do
!
      end subroutine tensor_phys_2_each_sf
!
! ----------------------------------------------------------------------
!
      end module set_nodal_2_each_surface

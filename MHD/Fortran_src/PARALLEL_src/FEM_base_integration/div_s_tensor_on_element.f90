!
!     module div_s_tensor_on_element
!
!     Written by H. Matsui on Nov., 2006
!
!!      subroutine fem_div_sym_tensor_on_ele(iele_fsmp_stack,           &
!!     &          numnod, numele, nnod_4_ele, ie, a_vol_ele,            &
!!     &          max_int_point, maxtot_int_3d, int_start3, owe3d,      &
!!     &          ntot_int_3d, n_int, dnx, xjac, d_ele, d_nod)
!!      subroutine fem_div_sym_tensor_grp_on_ele                        &
...
!
     ...
     &                         + dnx(iele,k1,ix,2) * d_nod(inod,4)      &
     &                         + dnx(iele,k1,ix,3) * d_nod(inod,5) )    &
     &                        * xjac(iele,ix) * owe3d(ix)               &
     &                        * a_vol_ele(iele)
!
              d_ele(iele,3) = d_ele(iele,3)                             &
     &                       + ( dnx(iele,k1,ix,1) * d_nod(inod,3)      &
     &                         + dnx(iele,k1,ix,2) * d_nod(inod,5)      &
     &                         + dnx(iele,k1,ix,3) * d_nod(inod,6) )    &
     &                        * xjac(iele,ix) * owe3d(ix)               &
     &                        * a_vol_ele(iele)
!
            end do
...
!$omp end parallel do
!
      end subroutine fem_div_sym_tensor_on_ele
!
! ----------------------------------------------------------------------
!
      subroutine fem_div_sym_tensor_grp_on_ele                          &
...
!$omp end parallel do
!
      end subroutine fem_div_sym_tensor_grp_on_ele
!
! ----------------------------------------------------------------------
!
      end module div_s_tensor_on_element

...
!
!      subroutine fem_skv_all_div(numele, nnod_4_e1, nnod_4_e2, np_smp, &
!     &          iele_fsmp_stack, n_int, k2, ntot_int_3d, xjac, an, dnx,&
!     &          vect_1, sk_v)
!      subroutine fem_skv_grp_div(numele, nnod_4_e1, nnod_4_e2, np_smp, &
...
!
     ...
     &                     * ( dnx(iele,k2,ix,1) * vect_1(iele,1)       &
     &                       + dnx(iele,k2,ix,2) * vect_1(iele,2)       &
     &                       + dnx(iele,k2,ix,3) * vect_1(iele,3) )     &
...
!$omp end parallel do
!
      end subroutine fem_skv_all_div
!
!-----------------------------------------------------------------------
!
      subroutine fem_skv_grp_div(numele, nnod_4_e1, nnod_4_e2, np_smp,  &
...
!$omp end parallel do
!
      end subroutine fem_skv_grp_div
!
!-----------------------------------------------------------------------
!
      end module fem_skv_div

...
!
!!      subroutine difference_on_element(node, ele, jac_3d,             &
!     &          iele_fsmp_stack, n_int, nd, d_nod, d_ele)
!      subroutine gradient_on_element(node, ele, jac_3d,                &
!     &          iele_fsmp_stack, n_int, d_nod, d_ele)
!      subroutine divergence_on_element(node, ele, jac_3d,              &
!     &          iele_fsmp_stack, n_int,d_nod, d_ele)
!      subroutine rotation_on_element(node, ele, jac_3d,                &
!     &          iele_fsmp_stack, n_int, d_nod, d_ele)
!      subroutine div_sym_tensor_on_element(node, ele, jac_3d,          &
!     &          iele_fsmp_stack, n_int, d_nod, d_ele)
!      subroutine div_asym_tensor_on_element(node, ele, jac_3d,,        &
!     &          iele_fsmp_stack, n_int, d_nod, d_ele)
!
!      subroutine difference_grp_on_element(node, ele, jac_3d,          &
!     &          iele_fsmp_stack, nele_grp, iele_grp, n_int, nd,        &
!     &          d_nod, d_ele)
!      subroutine gradient_grp_on_element(node, ele, jac_3d,            &
!     &          iele_fsmp_stack, nele_grp, iele_grp, n_int,            &
!     &          d_nod, d_ele)
!      subroutine divergence_grp_on_element(node, ele, jac_3d,          &
!     &          iele_fsmp_stack, nele_grp, iele_grp, n_int,            &
!     &          d_nod, d_ele)
!      subroutine rotation_grp_on_element(node, ele, jac_3d,            &
!     &          iele_fsmp_stack, nele_grp, iele_grp, n_int,            &
!     &          d_nod, d_ele)
!      subroutine div_sym_tensor_grp_on_element(node, ele, jac_3d,      &
!     &          iele_fsmp_stack, nele_grp, iele_grp, n_int,            &
!     &          d_nod, d_ele)
!      subroutine div_asym_tensor_grp_on_element(node, ele, jac_3d,     &
!     &          iele_fsmp_stack, nele_grp, iele_grp, n_int,            &
!     &          d_nod, d_ele)

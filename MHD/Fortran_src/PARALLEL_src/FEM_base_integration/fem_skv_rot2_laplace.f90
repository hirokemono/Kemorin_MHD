...
!
!      subroutine fem_all_skv_rot2_laplace(numele, nnod_4_e1, nnod_4_e2,&
!     &          np_smp, iele_fsmp_stack, n_int, k2, ntot_int_3d,       &
!     &          xjac, dnx1, dnx2, vector_e, sk_v)
!      subroutine fem_skv_grp_rot2_laplace(numele, nnod_4_e1, nnod_4_e2,&
!     &          np_smp, iele_fsmp_stack, nele_grp, iele_grp, n_int, k2,&
!     &          ntot_int_3d, xjac, dnx1, dnx2, vector_e, sk_v)
!
      module fem_skv_rot2_laplace
!
      use m_precision
...
!
!
!$omp parallel do private(k1,ii,ix,iele,istart,iend,diffuse) 
      do iproc = 1, np_smp
...
!$omp end parallel do
!
      end subroutine fem_all_skv_rot2_laplace
!
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
!
...
!
!
!$omp parallel do private(k1,ii,ix,inum,iele,istart,iend,diffuse) 
      do iproc = 1, np_smp
        istart = iele_fsmp_stack(iproc-1)+1
        iend   = iele_fsmp_stack(iproc)
!
...
!$omp end parallel do
!
      end subroutine fem_skv_grp_rot2_laplace
!
!-----------------------------------------------------------------------
!
      end module fem_skv_rot2_laplace

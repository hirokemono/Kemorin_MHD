!set_delta_2_each_sf_w_cst.f90
!      module set_delta_2_each_sf_w_cst
!
!      Written by H. Matsui on Sep., 2005
!
!      subroutine dlt_scl_phys_2_each_sf_w_cst(np_smp, numnod, numele,  &
!     &          nnod_4_ele, ie, nnod_4_surf, node_on_sf, node_on_sf_n, &
!     &          num_surf_bc, surf_item, num_surf_smp,                  &
!     &          isurf_grp_smp_stack, igrp, k2, i_scalar,               &
!     &          ntot_comp, d_nod, coef, scalar_sf)
!        Input:  d_nod(1,i_scalar), Output:  scalar_sf
!      subroutine dlt_vect_phys_2_each_sf_w_cst(np_smp, numnod, numele, &
!     &          nnod_4_ele, ie, nnod_4_surf, node_on_sf, node_on_sf_n, &
!     &          num_surf_bc, surf_item, num_surf_smp,                  &
!     &          isurf_grp_smp_stack, igrp, k2, i_vector,               &
!     &          ntot_comp, d_nod, coef, vector_sf)
!        Input:  d_nod(1,i_vector), Output:  vector_sf
!      subroutine dlt_tsr_phys_2_each_sf_w_cst(np_smp, numnod, numele,  &
!     &          nnod_4_ele, ie, nnod_4_surf, node_on_sf, node_on_sf_n, &
!     &          num_surf_bc, surf_item, num_surf_smp,                  &
!     &          isurf_grp_smp_stack, igrp, k2, i_tensor,               &
!     &          ntot_comp, d_nod, coef, tensor_sf)
...
!$omp end parallel do
!
      end subroutine dlt_scl_phys_2_each_sf_w_cst
!
! ----------------------------------------------------------------------
!
      subroutine dlt_vect_phys_2_each_sf_w_cst(np_smp, numnod, numele,  &
...
!$omp end parallel do
!
      end subroutine dlt_vect_phys_2_each_sf_w_cst
!
! ----------------------------------------------------------------------
!
      subroutine dlt_tsr_phys_2_each_sf_w_cst(np_smp, numnod, numele,   &
...
!$omp end parallel do
!
      end subroutine dlt_tsr_phys_2_each_sf_w_cst
!
! ----------------------------------------------------------------------
!
      end module set_delta_2_each_sf_w_cst

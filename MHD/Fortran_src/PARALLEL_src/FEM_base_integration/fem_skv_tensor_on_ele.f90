...
!cdir nodep
     ...
     &                          + an1(k1,ix) * tensor_ele(iele,1)       &
     &                           * xjac(iele,ix) * owe3d(ix)
              sk_v(iele,2,k1) = sk_v(iele,2,k1)                         &
     &                          + an1(k1,ix) * tensor_ele(iele,2)       &
     &                           * xjac(iele,ix) * owe3d(ix)
              sk_v(iele,3,k1) = sk_v(iele,3,k1)                         &
     &                          + an1(k1,ix) * tensor_ele(iele,3)       &
     &                           * xjac(iele,ix) * owe3d(ix)
              sk_v(iele,4,k1) = sk_v(iele,4,k1)                         &
     &                          + an1(k1,ix) * tensor_ele(iele,3)       &
     &                           * xjac(iele,ix) * owe3d(ix)
              sk_v(iele,5,k1) = sk_v(iele,5,k1)                         &
     &                          + an1(k1,ix) * tensor_ele(iele,3)       &
     &                           * xjac(iele,ix) * owe3d(ix)
              sk_v(iele,6,k1) = sk_v(iele,6,k1)                         &
     &                          + an1(k1,ix) * tensor_ele(iele,3)       &
     &                           * xjac(iele,ix) * owe3d(ix)
            end do
          end do
...
!$omp end parallel do
!
      end subroutine fem_skv_tensor_on_ele_m
!
!-----------------------------------------------------------------------
!
      subroutine fem_skv_tensor_on_ele_HRZ_m(numele, nnod_4_e1,         &
...
!cdir nodep
          do iele = ist, ied
            sk_v(iele,1,k1) = volume_ele(iele) * tensor_ele(iele,1)     &
     &                       * sk_v(iele,1,k1) * ml_ele_diag(iele)
            sk_v(iele,2,k1) = volume_ele(iele) * tensor_ele(iele,2)     &
     &                       * sk_v(iele,2,k1) * ml_ele_diag(iele)
            sk_v(iele,3,k1) = volume_ele(iele) * tensor_ele(iele,3)     &
     &                       * sk_v(iele,3,k1) * ml_ele_diag(iele)
            sk_v(iele,4,k1) = volume_ele(iele) * tensor_ele(iele,4)     &
     &                       * sk_v(iele,4,k1) * ml_ele_diag(iele)
            sk_v(iele,5,k1) = volume_ele(iele) * tensor_ele(iele,5)     &
     &                       * sk_v(iele,5,k1) * ml_ele_diag(iele)
            sk_v(iele,6,k1) = volume_ele(iele) * tensor_ele(iele,6)     &
     &                       * sk_v(iele,6,k1) * ml_ele_diag(iele)
          end do
        end do
!
      end do
!$omp end parallel do
!
      end subroutine fem_skv_tensor_on_ele_HRZ_m
!
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
!
...
!cdir nodep
     ...
     &                          * xjac(iele,ix) * owe3d(ix)
              sk_v(iele,4,k1) = sk_v(iele,4,k1)                         &
     &                         + an1(k1,ix) * tensor_ele(iele,4)        &
     &                          * xjac(iele,ix) * owe3d(ix)
              sk_v(iele,5,k1) = sk_v(iele,5,k1)                         &
     &                         + an1(k1,ix) * tensor_ele(iele,5)        &
     &                          * xjac(iele,ix) * owe3d(ix)
              sk_v(iele,6,k1) = sk_v(iele,6,k1)                         &
     &                         + an1(k1,ix) * tensor_ele(iele,6)        &
     &                          * xjac(iele,ix) * owe3d(ix)
            end do
          end do
!
...
!
!
      end subroutine fem_skv_tensor_on_ele_grp_m
!
!-----------------------------------------------------------------------
!
      subroutine fem_skv_tensor_on_ele_grp_HRZ(numele, nnod_4_e1,       &
...
!$omp end parallel do
!
      end subroutine fem_skv_tensor_on_ele_grp_HRZ
!
!-----------------------------------------------------------------------
!
      end module fem_skv_tensor_on_ele

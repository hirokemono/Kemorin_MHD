...
!
!
      call add_skv_scalar_2_ff_smp (ele1%numele, nnod_4_ele,            &
...
!
!
      call sub_skv_scalar_2_ff_smp (ele1%numele, nnod_4_ele,            &
     &    np_smp, maxnod_4_smp, inod_ele_max, num_sort_smp,             &
     &    nod_stack_smp, iele_sort_smp, iconn_sort_smp,                 &
     &    ff_v_smp, sk_v)
!
...
!
!
      call add_skv_vector_2_ff_smp (ele1%numele, nnod_4_ele,            &
     &    np_smp, maxnod_4_smp, inod_ele_max, num_sort_smp,             &
     &    nod_stack_smp, iele_sort_smp, iconn_sort_smp,                 &
     &    ff_v_smp, sk_v)
!
...
!
!
      call sub_skv_vector_2_ff_smp (ele1%numele, nnod_4_ele,            &
     &    np_smp, maxnod_4_smp, inod_ele_max, num_sort_smp,             &
     &    nod_stack_smp, iele_sort_smp, iconn_sort_smp,                 &
     &    ff_v_smp, sk_v)
!
...
!
!
      call add_skv_tensor_2_ff_smp (ele1%numele, nnod_4_ele,            &
     &    np_smp, maxnod_4_smp, inod_ele_max, num_sort_smp,             &
     &    nod_stack_smp, iele_sort_smp, iconn_sort_smp,                 &
     &    ff_t_smp, sk_v)
!
...
!
!
      call sub_skv_tensor_2_ff_smp (ele1%numele, nnod_4_ele,            &
     &    np_smp, maxnod_4_smp, inod_ele_max, num_sort_smp,             &
     &    nod_stack_smp, iele_sort_smp, iconn_sort_smp,                 &
     &    ff_t_smp, sk_v)
!

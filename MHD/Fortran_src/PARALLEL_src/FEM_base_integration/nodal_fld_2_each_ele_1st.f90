...
!
!
      call position_to_local_ele(numnod, numele, nnod_4_ele,            &
...
!
!
      call scalar_to_local_ele(numnod, numele, nnod_4_ele,              &
...
!
!
      call vector_to_local_ele(numnod, numele, nnod_4_ele,              &
...
!
!
      call tensor_to_local_ele(numnod, numele, nnod_4_ele,              &
     &    ie, np_smp, iele_smp_stack, k2, i_field,                      &
...
!
      ...
      real (kind=kreal), intent(inout) :: vect_e(numele,3)
!
      call tensor_to_local_ele_v(numnod, numele, nnod_4_ele,            &
...
!
!
      call as_tensor_to_local_ele_v(numnod, numele, nnod_4_ele,         &

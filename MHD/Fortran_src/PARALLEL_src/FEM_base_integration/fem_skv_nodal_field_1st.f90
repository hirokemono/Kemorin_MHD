...
!
     ...
     &    jac1_3d_q%xjac, jac1_3d_q%an, jac1_3d_q%an, scalar_1, sk_v)
!
...
!
     ...
     &   (ele1%numele, ele1%nnod_4_ele, ele1%nnod_4_ele,                &
     &    jac1_3d_q%ntot_int, iele_fsmp_stack, n_int, k2,               &
     &    jac1_3d_q%xjac, jac1_3d_q%an, jac1_3d_q%an, vect_1, sk_v)
!
...
!
     ...
     &   (ele1%numele, ele1%nnod_4_ele, ele1%nnod_4_ele,                &
     &    jac1_3d_q%ntot_int, iele_fsmp_stack, n_int, k2,               &
     &    jac1_3d_q%xjac, jac1_3d_q%an, jac1_3d_q%an, tensor_1, sk_v)
!

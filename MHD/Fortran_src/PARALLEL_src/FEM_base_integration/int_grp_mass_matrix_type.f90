...
!
!      subroutine int_grp_consist_mass_mat_type(iele_fsmp_stack,        &
!     &          nele_grp, iele_grp, n_int, mesh, jac_3d, rhs_tbl,      &
!     &          mat_tbl, fem_wk, mat11)
!      subroutine int_vol_grp_mass_matrix_type(iele_fsmp_stack,         &
!     &          nele_grp, iele_grp, n_int, mesh, jac_3d, rhs_tbl,      &
!     &          fem_wk, rhs_l)
...
!
      end subroutine int_vol_grp_mass_matrix_type
!
!-----------------------------------------------------------------------
!
      subroutine int_grp_mass_matrix_diag_type(iele_fsmp_stack,         &
...
!-----------------------------------------------------------------------
!
      end module int_grp_mass_matrix_type

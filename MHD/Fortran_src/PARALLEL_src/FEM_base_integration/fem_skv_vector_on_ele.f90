!
!      module fem_skv_vector_on_ele
!
!     Written by H. Matsui on Aug., 2006
!
!      subroutine fem_skv_vector_on_ele_m(numele, nnod_4_e1,            &
!     &          iele_fsmp_stack, ntot_int_3d, n_int, xjac, an1,        &
!     &          vector_ele, sk_v)
!      subroutine fem_skv_vector_on_ele_HRZ_m(numele, nnod_4_e1,        &
!     &          iele_fsmp_stack, volume_ele, ml_ele_diag, vector_ele,  &
!     &          sk_v)
!
!      subroutine fem_skv_vector_on_ele_grp_m(numele, nnod_4_e1,        &
!     &          iele_fsmp_stack, nele_grp, iele_grp,                   &
!     &          ntot_int_3d, n_int, xjac, an1, vector_ele, sk_v)
!      subroutine fem_skv_vector_on_ele_grp_HRZ(numele, nnod_4_e1,      &
...
!cdir nodep
     ...
     &                          + an1(k1,ix) * vector_ele(iele,1)       &
     &                           * xjac(iele,ix) * owe3d(ix)
              sk_v(iele,2,k1) = sk_v(iele,2,k1)                         &
     &                          + an1(k1,ix) * vector_ele(iele,2)       &
     &                           * xjac(iele,ix) * owe3d(ix)
              sk_v(iele,3,k1) = sk_v(iele,3,k1)                         &
     &                          + an1(k1,ix) * vector_ele(iele,3)       &
     &                           * xjac(iele,ix) * owe3d(ix)
            end do
          end do
!
...
!$omp end parallel do
!
      end subroutine fem_skv_vector_on_ele_m
!
!-----------------------------------------------------------------------
!
      subroutine fem_skv_vector_on_ele_HRZ_m(numele, nnod_4_e1,         &
...
!cdir nodep
          do iele = ist, ied
            sk_v(iele,1,k1) = volume_ele(iele) * vector_ele(iele,1)     &
     &                       * sk_v(iele,1,k1) * ml_ele_diag(iele)
            sk_v(iele,2,k1) = volume_ele(iele) * vector_ele(iele,2)     &
     &                       * sk_v(iele,2,k1) * ml_ele_diag(iele)
            sk_v(iele,3,k1) = volume_ele(iele) * vector_ele(iele,3)     &
...
!$omp end parallel do
!
      end subroutine fem_skv_vector_on_ele_HRZ_m
!
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
!
...
!
!
      end subroutine fem_skv_vector_on_ele_grp_m
!
!-----------------------------------------------------------------------
!
      subroutine fem_skv_vector_on_ele_grp_HRZ(numele, nnod_4_e1,       &
...
!$omp end parallel do
!
      end subroutine fem_skv_vector_on_ele_grp_HRZ
!
!-----------------------------------------------------------------------
!
      end module fem_skv_vector_on_ele

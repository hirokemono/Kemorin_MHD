...
!!     &         (id_file, nprocs_in, id_rank, ioff_gl)
!!
!!      subroutine mpi_write_rtp_gl_1d_table_b(id_file, ioff_gl)
!!      subroutine mpi_write_rj_gl_1d_table_b(id_file, ioff_gl)
!!@endverbatim
!
...
!
     ...
     &   (id_file, nprocs_in, id_rank, ioff_gl,                         &
     &    ndir_sph_IO, nidx_sph_IO)
      call mpi_read_int_vector_b                                        &
     &   (id_file, nprocs_in, id_rank, ioff_gl,                         &
     &    ndir_sph_IO, ist_sph_IO)
      call mpi_read_int_vector_b                                        &
     &   (id_file, nprocs_in, id_rank, ioff_gl,                         &
     &    ndir_sph_IO, ied_sph_IO)
!
...
!
      call mpi_read_int_vector_b                                        &
     &   (id_file, nprocs_in, id_rank, ioff_gl,                         &
     &    nidx_sph_IO(1), idx_gl_1_IO)
      call mpi_read_1d_vector_b                                         &
     &   (id_file, nprocs_in, id_rank, ioff_gl,                         &
     &    nidx_sph_IO(1), r_gl_1_IO)
!
...
!
     ...
     &   (id_file, ioff_gl, ndir_sph_IO, nidx_sph_IO)
      call mpi_write_int_vector_b                                       &
     &   (id_file, ioff_gl, ndir_sph_IO, ist_sph_IO)
      call mpi_write_int_vector_b                                       &
     &   (id_file, ioff_gl, ndir_sph_IO, ied_sph_IO)
!
      call mpi_write_int_vector_b                                       &
     &   (id_file, ioff_gl, nidx_sph_IO(1), idx_gl_1_IO)
      call mpi_write_1d_vector_b                                        &
     &   (id_file, ioff_gl, nidx_sph_IO(1), r_gl_1_IO)
!
      nvect = nidx_sph_IO(2) * ncomp_itbl_1d_IO(2)
      call mpi_write_int_vector_b                                       &

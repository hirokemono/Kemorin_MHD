...
!!     &         (id_file, nprocs_in, id_rank, ioff_gl)
!!
!!      subroutine mpi_write_rank_4_sph_b(id_file, ioff_gl)
!!      subroutine mpi_write_gl_reso_sph_b(id_file, ioff_gl)
!!      subroutine mpi_write_gl_nodes_sph_b(id_file, ioff_gl)
!!@endverbatim
!
      module MPI_spherical_model_IO_b
!
...
!
!
      call mpi_write_one_integer_b(id_file, ioff_gl, nnod_sph_IO)
!

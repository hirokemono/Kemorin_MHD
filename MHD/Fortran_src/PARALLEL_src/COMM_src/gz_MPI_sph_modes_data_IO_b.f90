...
!!     &         (id_file, nprocs_in, ioff_gl, comm_IO, sph_IO)
...
!
     ...
     &   (id_file, nprocs_in, id_rank, ioff_gl, comm_IO)
      call gz_mpi_read_gl_reso_sph_b(id_file, ioff_gl, sph_IO)
...
!
     ...
     &   (id_file, nprocs_in, id_rank, ioff_gl,                         &
     &    sph_grps_IO%bc_rtp_grp)
      call gz_mpi_read_group_data_b                                     &
     &   (id_file, nprocs_in, id_rank, ioff_gl,                         &
     &    sph_grps_IO%radial_rtp_grp)
      call gz_mpi_read_group_data_b                                     &
     &   (id_file, nprocs_in, id_rank, ioff_gl,                         &
     &    sph_grps_IO%theta_rtp_grp)
      call gz_mpi_read_group_data_b                                     &
     &   (id_file, nprocs_in, id_rank, ioff_gl,                         &
     &    sph_grps_IO%zonal_rtp_grp)
!
...
!
      call gz_mpi_read_group_data_b                                     &
     &   (id_file, nprocs_in, id_rank, ioff_gl,                         &
     &    sph_grps_IO%radial_rj_grp)
      call gz_mpi_read_group_data_b                                     &
     &   (id_file, nprocs_in, id_rank, ioff_gl,                         &
     &    sph_grps_IO%sphere_rj_grp)
!
...
!
     ...
     &   (id_file, nprocs_in, ioff_gl, comm_IO)
      call gz_mpi_write_gl_reso_sph_b(id_file, ioff_gl, sph_IO)
      call gz_mpi_write_rank_4_sph_b(id_file, ioff_gl, sph_IO)
!
      call gz_mpi_write_rtp_gl_1d_table_b(id_file, ioff_gl, sph_IO)
!
      call gz_mpi_write_gl_nodes_sph_b(id_file, ioff_gl, sph_IO)
...
!
     ...
     &   (id_file, nprocs_in, ioff_gl, comm_IO)
      ...
      call gz_mpi_write_rank_4_sph_b(id_file, ioff_gl, sph_IO)
!
      call gz_mpi_write_rj_gl_1d_table_b(id_file, ioff_gl, sph_IO)
      call gz_mpi_write_gl_nodes_sph_b(id_file, ioff_gl, sph_IO)
!
      call gz_mpi_write_import_data_b(id_file, ioff_gl, comm_IO)
!
     ...
     &   (id_file, ioff_gl, sph_grps_IO%sphere_rj_grp)
!

...
!
     ...
     &          = IO_param%istack_merged(0:IO_param%nprocs_in) * kint
      if(my_rank .eq. 0) then
        ...
        call calypso_mpi_seek_write_int8(IO_param%id_file, ioffset,     &
     &      IO_param%nprocs_in, istack_buffer(1))
      end if
      IO_param%ioff_gl = IO_param%ioff_gl + kint_gl*IO_param%nprocs_in
!
      ioffset = IO_param%ioff_gl                                        &
     &         + kint * IO_param%istack_merged(IO_param%id_rank)
      IO_param%ioff_gl = IO_param%ioff_gl                               &
     &         + kint * IO_param%istack_merged(IO_param%nprocs_in)
!
...
!
      ioffset = IO_param%ioff_gl                                        &
     &         + kint_gl * IO_param%istack_merged(IO_param%id_rank)
      IO_param%ioff_gl = IO_param%ioff_gl                               &
     &         + kint_gl * IO_param%istack_merged(IO_param%nprocs_in)
!
      if(IO_param%id_rank .ge. IO_param%nprocs_in) return
...
!
      ioffset = IO_param%ioff_gl                                        &
     &         + kreal * IO_param%istack_merged(IO_param%id_rank)
      IO_param%ioff_gl = IO_param%ioff_gl                               &
     &         + kreal * IO_param%istack_merged(IO_param%nprocs_in)
!
      if(IO_param%id_rank .ge. IO_param%nprocs_in) return

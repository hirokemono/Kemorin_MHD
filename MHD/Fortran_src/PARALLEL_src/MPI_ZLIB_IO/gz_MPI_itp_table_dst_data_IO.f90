!>@file  gz_MPI_itp_table_dst_data_IO.f90
!!       module gz_MPI_itp_table_dst_data_IO
!!
!!@author H. Matsui
...
!!      subroutine gz_mpi_write_itp_index_dest                          &
...
!!      subroutine gz_mpi_read_itp_index_dest                           &
!!     &         (IO_param, IO_itp_dest, IO_itp_c_dest)
...
!-----------------------------------------------------------------------
!
      end module gz_MPI_itp_table_dst_data_IO

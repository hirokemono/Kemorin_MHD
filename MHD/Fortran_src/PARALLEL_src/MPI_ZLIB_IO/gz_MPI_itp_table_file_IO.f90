...
!!      subroutine gz_mpi_write_dbl_itp_tbl_file                        &
...
!!      subroutine gz_mpi_read_dbl_itp_tbl_file                         &
...
!
      ...
      call close_mpi_file(IO_param1)
!
      end subroutine gz_mpi_write_dbl_itp_tbl_file
!
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
!
...
!
     ...
     &   (gzip_name, num_pe, id_rank, IO_param1)
      ...
      call close_mpi_file(IO_param1)
!
      end subroutine gz_mpi_read_dbl_itp_tbl_file
!
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
!

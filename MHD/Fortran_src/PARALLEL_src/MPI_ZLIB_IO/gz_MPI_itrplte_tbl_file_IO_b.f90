!>@file  gz_MPI_itrplte_tbl_file_IO_b.f90
!!       module gz_MPI_itrplte_tbl_file_IO_b
!!
!!@author H. Matsui
...
!
      ...
      call gz_mpi_write_itp_coefs_org_b(IO_param1, itp_tbl_IO%tbl_org)
      call close_mpi_file(IO_param1)
!
      end subroutine gz_mpi_wt_itp_tbl_coef_file_b
!
!-----------------------------------------------------------------------
!
      subroutine gz_mpi_wt_itp_tbl_idx_file_b(gzip_name, itp_tbl_IO)
...
!
      ...
      call close_mpi_file(IO_param1)
!
      end subroutine gz_mpi_wt_itp_tbl_idx_file_b
!
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
!
...
!
      ...
      call gz_mpi_write_itp_coefs_org_b(IO_param1, itp_tbl1_IO%tbl_org)
!
      call write_gz_mpi_each_itp_table_b(IO_param1, itp_tbl2_IO)
      call gz_mpi_write_itp_coefs_org_b(IO_param1, itp_tbl2_IO%tbl_org)
      call close_mpi_file(IO_param1)
!
      end subroutine gz_mpi_wt_dbl_itbl_coef_file_b
!
!-----------------------------------------------------------------------
!
      subroutine gz_mpi_wt_dbl_itbl_idx_file_b                          &
...
!
      ...
      call close_mpi_file(IO_param1)
!
      end subroutine gz_mpi_wt_dbl_itbl_idx_file_b
!
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
!
...
!
     ...
     &   (gzip_name, num_pe, id_rank, IO_param1)
      ...
      call gz_mpi_read_itp_coefs_org_b(IO_param1, itp_tbl_IO%tbl_org)
      call close_mpi_file(IO_param1)
!
      end subroutine gz_mpi_rd_itp_tbl_coef_file_b
!
!-----------------------------------------------------------------------
!
      subroutine gz_mpi_rd_itp_tbl_idx_file_b                           &
...
!
     ...
     &   (gzip_name, num_pe, id_rank, IO_param1)
      ...
      call close_mpi_file(IO_param1)
!
      end subroutine gz_mpi_rd_itp_tbl_idx_file_b
!
!-----------------------------------------------------------------------
!
      subroutine gz_mpi_rd_dbl_itbl_coef_file_b                         &
...
!
     ...
     &   (gzip_name, num_pe, id_rank, IO_param1)
      ...
      call gz_mpi_read_itp_coefs_org_b(IO_param1, itp_tbl1_IO%tbl_org)
!
      call read_gz_mpi_each_itp_table_b(IO_param1, itp_tbl2_IO)
      call gz_mpi_read_itp_coefs_org_b(IO_param1, itp_tbl2_IO%tbl_org)
      call close_mpi_file(IO_param1)
!
      end subroutine gz_mpi_rd_dbl_itbl_coef_file_b
!
!-----------------------------------------------------------------------
!
      subroutine gz_mpi_rd_dbl_itbl_idx_file_b                          &
...
!
     ...
     &   (gzip_name, num_pe, id_rank, IO_param1)
      ...
      call close_mpi_file(IO_param1)
!
      end subroutine gz_mpi_rd_dbl_itbl_idx_file_b
!
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
!
...
!
      use gz_MPI_itp_tbl_org_data_IO_b
      use gz_MPI_itp_tbl_dst_data_IO_b
      use gz_MPI_binary_datum_IO
!
...
!-----------------------------------------------------------------------
!
      end module gz_MPI_itrplte_tbl_file_IO_b

...
!
     ...
     &   (IO_param, IO_itp_dest, IO_itp_c_dest)
      call close_mpi_file(IO_param)
!
      end subroutine mpi_wrt_itp_index_dest_file_b
!
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
!
...
!
     ...
     &   (IO_param, IO_itp_dest, IO_itp_c_dest)
      call close_mpi_file(IO_param)
!
      end subroutine mpi_read_itp_index_dest_file_b
!
!-----------------------------------------------------------------------
!
      subroutine mpi_read_itp_table_dest_file_b                         &

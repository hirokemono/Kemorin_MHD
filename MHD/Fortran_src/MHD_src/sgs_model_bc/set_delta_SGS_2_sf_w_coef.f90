!set_delta_SGS_2_sf_w_coef.f90
!      module set_delta_SGS_2_sf_w_coef
!
!      Written by H. Matsui on Sep., 2005
!
!      subroutine delta_flux_t_2_each_sf_w_coef                         &
...
!     &          ak_e, vector_sf)
!      subroutine delta_SGS_induct_t_2_sf_w_coef                        &
!     &         (np_smp, numnod, numele, nnod_4_ele, ie, nnod_4_surf,   &
!     &          node_on_sf, node_on_sf_n, num_surf_bc, surf_item,      &
!     &          num_surf_smp, isurf_grp_smp_stack, igrp, k2, nd,       &
!     &          i_flux, i_b, i_v, ntot_comp, d_nod, ak_e, vector_sf)
!
      module set_delta_SGS_2_sf_w_coef
!
      use m_precision
...
!
      implicit none
!
      private :: d_SGS_induct_x_2_surf_w_coef
      private :: d_SGS_induct_y_2_surf_w_coef
      private :: d_SGS_induct_z_2_surf_w_coef
!
! ----------------------------------------------------------------------
!
      contains
...
!$omp end parallel do
!
      end subroutine delta_flux_t_2_each_sf_w_coef
!
! ----------------------------------------------------------------------
! ----------------------------------------------------------------------
!
...
!
      if(nd .eq. 1) then
        call d_SGS_induct_x_2_surf_w_coef                               &
     &         (np_smp, numnod, numele, nnod_4_ele, ie, nnod_4_surf,    &
     &          node_on_sf, node_on_sf_n, num_surf_bc, surf_item,       &
     &          num_surf_smp, isurf_grp_smp_stack, igrp, k2,            &
     &          i_flux, i_b, i_v, ntot_comp, d_nod, ak_e, vector_sf)
      else if(nd .eq. 2) then
        call d_SGS_induct_y_2_surf_w_coef                               &
     &         (np_smp, numnod, numele, nnod_4_ele, ie, nnod_4_surf,    &
     &          node_on_sf, node_on_sf_n, num_surf_bc, surf_item,       &
     &          num_surf_smp, isurf_grp_smp_stack, igrp, k2,            &
     &          i_flux, i_b, i_v, ntot_comp, d_nod, ak_e, vector_sf)
      else if(nd .eq. 3) then
        call d_SGS_induct_z_2_surf_w_coef                               &
     &         (np_smp, numnod, numele, nnod_4_ele, ie, nnod_4_surf,    &
     &          node_on_sf, node_on_sf_n, num_surf_bc, surf_item,       &
     &          num_surf_smp, isurf_grp_smp_stack, igrp, k2,            &
     &          i_flux, i_b, i_v, ntot_comp, d_nod, ak_e, vector_sf)
...
!
      end subroutine delta_SGS_induct_t_2_sf_w_coef
!
! ----------------------------------------------------------------------
!
      subroutine d_SGS_induct_x_2_surf_w_coef                           &
     &         (np_smp, numnod, numele, nnod_4_ele, ie, nnod_4_surf,    &
     &          node_on_sf, node_on_sf_n, num_surf_bc, surf_item,       &
     &          num_surf_smp, isurf_grp_smp_stack, igrp, k2,            &
     &          i_flux, i_b, i_v, ntot_comp, d_nod, ak_e, vector_sf)
...
!$omp end parallel do
!
      end subroutine d_SGS_induct_x_2_surf_w_coef
!
! ----------------------------------------------------------------------
!
      subroutine d_SGS_induct_y_2_surf_w_coef                           &
     &         (np_smp, numnod, numele, nnod_4_ele, ie, nnod_4_surf,    &
     &          node_on_sf, node_on_sf_n, num_surf_bc, surf_item,       &
     &          num_surf_smp, isurf_grp_smp_stack, igrp, k2,            &
     &          i_flux, i_b, i_v, ntot_comp, d_nod, ak_e, vector_sf)
...
!$omp end parallel do
!
      end subroutine d_SGS_induct_y_2_surf_w_coef
!
! ----------------------------------------------------------------------
!
      subroutine d_SGS_induct_z_2_surf_w_coef                           &
     &         (np_smp, numnod, numele, nnod_4_ele, ie, nnod_4_surf,    &
     &          node_on_sf, node_on_sf_n, num_surf_bc, surf_item,       &
     &          num_surf_smp, isurf_grp_smp_stack, igrp, k2,            &
     &          i_flux, i_b, i_v, ntot_comp, d_nod, ak_e, vector_sf)
...
!$omp end parallel do
!
      end subroutine d_SGS_induct_z_2_surf_w_coef
!
! ----------------------------------------------------------------------
!
      end module set_delta_SGS_2_sf_w_coef

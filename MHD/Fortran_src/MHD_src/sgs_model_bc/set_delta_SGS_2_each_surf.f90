!set_delta_SGS_2_each_surf.f90
!      module set_delta_SGS_2_each_surf
!
!      Written by H. Matsui on Sep., 2005
!
!      subroutine delta_flux_t_2_each_surface                           &
...
!     &          k2, nd, i_vect, i_field, i_fluxs, ntot_comp, d_nod,    &
!     &          vector_sf)
!      subroutine delta_SGS_induct_t_2_surface                          &
!     &         (np_smp, numnod, numele, nnod_4_ele, ie, nnod_4_surf,   &
!     &          node_on_sf, node_on_sf_n, num_surf_bc, surf_item,      &
!     &          num_surf_smp, isurf_grp_smp_stack, igrp, k2, nd,       &
!     &          i_flux, i_b, i_v, ntot_comp, d_nod, vector_sf)
!
      module set_delta_SGS_2_each_surf
!
      use m_precision
...
!
      implicit none
!
      private :: d_SGS_induct_x_2_each_surface
      private :: d_SGS_induct_y_2_each_surface
      private :: d_SGS_induct_z_2_each_surface
!
! ----------------------------------------------------------------------
!
      contains
...
!$omp end parallel do
!
      end subroutine delta_flux_t_2_each_surface
!
! ----------------------------------------------------------------------
! ----------------------------------------------------------------------
!
...
!
      if(nd .eq. 1) then
        call d_SGS_induct_x_2_each_surface                              &
     &         (np_smp, numnod, numele, nnod_4_ele, ie, nnod_4_surf,    &
     &          node_on_sf, node_on_sf_n, num_surf_bc, surf_item,       &
     &          num_surf_smp, isurf_grp_smp_stack, igrp, k2,            &
     &          i_flux, i_b, i_v, ntot_comp, d_nod, vector_sf)
      else if(nd .eq. 2) then
        call d_SGS_induct_y_2_each_surface                              &
     &         (np_smp, numnod, numele, nnod_4_ele, ie, nnod_4_surf,    &
     &          node_on_sf, node_on_sf_n, num_surf_bc, surf_item,       &
     &          num_surf_smp, isurf_grp_smp_stack, igrp, k2,            &
     &          i_flux, i_b, i_v, ntot_comp, d_nod, vector_sf)
      else if(nd .eq. 3) then
        call d_SGS_induct_z_2_each_surface                              &
     &         (np_smp, numnod, numele, nnod_4_ele, ie, nnod_4_surf,    &
     &          node_on_sf, node_on_sf_n, num_surf_bc, surf_item,       &
     &          num_surf_smp, isurf_grp_smp_stack, igrp, k2,            &
     &          i_flux, i_b, i_v, ntot_comp, d_nod, vector_sf)
...
!
      end subroutine delta_SGS_induct_t_2_surface
!
! ----------------------------------------------------------------------
!
      subroutine d_SGS_induct_x_2_each_surface                          &
     &         (np_smp, numnod, numele, nnod_4_ele, ie, nnod_4_surf,    &
     &          node_on_sf, node_on_sf_n, num_surf_bc, surf_item,       &
     &          num_surf_smp, isurf_grp_smp_stack, igrp,                &
     &          k2, i_flux, i_b, i_v, ntot_comp, d_nod, vector_sf)
!
      integer(kind = kint), intent(in) :: np_smp, numnod, numele
      integer(kind = kint), intent(in) :: nnod_4_ele, nnod_4_surf
      integer(kind = kint), intent(in) :: ie(numele,nnod_4_ele)
...
!$omp end parallel do
!
      end subroutine d_SGS_induct_x_2_each_surface
!
! ----------------------------------------------------------------------
!
      subroutine d_SGS_induct_y_2_each_surface                          &
     &         (np_smp, numnod, numele, nnod_4_ele, ie, nnod_4_surf,    &
     &          node_on_sf, node_on_sf_n, num_surf_bc, surf_item,       &
     &          num_surf_smp, isurf_grp_smp_stack, igrp,                &
     &          k2, i_flux, i_b, i_v, ntot_comp, d_nod, vector_sf)
...
!$omp end parallel do
!
      end subroutine d_SGS_induct_y_2_each_surface
!
! ----------------------------------------------------------------------
!
      subroutine d_SGS_induct_z_2_each_surface                          &
     &         (np_smp, numnod, numele, nnod_4_ele, ie, nnod_4_surf,    &
     &          node_on_sf, node_on_sf_n, num_surf_bc, surf_item,       &
     &          num_surf_smp, isurf_grp_smp_stack, igrp,                &
     &          k2, i_flux, i_b, i_v, ntot_comp, d_nod, vector_sf)
...
!$omp end parallel do
!
      end subroutine d_SGS_induct_z_2_each_surface
!
! ----------------------------------------------------------------------
!
      end module set_delta_SGS_2_each_surf

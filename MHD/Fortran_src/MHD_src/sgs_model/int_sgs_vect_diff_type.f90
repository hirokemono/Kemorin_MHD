!int_sgs_vect_diff_type.f90
!      module int_sgs_vect_diff_type
!
!     programmed by H.Matsui on July 2005
!     Modified by H. Matsui on Oct., 2006
!
!      subroutine int_sgs_grad_type(mesh, jac_3d, FEM_elens,              &
!     &          rhs_tbl, nod_fld, iele_fsmp_stack, num_int,            &
!     &          i_filter, ak_diff, i_field, fem_wk, f_nl)
!      subroutine int_sgs_div_type(mesh, jac_3d, FEM_elens,             &
!     &          rhs_tbl, nod_fld, iele_fsmp_stack, num_int,            &
!     &          i_filter, ak_diff, i_field, fem_wk, f_nl)
!      subroutine int_sgs_rot_type(mesh, jac_3d, FEM_elens,             &
!     &          rhs_tbl, nod_fld, iele_fsmp_stack, num_int,            &
!     &          i_filter, ak_diff, i_field, fem_wk, f_nl)
!
!      subroutine int_sgs_div_tsr_type(mesh, jac_3d, FEM_elens,         &
!     &          rhs_tbl, nod_fld, iele_fsmp_stack, num_int,            &
!     &          i_filter, ak_diff, i_field, fem_wk, f_nl)
!      subroutine int_sgs_div_as_tsr_type(mesh, jac_3d, FEM_elens,      &
!     &          rhs_tbl, nod_fld, iele_fsmp_stack, num_int,            &
!     &          i_filter, ak_diff, i_field, fem_wk, f_nl)
!
      module int_sgs_vect_diff_type
...
!
      end subroutine int_sgs_grad_type
!
!-----------------------------------------------------------------------
!
      subroutine int_sgs_div_type(mesh, jac_3d, FEM_elens,              &
...
!
      end subroutine int_sgs_div_type
!
!-----------------------------------------------------------------------
!
      subroutine int_sgs_rot_type(mesh, jac_3d, FEM_elens,              &
...
!
      call add3_skv_to_ff_v_smp_type(mesh, rhs_tbl, fem_wk, f_nl)
!
      end subroutine int_sgs_rot_type
!
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
!
...
!
      call add3_skv_to_ff_v_smp_type(mesh, rhs_tbl, fem_wk, f_nl)
!
      end subroutine int_sgs_div_tsr_type
!
!-----------------------------------------------------------------------
!
      subroutine int_sgs_div_as_tsr_type(mesh, jac_3d, FEM_elens,       &
...
!
      call add3_skv_to_ff_v_smp_type(mesh, rhs_tbl, fem_wk, f_nl)
!
      end subroutine int_sgs_div_as_tsr_type
!
!-----------------------------------------------------------------------
!
      end module int_sgs_vect_diff_type

!int_vol_rms_dynamic_grpsmp.f90
...
!
      end subroutine int_vol_rms_dynamic_grpsmp_l
!
! ----------------------------------------------------------------------
!
      subroutine int_vol_rms_dynamic_grpsmp_q(n_tensor, n_int)
...
!
      end subroutine int_vol_rms_dynamic_grpsmp_q
!
!  ---------------------------------------------------------------------
!
      end module int_vol_rms_dynamic_grpsmp

!fem_skv_div_ast_w_sgs.f90
!      module fem_skv_div_ast_w_sgs
!
!        programmed by H.Matsui on July, 2005
!        modified by H.Matsui on Aug., 2006
!
!!      subroutine fem_skv_div_sgs_asym_t_pg                            &
...
!
!
              div_ox = an1(k1,ix) * (dnx2(iele,k2,ix,2)*sgs_1(iele,1)   &
     &                             - dnx2(iele,k2,ix,3)*sgs_1(iele,3))
              div_oy = an1(k1,ix) *(-dnx2(iele,k2,ix,1)*sgs_1(iele,1)   &
...
!$omp end parallel do
!
      end subroutine fem_skv_div_sgs_asym_t_pg
!
!   --------------------------------------------------------------------
!
      end module fem_skv_div_ast_w_sgs

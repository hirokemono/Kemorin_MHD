!
!      module int_vol_rms_ave_dynamic
!
...
!
      implicit none
!
      private :: int_vol_rms_ave_dynamic_l, int_vol_rms_ave_dynamic_q
!
!  ---------------------------------------------------------------------
!
      contains
...
!
      end subroutine s_int_vol_rms_ave_dynamic
!
!  ---------------------------------------------------------------------
!  ---------------------------------------------------------------------
!
...
!  ---------------------------------------------------------------------
!
      end module int_vol_rms_ave_dynamic

!fem_skv_inertia_sgs.f90
!     module fem_skv_inertia_sgs
!
...
!
!!      subroutine fem_skv_scalar_inertia_sgs                           &
!!     &         (numele, nnod_4_e1, nnod_4_e2, np_smp, iele_fsmp_stack,&
!!     &         max_int_point, maxtot_int_3d, int_start3, owe3d,       &
!!     &         n_int, k2, ntot_int_3d, xjac, an1, dnx2,               &
!!     &         scalar_e, sgs_e, vxe, sk_v)
!!      subroutine fem_skv_vector_inertia_sgs                           &
!!     &        (numele, nnod_4_e1, nnod_4_e2, np_smp, iele_fsmp_stack, &
!!     &         max_int_point, maxtot_int_3d, int_start3, owe3d,       &
!!     &         n_int, k2, ntot_int_3d, xjac, an1, dnx2,               &
!!     &         vector_e, sgs_e, vxe, sk_v)
!!      subroutine fem_skv_inertia_rot_sgs                              &
!!     &        (numele, nnod_4_e1, nnod_4_e2, np_smp, iele_fsmp_stack, &
!!     &         max_int_point, maxtot_int_3d, int_start3, owe3d,       &
!!     &         n_int, k2, ntot_int_3d, xjac, an1, an2, dnx2,          &
...
!
      real (kind=kreal) :: inertia, div_s
      integer (kind=kint) :: k1
      integer (kind=kint) :: iproc, iele, ii, ix
      integer (kind=kint) :: istart, iend
!
!
!$omp parallel do private(k1,ii,ix,iele,istart,iend,inertia,div_s)
      do iproc = 1, np_smp
...
!
              div_s = an1(k1,ix) * ( dnx2(iele,k2,ix,1)*sgs_e(iele,1)   &
...
!$omp end parallel do
      ...
      end subroutine fem_skv_scalar_inertia_sgs
!
!-----------------------------------------------------------------------
!
      subroutine fem_skv_vector_inertia_sgs                             &
...
!  ------  set inertia term
!
              div_x = an1(k1,ix) * ( dnx2(iele,k2,ix,1)*sgs_e(iele,1)   &
     &                             + dnx2(iele,k2,ix,2)*sgs_e(iele,2)   &
     &                             + dnx2(iele,k2,ix,3)*sgs_e(iele,3))
!
              div_y = an1(k1,ix) * ( dnx2(iele,k2,ix,1)*sgs_e(iele,1)   &
     &                             + dnx2(iele,k2,ix,2)*sgs_e(iele,4)   &
     &                             + dnx2(iele,k2,ix,3)*sgs_e(iele,5))
!
              div_z = an1(k1,ix) * ( dnx2(iele,k2,ix,1)*sgs_e(iele,3)   &
     &                             + dnx2(iele,k2,ix,2)*sgs_e(iele,4)   &
...
!$omp end parallel do
!
      end subroutine fem_skv_vector_inertia_sgs
!
!-----------------------------------------------------------------------
!
      subroutine fem_skv_inertia_rot_sgs                                &
...
!$omp end parallel do
!
      end subroutine fem_skv_inertia_rot_sgs
!
!-----------------------------------------------------------------------
!
      end module fem_skv_inertia_sgs

!fem_skv_div_tsr_w_sgs_upw.f90
!      module fem_skv_div_tsr_w_sgs_upw
!
!        programmed by H.Matsui on July, 2005
!        modified by H.Matsui on Aug., 2006
!
!      subroutine fem_skv_div_tensor_w_sgs_upw                          &
...
!
!
              div_ox = tau * ( dnx2(iele,k2,ix,1)*sgs_1(iele,1)         &
     &                       + dnx2(iele,k2,ix,2)*sgs_1(iele,2)         &
     &                       + dnx2(iele,k2,ix,3)*sgs_1(iele,3) )
              div_oy = tau * ( dnx2(iele,k2,ix,1)*sgs_1(iele,2)         &
...
!$omp end parallel do
!
      end subroutine fem_skv_div_tensor_w_sgs_upw
!
!   --------------------------------------------------------------------
!
      end module fem_skv_div_tsr_w_sgs_upw

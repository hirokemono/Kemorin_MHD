!fem_skv_inertia1_sgsmod.f90
!     module fem_skv_inertia1_sgsmod
!
...
!
!      subroutine fem_skv_scalar_inertia_sgsmod                         &
...
!$omp&                    inertia,div_s,div_cx,div_cy,div_cz)
      do iproc = 1, np_smp
...
!$omp end parallel do
!
      end subroutine fem_skv_scalar_inertia_sgsmod
!
!-----------------------------------------------------------------------
!
      end module fem_skv_inertia1_sgsmod

...
!!     &          mhd_fem_wk, fem_wk, f_l, nod_fld, v_sol)
...
!
     ...
     &      fem_wk, mhd_fem_wk, nod_fld, v_sol)
!
     ...
     &     filtering, sgs_coefs_nod, wk_filter, nod_fld, v_sol)
!
     ...
     &      mlump_fl, fem_wk, f_l, f_nl, nod_fld, v_sol)
      end if
!
...
!
     ...
     &     rhs_tbl, mlump_fl, fem_wk, f_l, f_nl, nod_fld, v_sol)
      end if
!

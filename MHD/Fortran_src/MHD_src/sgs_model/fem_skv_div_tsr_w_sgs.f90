!fem_skv_div_tsr_w_sgs.f90
!      module fem_skv_div_tsr_w_sgs
!
!        programmed by H.Matsui on July, 2005
!        modified by H.Matsui on Aug., 2006
!
!      subroutine fem_skv_div_tensor_w_sgs_pg                           &
...
!
      real(kind=kreal), intent(in) :: sgs_1(numele,6)
      real(kind=kreal), intent(in) :: flux_1(numele,6)
...
!
     ...
     &           * dnx2(iele,k2,ix,3) )
!
              div_ox = an1(k1,ix) * ( dnx2(iele,k2,ix,1)*sgs_1(iele,1)  &
     &                              + dnx2(iele,k2,ix,2)*sgs_1(iele,2)  &
     &                              + dnx2(iele,k2,ix,3)*sgs_1(iele,3))
              div_oy = an1(k1,ix) * ( dnx2(iele,k2,ix,1)*sgs_1(iele,2)  &
     &                              + dnx2(iele,k2,ix,2)*sgs_1(iele,4)  &
     &                              + dnx2(iele,k2,ix,3)*sgs_1(iele,5))
              div_oz = an1(k1,ix) * ( dnx2(iele,k2,ix,1)*sgs_1(iele,3)  &
     &                              + dnx2(iele,k2,ix,2)*sgs_1(iele,5)  &
     &                              + dnx2(iele,k2,ix,3)*sgs_1(iele,6))
!
!
...
!$omp end parallel do
!
      end subroutine fem_skv_div_tensor_w_sgs_pg
!
!   --------------------------------------------------------------------
!
      end module fem_skv_div_tsr_w_sgs

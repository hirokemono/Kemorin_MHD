!fem_skv_inertia1_sgsmod_upw.f90
!     module fem_skv_inertia1_sgsmod_upw
!
...
!
!!      subroutine fem_skv_sclr_inertia_modsgs_upw                      &
...
!
      real(kind=kreal) :: inertia, tau, div_s
...
!
!
!$omp parallel do private(k1,ii,ix,iele,istart,iend,tau,inertia,div_s,  &
!$omp&                    div_cx,div_cy,div_cz)
      do iproc = 1, np_smp
...
!$omp end parallel do
!
      end subroutine fem_skv_sclr_inertia_modsgs_upw
!
!-----------------------------------------------------------------------
!
      end module fem_skv_inertia1_sgsmod_upw

!fem_skv_div_vect_w_sgs_upw.f90
!      module fem_skv_div_vect_w_sgs_upw
!
!        programmed by H.Matsui on July, 2005
!        modified by H.Matsui on Aug., 2006
!
!      subroutine fem_skv_div_sgs_vector_upw                            &
...
!
     ...
     &           * dnx2(iele,k2,ix,3) )
!
              div_og = tau * ( dnx2(iele,k2,ix,1)*sgs_1(iele,1)         &
...
!$omp end parallel do
!
      end subroutine fem_skv_div_sgs_vector_upw
!
!   --------------------------------------------------------------------
!
      end module fem_skv_div_vect_w_sgs_upw

!fem_skv_inertia3_sgsmod.f90
!     module fem_skv_inertia3_sgsmod
!
...
!
!!      subroutine fem_skv_vector_inertia_sgsmod                        &
...
!$omp&                    inertia,div_cx,div_cy,div_cz)
      do iproc = 1, np_smp
...
!
              div_y = an1(k1,ix) * (dnx2(iele,k2,ix,1)*sgs_e(iele,2)    &
...
!$omp end parallel do
!
      end subroutine fem_skv_vector_inertia_sgsmod
!
!-----------------------------------------------------------------------
!
      end module fem_skv_inertia3_sgsmod

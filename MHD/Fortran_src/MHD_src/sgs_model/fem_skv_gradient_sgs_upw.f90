!fem_skv_gradient_sgs_upw.f90
!     module fem_skv_gradient_sgs_upw
!
!        programmed by H.Matsui on July, 2005
!        modified by H. Matsui on Aug., 2007
!
!      subroutine fem_skv_grad_sgs_upw(numele, nnod_4_e1, nnod_4_e2,    &
...
!
              grad_x = tau * dnx2(iele,k2,ix,1)
              grad_y = tau * dnx2(iele,k2,ix,2)
              grad_z = tau * dnx2(iele,k2,ix,3)
!
!
...
!$omp end parallel do
!
      end subroutine fem_skv_grad_sgs_upw
!
!-----------------------------------------------------------------------
!
      end module fem_skv_gradient_sgs_upw

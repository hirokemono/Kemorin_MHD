...
!
!
      call fem_skv_grad_sgs_upw(ele1%numele, nnod_4_ele, nnod_4_ele,    &
...
!
!
      call fem_skv_div_tsr_sgs_upw(ele1%numele, nnod_4_ele, nnod_4_ele, &
     &    np_smp, iele_fsmp_stack, n_int, k2, dt,                       &
     &    ntot_int_3d, xjac, aw, dwx, dwx,                              &
     &    FEM1_elen%filter_conf%xmom_1d_org(i_filter,2),                &
     &    FEM1_elen%nele_filter_mom,                                    &
...
!
!
      call fem_skv_div_ast_sgs_upw(ele1%numele, nnod_4_ele, nnod_4_ele, &
     &    np_smp, iele_fsmp_stack, n_int, k2, dt,                       &
     &    ntot_int_3d, xjac, aw, dwx, dwx,                              &
     &    FEM1_elen%filter_conf%xmom_1d_org(i_filter,2),                &
     &    FEM1_elen%nele_filter_mom,                                    &

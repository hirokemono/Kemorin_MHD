!fem_skv_div_vect_w_sgs.f90
!      module fem_skv_div_vect_w_sgs
!
!        programmed by H.Matsui on July, 2005
!        modified by H.Matsui on Aug., 2006
!
!!      subroutine fem_skv_div_sgs_vector_pg                            &
...
!
!
!$omp  parallel do private(k1,ii,ix,iele,ist,ied,div_og,                &
...
!
!
              div_og = an1(k1,ix) * (dnx2(iele,k2,ix,1)*sgs_1(iele,1)   &
...
!$omp end parallel do
!
      end subroutine fem_skv_div_sgs_vector_pg
!
!   --------------------------------------------------------------------
!
      end module fem_skv_div_vect_w_sgs

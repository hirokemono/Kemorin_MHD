!fem_skv_commute_err_div.f90
!     module fem_skv_commute_err_div
!
!        programmed by H.Matsui on July, 2005
!        modified by H. Matsui on Aug., 2007
!
!      subroutine fem_skv_commute_error_div                             &
...
!
     ...
     &                         + ( div_x * vector_1(iele,1)             &
     &                           + div_y * vector_1(iele,2)             &
     &                           + div_z * vector_1(iele,3))            &
...
!$omp end parallel do
!
      end subroutine fem_skv_commute_error_div
!
!-----------------------------------------------------------------------
!
      end module fem_skv_commute_err_div

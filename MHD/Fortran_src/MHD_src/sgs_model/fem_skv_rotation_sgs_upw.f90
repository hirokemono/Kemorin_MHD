!fem_skv_rotation_sgs_upw.f90
!     module fem_skv_rotation_sgs_upw
!
!        programmed by H.Matsui on July, 2005
!        modified by H. Matsui on Aug., 2007
!
!      subroutine fem_skv_rot_sgs_upw(numele, nnod_4_e1, nnod_4_e2,     &
...
!$omp end parallel do
!
      end subroutine fem_skv_rot_sgs_upw
!
!-----------------------------------------------------------------------
!
      end module fem_skv_rotation_sgs_upw

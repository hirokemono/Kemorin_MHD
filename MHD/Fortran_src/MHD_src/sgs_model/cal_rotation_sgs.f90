...
!
     ...
     &      node, ele, surf, sf_grp, nod_fld, sgs_sf,                   &
     &      iak_diff, i_vector)
      else
        call choose_int_vol_rotations(iflag_4_supg, iele_fsmp_stack,    &
     &      node, ele, nod_fld, i_vector)
      end if
!
...
!
     ...
     &     (node, ele, jac1_3d_q, rhs_tbl1, nod_fld, FEM1_elen,         &
...
!
     ...
     &    nod_fld, jac1_sf_grp_2d_q, rhs_tbl1, FEM1_elen, sgs_sf,       &

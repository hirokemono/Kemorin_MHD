...
!
     ...
     &      jacs, FEM_elens, diff_coefs, sgs_sf, rhs_tbl,               &
     &      fem_wk, surf_wk, f_nl)
      else
...
!
     ...
     &      diff_coefs%ak(1,iak_diff), i_vector,                        &

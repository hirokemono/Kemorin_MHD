...
!
      call ele_nodal_bc_scalar_layer(node, ele, fluid, nod_bc1_t)
      call ele_nodal_bc_scalar_layer(node, ele, fluid, sgs_bc1_t)
!
...
!
      call ele_nodal_bc_scalar_layer(node, ele, fluid, nod_bc1_c)
      call ele_nodal_bc_scalar_layer(node, ele, fluid, sgs_bc1_c)
!

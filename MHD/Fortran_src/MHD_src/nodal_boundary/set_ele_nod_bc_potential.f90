...
!
     ...
     &    nod_bc1_p%num_idx_ibc, nod_bc1_p%ibc)
      call count_bc_element_layer                                       &
     &   (node1, ele1, iele_fl_start, iele_fl_end,                      &
     &    nod_bc1_p%num_idx_ibc2, nod_bc1_p%ibc2)
!
...
!
      call count_bc_element_layer                                       &
     &   (node1, ele1, iele_fl_start, iele_fl_end,                      &
     &    sgs_bc1_p%num_idx_ibc, sgs_bc1_p%ibc)
      call count_bc_element_layer                                       &
     &   (node1, ele1, iele_fl_start, iele_fl_end,                      &
     &    sgs_bc1_p%num_idx_ibc2, sgs_bc1_p%ibc2)
!
      call alloc_nod_bc_scalar_ele_type                                 &
...
!
      call set_bc_element_whole(node1, ele1,                            &
...
!
      call count_bc_element_layer                                       &
     &    (node1, ele1, iele_ins_start, iele_ins_end,                   &
     &     nod_bc1_fins%num_idx_ibc, nod_bc1_f%ibc)
      call count_bc_element_layer                                       &
     &    (node1, ele1, iele_ins_start, iele_ins_end,                   &
     &    nod_bc1_fins%num_idx_ibc2, nod_bc1_f%ibc2)
!
      call alloc_nod_bc_scalar_ele_type                                 &
...
!
     ...
     &   (node1, ele1, iele_ins_start, iele_ins_end,                    &
     &    nod_bc1_fins%num_idx_ibc, nod_bc1_f%ibc,                      &
     &    nod_bc1_fins%ele_bc_id, nod_bc1_fins%nod_bc_id,               &
     &    num_t_linear)
      call set_bc_element_layer                                         &
     &   (node1, ele1, iele_ins_start, iele_ins_end,                    &
     &    nod_bc1_fins%num_idx_ibc2, nod_bc1_f%ibc2,                    &
     &    nod_bc1_fins%ele_bc2_id, nod_bc1_fins%nod_bc2_id,             &
     &    num_t_linear)
!
...
!
      call count_bc_element_layer                                       &
     &   (node1, ele1, iele_cd_start, iele_cd_end,                      &

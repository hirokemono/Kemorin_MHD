...
!
      call set_ele_4_vector_nodal_bc_fl(ibc_velo, ibc2_velo,            &
...
!
      call set_ele_4_vector_nodal_bc_fl(ibc_v_sgs, ibc2_v_sgs,          &
...
!
      call set_ele_4_vector_nodal_bc(ibc_vp, ibc2_vp, nmax_idx_ibc_vp,  &
...
!
      call set_ele_4_vector_nodal_bc(ibc_a_sgs, ibc2_a_sgs,             &
...
!
      call set_ele_4_vector_nodal_bc(ibc_magne, ibc2_magne,             &
...
!
      call set_ele_4_vector_nodal_bc(ibc_b_sgs, ibc2_b_sgs,             &

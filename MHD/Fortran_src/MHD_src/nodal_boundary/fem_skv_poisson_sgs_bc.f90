!fem_skv_poisson_sgs_bc.f90
!     module fem_skv_poisson_sgs_bc
!
!        programmed by H.Matsui on July, 2005
!        modified by H.Matsui on AUg., 2007
!
!      subroutine fem_skv_poisson_sgs_fixed                             &
!!     &       (numele, nnod_4_e1, nnod_4_e2, np_smp, num_index_ibc,    &
!!     &        ele_bc_id, ibc_stack_smp, max_int_point, maxtot_int_3d, &
!!     &        int_start3, owe3d, k2, n_int, ntot_int_3d,              &
...
!
     ...
     &                         - (  diffuse + ak_diff(iele)             &
     &                          * (div_x+div_y+div_z) )                 &
     &                          * phi_e(iele) * xjac(iele,ix)*owe3d(ix)
!
            end do
!
          end do
...
!$omp end parallel do
!
      end subroutine fem_skv_poisson_sgs_fixed
!
!-----------------------------------------------------------------------
!
      end module fem_skv_poisson_sgs_bc

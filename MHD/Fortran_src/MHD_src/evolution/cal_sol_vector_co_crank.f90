...
!
!      subroutine cal_sol_velo_co_crank
!      subroutine cal_sol_vect_p_co_crank
!      subroutine cal_sol_magne_co_crank
!      subroutine cal_sol_velo_co_crank_consist
!      subroutine cal_sol_vect_p_co_crank_consist
!      subroutine cal_sol_magne_co_crank_consist
!
...
!
      use m_node_phys_address
!
      call cal_sol_vect_co_crank(iphys%i_vecp)
!
...
!
      use m_node_phys_address
!
      call cal_sol_vect_co_crank(iphys%i_magne)
!
...
!
!
      call cal_sol_vect_co_crank_consist(coef_velo)
!
...
!
!
      call cal_sol_vect_co_crank_consist(coef_magne)
!
...
! -----------------------------------------------------------------------! -----------------------------------------------------------------------
!
      subroutine cal_sol_vect_co_crank(i_field)
!
      use m_machine_parameter
      use m_geometry_parameter
      use m_finite_element_matrix
...
! ----------------------------------------------------------------------
!
      subroutine cal_sol_vect_co_crank_consist(coef_field)
!
      use m_machine_parameter
      use m_geometry_parameter
      use m_finite_element_matrix

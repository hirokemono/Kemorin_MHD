...
!
     ...
     &      SGS_MHD_wk%fem_int, icomp_sgs_term, iak_diff_base,          &
     &      iphys_elediff_vec, sgs_coefs, diff_coefs, FEM_filters,      &
     ...
     &     iphys_LES%SGS_wk, SGS_MHD_wk%iphys_ele, SGS_MHD_wk%fem_int,  &

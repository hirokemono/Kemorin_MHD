...
!!     &          FEM_elens, ifld_sgs, icomp_sgs, ifld_diff,            &
!!     &          iphys_elediff, sgs_coefs_nod, diff_coefs, filtering,  &
!!     &          layer_tbl, Vmatrix, MG_vector, wk_lsq, wk_sgs,        &
...
!!     &         iphys_ele, ele_fld, ak_MHD, jacobians, rhs_tbl,        &
...
!
     ...
     &        .and. fl_prop%coef_exp.gt.zero) then
        call int_vol_vector_diffuse_ele(SGS_par%model_p%ifilter_final,  &
...
!
     ...
     &      node, ele, fluid, fl_prop, jacobians%jac_3d, rhs_tbl,       &
...
!
     ...
     &    Vsf_bcs, Bsf_bcs, iphys, nod_fld, jacobians%jac_sf_grp,       &
...
!
     ...
     &     fluid, fl_prop, iphys, iphys_ele, ele_fld, jacobians%jac_3d, &
...
!
     ...
     &      iphys, iphys_ele, ele_fld, jacobians%jac_3d, rhs_tbl,       &
...
!
     ...
     &      Vnod_bcs, jacobians%jac_3d, rhs_tbl, FEM_elens, diff_coefs, &
...
!
     ...
     &   (FEM_prm%npoint_poisson_int, SGS_par%model_p%ifilter_final,    &
...
!
     ...
     &      FEM_prm, nod_comm, node, ele, fluid, jacobians%jac_3d,      &
     &      rhs_tbl, mhd_fem_wk, fem_wk, f_l, f_nl, nod_fld)
      end if
!
!

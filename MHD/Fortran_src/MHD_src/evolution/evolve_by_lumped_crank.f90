...
!!     &          g_FEM, jac_3d, rhs_tbl, FEM_elens, Cdiff_velo,        &
...
!!     &          FEM_elens, Cdiff_magne, mlump_cd, Bmatrix, MG_vector, &
...
!!     &          rhs_tbl, FEM_elens, Cdiff, mlump_fl,                  &
...
!
     ...
     &      Cdiff_velo, Vnod_bcs%nod_bc_v, Vnod_bcs%nod_bc_rot,         &

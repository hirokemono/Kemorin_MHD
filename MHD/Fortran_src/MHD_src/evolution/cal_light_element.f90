...
!
     ...
     &      rhs_tbl, FEM_elens, diff_coefs, ifld_diff%base%i_light,     &
...
!
     ...
     &      diff_coefs%num_field, ifld_diff%SGS_term%i_SGS_c_flux,      &
...
!
     ...
     &      i_field, iphys%exp_work%i_pre_composit, ifld_diff%base%i_light,  &

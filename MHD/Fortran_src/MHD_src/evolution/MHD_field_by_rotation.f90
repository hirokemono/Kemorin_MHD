...
!!     &          g_FEM, jac_3d, jac_sf_grp, rhs_tbl, FEM_elens,        &
...
!
     ...
     &       iphys_ele, ele_fld, g_FEM, jac_3d, jac_sf_grp, FEM_elens,  &
...
!     &          g_FEM, jac_3d, jac_sf_grp, rhs_tbl, m_lump,            &

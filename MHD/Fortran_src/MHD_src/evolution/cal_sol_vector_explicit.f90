...
!
!
      call cal_sol_vect_pre_fluid_euler(n_vector, iphys%i_velo)
!
...
!
!
      call cal_sol_vect_pre_fluid_euler(n_scalar, iphys%i_temp)
!
...
!
!
      call cal_sol_vect_pre_fluid_euler(n_scalar, iphys%i_par_temp)
!
...
!
!
      call cal_sol_vect_pre_fluid_euler(n_scalar, iphys%i_light)
!
...
!
!
      call cal_sol_vect_pre_fluid_adams(n_vector, iphys%i_velo,         &
     &    iphys%i_pre_mom)
!
...
!
!
      call cal_sol_vect_pre_fluid_adams(n_scalar, iphys%i_temp,         &
     &    iphys%i_pre_heat)
!
...
!
!
      call cal_sol_vect_pre_fluid_adams(n_scalar, iphys%i_par_temp,     &
     &    iphys%i_pre_heat)
!
...
!
!
      call cal_sol_vect_pre_fluid_adams(n_scalar, iphys%i_light,        &
     &    iphys%i_pre_composit)
!
...
! -----------------------------------------------------------------------
!
      subroutine cal_sol_vect_pre_fluid_euler(numdir, i_field)
!
...
!
!
!$omp parallel do private(nd,icomp,inod)
      do iproc = 1, np_smp
        do nd=1, numdir
          icomp = i_field + nd - 1
!cdir nodep
...
! -----------------------------------------------------------------------
!
      subroutine cal_sol_vect_pre_fluid_adams(numdir, i_field, if_pre)
!
      use m_machine_parameter
      use m_geometry_parameter
      use m_node_phys_data
...
!
!
!$omp parallel do private(nd,icomp,if_comp,inod)
      do iproc = 1, np_smp
        do nd=1, numdir
          icomp = i_field + nd - 1
          if_comp = if_pre + nd - 1

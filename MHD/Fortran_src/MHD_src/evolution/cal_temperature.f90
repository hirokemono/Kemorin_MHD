...
!
     ...
     &         iref_grad, ref_fld, iphys, iphys_LES, iphys_ele_base,    &
     &         ele_fld, fem_int, FEM_elens,                       &
...
!
     ...
     &          iphys_elediff_vec, sgs_coefs, sgs_coefs_nod,            &
     &          diff_coefs, filtering, mk_MHD%mlump_fl, Smatrix, ak_MHD%ak_d_temp,   &

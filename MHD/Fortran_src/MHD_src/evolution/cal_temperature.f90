...
!
     ...
     &    MGCG_WK, FEM_SGS_wk%wk_filter, mhd_fem_wk, rhs_mat,           &
     &    nod_fld, m_SR)
!
...
!
      ...
      i_scalar =   iphys_base%i_temp
      i_velo =     iphys_base%i_velo
      i_gref =     iref_grad%i_grad_temp
      i_pre_advect = iphys_exp%i_pre_heat
      i_tensor =   iphys_SGS%i_SGS_h_flux

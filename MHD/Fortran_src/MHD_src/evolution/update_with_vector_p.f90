...
!!     &          jacs, rhs_tbl, FEM_filters, m_lump, FEM_SGS_wk,       &
...
!
     ...
     &            jacs, rhs_tbl, FEM_filters%FEM_elens,                 &
     &            FEM_filters%filtering, m_lump, FEM_SGS_wk%wk_filter,  &
...
!
     ...
     &         mesh%node, mesh%ele, nod_fld, jacs%g_FEM,                &
     &         jacs%jac_3d, jacs%jac_3d_l, mhd_fem_wk)
         end if
!

...
!
     ...
     &            jacobians, rhs_tbl, FEM_elen, filtering, m_lump,      &
...
!
     ...
     &      jacobians%jac_3d, jacobians%jac_sf_grp, FEM_elen,           &
     &      diff_coefs, Bnod_bcs%nod_bc_b, Asf_bcs%sgs, rhs_tbl,        &

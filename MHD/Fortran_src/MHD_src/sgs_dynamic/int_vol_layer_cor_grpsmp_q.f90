!>@file   int_vol_layer_cor_grpsmp_q.f90
!!@brief  module int_vol_layer_cor_grpsmp_q
!!
!!@author H. Matsui
...
!!
!!@verbatim
!!      subroutine s_int_vol_layer_cor_grpsmp_q                         &
...
!!@endverbatim
!
      module int_vol_layer_cor_grpsmp_q
!
      use m_precision
!
...
!
      end subroutine s_int_vol_layer_cor_grpsmp_q
!
!-----------------------------------------------------------------------
!
      end module int_vol_layer_cor_grpsmp_q

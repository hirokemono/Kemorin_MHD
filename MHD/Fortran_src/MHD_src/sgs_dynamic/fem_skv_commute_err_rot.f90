!fem_skv_commute_err_rot.f90
!     module fem_skv_commute_err_rot
!
!        programmed by H.Matsui on July, 2005
!        modified by H. Matsui on Aug., 2007
!
!      subroutine fem_skv_commute_error_rot                             &
...
!
     ...
     &                         + ( div_y * vector_1(iele,3)             &
     &                           - div_z * vector_1(iele,2) )           &
     &                          * xjac(iele,ix)*owe3d(ix)
              sk_v(iele,2,k1) = sk_v(iele,2,k1)                         &
     &                         + ( div_z * vector_1(iele,1)             &
     &                           - div_x * vector_1(iele,3) )           &
     &                          * xjac(iele,ix)*owe3d(ix)
              sk_v(iele,3,k1) = sk_v(iele,3,k1)                         &
     &                         + ( div_x * vector_1(iele,2)             &
     &                           - div_y * vector_1(iele,1) )           &
     &                          * xjac(iele,ix)*owe3d(ix)
            end do
          end do
!
...
!$omp end parallel do
!
      end subroutine fem_skv_commute_error_rot
!
!-----------------------------------------------------------------------
!
      end module fem_skv_commute_err_rot

...
!                               (to iphys%SGS_wk%i_nlg)
!
      if (iflag_debug.gt.0) write(*,*) 'cal_rotation_whole',            &
     &                     iphys%SGS_wk%i_nlg, iphys%base%i_vecp
      call choose_cal_rotation                                          &
     &   (FEM_prm%iflag_magne_supg, FEM_prm%npoint_t_evo_int, dt,       &
     &    iphys%base%i_vecp, iphys%SGS_wk%i_nlg, ele%istack_ele_smp,    &
...
!      call cal_filtered_scalar_whole                                   &
!     &   (SGS_par%filter_p, nod_comm, node, filtering,                 &
!     &    iphys%SGS_wk%i_nlg+6, iphys%SGS_wk%i_nlg+6, wk_filter,       &
!     &    nod_fld)
!
...
!      call subtract_2_nod_scalars(nod_fld, iphys%SGS_wk%i_nlg+6,       &

...
!
!!      subroutine cal_w_filter_scalar_phys                             &
!!     &         (nod_comm, node, num_filter_grp, id_filter_grp,        &
!!     &          i_field, ntot_comp, i_filter, d_nod)
!!      subroutine cal_w_filter_vector_phys                             &
!!     &         (nod_comm, node, num_filter_grp, id_filter_grp,        &
!!     &          i_field, ntot_comp, i_filter, d_nod)
!!      subroutine cal_w_filter_tensor_phys                             &
!!     &         (nod_comm, node, num_filter_grp, id_filter_grp,        &
!!     &          i_field, ntot_comp, i_filter, d_nod)
...
!!
!!      subroutine cal_w_ez_filter_scalar_phys                          &
!!     &         (nod_comm, node, num_filter_grp, id_filter_grp,        &
!!     &          i_field, ntot_comp, i_filter, d_nod)
!!      subroutine cal_w_ez_filter_vector_phys                          &
!!     &         (nod_comm, node, num_filter_grp, id_filter_grp,        &
!!     &          i_field, ntot_comp, i_filter, d_nod)
!!      subroutine cal_w_ez_filter_tensor_phys                          &
!!     &         (nod_comm, node, num_filter_grp, id_filter_grp,        &
!!     &          i_field, ntot_comp, i_filter, d_nod)

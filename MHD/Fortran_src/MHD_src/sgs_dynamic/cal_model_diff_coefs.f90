...
!
     ...
     &     (layer_tbl, ele%istack_ele_smp, SGS_par,                     &
     &      node, ele, iphys, nod_fld, g_FEM, jac_3d_q, jac_3d_l,       &

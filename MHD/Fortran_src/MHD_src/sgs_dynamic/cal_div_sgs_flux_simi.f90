...
!!     &          mlump_fl, f_l, f_nl, nod_fld, v_sol, SR_sig, SR_r)
...
!!     &          iphys_ele_base, ele_fld, jacs, rhs_tbl, fem_wk,       &
!!     &          mlump_cd, f_l, f_nl, nod_fld, v_sol, SR_sig, SR_r)
...
!
     ...
     &      nod_fld, jacs%g_FEM, jacs%jac_3d, rhs_tbl, fem_wk, f_nl)
      end if
!
...
!
     ...
     &      conduct, nod_fld, jacs%g_FEM, jacs%jac_3d, rhs_tbl,         &
     &      fem_wk, f_nl)
      end if
!
      call set_ff_nl_smp_2_ff(n_vector, node, rhs_tbl, f_l, f_nl)

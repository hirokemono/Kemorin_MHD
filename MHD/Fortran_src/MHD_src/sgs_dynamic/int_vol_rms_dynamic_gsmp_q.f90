!>@file   int_vol_rms_dynamic_gsmp_q.f90
!!@brief  module int_vol_rms_dynamic_gsmp_q
!!
!!@author H. Matsui
...
!!
!!@verbatim
!!      subroutine s_int_vol_rms_dynamic_grpsmp_q                       &
...
!!@endverbatim
!
      module int_vol_rms_dynamic_gsmp_q
!
      use m_precision
!
...
!
      end subroutine s_int_vol_rms_dynamic_grpsmp_q
!
!  ---------------------------------------------------------------------
!
      end module int_vol_rms_dynamic_gsmp_q

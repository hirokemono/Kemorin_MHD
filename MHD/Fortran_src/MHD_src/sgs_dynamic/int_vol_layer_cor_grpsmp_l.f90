!>@file   int_vol_layer_cor_grpsmp_l.f90
!!@brief  module int_vol_layer_cor_grpsmp_l
!!
!!@author H. Matsui
...
!!
!!@verbatim
!!      subroutine s_int_vol_layer_cor_grpsmp_l                         &
...
!!@endverbatim
!
      module int_vol_layer_cor_grpsmp_l
!
      use m_precision
!
...
!
      end subroutine s_int_vol_layer_cor_grpsmp_l
!
!-----------------------------------------------------------------------
!
      end module int_vol_layer_cor_grpsmp_l

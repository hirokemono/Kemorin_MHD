...
!
     ...
     &    i_sgs, nod_fld1%ntot_phys, nod_fld1%d_fld, sgs_e, flux_e)
!
...
!
     ...
     &    nod_fld1%ntot_phys, nod_fld1%d_fld, sgs_e, flux_e)
!
...
!
     ...
     &   (node1%numnod, ele1%numele, ele1%nnod_4_ele, ele1%ie,          &
     &    np_smp, ele1%istack_ele_smp, k2, i_vect, i_scalar,            &
     &    i_sgs, nod_fld1%ntot_phys, nod_fld1%d_fld,                    &
     &    ak_e, sgs_e, flux_e)
!
...
!
     ...
     &   (node1%numnod, ele1%numele, ele1%nnod_4_ele, ele1%ie,          &
     &    np_smp, ele1%istack_ele_smp, k2, i_vect, i_sgs,               &
     &    nod_fld1%ntot_phys, nod_fld1%d_fld, ak_e, sgs_e, flux_e)
!
...
!
     ...
     &    nod_fld1%d_fld, ak_e, sgs_e, flux_e)
!
...
!
     ...
     &    ele1%nnod_4_ele, ele1%ie, np_smp, ele1%istack_ele_smp,        &
     &    k2, nd, i_b, i_v, i_sgs, nod_fld1%ntot_phys, nod_fld1%d_fld,  &
     &    ak_e, sgs_e, flux_e)
!
...
!
     ...
     &   (node1%numnod, ele1%numele, ele1%nnod_4_ele, ele1%ie,          &
     &    np_smp, ele1%istack_ele_smp, k2, i_vect, i_sgs,               &
     &    nod_fld1%ntot_phys, nod_fld1%d_fld, coef, sgs_e, flux_e)
!
...
!
     ...
     &    ele1%nnod_4_ele, ele1%ie, np_smp, ele1%istack_ele_smp,        &
     &    k2, nd, i_vect, i_field, i_sgs, nod_fld1%ntot_phys,           &
     &    nod_fld1%d_fld, coef, sgs_e, flux_e)
!

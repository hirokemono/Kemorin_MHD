!int_sgs_vect_cst_diff.f90
!      module int_sgs_vect_cst_diff
!
!     programmed by H.Matsui on July 2005
!     Modified by H. Matsui on Oct., 2006
!
!!      subroutine int_sgs_grad_w_const                                 &
!!     &         (node, ele, g_FEM, jac_3d, rhs_tbl, nod_fld, FEM_elens,&
!!     &          iele_fsmp_stack, num_int, i_filter, ak_diff, i_field, &
!!     &          coef, fem_wk, f_nl)
!!      subroutine int_sgs_div_w_const                                  &
!!     &         (node, ele, g_FEM, jac_3d, rhs_tbl, nod_fld, FEM_elens,&
!!     &          iele_fsmp_stack, num_int, i_filter, ak_diff, i_field, &
!!     &          coef, fem_wk, f_nl)
!!      subroutine int_sgs_rot_w_const                                  &
!!     &         (node, ele, g_FEM, jac_3d, rhs_tbl, nod_fld, FEM_elens,&
!!     &          iele_fsmp_stack, num_int, i_filter, ak_diff, i_field, &
!!     &          coef, fem_wk, f_nl)
!!
!!      subroutine int_sgs_div_tsr_w_const                              &
!!     &         (node, ele, g_FEM, jac_3d, rhs_tbl, nod_fld, FEM_elens,&
!!     &          iele_fsmp_stack, num_int, i_filter, ak_diff, i_field, &
!!     &          coef, fem_wk, f_nl)
!!      subroutine int_sgs_div_as_tsr_w_const                           &
!!     &         (node, ele, g_FEM, jac_3d, rhs_tbl, nod_fld, FEM_elens,&
!!     &          iele_fsmp_stack, num_int, i_filter, ak_diff, i_field, &
!!     &          coef, fem_wk, f_nl)
!
...
!
      end subroutine int_sgs_grad_w_const
!
!-----------------------------------------------------------------------
!
      subroutine int_sgs_div_w_const                                    &
...
!
     ...
     &     (iele_fsmp_stack, num_int, k2, i_filter, ak_diff,            &
     &      ele, g_FEM, jac_3d, FEM_elens, fem_wk%vector_1,             &
     &      fem_wk%sk6)
      end do
!
     ...
     &   (node, ele, rhs_tbl, fem_wk%sk6, f_nl%ff_smp)
!
      end subroutine int_sgs_div_w_const
!
!-----------------------------------------------------------------------
!
      subroutine int_sgs_rot_w_const                                    &
...
!
     ...
     &   (node, ele, rhs_tbl, fem_wk%sk6, f_nl%ff_smp)
!
      end subroutine int_sgs_rot_w_const
!
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
!
...
!
     ...
     &     (iele_fsmp_stack, num_int, k2, i_filter, ak_diff,            &
     &      ele, g_FEM, jac_3d, FEM_elens, fem_wk%tensor_1,             &
     &      fem_wk%sk6)
      end do
!
      call add3_skv_to_ff_v_smp                                         &
     &   (node, ele, rhs_tbl, fem_wk%sk6, f_nl%ff_smp)
!
      end subroutine int_sgs_div_tsr_w_const
!
!-----------------------------------------------------------------------
!
      subroutine int_sgs_div_as_tsr_w_const                             &
...
!
     ...
     &   (node, ele, rhs_tbl, fem_wk%sk6, f_nl%ff_smp)
!
      end subroutine int_sgs_div_as_tsr_w_const
!
!-----------------------------------------------------------------------
!
      end module int_sgs_vect_cst_diff

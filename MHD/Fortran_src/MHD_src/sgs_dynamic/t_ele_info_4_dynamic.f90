...
!
        ...
        real(kind = kreal), allocatable    :: fld_clip(:,:)
        real(kind = kreal), allocatable    :: fld_whole(:)
        real(kind = kreal), allocatable    :: fld_whole_clip(:)
        real(kind = kreal), allocatable    :: comp_coef(:,:)
        real(kind = kreal), allocatable    :: comp_clip(:,:)
        real(kind = kreal), allocatable    :: comp_whole(:)
        real(kind = kreal), allocatable    :: comp_whole_clip(:)
...
!
        ...
        real(kind = kreal), allocatable    :: covariant_w(:)
        real(kind = kreal), allocatable    :: ratio_w(:)
!
        real(kind = kreal), allocatable    :: coef_p(:,:)
        real(kind = kreal), allocatable    :: coef_wp(:)

...
!   SGS advection flag
     ...
     &    iphys%i_SGS_vp_induct, icou, trns_DYNS%forward)
      call set_field_name_4_sph_trns                                    &

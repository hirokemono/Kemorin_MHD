...
!!
!!@verbatim
!!      subroutine sel_sph_SGS_induct_nl_gradient(sph_rtp, gamma, coef, &
...
!
     ...
     &      sph_rtp%sin_theta_1d_rtp, sph_rtp%cot_theta_1d_rtp, gamma,  &
     &      coef, fld_rtp(1,ib_mhd_velo), fld_sgs_rtp(1,ib_grad_ux),    &

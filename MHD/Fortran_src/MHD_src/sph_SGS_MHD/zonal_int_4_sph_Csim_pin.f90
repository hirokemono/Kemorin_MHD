...
!!
!!@verbatim
!!      subroutine zonal_int_vector_Csim_pin(sph_rtp, sph_d_grp,        &
!!     &          frc_simi, frc_wide, frc_dble, sgs_zl, sgs_zt)
!!      subroutine zonal_int_tentor_Csim_pin(sph_rtp, sph_d_grp,        &
!!     &          frc_simi, frc_wide, frc_dble, sgs_zl, sgs_zt)
!!
...
!!@endverbatim
!
      module zonal_int_4_sph_Csim_pin
!
      use m_precision
      use m_constants
...
!
!$omp  parallel do                                                      &
!$omp& private(klgrp,kgrp,lgrp,kst,ked,lst,led,k,l,kr,lt,i1,diff,sim2)
...
!
      end subroutine zonal_int_vector_Csim_pin
!
!  ---------------------------------------------------------------------
!
      subroutine zonal_int_tentor_Csim_pin(sph_rtp, sph_d_grp,          &
...
!
      end subroutine zonal_int_tentor_Csim_pin
!
!  ---------------------------------------------------------------------
!  ---------------------------------------------------------------------
!
...
!  ---------------------------------------------------------------------
!
      end module zonal_int_4_sph_Csim_pin

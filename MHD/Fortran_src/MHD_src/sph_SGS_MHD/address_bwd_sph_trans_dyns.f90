...
!   double filtered temperature
     ...
     &    itor%i_dbl_fil_temp, iphys%i_dbl_fil_temp, icou, trns_DYNS%backward)
      call set_field_name_4_sph_trns(fhd_d_filter_comp,                 &
     &    trns_DYNS%b_trns%i_dbl_fil_comp, ipol%i_dbl_fil_comp,         &
     &    itor%i_dbl_fil_comp, iphys%i_dbl_fil_comp, icou, trns_DYNS%backward)
!

...
!      wide filtered force
     ...
     &    ipol%i_wide_fil_velo, iphys%i_wide_fil_velo, icou, trns_DYNS)
      call set_field_name_4_bwd_trns                                    &
     &   (fhd_w_filter_vort, trns_DYNS%b_trns%i_wide_fil_vort,          &
     &    ipol%i_wide_fil_vort, iphys%i_wide_fil_vort, icou, trns_DYNS)
      call set_field_name_4_bwd_trns                                    &
...
!      dual filtered force
     ...
     &    ipol%i_dbl_fil_velo, iphys%i_dbl_fil_velo, icou, trns_DYNS)
      call set_field_name_4_bwd_trns                                    &
     &   (fhd_d_filter_vort, trns_DYNS%b_trns%i_dbl_fil_vort,           &
     &    ipol%i_dbl_fil_vort, iphys%i_dbl_fil_vort, icou, trns_DYNS)
      call set_field_name_4_bwd_trns                                    &
     &   (fhd_d_filter_magne, trns_DYNS%b_trns%i_dbl_fil_magne,         &
     &    ipol%i_dbl_fil_magne, iphys%i_dbl_fil_magne, icou, trns_DYNS)
      call set_field_name_4_bwd_trns                                    &

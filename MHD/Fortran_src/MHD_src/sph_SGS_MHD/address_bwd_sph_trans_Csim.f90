...
!
!   wide filtered temperature
      call set_field_name_4_sph_trns(fhd_w_filter_temp,                 &
     &    trns_Csim%b_trns%i_wide_fil_temp, ipol%i_wide_fil_temp,       &
     &    itor%i_wide_fil_temp, iphys%i_wide_fil_temp,                  &
     &    icou, trns_Csim%backward)
      call set_field_name_4_sph_trns(fhd_w_filter_comp,                 &
...
!   double filtered temperature
      call set_field_name_4_sph_trns(fhd_d_filter_temp,                 &
     &    trns_Csim%b_trns%i_dbl_fil_temp, ipol%i_dbl_fil_temp,         &
     &    itor%i_dbl_fil_temp, iphys%i_dbl_fil_temp, icou, trns_Csim%backward)
      call set_field_name_4_sph_trns(fhd_d_filter_comp,                 &
     &    trns_Csim%b_trns%i_dbl_fil_comp, ipol%i_dbl_fil_comp,         &
     &    itor%i_dbl_fil_comp, iphys%i_dbl_fil_comp, icou, trns_Csim%backward)
!

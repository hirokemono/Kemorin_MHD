...
!!      subroutine zmean_SGS_force_from_trans(sph_params, sph_rtp,      &
!!     &         trns_SGS, node, iphys, nod_fld)
!!      subroutine zrms_SGS_force_from_trans(sph_params, sph_rtp,       &
!!     &         trns_SGS, node, iphys, nod_fld)
!!        type(sph_shell_parameters), intent(in) :: sph_params
!!        type(sph_rtp_grid), intent(in) :: sph_rtp
!!        type(node_data), intent(in) :: node
...
!
      call zmean_scalar_from_snap_force                                 &
     &   (trns_SGS%f_trns%i_Csim_SGS_buoyancy,                          &
     &    iphys%i_Csim_SGS_buoyancy, sph_params%m_folding,              &
     &    sph_rtp, trns_SGS, node, nod_fld)
!
      call zmean_scalar_from_snap_force                                 &
     &   (trns_SGS%f_trns%i_Csim_SGS_comp_buo,                          &
     &    iphys%i_Csim_SGS_comp_buo, sph_params%m_folding,              &
     &    sph_rtp, trns_SGS, node, nod_fld)
!
      end  subroutine zmean_SGS_force_from_trans
!
!-----------------------------------------------------------------------
!
      subroutine zrms_SGS_force_from_trans(sph_params, sph_rtp,         &
...
!
     ...
     &    sph_rtp, trns_SGS, node, nod_fld)
!
      end  subroutine zrms_SGS_force_from_trans
!
!-----------------------------------------------------------------------
!

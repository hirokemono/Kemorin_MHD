...
!
     ...
     &      fg_trns%SGS_term%i_SGS_inertia, trns_f_SGS%ncomp,           &
     &      trns_f_SGS%fld_rtp)
      end if
!
     ...
     &      bn_trns%diff_vector%i_grad_jz,                              &
     &      bn_trns%diff_vector%i_grad_bx,                              &
     &      bn_trns%diff_vector%i_grad_by,                              &
     &      bn_trns%diff_vector%i_grad_bz,                              &
     &      trns_b_NLGD%ncomp, trns_b_NLGD%fld_rtp,                     &
     &      fg_trns%SGS_term%i_SGS_Lorentz, trns_f_SGS%ncomp,           &
     &      trns_f_SGS%fld_rtp)
      end if
!
     ...
     &      bn_trns%diff_vector%i_grad_bz,                              &
     &      trns_b_NLGD%ncomp, trns_b_NLGD%fld_rtp,                     &
     &      fg_trns%SGS_term%i_SGS_vp_induct, trns_f_SGS%ncomp,         &
     &      trns_f_SGS%fld_rtp)
      end if
!
...
!
      if(fd_trns%wide_SGS%i_SGS_Lorentz .gt. 0) then
        call sel_sph_SGS_induct_nl_gradient                             &
     &     (sph%sph_rtp, wide_filters, MHD_prop%fl_prop%coef_lor,       &
     &      bg_trns%filter_fld%i_current, bg_trns%filter_fld%i_magne,   &
     &      trns_b_SGS%ncomp, trns_b_SGS%fld_rtp,                       &
     ...
     &      trns_b_DYNG%ncomp, trns_b_DYNG%fld_rtp,                     &
     &      fd_trns%wide_SGS%i_SGS_Lorentz, trns_f_DYNS%ncomp,          &
     &      trns_f_DYNS%fld_rtp)
      end if
!
     ...
     &      bg_trns%filter_fld%i_velo, bg_trns%filter_fld%i_magne,      &
     &      trns_b_SGS%ncomp, trns_b_SGS%fld_rtp,                       &
     &      bd_trns%diff_fil_vect%i_grad_vx,                            &
     &      bd_trns%diff_fil_vect%i_grad_vy,                            &
     &      bd_trns%diff_fil_vect%i_grad_vz,                            &
     ...
     &      bd_trns%diff_fil_vect%i_grad_bz,                            &
     &      trns_b_DYNG%ncomp, trns_b_DYNG%fld_rtp,                     &
     &      fd_trns%wide_SGS%i_SGS_vp_induct, trns_f_DYNS%ncomp,        &
     &      trns_f_DYNS%fld_rtp)
      end if
!

...
!!      subroutine zmean_SGS_snap_fld_from_trans(sph_params, sph_rtp,   &
!!     &          trns_snap, node, iphys, nod_fld)
!!      subroutine zrms_SGS_snap_fld_from_trans(sph_params, sph_rtp,    &
!!     &          trns_snap, node, iphys, nod_fld)
!!        type(sph_shell_parameters), intent(in) :: sph_params
!!        type(sph_rtp_grid), intent(in) :: sph_rtp
!!        type(node_data), intent(in) :: node
...
!
!
      end  subroutine zmean_SGS_snap_fld_from_trans
!
!-----------------------------------------------------------------------
!
      subroutine zrms_SGS_snap_fld_from_trans(sph_params, sph_rtp,      &
...
!
!
      end  subroutine zrms_SGS_snap_fld_from_trans
!
!-----------------------------------------------------------------------
!

...
!
     ...
     &    sph, fem, nod_fld, zmeans%zm_psf)
      call SGS_MHD_zonal_RMS_section(viz_step, time_d, SPH_SGS%SGS_par, &
     &    sph, fem, WK, SPH_SGS%trns_WK_LES, nod_fld, zmeans%zrms_psf)
!
...
!
     ...
     &   (viz_step%PSF_t, time_d, fem, nod_fld, zrms_psf)

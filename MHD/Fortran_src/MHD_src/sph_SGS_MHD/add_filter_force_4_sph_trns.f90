...
!!     &         (d_rj, ipol_fil_frc, iphys_fil_frc,                    &
!!     &          f_trns_fil_frc, trns)
...
!!
!!      subroutine add_filter_force_fwd_trns_snap(d_rj,                 &
...
!!     &         (d_rj, ipol_fil_frc, iphys_fil_frc,                    &
!!     &          b_trns_fil_frc, trns)
!!      subroutine add_fil_scl_flux_bwd_trns_snap(d_rj,                 &
...
!!     &         (d_rj, ipol_rot_fil_frc, iphys_rot_fil_frc,            &
...
!
      call add_field_4_sph_trns_by_pol(d_rj,                            &
     &    ipol_fil_frc%i_thrm_buo, iphys_fil_frc%i_thrm_buo,            &
     &    b_trns_fil_frc%i_thrm_buo, trns)
      call add_field_4_sph_trns_by_pol(d_rj,                            &
...
!
     ...
     &    b_trns_rot_fil_frc%i_lorentz, trns)
      call add_field_name_4_sph_trns_snap(d_rj,                         &
     &    ipol_rot_fil_frc%i_thrm_buo, iphys_rot_fil_frc%i_thrm_buo,    &
     &    b_trns_rot_fil_frc%i_thrm_buo, trns)
      call add_field_name_4_sph_trns_snap(d_rj,                         &

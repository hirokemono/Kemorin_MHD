...
!!     &         (d_rj, ipol_gfl, iphys_gfl, b_trns_gfl, trns)
...
!!     &         (d_rj, ipol_dfv, iphys_dfv, b_trns_dfv, trns)
!!      subroutine add_diff_fil_vec_4_scalar_trns                       &
!!     &         (d_rj, ipol_dfv, iphys_dfv, f_trns_dfv, trns)
!!        type(phys_data), intent(in) :: d_rj
...
!
!   Radial velocity
      call add_scalar_4_sph_trns_by_pol(d_rj,                           &
     &    ipol_dfv%i_grad_vx, iphys_dfv%i_grad_vx,                      &

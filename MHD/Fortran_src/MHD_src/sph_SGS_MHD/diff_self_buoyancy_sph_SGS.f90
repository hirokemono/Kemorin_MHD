!>@file   diff_self_buoyancy_sph_SGS.f90
!!@brief  module diff_self_buoyancy_sph_SGS
!!
!!@author H. Matsui
...
!!
!!@verbatim
!!      subroutine cal_rot_self_buo_sph_SGS_MHD                         &
!!     &         (sph_rj, ipol, MHD_prop, sph_bc_U, rj_fld)
!!      subroutine cal_div_self_buo_sph_SGS_MHD                         &
!!     &         (sph_rj, ipol, MHD_prop, sph_bc_U, rj_fld)
...
!
      module diff_self_buoyancy_sph_SGS
!
      use m_precision
...
!
     ...
     &    MHD_prop%fl_prop, sph_bc_U, rj_fld)
!
      end subroutine cal_rot_self_buo_sph_SGS_MHD
!
!-----------------------------------------------------------------------
!
      subroutine cal_div_self_buo_sph_SGS_MHD                           &
...
!
     ...
     &    MHD_prop%fl_prop, sph_bc_U, rj_fld)
!
      end subroutine cal_div_self_buo_sph_SGS_MHD
!
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
!
...
!-----------------------------------------------------------------------
!
      end module diff_self_buoyancy_sph_SGS

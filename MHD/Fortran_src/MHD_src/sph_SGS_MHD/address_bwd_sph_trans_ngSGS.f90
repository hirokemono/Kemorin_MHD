...
!   Gradient of Radial velocity
      call add_field_name_4_sph_trns(ipol%i_grad_vx,                    &
     &    grad_v_1%name, grad_v_1%n_comp, ipol%i_grad_vx,               &
     &    itor%i_grad_vx, iphys%i_grad_vx, b_trns%i_grad_vx, trns_back)
!   Gradient of meridional velocity
      call add_field_name_4_sph_trns(ipol%i_grad_vy,                    &
     &    grad_v_2%name, grad_v_2%n_comp, ipol%i_grad_vy,               &
     &    itor%i_grad_vy, iphys%i_grad_vy, b_trns%i_grad_vy, trns_back)
!   Gradient of zonal velocity
      call add_field_name_4_sph_trns(ipol%i_grad_vz,                    &
     &    grad_v_3%name, grad_v_3%n_comp, ipol%i_grad_vz,               &
     &    itor%i_grad_vz, iphys%i_grad_vz, b_trns%i_grad_vz, trns_back)
!
!   Gradient of Radial vorticity
      call add_field_name_4_sph_trns(ipol%i_grad_wx,                    &
     &    grad_w_1%name, grad_w_1%n_comp, ipol%i_grad_wx,               &
     &    itor%i_grad_wx, iphys%i_grad_wx, b_trns%i_grad_wx, trns_back)
!   Gradient of meridional vorticity
      call add_field_name_4_sph_trns(ipol%i_grad_wy,                    &
     &    grad_w_2%name, grad_w_2%n_comp, ipol%i_grad_wy,               &
     &    itor%i_grad_wy, iphys%i_grad_wy, b_trns%i_grad_wy, trns_back)
!   Gradient of zonal vorticity
      call add_field_name_4_sph_trns(ipol%i_grad_wz,                    &
     &    grad_w_3%name, grad_w_3%n_comp, ipol%i_grad_wz,               &
     &    itor%i_grad_wz, iphys%i_grad_wz, b_trns%i_grad_wz, trns_back)
!
!   Gradient of Radial magnetic field
      call add_field_name_4_sph_trns(ipol%i_grad_bx,                    &
     &    grad_b_1%name, grad_b_1%n_comp, ipol%i_grad_bx,               &
     &    itor%i_grad_bx, iphys%i_grad_bx, b_trns%i_grad_bx, trns_back)
!   Gradient of meridional magnetic field
      call add_field_name_4_sph_trns(ipol%i_grad_by,                    &
     &    grad_b_2%name, grad_b_2%n_comp, ipol%i_grad_by,               &
     &    itor%i_grad_by, iphys%i_grad_by, b_trns%i_grad_by, trns_back)
!   Gradient of zonal magnetic field
      call add_field_name_4_sph_trns(ipol%i_grad_bz,                    &
     &    grad_b_3%name, grad_b_3%n_comp, ipol%i_grad_bz,               &
     &    itor%i_grad_bz, iphys%i_grad_bz, b_trns%i_grad_bz, trns_back)
!
!   Gradient of Radial current density
      call add_field_name_4_sph_trns(ipol%i_grad_jx,                    &
     &    grad_j_1%name, grad_j_1%n_comp, ipol%i_grad_jx,               &
     &    itor%i_grad_jx, iphys%i_grad_jx, b_trns%i_grad_jx, trns_back)
!   Gradient of meridional current density
      call add_field_name_4_sph_trns(ipol%i_grad_jy,                    &
     &    grad_j_2%name, grad_j_2%n_comp, ipol%i_grad_jy,               &
     &    itor%i_grad_jy, iphys%i_grad_jy, b_trns%i_grad_jy, trns_back)
!   Gradient of zonal current density
      call add_field_name_4_sph_trns(ipol%i_grad_jz,                    &
     &    grad_j_3%name, grad_j_3%n_comp, ipol%i_grad_jz,               &

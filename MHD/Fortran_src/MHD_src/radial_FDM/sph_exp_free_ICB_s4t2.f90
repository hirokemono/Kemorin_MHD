...
!!     &          fdm2_free_vt_ICB, n_point, d_rj_fld, d_rj_rot)
!!        integer(kind = kint), intent(in) :: nri, jmax, kr_in
!!        real(kind = kreal), intent(in) :: g_sph_rj(jmax,13)
!!        real(kind = kreal), intent(in) :: r_ICB1(0:2)
!!        real(kind = kreal), intent(in) :: d1nod_mat_fdm_2(nri,-1:1)
...
!!     &          d2nod_mat_fdm_2, fdm4_free_vp_ICB0,                   &
!!     &          fdm4_free_vp_ICB1, fdm2_free_vt_ICB, coef_d,          &
...
!$omp parallel do private(inod,i_p1,i_p2,i_p3,j,d1s_dr1,d2s_dr2,d1t_dr1)
      do j = 1, jmax
        ...
        i_p3 = i_p2 + jmax
!
        d1s_dr1 =  fdm4_free_vp_ICB0( 2,2) * d_rj_fld(i_p2,1)           &
     &           + fdm4_free_vp_ICB0( 1,2) * d_rj_fld(i_p1,1)
        d2s_dr2 =  fdm4_free_vp_ICB0( 2,3) * d_rj_fld(i_p2,1)           &
     &           + fdm4_free_vp_ICB0( 1,3) * d_rj_fld(i_p1,1)
...
!
!
        d1s_dr1 =  fdm4_free_vp_ICB1( 2,2) * d_rj_fld(i_p3,1)           &
     &           + fdm4_free_vp_ICB1( 1,2) * d_rj_fld(i_p2,1)           &
     &           + fdm4_free_vp_ICB1( 0,2) * d_rj_fld(i_p1,1)           &
     &           + fdm4_free_vp_ICB1(-1,2) * d_rj_fld(inod,1)
        d2s_dr2 =  fdm4_free_vp_ICB1( 2,3) * d_rj_fld(i_p3,1)           &
     &           + fdm4_free_vp_ICB1( 1,3) * d_rj_fld(i_p2,1)           &
     &           + fdm4_free_vp_ICB1( 0,3) * d_rj_fld(i_p1,1)           &
     &           + fdm4_free_vp_ICB1(-1,3) * d_rj_fld(inod,1)

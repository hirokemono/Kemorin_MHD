...
!
     ...
     &    g_sph_rj, fdm3e_d0_mat, fdm3e_d1_mat, fdm3e_d3_mat,           &
     &    hdiv_visous_mat)
!
     ...
     &      fl_prop%flag_ref_density_valiation, sph_rj%nidx_rj(2),      &
     &      sph_rj%ar_ele_rj(kr,1), sph_rj%ar_ele_rj(kr,2), g_sph_rj,   &
     &      relative_d, h_nu, h_rho, h_drhodr,                          &

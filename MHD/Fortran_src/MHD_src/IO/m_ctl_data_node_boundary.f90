...
!!@n      node_bc_MP_ctl%vect:    Boudary condition value
...
!!@n      node_bc_A_ctl%vect:    Boudary condition value
      type(ctl_array_c2r) :: node_bc_A_ctl
!
!!      Structure of nodal boudary conditions for current density
!!@n      node_bc_J_ctl%c1_tbl:  Type of boundary conditions
!!@n      node_bc_J_ctl%c2_tbl:  Node (radial) group name for boundary
!!@n      node_bc_J_ctl%vect:    Boudary condition value

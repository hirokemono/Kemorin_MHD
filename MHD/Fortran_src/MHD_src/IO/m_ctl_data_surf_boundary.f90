...
!!@n      surf_bc_BN_ctl%vect:    Boudary condition value
...
!!@n      surf_bc_JN_ctl%vect:    Boudary condition value
...
!!@n      surf_bc_AN_ctl%vect:    Boudary condition value

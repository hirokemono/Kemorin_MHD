...
!
!
!!      Structure of number and power to construct viscousity term
...
!
!!      Structure of number and power to construct intertia term
...
!!      Structure of number and power to construct compositional buoyancy
...
!!      Structure of number and power to construct Coriolis force
...
!!      Structure of number and power to construct Lorentz force

...
!
     ...
     &    model_ctl, smctl_ctl, nmtr_ctl, psph_ctl, MHD_files,          &
     &    bc_IO, refs%ref_inoput_IO, MHD_step, MHD_prop,                &
...
!
     ...
     &          model_ctl, smctl_ctl, nmtr_ctl, psph_ctl, MHD_files,    &
     &          bc_IO, ref_inoput_IO, MHD_step, MHD_prop, MHD_BC,       &
...
!
      ...
      type(MHD_file_IO_params), intent(inout) :: MHD_files
      type(boundary_spectra), intent(inout) :: bc_IO
      type(field_IO_params), intent(inout) :: ref_inoput_IO
      type(MHD_step_param), intent(inout) :: MHD_step
      type(MHD_evolution_param), intent(inout) :: MHD_prop
      type(MHD_BC_lists), intent(inout) :: MHD_BC
      type(parameters_4_sph_trans), intent(inout) :: trans_p
...
!
     ...
     &    MHD_files%fst_file_IO, bc_IO, ref_inoput_IO,                  &
     &    trans_p, WK%WK_leg)
!

!DJDS_const_solver_list_ins1.f90
!     module DJDS_const_solver_list_ins1
!
!        programmed by H.Matsui and H.Okuda
!        modified by H. Matsui on Nov. 2003
!        modified by H. Matsui on Aug., 2007
!
!      subroutine reordering_djds_smp_l_ins
!
      module DJDS_const_solver_list_ins1
!
      use m_precision
...
!
     ...
     &      NLmaxHYP1, NUmaxHYP1, itotal1_ins_l, itotal1_ins_u)
!
...
!
     ...
     &      npLX1_1, npUX1_1, NLmax1, NUmax1, NLmaxHYP1, NUmaxHYP1,     &
     &      itotal1_ins_l, itotal1_ins_u, indexDJDS1_L, indexDJDS1_U)
!
...
!
      end subroutine reordering_djds_smp_l_ins
!
!-----------------------------------------------------------------------
!
      end module DJDS_const_solver_list_ins1

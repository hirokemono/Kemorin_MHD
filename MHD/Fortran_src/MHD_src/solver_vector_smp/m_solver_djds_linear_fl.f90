!
!     module m_solver_djds_linear_fl
!
...
!C-- MATRIX arrays
!
      integer (kind=kint) :: itotal1_fl_l
      integer (kind=kint) :: itotal1_fl_u
!
...
! ------------------------------------------
!
       subroutine allocate_4_RCM_fl_l
!
...
!
       ...
       NEWtoOLD1= 0
!
       end subroutine allocate_4_RCM_fl_l
!
! ------------------------------------------
!
       subroutine allocate_number_4_djds_fl_l
!
...
!
       ...
       NUmaxHYP1= 0
!
       end subroutine allocate_number_4_djds_fl_l
!
! ------------------------------------------
!
       subroutine allocate_lists_4_DJDS_fl_l
!
       use m_geometry_parameter
...
!
!
       end subroutine allocate_lists_4_DJDS_fl_l
!
! ------------------------------------------
!
       subroutine allocate_address_4_DJDS_fl_l
!
       allocate (itemDJDS1_L(itotal1_fl_l))
       allocate (itemDJDS1_U(itotal1_fl_u))
!
       itemDJDS1_L = 0
       itemDJDS1_U = 0
!
       end subroutine allocate_address_4_DJDS_fl_l
!
! ------------------------------------------
!
...
! ------------------------------------------
!
       subroutine deallocate_4_djds_table_fl_l
!
       deallocate (NEWtoOLD_DJDS1_L)
!
       end subroutine deallocate_4_djds_table_fl_l
!
! ------------------------------------------
!
...
! ------------------------------------------
!
      end module m_solver_djds_linear_fl

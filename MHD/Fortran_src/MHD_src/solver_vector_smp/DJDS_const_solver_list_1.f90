!DJDS_const_solver_list_1.f90
!     module DJDS_const_solver_list_1
!
!        programmed by H.Matsui and H.Okuda
!        modified by H. Matsui on Nov. 2003
!        modified by H. Matsui on Aug., 2007
!
!      subroutine reordering_djds_smp_linear
!
      module DJDS_const_solver_list_1
!
      use m_precision
...
!
     ...
     &      NLmaxHYP1, NUmaxHYP1, itotal1_l, itotal1_u)
...
!
     ...
     &      inod_smp_stack, NHYP1, IVECT1, STACKmcG1, STACKmc1, PEon1,  &
...
!
     ...
     &      npLX1_1, npUX1_1, NLmax1, NUmax1, NLmaxHYP1, NUmaxHYP1,     &
     &      itotal1_l, itotal1_u, indexDJDS1_L, indexDJDS1_U)
!
...
!
      end subroutine reordering_djds_smp_linear
!
!-----------------------------------------------------------------------
!
      end module DJDS_const_solver_list_1

!
!      module m_solver_djds_linear_cd
!
...
!C-- MATRIX arrays
! 
      integer (kind=kint) :: itotal1_cd_l
      integer (kind=kint) :: itotal1_cd_u
!
...
!
      integer(kind=kint), target, allocatable :: NOD_EXPORT_NEW_cd1(:)
!
!  ---  constants
!
...
! ------------------------------------------
!
       subroutine allocate_4_RCM_cd_l
!
...
!
       ...
       NEWtoOLD1= 0
!
       end subroutine allocate_4_RCM_cd_l
!
! ------------------------------------------
!
       subroutine allocate_number_4_djds_cd_l
!
...
!
       ...
       NUmaxHYP1= 0
!
       end subroutine allocate_number_4_djds_cd_l
!
! ------------------------------------------
!
       subroutine allocate_lists_4_DJDS_cd_l
!
       use m_geometry_parameter
...
!
!
       end subroutine allocate_lists_4_DJDS_cd_l
!
! ------------------------------------------
!
       subroutine allocate_address_4_DJDS_cd_l
!
       allocate (itemDJDS1_L(itotal1_cd_l))
       allocate (itemDJDS1_U(itotal1_cd_u))
!
       itemDJDS1_L = 0
       itemDJDS1_U = 0
!
       end subroutine allocate_address_4_DJDS_cd_l
!
! ------------------------------------------
!
       subroutine allocate_new_comm_table_cd_l
!
       use m_nod_comm_table
!
       allocate  ( NOD_EXPORT_NEW_cd1(ntot_export) )
       NOD_EXPORT_NEW_cd1 = 0
!
       end subroutine allocate_new_comm_table_cd_l
!
! ------------------------------------------
!
       subroutine deallocate_4_djds_table_cd_l
!
       deallocate (NEWtoOLD_DJDS1_L)
!
       end subroutine deallocate_4_djds_table_cd_l
!
! ------------------------------------------
!
       subroutine set_djds_4_linear_cd
!
       use m_geometry_parameter
       use m_solver_djds_conduct
!
!
       call allocate_4_RCM_cd_l
!
       OLDtoNEW1= OLDtoNEW
       NEWtoOLD1= NEWtoOLD
!
       NHYP1 = NHYP
!
       call allocate_number_4_djds_cd_l
!
       IVECT1   = IVECT
       NLmaxHYP1= NLmaxHYP
       NUmaxHYP1= NUmaxHYP
!
       ...
       npUX1_1 = npUX1
!
       call allocate_lists_4_DJDS_cd_l
!
...
!
       ...
       COLORon1 = COLORon
!
       call allocate_address_4_DJDS_cd_l
!
       itemDJDS1_L = itemDJDS_L
       itemDJDS1_U = itemDJDS_U
!
       end subroutine set_djds_4_linear_cd
!
! ------------------------------------------
!
...
!
     ...
     &        ' OLDtoNEW_DJDS1_U, LtoU1 4 conductor'
      do i = 1, numnod
      write(50+my_rank,'(10i8)') i, NEWtoOLD1(i),                      &
     &            OLDtoNEW_DJDS1_L(i), OLDtoNEW_DJDS1_U(i), LtoU1(i)
      end do
!
      write(50+my_rank,*) 'indexDJDS1_L 4 conductor'
       write(50+my_rank,'(10i8)') indexDJDS1_L
      write(50+my_rank,*) 'itemDJDS1_l 4 conductor'
      write(50+my_rank,'(10i8)') itemDJDS1_l
      write(50+my_rank,*) 'indexDJDS1_U 4 conductor'
       write(50+my_rank,'(10i8)') indexDJDS1_U
      write(50+my_rank,*) 'itemDJDS1_u 4 conductor'
...
! ------------------------------------------
!
      end module m_solver_djds_linear_cd

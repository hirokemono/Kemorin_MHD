!DJDS_const_solver_list_fl.f90
!     module DJDS_const_solver_list_fl
!
...
!
     ...
     &      NLmax, NUmax, NLmaxHYP, NUmaxHYP, itotal_fl_l, itotal_fl_u, &
...
!
!
      end subroutine reordering_djds_smp_fl
!
!-----------------------------------------------------------------------
!
      end module DJDS_const_solver_list_fl

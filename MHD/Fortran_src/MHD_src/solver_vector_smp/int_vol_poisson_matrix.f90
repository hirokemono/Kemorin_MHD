...
!!     &          mat_tbl_l, mat_tbl_fl_l, FEM_elens, diff_coefs,      &
!!     &          fem_wk)
...
!
      subroutine int_vol_poisson_matrices(ele, jac_3d_l, rhs_tbl,       &
     &          mat_tbl_l, mat_tbl_fl_l, FEM_elens, diff_coefs, fem_wk)
!
      use m_phys_constants
...
!
     ...
     &      diff_coefs%num_field, iak_diff_v, diff_coefs%ak, fem_wk,    &
...
!
     ...
     &      diff_coefs%num_field, iak_diff_b, diff_coefs%ak, fem_wk,    &
...
!
     ...
     &     diff_coefs%num_field, iak_diff_v, diff_coefs%ak, coef_imp_v, &
...
!
     ...
     &     diff_coefs%num_field, iak_diff_b, diff_coefs%ak, coef_imp_b, &
...
!
     ...
     &     rhs_tbl, mat_tbl_fl_q, FEM_elens, intg_point_t_evo,          &
     &     diff_coefs%num_field, iak_diff_t, diff_coefs%ak, coef_imp_t, &
...
!
      if (iflag_t_evo_4_composit .ge. id_Crank_nicolson) then
        call choose_int_diffuse1_crank_mat(ele, jac_3d,                 &
     &     rhs_tbl, mat_tbl_fl_q, FEM_elens, intg_point_t_evo,          &
     &     diff_coefs%num_field, iak_diff_c, diff_coefs%ak, coef_imp_c, &

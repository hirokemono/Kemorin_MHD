!DJDS_const_solver_list_ins.f90
!     module DJDS_const_solver_list_ins
!
!        programmed by H.Matsui and H.Okuda
!        modified by H. Matsui on Nov. 2003
!        modified by H. Matsui on Aug., 2007
!
!      subroutine reordering_djds_smp_ins
!
      module DJDS_const_solver_list_ins
!
      use m_precision
...
!C +-----------------+
!C===
      call allocate_lists_4_DJDS_ins
!
...
!
     ...
     &      NLmax, NUmax, NLmaxHYP, NUmaxHYP,                          &
     &      itotal_ins_l, itotal_ins_u, indexDJDS_L, indexDJDS_U)
!
      call deallocate_mc_connect
!C
!C== ADDRESS
!
      call allocate_address_4_DJDS_ins
!
...
!
      end subroutine reordering_djds_smp_ins
!
!-----------------------------------------------------------------------
!
      end module DJDS_const_solver_list_ins

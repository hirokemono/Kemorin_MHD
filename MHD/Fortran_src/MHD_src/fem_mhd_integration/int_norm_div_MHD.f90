...
!!     &          iphys, nod_fld, jac_3d, j_ave, fem_wk, fem_msq, rsig)
...
!
     ...
     &    jac_3d, fem_wk, fem_msq%ave_local(j_ave%i_div_v))
      call MPI_allREDUCE                                                &
...
!
     ...
     &    jac_3d, fem_wk, fem_msq%ave_local(j_ave%i_div_b))
      call MPI_allREDUCE                                                &
...
!
     ...
     &    jac_3d, fem_wk, fem_msq%ave_local(j_ave%i_div_a))
      call MPI_allREDUCE                                                &

...
!     &          vxe, flux_1, sk_v)
!      subroutine fem_skv_grp_div_flux_upw                              &
!     &         (numele, nnod_4_e1, nnod_4_e2, np_smp, iele_fsmp_stack, &
!     &          nele_grp, iele_grp, n_int, k2, dt, ntot_int_3d,        &
!     &          xjac, an, dnx1, dnx2, vxe, flux_1, sk_v)
!
      module fem_skv_div_flux_upw
!
      use m_precision
...
!
     ...
     &                     * ( dnx2(iele,k2,ix,1) * flux_1(iele,1)      &
     &                       + dnx2(iele,k2,ix,2) * flux_1(iele,2)      &
     &                       + dnx2(iele,k2,ix,3) * flux_1(iele,3) )    &
     &                        * xjac(iele,ix)*owe3d(ix)
              sk_v(iele,2,k1) = sk_v(iele,2,k1) + tau                   &
     &                     * ( dnx2(iele,k2,ix,1) * flux_1(iele,2)      &
     &                       + dnx2(iele,k2,ix,2) * flux_1(iele,4)      &
     &                       + dnx2(iele,k2,ix,3) * flux_1(iele,5) )    &
     &                        * xjac(iele,ix)*owe3d(ix)
              sk_v(iele,3,k1) = sk_v(iele,3,k1) + tau                   &
     &                     * ( dnx2(iele,k2,ix,1) * flux_1(iele,3)      &
     &                       + dnx2(iele,k2,ix,2) * flux_1(iele,5)      &
     &                       + dnx2(iele,k2,ix,3) * flux_1(iele,6) )    &
     &                        * xjac(iele,ix)*owe3d(ix)
            end do
          end do
!
...
!$omp end parallel do
!
      end subroutine fem_skv_all_div_flux_upw
!
!-----------------------------------------------------------------------
!
      subroutine fem_skv_grp_div_flux_upw                               &
...
!$omp end parallel do
!
      end subroutine fem_skv_grp_div_flux_upw
!
!-----------------------------------------------------------------------
!
      end module fem_skv_div_flux_upw

...
!
!      subroutine fem_all_skv_rot_upw(numele, nnod_4_e1, nnod_4_e2,     &
!     &          np_smp, iele_fsmp_stack, n_int, k2, dt, ntot_int_3d,   &
!     &          xjac, an, dnx1, dnx2, vxe, vect_1, sk_v)
!      subroutine fem_skv_grp_rot_upw(numele, nnod_4_e1, nnod_4_e2,     &
...
!
     ...
     &                       * ( dnx2(iele,k2,ix,2) * vect_1(iele,3)    &
     &                         - dnx2(iele,k2,ix,3) * vect_1(iele,2) )  &
     &                        * xjac(iele,ix)*owe3d(ix)
              sk_v(iele,2,k1) = sk_v(iele,2,k1) + tau                   &
     &                       * ( dnx2(iele,k2,ix,3) * vect_1(iele,1)    &
     &                         - dnx2(iele,k2,ix,1) * vect_1(iele,3) )  &
     &                        * xjac(iele,ix)*owe3d(ix)
              sk_v(iele,3,k1) = sk_v(iele,3,k1) + tau                   &
     &                       * ( dnx2(iele,k2,ix,1) * vect_1(iele,2)    &
     &                         - dnx2(iele,k2,ix,2) * vect_1(iele,1) )  &
     &                        * xjac(iele,ix)*owe3d(ix)
            end do
          end do
!
...
!$omp end parallel do
!
      end subroutine fem_all_skv_rot_upw
!
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
!
...
!$omp end parallel do
!
      end subroutine fem_skv_grp_rot_upw
!
!-----------------------------------------------------------------------
!
      end module fem_skv_rot_upw

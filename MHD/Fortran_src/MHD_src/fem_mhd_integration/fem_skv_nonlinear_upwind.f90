...
!
!!      subroutine fem_skv_scalar_inertia_upwind                        &
!!     &         (iele_fsmp_stack, n_int, k2, dt, scalar_1, vxe, vxe_up,&
!!     &          ele, g_FEM, jac_3d, sk_v)
!!      subroutine fem_skv_vector_inertia_upwind                        &
!!     &         (iele_fsmp_stack, n_int, k2, dt, vector_1, vxe, vxe_up,&
!!     &          ele, g_FEM, jac_3d, sk_v)
!!      subroutine fem_skv_rot_inertia_upwind                           &
!!     &         (iele_fsmp_stack, n_int, k2, dt, vector_1, wxe, vxe_up,&
!!     &          ele, g_FEM, jac_3d, sk_v)
!!
!!      subroutine fem_skv_coriolis_upwind                              &
!!     &         (iele_fsmp_stack, n_int, k2, dt, vector_1, angular,    &
!!     &          vxe_up, ele, g_FEM, jac_3d, sk_v)
...
!
     ...
     &    n_int, k2, dt, jac_3d%ntot_int, jac_3d%xjac, jac_3d%an,       &
     &    jac_3d%dnx, jac_3d%dnx, scalar_1, vxe, vxe_up, sk_v)
!
...
!
     ...
     &    g_FEM%maxtot_int_3d, g_FEM%int_start3, g_FEM%owe3d,           &
     &    n_int, k2, dt, jac_3d%ntot_int, jac_3d%xjac, jac_3d%an,       &
     &    jac_3d%dnx, jac_3d%dnx, vector_1, vxe, vxe_up, sk_v)
!
...
!
     ...
     &    g_FEM%maxtot_int_3d, g_FEM%int_start3, g_FEM%owe3d,           &
     &    n_int, k2, dt, jac_3d%ntot_int, jac_3d%xjac, jac_3d%an,       &
     &    jac_3d%dnx, jac_3d%an, vector_1, wxe, vxe_up, sk_v)
!
...
!
     ...
     &    g_FEM%maxtot_int_3d, g_FEM%int_start3, g_FEM%owe3d,           &
     &    n_int, k2, dt, jac_3d%ntot_int, jac_3d%xjac, jac_3d%an,       &
     &    jac_3d%dnx, jac_3d%an, vector_1, angular, vxe_up, sk_v)
!

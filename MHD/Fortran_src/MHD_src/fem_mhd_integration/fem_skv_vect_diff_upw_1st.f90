...
!
     ...
     &    np_smp, iele_fsmp_stack, n_int, k2, dt, ntot_int_3q,          &
...
!
     ...
     &    iele_fsmp_stack, n_int, k2, dt, ntot_int_3q, xjac,            &
...
!
     ...
     &   (ele1%numele, ele1%nnod_4_ele, ele1%nnod_4_ele,                &
     &    np_smp, iele_fsmp_stack, n_int, k2, dt, ntot_int_3q, xjac,    &
...
!
     ...
     &    n_int, k2, dt, ntot_int_3q, xjac, aw, dwx, dwx,               &
     &    vxe, scalar_1, sk_v)
!
...
!
     ...
     &    ntot_int_3q, xjac, aw, dwx, dwx, vxe, vect_1, sk_v)
!
...
!
     ...
     &    ntot_int_3q, xjac, aw, dwx, dwx,  vxe, flux_1, sk_v)
!
...
!
     ...
     &   (ele1%numele, ele1%nnod_4_ele, ele1%nnod_4_ele,                &
     &    np_smp, iele_fsmp_stack, nele_grp, iele_grp, n_int, k2, dt,   &
     &    ntot_int_3q, xjac, aw, vxe, dwx, dwx,  flux_1, sk_v)
!

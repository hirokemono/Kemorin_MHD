...
!
     ...
     &    iele_fsmp_stack, n_int, k2, dt, jac1_3d_q%ntot_int, xjac,     &
...
!
     ...
     &    n_int, k2, dt, jac1_3d_q%ntot_int, xjac, aw, dwx, dwx,        &
     &    vxe, scalar_1, sk_v)
!
...
!
     ...
     &    jac1_3d_q%ntot_int, xjac, aw, dwx, dwx, vxe, vect_1, sk_v)
!
...
!
     ...
     &    jac1_3d_q%ntot_int, xjac, aw, dwx, dwx,  vxe, flux_1, sk_v)
!
...
!
     ...
     &   (ele1%numele, ele1%nnod_4_ele, ele1%nnod_4_ele,                &
     &    np_smp, iele_fsmp_stack, nele_grp, iele_grp, n_int, k2, dt,   &
     &    jac1_3d_q%ntot_int, xjac, aw, vxe, dwx, dwx,  flux_1, sk_v)
!

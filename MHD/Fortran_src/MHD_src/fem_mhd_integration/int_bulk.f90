...
!!     &          iphys_ele, ele_fld, fluid, jac_3d_q, i_rms, j_ave,    &
!!     &          fem_wk, fem_msq)
...
!
     ...
     &    npoint_integrate, ifld_msq%ja_amom, iphys%i_velo, node, ele,  &
     &    nod_fld, jac_3d_q, jac_3d_l, mhd_fem_wk, fem_wk, fem_msq)
!
      call int_all_4_vector                                             &
     &   (fluid%istack_ele_fld_smp, npoint_integrate,                   &
...
!
     ...
     &    jac_3d_q, jac_3d_l, fem_wk, fem_msq)
!

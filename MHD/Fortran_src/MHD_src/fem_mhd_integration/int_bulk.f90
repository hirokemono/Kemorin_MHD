...
!!     &          iphys, nod_fld, g_FEM, jac_3d_q, jac_3d_l,            &
...
!!     &          iphys_ele, ele_fld, fluid, g_FEM, jac_3d_q,           &
...
!
     ...
     &    fem_wk, fem_msq)
      call int_all_4_scalar (ele%istack_ele_smp, npoint_integrate,      &
...
!
     ...
     &    node, ele, nod_fld, g_FEM, jac_3d_q, jac_3d_l, mhd_fem_wk,    &
     &    fem_wk, fem_msq)
!
      call int_all_4_vector                                             &
     &   (fluid%istack_ele_fld_smp, npoint_integrate,                   &
...
!
     ...
     &    g_FEM, jac_3d_q, jac_3d_l, fem_wk, fem_msq)
!
...
!
     ...
     &      g_FEM, jac_3d_q, fem_wk, fem_msq%ave_local(j_ave%i_div_v))
        call int_rms_divergence                                         &
     &     (fluid%istack_ele_fld_smp, iphys%i_velo, node, ele, nod_fld, &
     &      g_FEM, jac_3d_q, fem_wk, fem_msq%rms_local(i_rms%i_div_v))
...
!
     ...
     &      g_FEM, jac_3d_q, fem_wk, fem_msq%ave_local(j_ave%i_div_a))
        call int_rms_divergence                                         &
     &     (ele%istack_ele_smp, iphys%i_vecp, node, ele, nod_fld,       &
     &      g_FEM, jac_3d_q, fem_wk, fem_msq%rms_local(i_rms%i_div_a))
      end if
!
     ...
     &      g_FEM, jac_3d_q, fem_wk, fem_msq%ave_local(j_ave%i_div_b))
        call int_rms_divergence                                         &
     &     (ele%istack_ele_smp, iphys%i_magne, node, ele, nod_fld,      &
     &      g_FEM, jac_3d_q, fem_wk, fem_msq%rms_local(i_rms%i_div_b))
      end if
!

...
!     &          vxe, flux_1, sk_v)
!      subroutine fem_skv_grp_div_asym_t_upw                            &
!     &         (numele, nnod_4_e1, nnod_4_e2, np_smp, iele_fsmp_stack, &
...
!$omp end parallel do
!
      end subroutine fem_skv_all_div_asym_t_upw
!
!-----------------------------------------------------------------------
!
      subroutine fem_skv_grp_div_asym_t_upw                             &
...
!$omp end parallel do
!
      end subroutine fem_skv_grp_div_asym_t_upw
!
!-----------------------------------------------------------------------
!
      end module fem_skv_div_asym_t_upw

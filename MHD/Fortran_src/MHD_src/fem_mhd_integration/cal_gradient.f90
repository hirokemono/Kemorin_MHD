...
!
     ...
     &   (iflag_4_supg, num_int, iele_fsmp_stack, i_scalar,             &
...
!
     ...
     &   (iflag_4_supg, num_int, iele_fsmp_stack, const, i_scalar,      &
     &    node, ele, nod_fld, iphys_ele, ele_fld, jac_3d,               &
     &    rhs_tbl, fem_wk, f_nl)
!
      call set_ff_nl_smp_2_ff(n_vector, node, rhs_tbl, f_l, f_nl)
...
!
     ...
     &      iele_fsmp_stack, num_int, i_scalar,                         &

...
!
!      subroutine scalar_phys_2_each_surface(igrp, k2,                  &
!     &          i_scalar, scalar_sf)
!        Input:  d_nod(1,i_scalar), Output:  scalar_sf
!      subroutine vector_phys_2_each_surface(igrp, k2,                  &
!     &          i_vector, vector_sf)
!        Input:  d_nod(1,i_tensor), Output:  vector_sf
!      subroutine tensor_phys_2_each_surface(igrp, k2,                  &
!     &          i_tensor, tensor_sf)
!        Input:  d_nod(1,i_tensor), Output:  vector_sf
!
!      subroutine scalar_phys_2_each_surf_coef(igrp, k2,                &
!     &          i_scalar, ak_e, scalar_sf)
!      subroutine vector_phys_2_each_surf_coef(igrp, k2,                &
!     &          i_vector, ak_e, vector_sf)
!      subroutine tensor_phys_2_each_surf_coef(igrp, k2,                &
!     &          i_tensor, ak_e, tensor_sf)
!
!      subroutine scalar_phys_2_each_surf_cst(igrp, k2,                 &
!     &          i_scalar, coef, scalar_sf)
!      subroutine vector_phys_2_each_surf_cst(igrp, k2,                 &
!     &          i_vector, coef, vector_sf)
!      subroutine tensor_phys_2_each_surf_cst(igrp, k2,                 &
...
!
!
      call scalar_phys_2_each_sf(np_smp, numnod, numele,                &
...
!
!
      call vector_phys_2_each_sf(np_smp, numnod, numele,                &
     &    nnod_4_ele, ie, nnod_4_surf, node_on_sf,                      &
     &    sf_grp1%num_item, surf_item,                                  &
     &    num_surf_smp, isurf_grp_smp_stack,    &
...
!
!
      call scalar_phys_2_each_sf_w_coef(np_smp, numnod, numele,         &
     &    nnod_4_ele, ie, nnod_4_surf, node_on_sf,                      &
     &    sf_grp1%num_item, surf_item,                                  &
     &    num_surf_smp, isurf_grp_smp_stack,    &
...
!
!
      call vector_phys_2_each_sf_w_coef(np_smp, numnod, numele,         &
     &    nnod_4_ele, ie, nnod_4_surf, node_on_sf,                      &
     &    sf_grp1%num_item, surf_item,                                  &
     &    num_surf_smp, isurf_grp_smp_stack,    &
...
!
!
      call scalar_phys_2_each_sf_w_const(np_smp, numnod, numele,        &
     &    nnod_4_ele, ie, nnod_4_surf, node_on_sf,                      &
     &    sf_grp1%num_item, surf_item,                                  &
     &    num_surf_smp, isurf_grp_smp_stack,    &
...
!
!
      call vector_phys_2_each_sf_w_const(np_smp, numnod, numele,        &
     &    nnod_4_ele, ie, nnod_4_surf, node_on_sf,                      &
     &    sf_grp1%num_item, surf_item,                                  &
     &    num_surf_smp, isurf_grp_smp_stack,    &
...
!
!
      call tensor_phys_2_each_sf_w_const(np_smp, numnod, numele,        &
     &    nnod_4_ele, ie, nnod_4_surf, node_on_sf,                      &
     &    sf_grp1%num_item, surf_item,                                  &
     &    num_surf_smp, isurf_grp_smp_stack,    &

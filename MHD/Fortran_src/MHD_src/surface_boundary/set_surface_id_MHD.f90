...
!
      if (fl_prop%iflag_scheme .gt. id_no_evolution) then
        if (iflag_debug .gt. 0) write(*,*) 'count_num_bc_torque'
...
!
        if (iflag_debug .gt. 0) write(*,*) 'count_num_bc_press_sf'
...
!
     ...
     &   .or. cd_prop%iflag_Aevo_scheme .gt. id_no_evolution) then
        if (iflag_debug .gt. 0) write(*,*) 'count_num_bc_magne_sf'
...
!
        if (iflag_debug .gt. 0) write(*,*) 'count_num_bc_current_sf'
...
!
      if (cd_prop%iflag_Aevo_scheme .gt. id_no_evolution) then
        if (iflag_debug .gt. 0) write(*,*) 'count_num_bc_vecp_sf'
...
! 
      if (ht_prop%iflag_scheme .gt. id_no_evolution) then
        if (iflag_debug .gt. 0) write(*,*) 'count_num_bc_h_flux'
...
!
      if (iflag_debug .gt. 0) write(*,*) 'count_num_bc_d_scalar_sf'

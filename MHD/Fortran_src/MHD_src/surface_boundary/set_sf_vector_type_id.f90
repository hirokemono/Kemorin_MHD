...
!
     ...
     &     current%sgs%nmax_sf_dat, current%sgs%id_grp_sf_dat,          &
...
!
     ...
     &    num_bc_tq, bc_tq_name, ibc_tq_type,                           &
     &    velo%torque%nmax_sf_fix_fx, velo%torque%id_grp_sf_fix_fx,     &
     &    velo%torque%ist_ele_sf_fix_fx, velo%torque_lead%nmax_sf_dat,  &
...
!
     ...
     &    (sf_grp%num_grp, sf_grp%istack_grp, sf_grp%grp_name,          &
     &     num_bc_js, bc_js_name, ibc_js_type,                          &
     &     current%grad%nmax_sf_fix_fx, current%grad%id_grp_sf_fix_fx,  &

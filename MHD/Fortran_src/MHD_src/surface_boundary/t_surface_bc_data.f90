...
!
      deallocate(Vsf_bcs%sgs)
      deallocate(Vsf_bcs%grad)
      deallocate(Vsf_bcs%torque_lead)
!
...
!
      deallocate(Bsf_bcs%sgs)
      deallocate(Bsf_bcs%grad)
      deallocate(Bsf_bcs%torque_lead)
!

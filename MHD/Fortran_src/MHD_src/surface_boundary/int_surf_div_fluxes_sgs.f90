...
!
      ...
      integer(kind=kint), intent(in) :: i_diff
...
!
     ...
     &          i_diff, diff_coefs%num_field, diff_coefs%ak,            &
     &          coef_field, fem_wk%sk6)
          end do
!
        end if
      end do

...
!!     &         (dt, coef_exp, ipol, nnod_rj, ntot_phys_rj, d_rj)
...
!$omp parallel do private (inod)
     ...
     &                 + adam_1 * d_rj(inod,ipol%exp_work%i_pre_uxb  ))
        d_rj(inod,ipol%base%i_magne+2) = d_rj(inod,ipol%base%i_magne+2) &
     &         + dt*(coef_exp * d_rj(inod,ipol%diffusion%i_b_diffuse+2) &
     &                 + adam_0 * d_rj(inod,ipol%forces%i_induction+2)  &
     &                 + adam_1 * d_rj(inod,ipol%exp_work%i_pre_uxb+2))
!
        d_rj(inod,ipol%exp_work%i_pre_uxb  )                            &
     &       = d_rj(inod,ipol%forces%i_induction  )
        d_rj(inod,ipol%exp_work%i_pre_uxb+2)                            &
     &       = d_rj(inod,ipol%forces%i_induction+2)
      end do
!$omp end parallel do
!
...
!$omp parallel do private (inod)
     ...
     &      + dt*(coef_exp * d_rj(inod,ipol%diffusion%i_b_diffuse+2)    &
     &            + adam_0 * d_rj(inod,ipol%forces%i_induction+2)       &
     &            + adam_0 * d_rj(inod,ipol%SGS_term%i_SGS_induction+2) &
     &            + adam_1 * d_rj(inod,ipol%exp_work%i_pre_uxb+2))
!
        d_rj(inod,ipol%exp_work%i_pre_uxb  )                            &
     &             =  d_rj(inod,ipol%forces%i_induction  )              &
     &              + d_rj(inod,ipol%SGS_term%i_SGS_induction  )
        d_rj(inod,ipol%exp_work%i_pre_uxb+2)                            &
     &             =  d_rj(inod,ipol%forces%i_induction+2)              &
     &              + d_rj(inod,ipol%SGS_term%i_SGS_induction+2)
      end do
!$omp end parallel do
!

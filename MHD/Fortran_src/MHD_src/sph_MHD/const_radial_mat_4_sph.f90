...
!
     ...
     &      fdm2_center1, fdm2_free_ICB1, fdm2_free_CMB1, g_sph_rj,     &
...
!
      ...
      call const_radial_mat_scalar00_sph(mat_name, dt, sph_rj,          &
     &    MHD_prop%ht_prop, sph_MHD_bc%sph_bc_T, fdm2_center1,          &

...
!!
!!@verbatim
!!      subroutine cal_sph_nod_cmb_qvc_b_and_j(nnod_rj, jmax,           &
!!     &          kr_out, r_CMB, fdm2_fix_fld_CMB, fdm2_fix_dr_CMB,     &
!!     &          is_fld, is_rot, ntot_phys_rj, d_rj)
!!      subroutine cal_sph_nod_cmb_qvc_mag2(nnod_rj, jmax, kr_out,      &
!1     &          is_fld, ntot_phys_rj, d_rj)
!!
!!      subroutine cal_sph_nod_cmb_qvc_vp_rot2(nnod_rj, jmax, kr_out,   &
!!     &          is_fld, is_rot, ntot_phys_rj, d_rj)
!!      subroutine cal_sph_nod_cmb_qvc_rot2(nnod_rj, jmax,              &
!!     &          kr_out, r_CMB, fdm2_fix_fld_CMB, fdm2_fix_dr_CMB,     &
!!     &          is_fld, is_rot, ntot_phys_rj, d_rj)
!!      subroutine cal_sph_nod_cmb_qvc_diffuse2(nnod_rj, jmax,          &
!!     &          kr_out, r_CMB, fdm2_fix_fld_CMB, fdm2_fix_dr_CMB,     &

...
!!      (Only used for l = m = 0 component of scalar)
!!      dfdr =      fdm2_fix_dr_ctr1(-1,2) * dfdr(0)
!!                + fdm2_fix_dr_ctr1( 0,2) * d_rj(1)
!!                + fdm2_fix_dr_ctr1( 1,2) * d_rj(2)
!!      d2fdr2 =    fdm2_fix_dr_ctr1(-1,3) * dfdr(0)
!!                + fdm2_fix_dr_ctr1( 0,3) * d_rj(1)
!!                + fdm2_fix_dr_ctr1( 1,3) * d_rj(2)
!!@endverbatim
!!
...
!>      Matrix to evaluate field at ICB with fixed radial derivative
      real(kind = kreal) :: fdm2_fix_dr_ctr1(-1:1,3)
!
!
...
!
!>      Work matrix to evaluate fdm2_fix_dr_ctr1(-1:1,3)
!!@verbatim
!!      dfdr =     mat_fdm_ctr1_fix_dr_2(2,1) * d_rj(1)
!!               + mat_fdm_ctr1_fix_dr_2(2,2) * dfdr(0)
!!               + mat_fdm_ctr1_fix_dr_2(2,3) * d_rj(2)
!!      d2fdr2 =   mat_fdm_ctr1_fix_dr_2(3,1) * d_rj(1)
!!               + mat_fdm_ctr1_fix_dr_2(3,2) * dfdr(0)
!!               + mat_fdm_ctr1_fix_dr_2(3,3) * d_rj(2)
!!@endverbatim
      real(kind = kreal) :: mat_fdm_ctr1_fix_dr_2(3,3)
!
      private :: mat_fdm_ctr_fix_2, mat_fdm_ctr1_fix_dr_2
!
! -----------------------------------------------------------------------
!
      contains
...
!
      ...
      mat_taylor_3(3,3) = dr_p1*dr_p1 / two
!
      call cal_inverse_33_matrix(mat_taylor_3, mat_fdm_ctr1_fix_dr_2,   &
     &      ierr)
      if(ierr .eq. 1) then
...
!
      fdm2_fix_dr_ctr1(-1,1:3) = mat_fdm_ctr1_fix_dr_2(1:3,2)
      fdm2_fix_dr_ctr1( 0,1:3) = mat_fdm_ctr1_fix_dr_2(1:3,1)
      fdm2_fix_dr_ctr1( 1,1:3) = mat_fdm_ctr1_fix_dr_2(1:3,3)
!
...
!
      write(50,*) ' fdm2_fix_dr_ctr1'
      write(50,*) ' mat_fdm21,  mat_fdm22,  mat_fdm23'
      write(50,'(1p9E25.15e3)') fdm2_fix_dr_ctr1(-1:1,2)
      write(50,*) ' mat_fdm31,  mat_fdm32,  mat_fdm33'
      write(50,'(1p9E25.15e3)') fdm2_fix_dr_ctr1(-1:1,3)
!

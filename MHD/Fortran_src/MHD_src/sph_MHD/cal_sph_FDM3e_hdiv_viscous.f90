...
!!
!!@verbatim
!!      subroutine set_sph_FDM_fix_hdiv_viscs_mat                       &
!!     &         (kr, jmax, a2r_ele_rj, a3r_ele_rj, g_sph_rj,           &
...
!!     &                   :: hdiv_visous_mat(jmax,-2:1)
!!      subroutine add_sph_FDM_val_hdiv_viscs_mat(kr,                   &
...
!
      if(flag_ref_density_valiation) then
        call add_sph_hdiv_viscous_rho_depend(kr, jmax,                  &
     &      a1r_ele_rj, a2r_ele_rj, g_sph_rj, h_rho_e, h_drhodr_e,      &
     &      nri_fdm, fdm3e_d0_mat, fdm3e_d1_mat, fdm3e_d2_mat,          &
     &      hdiv_visous_mat)
!
        if(flag_viscous_variation) then
          mat_tmp(-2:1) = h_nu_e * h_rho_e * fdm3e_d1_mat(kr,-2:1)
          do i_next = -2, 1
     ...
     &        = hdiv_visous_mat(1:jmax,i_next) + mat_tmp(i_next)
      ...
      if(flag_viscous_variation) then
        call add_sph_hdiv_viscous_nu_depend(kr, jmax,                   &
...
! -----------------------------------------------------------------------
!
      subroutine add_sph_hdiv_viscous_rho_depend(kr, jmax,              &
...
! -----------------------------------------------------------------------
!
      subroutine add_sph_hdiv_viscous_nu_depend(kr, jmax,               &

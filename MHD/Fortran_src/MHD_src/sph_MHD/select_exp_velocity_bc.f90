...
!!
!!@verbatim
!!      subroutine sel_bc_grad_vp_and_vorticity(sph_rj, g_sph_rj,       &
!!     &          is_velo, is_vort, rj_fld)
!!        Input:    ipol%i_velo, itor%i_velo
!!        Solution: idpdr%i_velo, ipol%i_vort, itor%i_vort, idpdr%i_vort
!!      subroutine sel_bc_grad_poloidal_moment(sph_rj, is_fld, rj_fld)
!!        Input:    is_fld, is_fld+2
!!        Solution: is_fld+1
!!
!!      subroutine sel_bc_sph_vorticity(sph_rj, sph_bc_U, g_sph_rj,     &
!!     &          is_fld, is_rot, rj_fld)
!!        Input:    ipol%i_velo, itor%i_velo
!!        Solution: ipol%i_vort, itor%i_vort, idpdr%i_vort
!!
!!      subroutine sel_bc_sph_viscous_diffusion                         &
...
!!      subroutine sel_bc_sph_vort_diffusion(sph_rj, sph_bc_U, g_sph_rj,&
...
!
     ...
     &     (sph_rj%nidx_rj(2), sph_rj%ar_1d_rj(ione,2), g_sph_rj,       &
...
!
      if(sph_bc_U%iflag_icb .eq. iflag_sph_fill_center) then
        call cal_dsdr_sph_center_2(sph_rj%nidx_rj(2), is_fld,           &
     &      rj_fld%n_point, rj_fld%ntot_phys, rj_fld%d_fld)
      else if(sph_bc_U%iflag_icb .eq. iflag_free_slip) then
...
!
     ...
     &     (sph_rj%nidx_rj(2), sph_rj%ar_1d_rj(ione,2),                 &
     &      g_sph_rj, coef_diffuse, is_velo, is_viscous,                &
     &      rj_fld%n_point, rj_fld%ntot_phys, rj_fld%d_fld)
        call cal_dsdr_sph_center_2(sph_rj%nidx_rj(2), is_viscous,       &
     &      rj_fld%n_point, rj_fld%ntot_phys, rj_fld%d_fld)
      else if(sph_bc_U%iflag_icb .eq. iflag_free_slip) then
        call cal_sph_nod_icb_free_diffuse2                              &
     &     (sph_rj%nidx_rj(2), g_sph_rj, sph_bc_U%kr_in,                &
     &      sph_bc_U%r_ICB, fdm2_free_vp_ICB, fdm2_free_vt_ICB,         &
...
!
     ...
     &      rj_fld%n_point, rj_fld%ntot_phys, rj_fld%d_fld)
        call cal_dsdr_sph_center_2(sph_rj%nidx_rj(2), is_w_diffuse,     &
     &      rj_fld%n_point, rj_fld%ntot_phys, rj_fld%d_fld)
      else if(sph_bc_U%iflag_icb .eq. iflag_free_slip) then

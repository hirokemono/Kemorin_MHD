...
!!                  forces%i_c_flux
!!       Output:  rj_fld(1:is_fld)
!!          is_fld = i_wide_SGS_inertia, wide_SGS%i_SGS_Lorentz,
...
!
      call vector_sph_filter                                            &
     &   (ipol%forces%i_vp_induct, ipol%SGS_term%i_SGS_induction,       &
     &    sph_rj, sph_base_f%r_filter, sph_base_f%sph_filter, rj_fld)
!
      call vector_sph_filter                                            &
...
!
      call vector_sph_filter                                            &
     &   (ipol%forces%i_h_flux, ipol%i_wide_SGS_h_flux,                 &
     &    sph_rj, sph_wide_f%r_filter, sph_wide_f%sph_filter, rj_fld)
!
      call vector_sph_filter                                            &
     &   (ipol%forces%i_c_flux, ipol%i_wide_SGS_c_flux,                 &
     &    sph_rj, sph_wide_f%r_filter, sph_wide_f%sph_filter, rj_fld)
!
...
!
      call vector_sph_filter                                            &
     &   (ipol%SGS_term%i_SGS_inertia, ipol%i_dbl_SGS_inertia,          &
     &    sph_rj, sph_base_f%r_filter, sph_base_f%sph_filter, rj_fld)
!
      call vector_sph_filter                                            &
     &   (ipol%SGS_term%i_SGS_Lorentz, ipol%i_dbl_SGS_Lorentz,          &
     &    sph_rj, sph_base_f%r_filter, sph_base_f%sph_filter, rj_fld)
!
      call vector_sph_filter                                            &

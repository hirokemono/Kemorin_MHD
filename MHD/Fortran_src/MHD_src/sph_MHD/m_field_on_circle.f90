...
!!
!!@verbatim
!!      subroutine allocate_circle_field(sph_rtp, sph_rj)
...
!
!
      if(mphi_circle .le. izero) mphi_circle = sph_rtp%nidx_rtp(3)
...
!
      ...
      call allocate_circle_field(sph_rtp, sph_rj)
!

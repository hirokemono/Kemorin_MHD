...
!
      write(fmt_txt,'(a20,i5,a13)') '(i15,1pE25.15e3,i15,',             &
...
!
      ...
      write(id_circ_fid,'(2i15)') mphi_circle, d_circle%ntot_phys_viz
      write(id_circ_sq, '(2i15)') mphi_circle/2, d_circle%ntot_phys_viz
      write(id_circ_ph, '(2i15)') mphi_circle/2, d_circle%ntot_phys_viz
!
!

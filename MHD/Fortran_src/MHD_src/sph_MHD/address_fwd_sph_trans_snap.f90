...
!
     ...
     &    ipol%prod_fld%i_square_w, itor%prod_fld%i_square_w,           &
     &    iphys%prod_fld%i_square_w, f_trns%prod_fld%i_square_w,        &
     &    trns_fwd)
      call add_field_name_4_sph_trns_snap                               &
...
!
     ...
     &    ipol%prod_fld%i_m_heli, itor%prod_fld%i_m_heli,               &
     ...
     &    ipol%prod_fld%i_x_heli, itor%prod_fld%i_x_heli,               &
     &    iphys%prod_fld%i_x_heli, f_trns%prod_fld%i_x_heli, trns_fwd)
!
      call add_field_name_4_sph_trns_snap                               &

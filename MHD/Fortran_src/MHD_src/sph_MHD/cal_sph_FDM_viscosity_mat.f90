...
!!
!!@verbatim
!!      subroutine set_sph_FDM_pressure_grad_mat(n_next, kr,            &
...
!!      subroutine set_sph_FDM_fix_viscous_mat(n_next, kr, jmax,        &
...
!!
!!      subroutine add_sph_FDM_val_viscous_mat(n_next, kr,              &
...
!
     ...
     &          = relative_d * mat_viscous(1:jmax,-n_next:n_next)
      end if
!

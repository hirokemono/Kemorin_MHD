...
!
     ...
     &      rj_fld1%ntot_phys, reftemp_rj, rj_fld1%d_fld)
      end if
!
...
!$omp parallel workshare
      rj_fld1%d_fld(1:nnod_rj,ipol%i_h_advect) = zero
!$omp end parallel workshare
!
      if(ipol%i_forces .gt. 0) then
!$omp parallel workshare
        rj_fld1%d_fld(1:nnod_rj,ipol%i_forces) = zero
        rj_fld1%d_fld(1:nnod_rj,itor%i_forces) = zero
!$omp end parallel workshare
      end if
!
!

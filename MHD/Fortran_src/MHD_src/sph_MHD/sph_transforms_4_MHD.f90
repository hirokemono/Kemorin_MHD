...
!
      ...
      private :: ncomp_max_trans, nvector_max_trans, nscalar_max_trans
!
...
!
     ...
     &     (sph, comms_sph, trans_p, rj_fld, trns_WK%trns_MHD)
      end if
!
...
!
     ...
     &    sph, comms_sph, trans_p, trns_MHD, n_WS, n_WR, WS(1), WR(1))
!

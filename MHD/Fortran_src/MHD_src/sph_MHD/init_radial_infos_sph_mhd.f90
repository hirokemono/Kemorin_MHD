...
!
     ...
     &    sph_MHD_bc%bc_Tspec, sph_MHD_bc%ICB_Tevo, sph_MHD_bc%CMB_Tevo)
      call init_reference_temps                                         &
     ...
     &    sph_MHD_bc%bc_Cspec, sph_MHD_bc%ICB_Cevo, sph_MHD_bc%CMB_Cevo)
!
...
!
     ...
     &          reftemp, rj_fld, sph_bc_S, bc_Sspec,        &
     &          ICB_Sevo, CMB_Sevo)
!
...
!
     ...
     &      reftemp%t_rj, sph_bc_S, bc_Sspec, ICB_Sevo, CMB_Sevo)
!

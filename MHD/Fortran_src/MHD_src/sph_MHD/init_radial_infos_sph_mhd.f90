...
!
     ...
     &    sph_MHD_bc%bc_Tspec, sph_MHD_bc%bc_Tevo)
      call init_reference_temps                                         &
     ...
     &    sph_MHD_bc%bc_Cspec, sph_MHD_bc%bc_Cevo)
!
...
!
     ...
     &          reftemp, rj_fld, sph_bc_S, bc_Sspec, bc_Sevo)
!
...
!
     ...
     &      reftemp%t_rj, sph_bc_S, bc_Sspec, bc_Sevo)
!

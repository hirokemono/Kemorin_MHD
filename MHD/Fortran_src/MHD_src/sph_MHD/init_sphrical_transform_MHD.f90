...
!!     &         (sph_MHD_bc, sph, comms_sph, ncomp_max_trans, trns_MHD,&
!!     &          WK_sph, MHD_mul_FFTW, trans_p, gt_cor, cor_rlm)
!!      subroutine sel_sph_transform_MHD                                &
!!     &         (ipol, MHD_prop, sph_MHD_bc, sph, comms_sph, omega_sph,&
!!     &          ncomp_max_trans, nvector_max_trans, nscalar_max_trans,&
!!     &          trns_MHD, WK_sph, MHD_mul_FFTW, trans_p,              &
...
!
     ...
     &   (ncomp_max_trans, sph%sph_rtp, comms_sph%comm_rtp, trns_MHD,   &

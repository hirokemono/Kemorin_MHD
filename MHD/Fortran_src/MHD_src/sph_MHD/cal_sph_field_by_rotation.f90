...
!!
!!@verbatim
!!      subroutine cal_rot_of_forces_sph_2(sph_rj, rj_fld)
!!      subroutine cal_div_of_forces_sph_2(sph_rj, rj_fld)
!!      subroutine cal_rot_of_induction_sph(sph_rj, rj_fld)
!!      subroutine cal_div_of_fluxes_sph(sph_rj, rj_fld)
...
!
      if( (ipol%i_m_advect*ipol%i_rot_inertia) .gt. 0) then
        ...
        call const_sph_force_rot2(sph_rj, sph_bc_U,                     &
...
!
!
      call const_sph_div_force(sph_rj, sph_bc_U,                        &
...
!
      if( (ipol%i_vp_induct*ipol%i_induction) .gt. 0) then
        ...
        call const_sph_rotation_uxb(sph_rj, sph_bc_B,                   &
...
!
      if( (ipol%i_h_flux*ipol%i_h_advect) .gt. 0) then
        ...
        call const_sph_scalar_advect(sph_rj, sph_bc_T,                  &
...
!
      if( (ipol%i_c_flux*ipol%i_c_advect) .gt. 0) then
        ...
        call const_sph_scalar_advect(sph_rj, sph_bc_C,                  &

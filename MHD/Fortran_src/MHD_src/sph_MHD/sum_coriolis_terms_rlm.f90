...
!
!$omp  parallel do                                                      &
!$omp& private(k_rlm,j_rlm,irlm,i11,i21,i12,                            &
...
!
          d_cor_rlm(ip_rlm_rot_cor,irlm)                                &
     &          = -coef_cor * d_cor_rlm(ip_rlm_rot_cor,irlm)            &
     &                      * a_r_1d_rlm_r(k_rlm)*a_r_1d_rlm_r(k_rlm)
          d_cor_rlm(it_rlm_rot_cor,irlm)                                &
     &          = -coef_cor * d_cor_rlm(it_rlm_rot_cor,irlm)            &
     &                      * a_r_1d_rlm_r(k_rlm)*a_r_1d_rlm_r(k_rlm)
        end do
      end do
!$omp end parallel do
...
!
          d_cor_rlm(ip_rlm_div_cor,irlm)                                &
     &     = -coef_cor * d_cor_rlm(ip_rlm_div_cor,irlm)                 &
     &                 * a_r_1d_rlm_r(k_rlm)*a_r_1d_rlm_r(k_rlm)
        end do
      end do
!$omp end parallel do
...
!$omp  parallel do private(k_rlm,irlm,i11,sp_wp_k1,sp_dwp_k1)
        do k_rlm = 1, nidx_rlm(1)
          irlm = j_rlm + (k_rlm-1)*nidx_rlm(2)
...
!
!$omp  parallel do                                                      &
!$omp& private(j_rlm,i11,i21,i12,ivd_rlm_l1,ivt_rlm_k1,ivt_rlm_k2,      &
...
!
        ivd_rlm_l1 = b_trns%i_velo+1
!
        ivt_rlm_k1 = b_trns%i_velo+2
        ivt_rlm_k2 = b_trns%i_velo+2
!

...
!!
!!@verbatim
!!      subroutine sel_bc_radial_grad_scalar(sph_rj, sph_bc, g_sph_rj,  &
!!     &          is_fld, is_grad, rj_fld)
!!        Input:    is_fld
!!        Solution: is_grad
!!
!!      subroutine sel_bc_sph_scalar_diffusion(sph_rj, sph_bc, g_sph_rj,&
!!     &          coef_diffuse, is_fld, is_diffuse, rj_fld)
!!        Input:    is_fld
!!        Solution: is_diffusee
!!
!!      subroutine sel_bc_sph_scalar_advect(sph_rj, sph_bc, g_sph_rj,   &

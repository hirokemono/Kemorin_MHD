...
!!     &          is_fld, is_diffuse, ntot_phys_rj, rj_fld)
!!        Input:    is_fld
...
!
     ...
     &      fdm2_fixed_center, is_fld, is_grad,                         &
     &      rj_fld%ntot_phys, rj_fld%d_fld)
      else if(sph_bc%iflag_icb .eq. iflag_fixed_flux) then
        call dsdr_sph_in_fix_flux_2(rj_fld%n_point, sph_rj%nidx_rj(2),  &
     &      sph_bc%kr_in, sph_bc%r_ICB, sph_bc%ICB_flux,                &
     &      is_fld, is_grad, rj_fld%ntot_phys, rj_fld%d_fld)
        call dsdr_sph_lm0_in_fix_flux_2(sph_rj%idx_rj_degree_zero,      &
     &      rj_fld%n_point, sph_rj%nidx_rj(2),                          &
     ...
     &      rj_fld%ntot_phys, rj_fld%d_fld)
        call dsdr_sph_lm0_fix_scalar_in_2(sph_rj%idx_rj_degree_zero,    &
     &      rj_fld%n_point, sph_rj%nidx_rj(2),                          &
     &      sph_bc%kr_in, sph_bc%r_ICB, sph_bc%fdm2_fix_fld_ICB,        &
     &      sph_bc%ICB_fld, is_fld, is_grad,                            &
     &      rj_fld%ntot_phys, rj_fld%d_fld)
...
!
     ...
     &      is_fld, is_grad, rj_fld%ntot_phys, rj_fld%d_fld)
        call dsdr_sph_lm0_out_fix_flux_2(sph_rj%idx_rj_degree_zero,     &
     &      rj_fld%n_point, sph_rj%nidx_rj(2),                          &
     ...
     &      rj_fld%ntot_phys, rj_fld%d_fld)
        call dsdr_sph_lm0_fix_scalar_out_2(sph_rj%idx_rj_degree_zero,   &
     &      rj_fld%n_point, sph_rj%nidx_rj(2),                          &
     &      sph_bc%kr_out, sph_bc%r_CMB, sph_bc%fdm2_fix_fld_CMB,       &
     &      sph_bc%CMB_fld, is_fld, is_grad,                            &
     &      rj_fld%ntot_phys, rj_fld%d_fld)
...
!
     ...
     &     (sph_rj%inod_rj_center, sph_rj%idx_rj_degree_zero,           &
     &      rj_fld%n_point, is_diffuse, rj_fld%ntot_phys, rj_fld%d_fld)
      else if(sph_bc%iflag_icb .eq. iflag_fixed_flux) then
...
!
     ...
     &      rj_fld%n_point, sph_rj%nidx_rj(2),                          &
     &      sph_bc%r_ICB,fdm2_fix_fld_ctr1, fdm2_fix_dr_center,         &
     &      dminus, is_flux, is_advect, rj_fld%ntot_phys, rj_fld%d_fld)
      else if(sph_bc%iflag_icb .eq. iflag_sph_fix_center) then
        call cal_sph_div_flux_4_fix_ctr                                 &
     &     (rj_fld%n_point, sph_rj%nidx_rj(2),                          &
     &      sph_bc%r_ICB, sph_bc%ICB_fld, fdm2_fix_fld_ctr1,            &
     &      is_flux, is_advect, rj_fld%ntot_phys, rj_fld%d_fld)
        call cal_sph_fixed_center_diffuse2                              &
     &     (sph_rj%inod_rj_center, sph_rj%idx_rj_degree_zero,           &
     &      rj_fld%n_point, is_advect, rj_fld%ntot_phys, rj_fld%d_fld)
      else if(sph_bc%iflag_icb .eq. iflag_fixed_flux) then
        call cal_div_sph_in_fix_flux_2                                  &
     &     (rj_fld%n_point, sph_rj%nidx_rj(2), sph_bc%kr_in,            &
...
!
     ...
     &     (rj_fld%n_point, sph_rj%nidx_rj(2), sph_bc%kr_out,           &

...
!!     &           is_magne, is_current, sph_rj, rj_fld)
...
!!     &          is_magne, is_ohmic, ids_ohmic, sph_rj, rj_fld)
!!        Input:    ipol%i_magne, itor%i_magne
...
!
     ...
     &     (rj_fld%n_point, sph_rj%nidx_rj(2), is_magne,                &
...
!
     ...
     &      rj_fld%ntot_phys, rj_fld%d_fld)
        call cal_dsdr_sph_center_2                                      &
     &     (rj_fld%n_point, sph_rj%nidx_rj(2), is_ohmic,                &
     &      rj_fld%ntot_phys, rj_fld%d_fld)
      else if(sph_bc_B%iflag_icb .eq. iflag_radial_magne) then
     ...
     &      is_ohmic, ids_ohmic, rj_fld%ntot_phys, rj_fld%d_fld)
      else

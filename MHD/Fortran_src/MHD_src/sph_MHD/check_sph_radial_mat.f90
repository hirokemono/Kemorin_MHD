...
!
      write(50+my_rank,'(a)')                                           &
     &          'j_local, j, l, m, k, r, a(k,k-1), a(k,k), a(k,k+1)'
      do j = 1, jmax
!
        write(50+my_rank,'(5i6,1p4E25.15e3)') j, j_sph(j,1:3), ione,    &
...
!
      integer(kind = kint) :: j, k, l
!
!
      write(50+my_rank,'(a,a)') 'j_local, j, l, m, k, r, ',             &
     &          'a(k,k-2), a(k,k-1), a(k,k), a(k,k+1), a(k,k+2)'
      do j = 1, jmax
!
        write(50+my_rank,'(5i6,1p6E25.15e3)') j, j_sph(j,1:3), ione,    &
     &              rr(1), -1.0d30, -1.0d30, (mat(3-l,1+l,j),l=0,2)
        write(50+my_rank,'(5i6,1p6E25.15e3)') j, j_sph(j,1:3), itwo,    &
...
!
!
      write(50+my_rank,'(a,a,a)') 'j_local, j, l, m, k, r, ',           &
     &       'a(k,k-3), a(k,k-2), a(k,k-1), a(k,k), ',                  &
     &       'a(k,k+1), a(k,k+2), a(k,k+3)'
      do j = 1, jmax
!
        write(50+my_rank,'(5i6,1p8E25.15e3)') j, j_sph(j,1:3), ione,    &
     &              rr(1), -1.0d30, -1.0d30, (mat(4-l,1+l,j),l=0,3)
        write(50+my_rank,'(5i6,1p8E25.15e3)') j, j_sph(j,1:3), itwo,    &
     &              rr(1), -1.0d30, -1.0d30, (mat(4-l,1+l,j),l=-1,3)
        write(50+my_rank,'(5i6,1p8E25.15e3)') j, j_sph(j,1:3), ithree,  &
     &              rr(2), -1.0d30, (mat(4-l,2+l,j),l=-2,3)
        do k = 4, nri-3
          write(50+my_rank,'(5i6,1p8E25.15e3)') j, j_sph(j,1:3), k,     &
     &              rr(k), (mat(4-l,k+l,j),l=-3,3)
        end do
        write(50+my_rank,'(5i6,1p8E25.15e3)') j, j_sph(j,1:3), (nri-2), &

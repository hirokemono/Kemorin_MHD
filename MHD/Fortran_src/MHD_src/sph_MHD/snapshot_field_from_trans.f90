...
!!      subroutine zmean_snap_vec_fld_from_trans(m_folding, sph_rtp,    &
!!     &          trns_snap, node, iphys, nod_fld)
!!      subroutine zrms_snap_vec_fld_from_trans(m_folding, sph_rtp,     &
!!     &          trns_snap, node, iphys, nod_fld)
!!        type(sph_rtp_grid), intent(in) :: sph_rtp
!!        type(node_data), intent(in) :: node
!!        type(phys_address), intent(in) :: iphys
...
!
     ...
     &    m_folding, sph_rtp, trns_snap, node, nod_fld)
!
      end subroutine zmean_snap_vec_fld_from_trans
!
!-----------------------------------------------------------------------
!
      subroutine zrms_snap_vec_fld_from_trans(m_folding, sph_rtp,       &
...
!
     ...
     &    m_folding, sph_rtp, trns_snap, node, nod_fld)
!
      end subroutine zrms_snap_vec_fld_from_trans
!
!-----------------------------------------------------------------------
!

...
!
     ...
     &     (time, sph_rj%nidx_rj(2), sph_rj%idx_gl_1d_rj_j,             &
     &      bc_Uevo%vp_ICB_mag, bc_Uevo%dp_ICB_mag, bc_Uevo%vt_ICB_mag, &
     &      bc_Uevo%vp_ICB_freq, bc_Uevo%vt_ICB_freq,                   &
     &      bc_Uevo%vp_ICB_phase, bc_Uevo%vt_ICB_phase,                 &
...
!
     ...
     &    .or. sph_bc%iflag_cmb .eq. iflag_evolve_flux) then
        call cal_sph_nod_evo_vector_BC                                  &
     &     (time, sph_rj%nidx_rj(2), sph_rj%idx_gl_1d_rj_j,             &
     &      bc_Uevo%vp_CMB_mag, bc_Uevo%dp_CMB_mag, bc_Uevo%vt_CMB_mag, &
     &      bc_Uevo%vp_CMB_freq, bc_Uevo%vt_CMB_freq,                   &
     &      bc_Uevo%vp_CMB_phase, bc_Uevo%vt_CMB_phase,                 &
...
!
     ...
     &         S_BC_mag, S_BC_freq, S_BC_phase, S_BC)
!
...
!
     ...
     &          Vp_BC_freq, Vt_BC_freq, Vp_BC_phase, Vt_BC_phase,       &
     &          Vp_BC, Dp_BC, Vt_BC)
!
      integer(kind = kint), intent(in) :: jmax
      integer(kind = kint), intent(in) :: idx_rj(jmax,3)

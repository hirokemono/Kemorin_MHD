...
int main(int argc, char **argv)
{
	...
	int ist_div_forces = ist_rot_forces
			+ num_rot_forces_f();
	int ist_energy_fluxes = ist_div_forces
			+ num_div_forces_f();
	int ist_divergence_fields = ist_energy_fluxes
			+ num_energy_fluxes_f();
	...
	int ist_filter_fields = ist_SGS_model_coefs
			+ num_SGS_model_coefs_f();
	
	int ist_div_filter_fields = ist_filter_fields
			+ num_filter_fields_f();
	...
	set_rot_force_labels_f(&ncomp[ist_rot_forces], 
								&name1[len_f*ist_rot_forces],
								&math1[len_f*ist_rot_forces]);
	set_div_force_labels_f(&ncomp[ist_div_forces], 
								&name1[len_f*ist_div_forces],
								&math1[len_f*ist_div_forces]);
	set_energy_flux_names_f(&ncomp[ist_energy_fluxes], 
								&name1[len_f*ist_energy_fluxes],
								&math1[len_f*ist_energy_fluxes]);
	...
	set_filter_field_labels_f(&ncomp[ist_filter_fields], 
								&name1[len_f*ist_filter_fields],
								&math1[len_f*ist_filter_fields]);

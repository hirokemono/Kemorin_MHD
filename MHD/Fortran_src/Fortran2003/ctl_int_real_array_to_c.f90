...
!!      subroutine c_int_real_item_intvalue(c_ctl)                      &
!!     &          bind(C, NAME = 'c_int_real_item_intvalue')
!!      subroutine c_int_real_item_realvalue(c_ctl)                     &
!!     &          bind(C, NAME = 'c_int_real_item_realvalue')
!!
!!      subroutine c_int_real_array_block_name(c_ctl)                   &
!!     &          bind(C, NAME = 'c_int_real_array_block_name')
!!      subroutine c_int_real_array_num(c_ctl)                          &
!!     &          bind(C, NAME = 'c_int_real_array_num')
!!      subroutine c_int_real_array_icou(c_ctl)                         &
!!     &          bind(C, NAME = 'c_int_real_array_icou')
!!      subroutine c_int_real_array_i_tbl(c_ctl)                        &
!!     &          bind(C, NAME = 'c_int_real_array_i_tbl')
!!      subroutine c_int_real_array_r_tbl(c_ctl)                        &
!!     &          bind(C, NAME = 'c_int_real_array_r_tbl')
!!
!!      subroutine c_dealloc_int_real_array(c_ctl)                      &
!!     &          bind(C, NAME = 'c_dealloc_int_real_array')
!!      subroutine c_alloc_int_real_array(c_ctl)                        &
...
!  ---------------------------------------------------------------------
!
      type(c_ptr) function c_int_real_item_intvalue(c_ctl)              &
     &          bind(C, NAME = 'c_int_real_item_intvalue')
      type(c_ptr), value, intent(in) :: c_ctl
      type(read_int_real_item), pointer :: f_ctl
!
      call c_f_pointer(c_ctl, f_ctl)
      c_int_real_item_intvalue = C_loc(f_ctl%intvalue)
      end function c_int_real_item_intvalue
!
!  ---------------------------------------------------------------------
!
      type(c_ptr) function c_int_real_item_realvalue(c_ctl)             &
     &          bind(C, NAME = 'c_int_real_item_realvalue')
      type(c_ptr), value, intent(in) :: c_ctl
      type(read_int_real_item), pointer :: f_ctl
!
      call c_f_pointer(c_ctl, f_ctl)
      c_int_real_item_realvalue = C_loc(f_ctl%realvalue)
...
!  ---------------------------------------------------------------------
!
      type(c_ptr) function c_int_real_array_num(c_ctl)                  &
     &          bind(C, NAME = 'c_int_real_array_num')
      type(c_ptr), value, intent(in) :: c_ctl
      type(ctl_array_ir), pointer :: f_ctl
!
      call c_f_pointer(c_ctl, f_ctl)
      c_int_real_array_num = C_loc(f_ctl%num)
      end function c_int_real_array_num
!
!  ---------------------------------------------------------------------
!
      type(c_ptr) function c_int_real_array_icou(c_ctl)                 &
     &          bind(C, NAME = 'c_int_real_array_icou')
      type(c_ptr), value, intent(in) :: c_ctl
      type(ctl_array_ir), pointer :: f_ctl
!
      call c_f_pointer(c_ctl, f_ctl)
      c_int_real_array_icou = C_loc(f_ctl%icou)
      end function c_int_real_array_icou
!
!  ---------------------------------------------------------------------
!
      type(c_ptr) function c_int_real_array_i_tbl(c_ctl)                &
     &          bind(C, NAME = 'c_int_real_array_i_tbl')
      type(c_ptr), value, intent(in) :: c_ctl
      type(ctl_array_ir), pointer :: f_ctl
!
      call c_f_pointer(c_ctl, f_ctl)
      c_int_real_array_i_tbl = C_loc(f_ctl%ivec)
      end function c_int_real_array_i_tbl
!
!  ---------------------------------------------------------------------
!
      type(c_ptr) function c_int_real_array_r_tbl(c_ctl)                &
     &          bind(C, NAME = 'c_int_real_array_r_tbl')
      type(c_ptr), value, intent(in) :: c_ctl
      type(ctl_array_ir), pointer :: f_ctl
!
      call c_f_pointer(c_ctl, f_ctl)
      c_int_real_array_r_tbl = C_loc(f_ctl%vect)

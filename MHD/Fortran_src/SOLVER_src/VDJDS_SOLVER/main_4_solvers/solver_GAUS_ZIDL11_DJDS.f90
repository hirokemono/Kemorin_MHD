!Csolver_GAUS_ZIDL11_DJDS.f90
!C*** 
!C*** module solver_GAUS_ZIDL11_DJDS
!C***
!
...
!!
!!      subroutine init_VGAUSS_ZEIDEL11_DJDS_SMP(NP, PEsmpTOT, INITtime)
...
!!C
      module solver_GAUS_ZIDL11_DJDS
!
      use m_precision
      use t_solver_SR
      use calypso_mpi
...
!
     ...
     &           SR_sig, SR_r, COMPtime, COMMtime)
!
      end subroutine VGAUSS_ZEIDEL11_DJDS_SMP
!
!  ---------------------------------------------------------------------
!
      subroutine init_VGAUSS_ZEIDEL11_DJDS_SMP(NP, PEsmpTOT, INITtime)
...
!
     ...
     &               'solver_GAUSS_ZEIDEL_DJDS_SMP: ', ITER, RESID
         ITR = ITER
...
!
      end subroutine solve_VGAUSS_ZEIDEL11_DJDS_SMP
!
!  ---------------------------------------------------------------------
!
      end module solver_GAUS_ZIDL11_DJDS

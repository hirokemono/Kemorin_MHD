!Csolver_JACOBI11_DJDS.f90
!C*** 
!C*** module solver_JACOBI11_DJDS
!C***
!
...
!!C
!!C***
!!C***  VJACOBI11_DJDS_SMP
!!C***
!!      subroutine VJACOBI11_DJDS_SMP                                   &
...
!!
!!      subroutine init_VJACOBI11_DJDS_SMP(NP, PEsmpTOT, INITtime)
...
!
      end subroutine init_VJACOBI11_DJDS_SMP
!
!  ---------------------------------------------------------------------
!C
      subroutine solve_VJACOBI11_DJDS_SMP                               &
...
!C== change B,X
      ...
      IER = 0
!
      end subroutine solve_VJACOBI11_DJDS_SMP
!
!  ---------------------------------------------------------------------
!
      end module solver_JACOBI11_DJDS

!
!      module m_work_4_GPBiCG11
!
!     Written by Kemorin on Dec., 2005
!
!      subroutine verify_work_GPBiCG_11(NP, PEsmpTOT)
!      subroutine allocate_work_GPBiCG_11(NP, PEsmpTOT)
!      subroutine init_work_GPBiCG_11(NP, PEsmpTOT)
!      subroutine deallocate_work_GPBiCG_11
!
      module m_work_4_GPBiCG11
!
      use m_precision
!
      implicit none
!
      integer(kind = kint) :: iflag_work_GPBiCG11 = 0
      real(kind=kreal), allocatable :: W(:,:)
!
      private :: iflag_work_GPBiCG11
!
...
!
      if (iflag_work_GPBiCG11.eq.0) then
        call allocate_work_GPBiCG_11(NP, PEsmpTOT)
      else if (iflag_work_GPBiCG11.lt. (17*NP)) then
        call deallocate_work_GPBiCG_11
        call allocate_work_GPBiCG_11(NP, PEsmpTOT)
      end if
!
      end subroutine verify_work_GPBiCG_11
!
!  ---------------------------------------------------------------------
!
      subroutine allocate_work_GPBiCG_11(NP, PEsmpTOT)
...
!
      ...
      iflag_work_GPBiCG11 = 17*NP
!
      end subroutine allocate_work_GPBiCG_11
!
!  ---------------------------------------------------------------------
!
      subroutine init_work_GPBiCG_11(NP, PEsmpTOT)
...
!      RHO0 =   0.0d0
!
      end subroutine init_work_GPBiCG_11
!
!  ---------------------------------------------------------------------
!
      subroutine deallocate_work_GPBiCG_11
!
      ...
      iflag_work_GPBiCG11 = 0
!
      end subroutine deallocate_work_GPBiCG_11
!
!  ---------------------------------------------------------------------
!
      end module m_work_4_GPBiCG11

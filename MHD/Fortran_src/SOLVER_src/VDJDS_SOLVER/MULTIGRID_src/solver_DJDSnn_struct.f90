...
!     &          eps, itr, itr_res, my_rank, SOLVER_COMM)
!
...
!
      use solverNN_DJDS
!
      integer(kind = kint), intent(in)  :: NP, NB, PEsmpTOT, my_rank
...
!
      ...
      use solverNN_DJDS
!
      integer(kind = kint), intent(in)  :: NB, my_rank, PEsmpTOT

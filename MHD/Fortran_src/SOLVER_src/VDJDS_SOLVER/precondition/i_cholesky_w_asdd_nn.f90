...
!     Written by Kemorin
!
!      subroutine verify_work_4_IC_asddnn(NP,NB)
!      subroutine verify_work_4_IC_asdd3xnn(NP,NB)
!
!      subroutine allocate_work_4_IC_asddnn(NP,NB)
!      subroutine allocate_work_4_IC_asdd3xnn(NP,NB)
!      subroutine deallocate_work_4_IC_asddnn
!C
...
!
       implicit none
!
       integer(kind = kint) :: iflag_work_IC_asddnn = 0
       ...
       private :: W6, iflag_work_IC_asddnn
       private :: IZR
...
!
      if (iflag_work_IC_asddnn.eq.0) then
        call allocate_work_4_IC_asddnn(NP, NB)
      else if (iflag_work_IC_asddnn.lt.(2*NB*NP)) then
        call deallocate_work_4_IC_asddnn
        call allocate_work_4_IC_asddnn(NP, NB)
      end if
!
      end subroutine verify_work_4_IC_asddnn
!
!  ---------------------------------------------------------------------
!
      subroutine verify_work_4_IC_asdd3xnn(NP,NB)
...
!
      if (iflag_work_IC_asddnn.eq.0) then
        call allocate_work_4_IC_asdd3xnn(NP, NB)
      else if (iflag_work_IC_asddnn.lt.(6*NB*NP)) then
        call deallocate_work_4_IC_asddnn
        call allocate_work_4_IC_asdd3xnn(NP, NB)
      end if
!
      end subroutine verify_work_4_IC_asdd3xnn
!
!  ---------------------------------------------------------------------
!  ---------------------------------------------------------------------
!
...
!
       allocate ( W6(NB*NP,2) )
       W6 = 0.0d0
       iflag_work_IC_asddnn = NP*NB*2
!
      end subroutine allocate_work_4_IC_asddnn
!
!  ---------------------------------------------------------------------
!
      subroutine allocate_work_4_IC_asdd3xnn(NP,NB)
...
!
       allocate ( W6(NB*NP,6) )
       W6 = 0.0d0
       iflag_work_IC_asddnn = NP*NB*6
!
      end subroutine allocate_work_4_IC_asdd3xnn
!
!  ---------------------------------------------------------------------
!
      subroutine deallocate_work_4_IC_asddnn
!
       deallocate ( W6 )
       iflag_work_IC_asddnn = 0
!
      end subroutine deallocate_work_4_IC_asddnn
!
!  ---------------------------------------------------------------------
!  ---------------------------------------------------------------------
!

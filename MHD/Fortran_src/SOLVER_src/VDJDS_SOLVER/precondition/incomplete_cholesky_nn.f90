!
!      module incomplete_cholesky_nn
!
!     Written by Kemorin
!
!      subroutine verify_work_4_I_Choleskynn(NP, NB)
!      subroutine verify_work_4_I_Cholesky3xnn(NP, NB)
!C
!C***  Incomplete Cholesky
!C***
!C
!       subroutine incomplete_cholesky_1xnn                             &
!     &           (N, NP, NB, NL, NU, NPL, NPU, npLX1, npUX1, NVECT,    &
!     &            PEsmpTOT, STACKmcG, STACKmc, NLhyp, NUhyp, OtoN_L,   &
!     &            NtoO_U, LtoU, INL, INU, IAL, IAU, AL, AU,            &
!     &            ALU_L, ALU_U, S, V )
!       subroutine incomplete_cholesky_3xnn                             &
!     &           (N, NP, NB, NL, NU, NPL, NPU, npLX1, npUX1, NVECT,    &
!     &            PEsmpTOT, STACKmcG, STACKmc, NLhyp, NUhyp, OtoN_L,   &
!     &            NtoO_U, LtoU, INL, INU, IAL, IAU, AL, AU,            &
...
!
      implicit none
!
       integer(kind = kint) :: iflag_work_I_Choleskynn = 0
       ...
       private :: W6, iflag_work_I_Choleskynn
       private :: IZR
       private :: IZ1, IZ2, IZ3, IR1, IR2, IR3
!
       private :: deallocate_work_4_I_Choleskynn
!
!  ---------------------------------------------------------------------
!
      contains
...
!
      if (iflag_work_I_Choleskynn.eq.0) then
        call allocate_work_4_I_Choleskynn(NP, NB)
      else if (iflag_work_I_Choleskynn.lt.(2*NB*NP)) then
        call deallocate_work_4_I_Choleskynn
        call allocate_work_4_I_Choleskynn(NP, NB)
      end if
!
...
!
      if (iflag_work_I_Choleskynn.eq.0) then
        call allocate_work_4_I_Cholesky3xnn(NP, NB)
      else if (iflag_work_I_Choleskynn.lt.(6*NB*NP)) then
        call deallocate_work_4_I_Choleskynn
        call allocate_work_4_I_Cholesky3xnn(NP, NB)
      end if
!
      end subroutine verify_work_4_I_Cholesky3xnn
!
!  ---------------------------------------------------------------------
!  ---------------------------------------------------------------------
!
      subroutine allocate_work_4_I_Choleskynn(NP, NB)
!
       integer(kind = kint), intent(in) :: NP, NB
!
       allocate ( W6(NB*NP,2) )
       W6 = 0.0d0
       iflag_work_I_Choleskynn = 2*NB*NP
!
      end subroutine allocate_work_4_I_Choleskynn
!
!  ---------------------------------------------------------------------
!
      subroutine allocate_work_4_I_Cholesky3xnn(NP, NB)
!
       integer(kind = kint), intent(in) :: NP, NB
!
       allocate ( W6(NB*NP,6) )
       W6 = 0.0d0
       iflag_work_I_Choleskynn = 6*NB*NP
!
      end subroutine allocate_work_4_I_Cholesky3xnn
!
!  ---------------------------------------------------------------------
!
      subroutine deallocate_work_4_I_Choleskynn
!
       deallocate ( W6 )
       iflag_work_I_Choleskynn = 0
!
      end subroutine deallocate_work_4_I_Choleskynn
!
!  ---------------------------------------------------------------------
!  ---------------------------------------------------------------------
!
...
!C== backward substitution
     ...
     &    NtoO_U, S, W6(1,IZ1) )
!
      end subroutine incomplete_cholesky_1xnn
!
!  ---------------------------------------------------------------------
!
       subroutine incomplete_cholesky_3xnn                              &
...
!
      end subroutine incomplete_cholesky_3xnn
!
!  ---------------------------------------------------------------------
!
      end module incomplete_cholesky_nn

!
!      module forward_substitute_nn
!
!     Written by Kemorin
!
!       subroutine forward_substitute_1xnn(N, NP, NB, NL, NPL,          &
!     &           PEsmpTOT, NVECT, npLX1, STACKmc, NLhyp, INL, IAL, S,  &
!     &           AL, ALU_L)
!
!       subroutine forward_substitute_3xnn(N, NP, NB, NL, NPL,          &
...
!
       ...
       integer (kind = kint) :: k, k1, k2, ii, ix, im
!
!
!poption noparallel
      do iv= 1, NVECT
...
!$omp end parallel do
      ...
      enddo
       ...
       end subroutine forward_substitute_1xnn
!
!  ---------------------------------------------------------------------
!
       subroutine forward_substitute_3xnn(N, NP, NB, NL, NPL,           &
...
!$omp end parallel do
      ...
      enddo
       ...
       end subroutine forward_substitute_3xnn
!
!  ---------------------------------------------------------------------
!
      end module forward_substitute_nn

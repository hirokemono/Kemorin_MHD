...
!     Written by Kemorin
!
!      subroutine verify_work_4_IC_asdd33d(NP)
!      subroutine allocate_work_4_IC_asdd33d(NP)
!      subroutine deallocate_work_4_IC_asdd33d
!C
...
!
      implicit none
!
       integer(kind = kint) :: iflag_work_IC_asdd33d = 0
       ...
       private :: W6, iflag_work_IC_asdd33d
       private :: IZR
...
!
      if (iflag_work_IC_asdd33d.eq.0) then
        call allocate_work_4_IC_asdd33d(NP)
      else if (iflag_work_IC_asdd33d .lt. (2*3*NP)) then
        call deallocate_work_4_IC_asdd33d
        call allocate_work_4_IC_asdd33d(NP)
      end if
!
      end subroutine verify_work_4_IC_asdd33d
!
!  ---------------------------------------------------------------------
!
      subroutine allocate_work_4_IC_asdd33d(NP)
...
!
       allocate ( W6(3*NP,2) )
       W6 = 0.0d0
       iflag_work_IC_asdd33d = 2*3*NP
!
      end subroutine allocate_work_4_IC_asdd33d
!
!  ---------------------------------------------------------------------
!
      subroutine deallocate_work_4_IC_asdd33d
!
       deallocate ( W6 )
       iflag_work_IC_asdd33d = 0
!
      end subroutine deallocate_work_4_IC_asdd33d
!
!  ---------------------------------------------------------------------
!  ---------------------------------------------------------------------
!
...
!
!
      call verify_work_4_matvec33d(NP)
!
...
!
!
      call verify_work_4_matvec3x33d(NP)
!
      if (iterPRE .eq. 1) then
...
!
     ...
     &            AL, ALU_L)
      ...
      call ordering_3x3_by_l2u(NP, LtoU, W6(1,IZ1), W6(1,IZ2),          &
     &            W6(1,IZ3), STmp1, STmp2, STmp3 )
!C
!C== backward substitution
!
       call backward_substitute_3x33d(N, NP, NU, NPU, PEsmpTOT,         &
     &           NVECT, npUX1, STACKmc, NUhyp, INU, IAU, W6(1,IZ1),     &
     &           W6(1,IZ2), W6(1,IZ3), W6(1,IR1), W6(1,IR2), W6(1,IR3), &
     &           AU, ALU_U)
!

...
!
     ...
     &      OtoN_L, S1, S2, S3, V1, V2, V3)
        ...
        call clear_vector_solve_3x33(NP, W6(1,IR1), W6(1,IR2),          &
     &      W6(1,IR3) )
!C
!C== forward substitution
...
!C== backward substitution
      ...
      call backward_substitute_3x33d(N, NP, NU, NPU, PEsmpTOT, NVECT,   &
...
!
      end subroutine incomplete_cholesky_3x33d
!
!  ---------------------------------------------------------------------
!
      end module incomplete_cholesky_33d

!
!      module cal_4_lower_nn
!
!     Written by Kemorin
!
!       subroutine subtract_lower_nn(NP, NB, NL, NPL, PEsmpTOT, NVECT,  &
!     &           npLX1, STACKmc, NLhyp, INL, IAL, S, AL, V )
!       subroutine subtract_lower_3xnn(NP, NB, NL, NPL, PEsmpTOT,       &
!     &           NVECT, npLX1, STACKmc, NLhyp, INL, IAL, S1, S2, S3,   &
!     &           AL, V1, V2, V3 )
!
!       subroutine add_lower_nn(NP, NB, NL, NPL, PEsmpTOT, NVECT,       &
!     &           npLX1, STACKmc, NLhyp, INL, IAL, S, AL, V )
!       subroutine add_lower_3xnn(NP, NB, NL, NPL, PEsmpTOT, NVECT,     &
...
!
!
!cdir parallel do private(iv,iv0,j,iS,iE,i,k,k1,k2,ii,ix,im) 
!$omp parallel do private(iv,iv0,j,iS,iE,i,k,k1,k2,ii,ix,im) 
!poption indep (S,V,AL,INL,IAL,STACKmc) 
!poption tlocal(iv,iv0,j,iS,iE,i,k,k1,k2,ii,ix,im) 
      do ip= 1, PEsmpTOT
!poption noparallel
       do iv= 1, NVECT
...
!$omp end parallel do
       ...
       end subroutine subtract_lower_nn
!
!  ---------------------------------------------------------------------
!
       subroutine subtract_lower_3xnn(NP, NB, NL, NPL, PEsmpTOT,        &
...
!$omp end parallel do
       ...
       end subroutine subtract_lower_3xnn
!
!  ---------------------------------------------------------------------
!  ---------------------------------------------------------------------
!
...
!$omp end parallel do
!
       end subroutine add_lower_3xnn
!
!  ---------------------------------------------------------------------
!
      end module cal_4_lower_nn

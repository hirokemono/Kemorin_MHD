!
!      module cal_4_upper_nnd
!
!     Written by Kemorin
!
!       subroutine subtract_upper_nnd(NP, NB, NU, NPU, PEsmpTOT, NVECT, &
!     &           npUX1, STACKmc, NUhyp, INU, IAU, S, AU, V )
!       subroutine subtract_upper_3xnnd(NP, NB, NU, NPU, PEsmpTOT,      &
!     &           NVECT, npUX1, STACKmc, NUhyp, INU, IAU,               &
!     &           S1, S2, S3, AU, V1, V2, V3 )
!
!       subroutine add_upper_nnd(NP, NB, NU, NPU, PEsmpTOT, NVECT,      &
!     &           npUX1, STACKmc, NUhyp, INU, IAU, S, AU, V )
!       subroutine add_upper_3xnnd(NP, NB, NU, NPU, PEsmpTOT, NVECT,    &
...
!
       ...
       integer (kind = kint) :: k1, ii, ix, im
!
!
!cdir parallel do private(iv0,j,iS,iE,i,k,k1,ii,ix,im) 
!$omp parallel do private(iv0,j,iS,iE,i,k,k1,ii,ix,im) 
...
!$omp end parallel do
       ...
       end subroutine subtract_upper_nnd
!
!  ---------------------------------------------------------------------
!
       subroutine subtract_upper_3xnnd(NP, NB, NU, NPU, PEsmpTOT,       &
...
!$omp end parallel do
       ...
       end subroutine subtract_upper_3xnnd
!
!  ---------------------------------------------------------------------
!  ---------------------------------------------------------------------
!
...
!$omp end parallel do
       ...
       end subroutine add_upper_3xnnd
!
!  ---------------------------------------------------------------------
!
      end module cal_4_upper_nnd

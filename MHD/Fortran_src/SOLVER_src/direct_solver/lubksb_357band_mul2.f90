...
!
        x(mst:med,n)   =  x(mst:med,n) / band_lu(mst:med,3,n)
        x(mst:med,n-1) = (x(mst:med,n-1)                                &
     &                  - band_lu(mst:med,2,n) * x(mst:med,n))          &
     &                  / band_lu(mst:med,3,n-1)
!
        do i = n-2,1,-1
          x(mst:med,i) = (x(mst:med,i)                                  &

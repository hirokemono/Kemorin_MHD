...
!
      ...
      edge_comm_tbl_part(ip)%ntot_import = ntot_import_edge_2
!
...
!
     ...
     &       = istack_import_edge_2(0:num_neib_2)
!
...
!
     ...
     &       = item_import_surf_2(1:ntot_import_surf_2)
      edge_comm_tbl_part(ip)%item_import(1:ntot_import_edge_2)          &
     &       = item_import_edge_2(1:ntot_import_edge_2)
!
...
!
      ...
      ntot_import_edge_2 = edge_comm_tbl_part(ip)%ntot_import
!
...
!
     ...
     &                          - istack_import_surf_2(i-1)
          num_import_edge_2(i) = istack_import_edge_2(i)                &
     &                          - istack_import_edge_2(i-1)
      end do
!
...
!
      ...
      edge_comm_tbl_part(ip)%ntot_export = ntot_export_edge_2
!
...
!
     ...
     &       = istack_export_edge_2(0:num_neib_2)
!
...
!
     ...
     &       = item_export_surf_2(1:ntot_export_surf_2)
      edge_comm_tbl_part(ip)%item_export(1:ntot_export_edge_2)          &
     &       = item_export_edge_2(1:ntot_export_edge_2)
!
...
!
      ...
      ntot_export_edge_2 = edge_comm_tbl_part(ip)%ntot_export
!
...
!
     ...
     &                          - istack_export_surf_2(i-1)
          num_export_edge_2(i) = istack_export_edge_2(i)                &
     &                          - istack_export_edge_2(i-1)
      end do
!

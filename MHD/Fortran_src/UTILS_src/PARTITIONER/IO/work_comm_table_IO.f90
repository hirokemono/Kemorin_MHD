...
!
      ...
      write (id_file) istack_import_edge_2(1:num_neib_edge_2)
      ...
      write (id_file) item_import_edge_2(1:ntot_import_edge_2)
!
...
!
      ...
      write (id_file) istack_export_edge_2(1:num_neib_edge_2)
      ...
      write (id_file) item_export_edge_2(1:ntot_export_edge_2)
!
...
!
      ...
      read (id_file) istack_import_edge_2(1:num_neib_edge_2)
!
...
!
      ...
      read (id_file) item_import_edge_2(1:ntot_import_edge_2)
!
        do i = 1, num_neib_2
...
!
      ...
      read (id_file) istack_export_edge_2(1:num_neib_edge_2)
!
...
!
      ...
      read (id_file) item_export_edge_2(1:ntot_export_edge_2)
!
        do i = 1, num_neib_2

...
!
        do inod = 1, internal_node
          write(id_filter_z,'(i8,1p4E25.15e3)') globalnodid(inod),      &
...
!
        do iele = 1, numele
          write(id_filter_z,'(3i8,1p3E25.15e3)') globaledgeid(iele),    &
...
!
        do inod = 1, internal_node
          write(id_filter_z,'(i15,1p20E25.15e3)') globalnodid(inod),    &
...
!
        do inod = 1, internal_node
          write(id_filter_z,'(i15,1p6E25.15e3)') globalnodid(inod),     &
...
!
        do inod = 1, internal_node
          write(id_filter_z,'(2i10,1p20E25.15e3)') k,                   &

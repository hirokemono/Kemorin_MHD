...
!
        if      (iref_filter_type(i) .eq. 0) then
          call int_tophat_moment_infty(itwo, f_mom, f_width(i) )
        else if (iref_filter_type(i) .eq. 1) then
          call int_linear_moment_infty(itwo, f_mom, f_width(i) )
        else if (iref_filter_type(i) .eq. 2) then

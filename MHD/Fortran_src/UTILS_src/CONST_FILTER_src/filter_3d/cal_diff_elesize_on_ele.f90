...
!
!
!!      subroutine cal_filter_moms_ele_by_nod(num_int_points,           &
!!     &          node, ele, g_FEM, jac_3d, mom_nod, mom_ele)
!!
!!      subroutine cal_diffs_delta_on_element(num_int_points,           &
!!     &          node, ele, g_FEM, jac_3d, FEM_elen)
!!      subroutine cal_1st_diffs_filter_ele(num_int_points,             &
!!     &          node, ele, g_FEM, jac_3d, mom_nod, mom_ele)
!!      subroutine cal_2nd_diffs_delta_on_element(num_int_points,       &
!!     &          node, ele, g_FEM, jac_3d, FEM_elen)
!!      subroutine cal_2nd_diffs_filter_ele(num_int_points,             &
!!     &         (node, ele, g_FEM, jac_3d, mom_nod, mom_ele)
...
!
!
      call take_1st_diffs_ele(num_int_points, node, ele, g_FEM, jac_3d, &
...
!
!
      call take_2nd_diffs_ele(num_int_points, node, ele, g_FEM, jac_3d, &
...
!-----------------------------------------------------------------------
!
      subroutine take_1st_diffs_ele(num_int_points,                     &
...
!-----------------------------------------------------------------------
!
      subroutine take_2nd_diffs_ele(num_int_points,                     &
     &          node, ele, g_FEM, jac_3d, org_nod_field, diff_field)
!
      use cal_differences_on_ele
!

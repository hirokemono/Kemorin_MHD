...
!!     &          tbl_crs, mass, FEM_elen, fem_wk, f_nl)
!!      subroutine cal_diffs_filter_nod_consist                         &
!!     &         (nod_comm, node, ele, g_FEM, jac_3d, rhs_tbl,          &
!!     &          tbl_crs, mass, fem_wk, f_nl, mom_nod)
!!      subroutine cal_1st_diffs_dx_by_lump(node, ele, g_FEM, jac_3d,   &
!!     &          rhs_tbl, m_lump, FEM_elen, fem_wk, f_nl)
!!      subroutine cal_diffs_filter_nod_lump(node, ele, g_FEM, jac_3d,  &
...
!
     ...
     &    g_FEM, jac_3d, rhs_tbl, tbl_crs, mass, fem_wk, f_nl,          &
...
!
      call int_vol_diff_dxs(node, ele, g_FEM, jac_3d,                   &

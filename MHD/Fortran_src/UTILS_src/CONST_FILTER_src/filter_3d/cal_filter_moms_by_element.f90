...
!!     &          m_lump, FEM_elen, mass, fem_wk, f_l, ref_m)
...
!
!
      call cal_filter_moments_on_node(nod_comm, node, ele, g_FEM,       &
     &    jac_3d, rhs_tbl, tbl_crs, m_lump, FEM_elen%nnod_filter_mom,   &
...
!
     ...
     &          g_FEM, jac_3d, rhs_tbl, tbl_crs, m_lump,                &

...
!!     &         (jac_3d_q, rhs_tbl, mat_tbl, rhs_mat, FEM_elen,        &
!!     &          filter_dxi, dxidxs)
...
!
     ...
     &      rhs_mat%fem_wk, rhs_mat%fem_rhs%f_nl, mom_nod)
        ...
        call cal_diffs_filter_nod_lump(node1, ele1, jac_3d_q,           &
...
!
     ...
     &   (node1, ele1, jac_3d_q, mom_nod, mom_ele)

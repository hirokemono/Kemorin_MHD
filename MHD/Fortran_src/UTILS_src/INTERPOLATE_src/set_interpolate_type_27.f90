...
!!
!!@verbatim
!!      subroutine s_order_interpolate_type_27(id_rank, ist, ied,       &
...
!
      type(interpolate_table_dest), intent(in) :: itp_dest
      integer(kind = kint), intent(in) :: id_rank, ist, ied
...
!
          nnod_interpolate_type(1) = nnod_interpolate_type(1) + 1
          icou = inod_stack_type(0) + nnod_interpolate_type(1)
          itp_coef_dest%itype_inter_dest(icou) = 21
          call swap_interpolation_table                                 &
     &       (icou, inod, itp_dest, itp_coef_dest)
!
        else if(  itp_coef_dest%coef_inter_dest(inod,1) .eq.  one       &
...
!
          nnod_interpolate_type(1) = nnod_interpolate_type(1) + 1
          icou = inod_stack_type(0) + nnod_interpolate_type(1)
          itp_coef_dest%itype_inter_dest(icou) = 22
          call swap_interpolation_table                                 &
     &       (icou, inod, itp_dest, itp_coef_dest)
!
!
...
!
          nnod_interpolate_type(1) = nnod_interpolate_type(1) + 1
          icou = inod_stack_type(0) + nnod_interpolate_type(1)
          itp_coef_dest%itype_inter_dest(icou) = 23
          call swap_interpolation_table                                 &
     &       (icou, inod, itp_dest, itp_coef_dest)
!
        else if(  itp_coef_dest%coef_inter_dest(inod,1) .eq. zero       &
...
!
          nnod_interpolate_type(1) = nnod_interpolate_type(1) + 1
          icou = inod_stack_type(0) + nnod_interpolate_type(1)
          itp_coef_dest%itype_inter_dest(icou) = 24
          call swap_interpolation_table                                 &
     &       (icou, inod, itp_dest, itp_coef_dest)
!
!
...
!
          nnod_interpolate_type(1) = nnod_interpolate_type(1) + 1
          icou = inod_stack_type(0) + nnod_interpolate_type(1)
          itp_coef_dest%itype_inter_dest(icou) = 25
          call swap_interpolation_table                                 &
     &       (icou, inod, itp_dest, itp_coef_dest)
!
        else if(  itp_coef_dest%coef_inter_dest(inod,1) .eq. zero       &
...
!
          nnod_interpolate_type(1) = nnod_interpolate_type(1) + 1
          icou = inod_stack_type(0) + nnod_interpolate_type(1)
          itp_coef_dest%itype_inter_dest(icou) = 26
          call swap_interpolation_table                                 &
     &       (icou, inod, itp_dest, itp_coef_dest)
!
!
...
!
          nnod_interpolate_type(1) = nnod_interpolate_type(1) + 1
          icou = inod_stack_type(0) + nnod_interpolate_type(1)
          itp_coef_dest%itype_inter_dest(icou) = 27
          call swap_interpolation_table                                 &
     &       (icou, inod, itp_dest, itp_coef_dest)
!
!

...
!
      ...
      write(id_file,*) '#'
!
      write(id_file,'(3i10)') num_sph_grid
!
      write(id_file,*) '#'
      write(id_file,*) '#  number of bins (r, theta, phi)'
      write(id_file,*) '#'
!
      write(id_file,'(3i10)') num_sph_bin
!
      write(id_file,*) '#'
...
!
      do i = 0, num_sph_grid(1)
        write(id_file,'(i10,1pE25.15e3)') i, r_divide(i)
      end do
!
      write(id_file,*) '#'
...
!
      do i = 0, num_sph_grid(2)
        write(id_file,'(i10,1pE25.15e3)') i, theta_divide(i)
      end do
!
      write(id_file,*) '#'
...
!
      do i = 0, num_sph_grid(3)
        write(id_file,'(i10,1pE25.15e3)') i, phi_divide(i)
      end do
!

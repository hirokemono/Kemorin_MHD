...
!!        type(ctl_param_paraa_refiner), intent(inout) :: p_refine_p
...
!
      ...
      end type ctl_param_paraa_refiner
!
! -----------------------------------------------------------------------
!
      contains
...
!
     ...
     &           trim(p_refine_p%para_course_mesh_file%file_prefix)
        write(*,*) 'c2f_para_head:         ',                           &
     &       trim(p_refine_p%c2f_para_head)
        write(*,*) 'f2c_para_head:         ',                           &
     &       trim(p_refine_p%f2c_para_head)
        write(*,*) 'f2c_ele_para_head:     ',                           &
     &       trim(p_refine_p%f2c_ele_para_head)
        write(*,*) 'course_2_fine_head:    ',                           &
     &       trim(p_refine_p%course_2_fine_head)
        write(*,*) 'fine_2_course_head:    ',                           &
     &       trim(p_refine_p%fine_2_course_head)
        write(*,*) 'refine_info_head:      ',                           &
     &       trim(p_refine_p%refine_info_head)
      end if
!

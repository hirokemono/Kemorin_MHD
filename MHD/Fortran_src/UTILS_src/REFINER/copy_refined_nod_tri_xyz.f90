!copy_refined_nod_tri_xyz.f90
!      module copy_refined_nod_tri_xyz
!
      module copy_refined_nod_tri_xyz
!
      use m_precision
!
      implicit none
!
!      subroutine s_copy_refined_nod_tri_z(inod_refine_local,           &
!     &          inod_refine_nod_local, inod_refine_surf_local,         &
!     &          inod_refine_edge_local)
!      subroutine s_copy_refined_nod_tri_y(inod_refine_local,           &
!     &          inod_refine_nod_local, inod_refine_surf_local,         &
!     &          inod_refine_edge_local)
!      subroutine s_copy_refined_nod_tri_x(inod_refine_local,           &
!     &          inod_refine_nod_local, inod_refine_surf_local,         &
!     &          inod_refine_edge_local)
!
! ----------------------------------------------------------------------
...
!
      end subroutine s_copy_refined_nod_tri_z
!
! ----------------------------------------------------------------------
!
      subroutine s_copy_refined_nod_tri_y(inod_refine_local,            &
...
!
      ...
      inod_refine_local(64) = inod_refine_nod_local(7)
!
      end subroutine s_copy_refined_nod_tri_y
!
! ----------------------------------------------------------------------
!
      subroutine s_copy_refined_nod_tri_x(inod_refine_local,            &
...
!
      ...
      inod_refine_local(64) = inod_refine_nod_local(7)
!
      end subroutine s_copy_refined_nod_tri_x
!
! ----------------------------------------------------------------------
!
      end module copy_refined_nod_tri_xyz

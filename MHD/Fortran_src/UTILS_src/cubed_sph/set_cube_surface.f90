...
!      subroutine set_rect_skin(inod_sf_end, rad_edge)
...
!
      call const_rect_surface(inod_sf_end, x_size, z_size)
!
...
!   --------------------------------------------------------------------
!
      subroutine const_rect_surface(inod_sf_end, x_size, z_size)
!
      use m_constants
      use m_numref_cubed_sph
      use m_cubed_sph_surf_mesh
...
!
     ...
     &    inod_ed_end, cube_size, x_node, c_sphere1%x_csph)
!

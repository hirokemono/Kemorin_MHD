...
!
      call set_rect_rods(inod_sf_end, irod_sf_end, c_sphere1)
!
...
!
       ...
       call set_rect_surf_connect(iele_sf_end, c_sphere1)
!
...
!
      ...
      do icoarse = 1, max_coarse_level
        call cal_coarse_rect_params(icoarse, c_sphere1)
!
        call set_coarse_rect_skin(inod_sf_end, c_sphere1)
...
!
        call set_coarse_rect_surf_connect(iele_sf_end, c_sphere1)
...
!
       ...
       call set_merged_element_rect_surf(icoarse, c_sphere1)
!
      end do
!

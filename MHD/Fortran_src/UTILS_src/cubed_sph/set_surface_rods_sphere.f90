...
!
!!      subroutine set_cube_rods(inod_sf_end, irod_sf_end, c_sphere)
!!      subroutine set_rect_rods(inod_sf_end, irod_sf_end, c_sphere)
!!        type(cubed_sph_surf_mesh), intent(inout) :: c_sphere
!!
!!      subroutine set_circle_rods(inod_sf_end, irod_sf_end, c_sphere)
!!        type(cubed_sph_surf_mesh), intent(inout) :: c_sphere
!
!      Written by H. Matsui
...
!
     ...
     &    v_edge(1), c_sphere%numnod_sf20, c_sphere%ntot_edge_sf20,     &
     &    c_sphere%x_csph, c_sphere%iedge_sf20)

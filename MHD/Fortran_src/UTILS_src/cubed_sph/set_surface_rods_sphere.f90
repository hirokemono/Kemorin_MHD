...
!   bottom surface (z = -cube_size)
     ...
     &    c_sphere1%numnod_sf20, ntot_edge_sf20, xyz_surf, iedge_sf20)
...
!
     ...
     &    x_edge(1), c_sphere1%numnod_sf20, ntot_edge_sf20,             &
     &    xyz_surf, iedge_sf20)
      iele_ref = (6*num_hemi-2)*num_hemi
!
!    top vertical rod
!
      call set_top_vert_edge(num_hemi, num_hemi, iele, inod,            &
     &    x_edge(num_hemi), c_sphere1%numnod_sf20, ntot_edge_sf20,      &
     &    xyz_surf, iedge_sf20)
      iele_ref = (6*num_hemi+2)*num_hemi
!
!   side horizontal rod
...
!
     ...
     &    v_edge(1), c_sphere1%numnod_sf20, ntot_edge_sf20,             &
     &    xyz_surf, iedge_sf20)
...
!
     ...
     &    c_sphere1%numnod_sf20, ntot_edge_sf20,                        &
     &    xyz_surf, iedge_sf20)
      iele_ref = (2*num_hemi+4*ncube_vertical+2)*num_hemi

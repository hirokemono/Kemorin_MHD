...
!!      subroutine finalize_FFTW_kemo_type(Nsmp, WK)
...
!
      ...
      call init_kemo_FFTW_smp(Nsmp, Nfft, WK%plan_forward,              &
...
!
!
      call destroy_kemo_FFTW_smp(Nsmp,                                  &
...
!
     ...
     &    Nstacksmp, M, Nfft, X, WK%X_FFTW, WK%C_FFTW)
!

...
!!     &          Nstacksmp, M, Nfft, X, X_FFTW, C_FFTW)
!! ------------------------------------------------------------------
!!
...
!
          call kemo_fftw_execute_dft_r2c(plan_forward(ip),              &
...
!
          call kemo_fftw_execute_dft_c2r(plan_backward(ip),             &

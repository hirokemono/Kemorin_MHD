...
!!@verbatim
!! ------------------------------------------------------------------
 !!     subroutine init_kemo_FFTW_smp(Ncomp, Nfft,                      &
!!     &          plan_forward, plan_backward,  aNfft, X_FFTW, C_FFTW)
!!      subroutine init_kemo_FFTW_mul_smp(Nsmp, Nstacksmp, Ncomp, Nfft, &
!!     &          plan_forward_smp, plan_backward_smp,                  &
!!     &          aNfft, X_FFTW, C_FFTW)
!!
!!   wrapper subroutine for initierize FFTW plans
!! ------------------------------------------------------------------
!!      subroutine destroy_kemo_FFTW_smp(Ncomp,                         &
!!     &          plan_forward, plan_backward)
!!
!!   wrapper subroutine for clear FFTW plans
!! ------------------------------------------------------------------
!!
!!      subroutine kemo_FFTW_forward_SMP(plan_forward, Nsmp, Nstacksmp, &
!!     &          Ncomp, Nfft, aNfft, X, X_FFTW, C_FFTW)
!!      subroutine kemo_FFTW_mul_forward_SMP(plan_forward_smp,          &
...
!! ------------------------------------------------------------------
!!
!!      subroutine kemo_FFTW_backward_SMP(plan_backward,                &
!!     &          Nsmp, Nstacksmp, Ncomp, Nfft, X, X_FFTW, C_FFTW)
!!      subroutine kemo_FFTW_mul_backward_SMP(plan_backward_smp,        &
!!     &          Nsmp, Nstacksmp, Ncomp, Nfft, X, X_FFTW, C_FFTW)
!! ------------------------------------------------------------------
!!
...
!
     ...
     &      C_FFTW(1,j), X_FFTW(1,j) , FFTW_ESTIMATE)
      ...
      aNfft = one / dble(Nfft)
!
      end subroutine init_kemo_FFTW_smp
!
! ------------------------------------------------------------------
!
      subroutine init_kemo_FFTW_mul_smp(Nsmp, Nstacksmp, Ncomp, Nfft,   &
...
!
     ...
     &      X_FFTW(1,ist), inembed, istride, idist_r, FFTW_ESTIMATE)
      ...
      aNfft = one / dble(Nfft)
!
      end subroutine init_kemo_FFTW_mul_smp
!
! ------------------------------------------------------------------
!
      subroutine destroy_kemo_FFTW_smp(Ncomp,                           &
...
!
      end subroutine destroy_kemo_FFTW_smp
!
! ------------------------------------------------------------------
!
      subroutine kemo_FFTW_forward_SMP(plan_forward, Nsmp, Nstacksmp,   &
...
!
      end subroutine kemo_FFTW_forward_SMP
!
! ------------------------------------------------------------------
!
      subroutine kemo_FFTW_backward_SMP(plan_backward,                  &
...
!
      end subroutine kemo_FFTW_backward_SMP
!
! ------------------------------------------------------------------
!
      subroutine kemo_FFTW_mul_forward_SMP(plan_forward_smp,            &
...
!
      end subroutine kemo_FFTW_mul_forward_SMP
!
! ------------------------------------------------------------------
!
      subroutine kemo_FFTW_mul_backward_SMP(plan_backward_smp,          &
...
!
      elapsed_fftw(1:3) = elapsed_fftw(1:3) + rtmp(1:3) - dummy(1:3)
!
      end subroutine kemo_FFTW_mul_backward_SMP
!
! ------------------------------------------------------------------
! ------------------------------------------------------------------
!

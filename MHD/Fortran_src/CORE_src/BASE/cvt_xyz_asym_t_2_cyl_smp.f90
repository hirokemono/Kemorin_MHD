...
!
           if ( s(inod).eq.0.0 ) then
             ...
             tcyl(inod,1) =   txy
!
             tcyl(inod,2) = ( tzx * xx(inod)                            &
     &                      - tyz * yy(inod) ) * a_s(inod)
!
             tcyl(inod,3) = ( tzx * yy(inod)                            &
...
!
           if ( s(inod).eq.0.0 ) then
             ...
             tensor(inod,1) =   txy
!
             tensor(inod,2) = ( tzx * xx(inod)                          &
     &                        - tyz * yy(inod) ) * a_s(inod)
!
             tensor(inod,3) = ( tzx * yy(inod)                          &
     &                        + tyz * xx(inod) ) * a_s(inod)
           end if
!
        end do

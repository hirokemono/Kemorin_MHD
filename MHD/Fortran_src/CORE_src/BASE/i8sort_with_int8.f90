...
!C   array I8Y.  The array I8X may be sorted in increasing order or
...
!C            =  2  means sort I8X in increasing order and carry I8Y along.
!C            =  1  means sort I8X in increasing order (ignoring I8Y)
!C            = -1  means sort I8X in decreasing order (ignoring I8Y)
!C            = -2  means sort I8X in decreasing order and carry I8Y along.
!C
...
!C   901012  Declared all variables; changed X,Y to I8X,I8Y. (M. McClain)
...
!-----------------------------------------------------------------------
!
      SUBROUTINE I8SORT_W_INT (I8X, I8Y, N, KFLAG)
!C     .. Scalar Arguments ..
      INTEGER(kind = kint) :: KFLAG, N
!C     .. Array Arguments ..
      INTEGER(kind = kint_gl) :: I8X(N), I8Y(N)
!C     .. Local Scalars ..
      REAL R
...
!C
   90 I8X(K+1) = I8X(K)
      ...
      GO TO 80
!C
!C     Sort I8X and carry I8Y along
!C
  100 M = 1
      I = 1
      J = NN

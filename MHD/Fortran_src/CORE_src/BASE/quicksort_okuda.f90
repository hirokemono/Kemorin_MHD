!>@file   quicksort_okuda.f90
!!        module quicksort_okuda
!!
...
!!
!!@verbatim
!!      recursive subroutine quicksort_int_okd(n,ix,l,r)
!!      recursive subroutine quicksort_w_index_okd(n,ix,l,r,idx)
!!      recursive subroutine quicksort_int8_w_index_okd(n,i8x,l,r,idx)
!!      recursive subroutine quicksort_real_w_index(n,x,l,r,idx)
!!      recursive subroutine quicksort_coord_w_index_okd(n,xx,l,r,idx)
!!@endverbatim
!!
...
!
      if (l < r) then
        ...
        call quicksort_int_okd(n,ix,l,ls-1)
        call quicksort_int_okd(n,ix,ls+1,r)
      end if
!
      end subroutine quicksort_int_okd
!
!-----------------------------------------------------------------------
!
      recursive subroutine quicksort_w_index_okd(n,ix,l,r,idx)
...
!
      if (l < r) then
        ...
        call quicksort_w_index_okd(n,ix,l,ls-1,idx)
        call quicksort_w_index_okd(n,ix,ls+1,r,idx)
      end if
!
      end subroutine quicksort_w_index_okd
!
! ----------------------------------------------------------------------
!
      recursive subroutine quicksort_int8_w_index_okd(n,i8x,l,r,idx)
...
!
      if (l < r) then
        ...
        call swap(idx(ls),idx(l))
        call quicksort_int8_w_index_okd(n,i8x,l,ls-1,idx)
        call quicksort_int8_w_index_okd(n,i8x,ls+1,r,idx)
      end if
!
      end subroutine quicksort_int8_w_index_okd
!
! ----------------------------------------------------------------------
!
      recursive subroutine quicksort_real_w_index_okd(n,x,l,r,idx)
!
      integer (kind=kint), intent(in)  :: n,l,r
...
!
      if (l < r) then
        ...
        call swap(idx(ls),idx(l))
        call quicksort_real_w_index_okd(n,x,l,ls-1,idx)
        call quicksort_real_w_index_okd(n,x,ls+1,r,idx)
      end if
!
      end subroutine quicksort_real_w_index_okd
!
! ----------------------------------------------------------------------
! ----------------------------------------------------------------------
!
...
!
      if (l < r) then
        ...
        call swap(idx(ls),idx(l))
        call quicksort_coord_w_index_okd(n,xx,l,ls-1,idx)
        call quicksort_coord_w_index_okd(n,xx,ls+1,r,idx)
      end if
!
      end subroutine quicksort_coord_w_index_okd
!
!-----------------------------------------------------------------------
!
      end module quicksort_okuda

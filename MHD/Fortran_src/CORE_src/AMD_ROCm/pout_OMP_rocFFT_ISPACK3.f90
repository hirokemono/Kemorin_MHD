!>@file   pout_OMP_rocFFT_ISPACK3.f90
!!@brief  module pout_OMP_rocFFT_ISPACK3
!!
!!@author H. Matsui
!!@date Programmed in Aug., 2026
!!
!!
!>@brief  FFT by OpenMP rocFFT and ISPACK v3 with outmost data series
!!
!!@verbatim
!!      subroutine init_pout_OMP_rocFFT_ISPACK3                         &
...
!!
!!      subroutine pout_fwd_OMP_rocFFT_ISPACK3                          &
!!     &         (Ncomp, fwd_rocFFT, WK_rocFFT, WK_ISPACK3, X, elapsed)
...
!!      subroutine pout_bwd_OMP_rocFFT_ISPACK3                          &
!!     &         (Ncomp, bwd_rocFFT, WK_rocFFT, WK_ISPACK3, X, elapsed)
!!        integer(kind = kint), intent(in) :: Ncomp
...
!
      end subroutine init_pout_OMP_rocFFT_ISPACK3
!
! ------------------------------------------------------------------
!
      subroutine finalize_OMP_rocFFT_ISPACK3(fwd_rocFFT, bwd_rocFFT,    &
...
! ------------------------------------------------------------------
!
      end module pout_OMP_rocFFT_ISPACK3
!

!>@file   pin_real_rocFFT_FFTPACK.f90
!!@brief  module pin_real_rocFFT_FFTPACK
!!
!!@author H. Matsui
...
!!
!!      subroutine pin_fwd_real_rocFFT_FFTPACK(Ncomp, Ncomp_CPU,        &
...
!!      subroutine pin_bwd_real_rocFFT_FFTPACK(Ncomp, Ncomp_CPU,        &
...
!
      end subroutine init_pin_real_rocFFT_FFTPACK
!
! ------------------------------------------------------------------
!
      subroutine finalize_real_rocFFT_FFTPACK(fwd_rocFFT, bwd_rocFFT,   &
...
!
      end subroutine pin_fwd_real_rocFFT_FFTPACK
!
! ------------------------------------------------------------------
!
      subroutine pin_bwd_real_rocFFT_FFTPACK(Ncomp, Ncomp_CPU,          &
...
!      write(*,*) 'Total FFT clock', elapsed(1)
!
      end subroutine pin_bwd_real_rocFFT_FFTPACK
!
! ------------------------------------------------------------------
!
      end module pin_real_rocFFT_FFTPACK
!

!>@file   pout_real_rocFFT_FFTPACK.f90
!!@brief  module pout_real_rocFFT_FFTPACK
!!
!!@author H. Matsui
...
!!
!!@verbatim
!!      subroutine init_pout_real_rocFFT_FFTPACK                        &
!!     &         (Ncomp, Ncomp_GPU, Ncomp_CPU, Nfft, Nsmp,              &
!!     &          fwd_rocFFT, bwd_rocFFT, WK_rocFFT, WK_FFTPACK)
!!      subroutine finalize_real_rocFFT_FFTPACK(fwd_rocFFT, bwd_rocFFT, &
...
!!
!!      subroutine pout_fwd_real_rocFFT_FFTPACK                         &
...
!!      subroutine pout_bwd_real_rocFFT_FFTPACK                         &
...
!
      end subroutine init_pout_real_rocFFT_FFTPACK
!
! ------------------------------------------------------------------
!
      subroutine finalize_real_rocFFT_FFTPACK(fwd_rocFFT, bwd_rocFFT,   &
...
!
      end subroutine finalize_real_rocFFT_FFTPACK
!
! ------------------------------------------------------------------
! ------------------------------------------------------------------
!
...
!
      end subroutine pout_fwd_real_rocFFT_FFTPACK
!
! ------------------------------------------------------------------
!
      subroutine pout_bwd_real_rocFFT_FFTPACK                           &
...
!      write(*,*) 'Total FFT clock', elapsed(1)
!
      end subroutine pout_bwd_real_rocFFT_FFTPACK
!
! ------------------------------------------------------------------
!
      end module pout_real_rocFFT_FFTPACK
!

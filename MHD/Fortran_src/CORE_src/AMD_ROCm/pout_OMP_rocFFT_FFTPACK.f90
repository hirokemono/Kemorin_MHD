!>@file   pout_OMP_rocFFT_FFTPACK.f90
!!@brief  module pout_OMP_rocFFT_FFTPACK
!!
!!@author H. Matsui
!!@date Programmed in Aug., 2026
!!
!!
!>@brief  FFT by OpenMP rocFFT and FFTPACK5 with outmost data series
!!
!!@verbatim
...
!!
!!      subroutine pout_fwd_OMP_rocFFT_FFTPACK                          &
...
!!      subroutine pout_bwd_OMP_rocFFT_FFTPACK                          &
...
!!        real(kind = kreal), intent(inout) :: elapsed(4)
!!@endverbatim
      module pout_OMP_rocFFT_FFTPACK
!
...
! ------------------------------------------------------------------
!
      end module pout_OMP_rocFFT_FFTPACK
!

!>@file   sel_pout_rocFFT_FFTPACK.f90
!!@brief  module sel_pout_rocFFT_FFTPACK
!!
!!@author H. Matsui
...
!!
!!@verbatim
!!      subroutine init_pout_rocFFT_FFTPACK                             &
...
!!
!!      subroutine sel_pout_fwd_rocFFT_FFTPACK(iflag_GPU_FFT, Ncomp,    &
...
!!      subroutine sel_pout_bwd_rocFFT_FFTPACK(iflag_GPU_FFT, Ncomp,    &
...
!
      end subroutine init_pout_rocFFT_FFTPACK
!
! ------------------------------------------------------------------
!
      subroutine finalize_rocFFT_FFTPACK(fwd_rocFFT, bwd_rocFFT,        &
...
!
      end subroutine sel_pout_fwd_rocFFT_FFTPACK
!
! ------------------------------------------------------------------
!
      subroutine sel_pout_bwd_rocFFT_FFTPACK(iflag_GPU_FFT, Ncomp,      &
...
!      write(*,*) 'Total FFT clock', elapsed(1)
!
      end subroutine sel_pout_bwd_rocFFT_FFTPACK
!
! ------------------------------------------------------------------
!
      end module sel_pout_rocFFT_FFTPACK
!

...
!!      type(c_ptr) function c_link_stensor_dir_list_to_ctl(c_ctl)      &
!!     &           bind(C, NAME='c_link_stensor_dir_list_to_ctl')
!!      type(c_ptr) function c_link_atensor_dir_list_to_ctl(c_ctl)      &
...
!
      ...
      type(ctl_array_chara), save, private, target :: ast_dir_list
!
! ----------------------------------------------------------------------
!
      contains
...
!
     ...
     &           bind(C, NAME='c_link_xyz_dir_list_to_ctl')
      ...
      type(c_ptr), value, intent(in) :: c_ctl
!
      if(.not. allocated(xyz_dir_list%c_tbl))                           &
...
!
     ...
     &           bind(C, NAME='c_link_scalar_dir_list_to_ctl')
      ...
      type(c_ptr), value, intent(in) :: c_ctl
!
      if(.not. allocated(scl_dir_list%c_tbl))                           &
...
!
     ...
     &           bind(C, NAME='c_link_vector_dir_list_to_ctl')
      ...
      type(c_ptr), value, intent(in) :: c_ctl
!
      if(.not. allocated(vec_dir_list%c_tbl))                           &
...
!
     ...
     &           bind(C, NAME='c_link_stensor_dir_list_to_ctl')
      ...
      type(c_ptr), value, intent(in) :: c_ctl
!
      if(.not. allocated(str_dir_list%c_tbl))                           &
...
!
     ...
     &           bind(C, NAME='c_link_atensor_dir_list_to_ctl')
      ...
      type(c_ptr), value, intent(in) :: c_ctl
!
      if(.not. allocated(ast_dir_list%c_tbl))                           &

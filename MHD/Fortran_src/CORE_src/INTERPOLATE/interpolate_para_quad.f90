!
!     module interpolate_para_quad
!
!     Written by H. Matsui on Sep., 2006
!
!      subroutine s_interporate_scalar_para_20(np_smp, numnod, numele,  &
!     &          ie, v_org, num_dest_domain, istack_tbl_wtype_smp,      &
!     &          num_points, iele_gauss, itype_gauss, xi_gauss, vect)
!      subroutine s_interporate_vector_para_20(np_smp, numnod, numele,  &
!     &          ie, v_org, num_dest_domain, istack_tbl_wtype_smp,      &
!     &          num_points, iele_gauss, itype_gauss, xi_gauss, vect)
!      subroutine s_interporate_tensor_para_20(np_smp, numnod, numele,  &
!     &          ie, v_org, num_dest_domain, istack_tbl_wtype_smp,      &
!     &          num_points, iele_gauss, itype_gauss, xi_gauss, vect)
!
!      subroutine s_interporate_fields_para_20(np_smp, numnod, numele,  &
...
!
        ist = 4*np_smp*(ip-1)
        call s_interpolate_scalar_20(np_smp, numnod, numele,            &
     &      ie, v_org, istack_tbl_wtype_smp(ist), num_points,           &
     &      iele_gauss, itype_gauss, xi_gauss, vect)
!
      end do
!
      end subroutine s_interporate_scalar_para_20
!
!  ---------------------------------------------------------------------
!
      subroutine s_interporate_vector_para_20(np_smp, numnod, numele,   &
...
!
        ist = 4*np_smp*(ip-1)
        call s_interpolate_vector_20(np_smp, numnod, numele,            &
     &      ie, v_org, istack_tbl_wtype_smp(ist), num_points,           &
     &      iele_gauss, itype_gauss, xi_gauss, vect)
!
      end do
!
      end subroutine s_interporate_vector_para_20
!
!  ---------------------------------------------------------------------
!
      subroutine s_interporate_tensor_para_20(np_smp, numnod, numele,   &
...
!
        ist = 4*np_smp*(ip-1)
        call s_interpolate_tensor_20(np_smp, numnod, numele,            &
     &      ie, v_org, istack_tbl_wtype_smp(ist), num_points,           &
     &      iele_gauss, itype_gauss, xi_gauss, vect)
!
      end do
!
      end subroutine s_interporate_tensor_para_20
!
! ----------------------------------------------------------------------
! ----------------------------------------------------------------------
!
...
!
        ist = 4*np_smp*(ip-1)
        call s_interpolate_fields_20(np_smp, numnod, numele,            &
     &      ie, numdir, v_org, istack_tbl_wtype_smp(ist), num_points,   &
     &      iele_gauss, itype_gauss, xi_gauss, vect)
!
      end do
!
      end subroutine s_interporate_fields_para_20
!
! ----------------------------------------------------------------------
!
      end module interpolate_para_quad

!
!     module interpolate_fields_surf9
!
!     Written by H. Matsui on July, 2006
!
!      subroutine s_interpolate_fields_surf9(np_smp, numnod, numele, ie,&
...
!
!$omp parallel do                                                       &
!$omp& private(ist,ied,nd,ig,iele,isf,ld1,ld2,                          &
...
!$omp end parallel do
!
      end subroutine s_interpolate_fields_surf9
!
! ----------------------------------------------------------------------
!
      end module interpolate_fields_surf9

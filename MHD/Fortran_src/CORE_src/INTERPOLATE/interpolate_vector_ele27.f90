!>@file   interpolate_vector_ele27.f90
!!@brief  module interpolate_vector_ele27
!!
!!@author H. Matsui
...
!$omp end parallel do
!
      end subroutine itp_matvec_vector_surf9
!
! ----------------------------------------------------------------------
!
      subroutine itp_matvec_vector_ele27(np_smp, NP, v_org,             &
...
!
     ...
     &      + AM(ist+21) * v_org(3*i21-2) + AM(ist+22) * v_org(3*i22-2) &
     &      + AM(ist+23) * v_org(3*i23-2) + AM(ist+24) * v_org(3*i24-2) &
     &      + AM(ist+25) * v_org(3*i25-2) + AM(ist+26) * v_org(3*i26-2) &
     &      + AM(ist+27) * v_org(3*i27-2)
!
          vect(3*ig-1)                                                  &
     &      = AM(ist+ 1) * v_org(3* i1-1) + AM(ist+ 2) * v_org(3* i2-1) &
     &      + AM(ist+ 3) * v_org(3* i3-1) + AM(ist+ 4) * v_org(3* i4-1) &
     ...
     &      + AM(ist+21) * v_org(3*i21-1) + AM(ist+22) * v_org(3*i22-1) &
     &      + AM(ist+23) * v_org(3*i23-1) + AM(ist+24) * v_org(3*i24-1) &
     &      + AM(ist+25) * v_org(3*i25-1) + AM(ist+26) * v_org(3*i26-1) &
     &      + AM(ist+27) * v_org(3*i27-1)
!
          vect(3*ig  )                                                  &
     &      = AM(ist+ 1) * v_org(3* i1  ) + AM(ist+ 2) * v_org(3* i2  ) &
     &      + AM(ist+ 3) * v_org(3* i3  ) + AM(ist+ 4) * v_org(3* i4  ) &
     ...
     &      + AM(ist+21) * v_org(3*i21  ) + AM(ist+22) * v_org(3*i22  ) &
     &      + AM(ist+23) * v_org(3*i23  ) + AM(ist+24) * v_org(3*i24  ) &
     &      + AM(ist+25) * v_org(3*i25  ) + AM(ist+26) * v_org(3*i26  ) &
     &      + AM(ist+27) * v_org(3*i27  )
        end do
      end do
!$omp end parallel do
!
      end subroutine itp_matvec_vector_ele27
!
! ----------------------------------------------------------------------
!

...
!
      implicit none
!
      private :: s_interpolate_imark_8, s_interpolate_imark_20
      private :: s_interpolate_imark_27
!
! ----------------------------------------------------------------------
!
      contains
...
!
      if (nnod_4_ele .eq. 8)then
        call s_interpolate_imark_8(np_smp, numnod, numele,              &
     &      nnod_4_ele, ie, imark_org, istack_tbl_wtype_smp,            &
     &      num_points, iele_gauss, itype_gauss, imark)
      else if (nnod_4_ele .eq. 20)then
        call s_interpolate_imark_20(np_smp, numnod, numele,             &
     &      nnod_4_ele, ie, imark_org, istack_tbl_wtype_smp,            &
     &      num_points, iele_gauss, itype_gauss, imark)
      else if (nnod_4_ele .eq. 27)then
        call s_interpolate_imark_27(np_smp, numnod, numele,             &
     &      nnod_4_ele, ie, imark_org, istack_tbl_wtype_smp,            &
     &      num_points, iele_gauss, itype_gauss, imark)
      end if
!

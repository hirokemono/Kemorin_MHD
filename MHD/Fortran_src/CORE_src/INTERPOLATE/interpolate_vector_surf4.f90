!
!     module interpolate_vector_surf4
!
!     Written by H. Matsui on Sep., 2006
!
!      subroutine s_interpolate_vector_surf4(np_smp, numnod, numele, ie,&
...
!$omp end parallel do
!
      end subroutine s_interpolate_vector_surf4
!
! ----------------------------------------------------------------------
!
      end module interpolate_vector_surf4

!interpolate_matrix_surf8.f90
!     module interpolate_matrix_surf8
!
!     Written by H. Matsui on Sep., 2006
!
!      subroutine count_interpolate_mat_surf8(np_smp, istack_smp,       &
...
!
      end subroutine count_interpolate_mat_surf8
!
! ----------------------------------------------------------------------
!
      subroutine set_interpolate_mat_surf8(np_smp, numele, ie,          &
...
! ----------------------------------------------------------------------
!
      end module interpolate_matrix_surf8

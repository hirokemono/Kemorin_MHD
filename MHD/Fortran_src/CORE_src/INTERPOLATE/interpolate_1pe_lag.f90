!
!     module interpolate_1pe_lag
!
!     Written by H. Matsui on Sep., 2006
!
!      subroutine s_interpolate_scalar_27(np_smp, numnod, numele,       &
!     &          ie, v_org, istack_wtype_smp, num_points,               &
!     &          iele_gauss, itype_gauss, xi_gauss, vect)
!      subroutine s_interpolate_vector_27(np_smp, numnod, numele,       &
!     &          ie, v_org, istack_wtype_smp, num_points,               &
!     &          iele_gauss, itype_gauss, xi_gauss, vect)
!      subroutine s_interpolate_tensor_27(np_smp, numnod, numele,       &
!     &          ie, v_org, istack_wtype_smp, num_points,               &
!     &          iele_gauss, itype_gauss, xi_gauss, vect)
!      subroutine s_interpolate_fields_27(np_smp, numnod, numele,       &
...
!
      ist = 2*np_smp
      call s_interpolate_scalar_surf9(np_smp, numnod, numele, ie,       &
     &    v_org, istack_wtype_smp(ist), num_points, iele_gauss,         &
     &    itype_gauss, xi_gauss, vect)
!
      ist = 3*np_smp
      call s_interpolate_scalar_ele27(np_smp, numnod, numele, ie,       &
     &    v_org, istack_wtype_smp(ist), num_points, iele_gauss,         &
     &    xi_gauss, vect)
!
      end subroutine s_interpolate_scalar_27
!
! ----------------------------------------------------------------------
!
      subroutine s_interpolate_vector_27(np_smp, numnod, numele,        &
...
!
      ist = 2*np_smp
      call s_interpolate_vector_surf9(np_smp, numnod, numele, ie,       &
     &    v_org, istack_wtype_smp(ist), num_points, iele_gauss,         &
     &    itype_gauss, xi_gauss, vect)
!
      ist = 3*np_smp
      call s_interpolate_vector_ele27(np_smp, numnod, numele, ie,       &
     &    v_org, istack_wtype_smp(ist), num_points, iele_gauss,         &
     &    xi_gauss, vect)
!
      end subroutine s_interpolate_vector_27
!
! ----------------------------------------------------------------------
!
      subroutine s_interpolate_tensor_27(np_smp, numnod, numele,        &
...
!
      ist = 2*np_smp
      call s_interpolate_tensor_surf9(np_smp, numnod, numele, ie,       &
     &    v_org, istack_wtype_smp(ist), num_points, iele_gauss,         &
     &    itype_gauss, xi_gauss, vect)
!
      ist = 3*np_smp
      call s_interpolate_tensor_ele27(np_smp, numnod, numele, ie,       &
     &    v_org, istack_wtype_smp(ist), num_points, iele_gauss,         &
     &    xi_gauss, vect)
!
      end subroutine s_interpolate_tensor_27
!
! ----------------------------------------------------------------------
! ----------------------------------------------------------------------
!
...
!
      ist = 2*np_smp
      call s_interpolate_fields_surf9(np_smp, numnod, numele, ie,       &
     &    numdir, v_org, istack_wtype_smp(ist), num_points, iele_gauss, &
     &    itype_gauss, xi_gauss, vect)
!
      ist = 3*np_smp
      call s_interpolate_fields_ele27(np_smp, numnod, numele, ie,       &
     &    numdir, v_org, istack_wtype_smp(ist), num_points, iele_gauss, &
     &    xi_gauss, vect)
!
      end subroutine s_interpolate_fields_27
!
! ----------------------------------------------------------------------
!
      end module interpolate_1pe_lag

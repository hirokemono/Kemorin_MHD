!
!     module interpolate_scalar_edge3
!
!     Written by H. Matsui on Sep., 2006
!
!      subroutine s_interpolate_scalar_edge3(np_smp, numnod, numele, ie,&
...
!$omp end parallel do
!
      end subroutine s_interpolate_scalar_edge3
!
! ----------------------------------------------------------------------
!
      end module interpolate_scalar_edge3

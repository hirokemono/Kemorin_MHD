!
!     module interpolate_scalar_surf8
!
!     Written by H. Matsui on Sep., 2006
!
!      subroutine s_interpolate_scalar_surf8(np_smp, numnod, numele, ie,&
...
!$omp end parallel do
!
      end subroutine s_interpolate_scalar_surf8
!
! ----------------------------------------------------------------------
!
      end module interpolate_scalar_surf8

!
!     module interpolate_vector_edge2
!
!     Written by H. Matsui on Sep., 2006
!
!      subroutine s_interpolate_vector_edge2(np_smp, numnod, numele, ie,&
...
!$omp end parallel do
!
      end subroutine s_interpolate_vector_edge2
!
! ----------------------------------------------------------------------
!
      end module interpolate_vector_edge2

!set_nnod_for_ele_by_type_t.f90
!     module set_nnod_for_ele_by_type_t
!
!> @brief Set number of element from element type ID in mesh data
!
!      Written by H. Matsui on Sep., 2007
!
!      subroutine set_nnod_for_ele_by_etype_type(ierr)
...
!   --------------------------------------------------------------------
!
      subroutine set_nnod_for_ele_by_etype_type(node, ele, ierr)
!
      use t_geometry_data
...
!
      end subroutine set_nnod_for_ele_by_etype_type
!
!   --------------------------------------------------------------------
!
      end module set_nnod_for_ele_by_type_t

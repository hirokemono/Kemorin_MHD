...
!
!!      subroutine copy_wider_id_2_near_type                            &
!!     &         (numnod, near_tbl, near_tbl_wide)
...
!
!
      call alloc_num_4_near_nod(numnod, near_ele)
!
      near_ele%num_nod(1:numnod) = next_ele%nele_4_node(1:numnod)
      near_ele%istack_nod(0:numnod) = next_ele%istack_4_node(0:numnod)
!

...
!!
!!@verbatim
!!      subroutine write_step_fld_type_file_b(file_name, my_rank, fld_IO)
!!
!!      subroutine read_step_fld_type_file_b(file_name, my_rank, fld_IO)
!!      subroutine read_and_alloc_step_fld_t_b                          &
!!     &         (file_name, my_rank, fld_IO)
!!
!!      subroutine read_alloc_step_fld_t_head_b                         &
!!     &         (file_name, my_rank, fld_IO)
!!@endverbatim
!
      module field_type_IO_b
...
!
      close (id_phys_file)
!
      end subroutine write_step_fld_type_file_b
!
!------------------------------------------------------------------
!------------------------------------------------------------------
!
...
!
     ...
     &    fld_IO%fld_name, fld_IO%d_IO)
      close (id_phys_file)
!
      end subroutine read_step_fld_type_file_b
!
!------------------------------------------------------------------
!
      subroutine read_and_alloc_step_fld_t_b                            &
...
!
     ...
     &    fld_IO%fld_name, fld_IO%d_IO)
      close (id_phys_file)
!
      end subroutine read_and_alloc_step_fld_t_b
!
!------------------------------------------------------------------
!
      subroutine read_alloc_step_fld_t_head_b                           &
...
!
      call cal_istack_comp_IO(fld_IO)
!
      end subroutine read_alloc_step_fld_t_head_b
!
!------------------------------------------------------------------
!
      end module field_type_IO_b

...
!!     &         (id_rank, itp_tbl_org_IO, itp_tbl_dest_IO, bbuf_tbl)
...
!
      call write_interpolate_coefs_org_b(itp_tbl_org_IO, bbuf_tbl)
!
...
!
     ...
     &   (id_rank, itp_tbl_dest_IO, bbuf_tbl)
      if(bbuf_tbl%ierr_bin .gt. 0) return
!
      call write_interpolate_table_org_b                                &
     &   (id_rank, itp_tbl_org_IO, bbuf_tbl)
      if(bbuf_tbl%ierr_bin .gt. 0) return
      call write_interpolate_idx_org_b(itp_tbl_org_IO, bbuf_tbl)
!
...
!
     ...
     &   (id_rank, itp_tbl_org_IO, itp_tbl_dest_IO, bbuf_tbl)
      if(bbuf_tbl%ierr_bin .gt. 0) return
!
      call read_interpolate_coefs_org_b(bbuf_tbl, itp_tbl_org_IO)
!
...
!
     ...
     &   (bbuf_tbl, n_rank_file, itp_tbl_dest_IO)
      if(bbuf_tbl%ierr_bin .gt. 0) go to 99
!
      call read_interpolate_table_dest_b(bbuf_tbl, itp_tbl_dest_IO)
      if(bbuf_tbl%ierr_bin .ne. 0) go to 99
!
      call read_interpolate_domain_org_b                                &
     &   (bbuf_tbl, n_rank_file, itp_tbl_org_IO)
      if(bbuf_tbl%ierr_bin .gt. 0) go to 99
!
      call read_interpolate_table_org_b(bbuf_tbl, itp_tbl_org_IO)
      if(bbuf_tbl%ierr_bin .ne. 0) go to 99
!
      call read_interpolate_idx_org_b(bbuf_tbl, itp_tbl_org_IO)
  99  continue

...
!
      ...
      call write_interpolate_table_dest_b(id_rank, IO_itp_dest, bbuf1)
      if(bbuf1%ierr_bin .gt. 0) go to 99
!
...
!
     ...
     &   (IO_itp_dest, IO_itp_c_dest, bbuf1)
!
  99  continue
      call close_binary_file
      ierr = bbuf1%ierr_bin
...
!
     ...
     &   (bbuf1, IO_itp_dest, IO_itp_c_dest)
!
  99  continue
      call close_binary_file
      ierr = bbuf1%ierr_bin

!>@file  itp_table_dest_data_IO_b.f90
!!       module itp_table_dest_data_IO_b
!!
!!@author H. Matsui
...
!!      subroutine write_interpolate_idx_dest_b                         &
...
!!      subroutine read_interpolate_idx_dest_b                          &
...
!
      end subroutine write_interpolate_idx_dest_b
!
!-----------------------------------------------------------------------
!
      subroutine write_interpolate_coefs_dest_b                         &
...
!
      end subroutine read_interpolate_idx_dest_b
!
!-----------------------------------------------------------------------
!
      subroutine read_interpolate_coefs_dest_b                          &
...
!-----------------------------------------------------------------------
!
      end module itp_table_dest_data_IO_b

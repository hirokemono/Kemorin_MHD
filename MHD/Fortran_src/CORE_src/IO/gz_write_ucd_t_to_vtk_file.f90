!>@file   gz_write_ucd_t_to_vtk_file.f90
!!@brief  module gz_write_ucd_t_to_vtk_file
!!
!!@author H. Matsui
...
!!
!!@verbatim
!!      subroutine write_gz_ucd_t_2_para_vtk_file(my_rank, nprocs,      &
!!     &          istep, ucd)
!!
!!      subroutine write_ucd_type_2_gz_vtk(my_rank, istep, ucd)
!!      subroutine write_ucd_type_2_gz_vtk_phys(my_rank, istep, ucd)
!!      subroutine write_ucd_type_2_gz_vtk_grid(my_rank, ucd)
!!@endverbatim
!!
!!@param my_rank    subdomain ID
!!@param istep      Step number for VTK data
!
      module gz_write_ucd_t_to_vtk_file
!
      use m_precision
      use m_constants
...
!
      call delete_directory_name(ucd%header_name, fname_nodir)
      call add_int_suffix(istep, ucd%header_name, fname_tmp)
...
!
      call close_gzfile
!
      end subroutine write_gz_ucd_t_2_para_vtk_file
!
!  ---------------------------------------------------------------------
!
      subroutine write_ucd_type_2_gz_vtk(my_rank, istep, ucd)
...
!
!
      call set_parallel_ucd_file_name(ucd%header_name, iflag_vtk_gz,    &
...
!
     ...
     &    ucd%d_ucd)
!
      end subroutine write_ucd_type_2_gz_vtk
!
! -----------------------------------------------------------------------
!
      subroutine write_ucd_type_2_gz_vtk_phys(my_rank, istep, ucd)
...
!
!
      call set_parallel_ucd_file_name(ucd%header_name, iflag_vtd_gz,    &
     &    my_rank, istep, gzip_name)
!
      if(i_debug.gt.0 .or. my_rank.eq.0) write(*,*)                     &
...
!
      end subroutine write_ucd_type_2_gz_vtk_phys
!
! -----------------------------------------------------------------------
!
      subroutine write_ucd_type_2_gz_vtk_grid(my_rank, ucd)
...
!
!
      call set_parallel_grd_file_name(ucd%header_name, iflag_vtd_gz,    &
     &    my_rank, gzip_name)
!
      if(i_debug.gt.0 .or. my_rank.eq.0) write(*,*)                     &
...
!
     ...
     &    ucd%nnod, ucd%nele, ucd%nnod_4_ele, ucd%xx, ucd%ie)
!
      end subroutine write_ucd_type_2_gz_vtk_grid
!
! -----------------------------------------------------------------------
!
      end module gz_write_ucd_t_to_vtk_file

...
!
!
      write(id_file,'(2i15)') numnod_dummy, internal_node_dummy
!
      do i=1, numnod_dummy
        write(id_file,'(i15,1p3E25.15e3)')  globalnodid_dummy(i),       &
     &        xx_dummy(i,1:3)
      end do
!
...
!
      write(id_file,'(2i15)') numnod_dummy, internal_node_dummy
      do i = 1, numnod_dummy
        write(id_file,'(i15, 1p3e23.15)') i, ele_scalar_IO(i)
      end do
!
...
!
      write(id_file,'(2i15)') numnod_dummy, internal_node_dummy
      do i = 1, numnod_dummy
        write(id_file,'(i15,1p3e23.15)') i, ele_vector_IO(i,1:3)
      end do
!

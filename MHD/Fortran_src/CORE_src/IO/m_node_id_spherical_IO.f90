...
!
      subroutine allocate_idx_sph_1d2_IO
!
      allocate( idx_gl_2_IO(sph_IO1%nidx_sph(2),sph_IO1%ncomp_table_1d(2)) )
      idx_gl_2_IO =  0
!
...
!
      subroutine allocate_idx_sph_1d3_IO
!
      allocate( idx_gl_3_IO(sph_IO1%nidx_sph(3),sph_IO1%ncomp_table_1d(3)) )
      idx_gl_3_IO =  0
!

...
!!     &        (id_tbl_file, id_rank, itp_tbl_org_IO, itp_tbl_dest_IO)
...
!!
!!      subroutine read_each_itp_coef_table_a(id_tbl_file, id_rank,     &
!!     &          itp_tbl_org_IO, itp_tbl_dest_IO, ierr)
!!      subroutine read_each_itp_idx_table_a(id_tbl_file, id_rank,      &
!!     &          itp_tbl_org_IO, itp_tbl_dest_IO, ierr)
!!        integer(kind = kint), intent(in) :: id_tbl_file
!!        integer, intent(in) :: id_rank
...
!
     ...
     &   (id_tbl_file, id_rank, itp_tbl_dest_IO)
!
      call write_interpolate_table_org                                  &
     &   (id_tbl_file, id_rank, itp_tbl_org_IO)
      call write_interpolate_coefs_org(id_tbl_file, itp_tbl_org_IO)
!

!>@file  ucd_type_file_IO.f90
!!       module ucd_type_file_IO
!!
!! @author H. Matsui
...
!!
!!@verbatim
!!      subroutine write_ucd_type_file(my_rank, istep, ucd)
!!      subroutine write_udt_type_file(my_rank, istep, ucd)
!!      subroutine write_grd_type_file(my_rank, ucd)
!!
!!      subroutine read_udt_type_file(my_rank, istep, ucd)
!!      subroutine read_and_alloc_udt_type_params(my_rank, istep, ucd)
!!      subroutine read_and_alloc_udt_type_file(my_rank, istep, ucd)
...
!
!
      call set_parallel_ucd_file_name(ucd%header_name, iflag_ucd,       &
...
!
      ...
      close(id_ucd_file)
!
      end subroutine write_ucd_type_file
!
!-----------------------------------------------------------------------
!
      subroutine write_udt_type_file(my_rank, istep, ucd)
...
!
!
      call set_parallel_ucd_file_name(ucd%header_name, iflag_udt,       &
     &    my_rank, istep, file_name)
!
      if(my_rank.eq.0 .or. i_debug .gt. 0) write(*,*)                   &
...
!
      ...
      close(id_ucd_file)
!
      end subroutine write_udt_type_file
!
!-----------------------------------------------------------------------
!
      subroutine write_grd_type_file(my_rank, ucd)
...
!
!
      call set_parallel_grd_file_name(ucd%header_name, iflag_udt,       &
     &    my_rank, file_name)
!
      if(my_rank.eq.0 .or. i_debug .gt. 0) write(*,*)                   &
...
!-----------------------------------------------------------------------
!
      subroutine write_udt_type_fields(ucd)
!
      use udt_data_IO
!
      type(ucd_data), intent(in) :: ucd
...
!
      close(id_ucd_file)
!
      end subroutine read_udt_type_file
!
!-----------------------------------------------------------------------
!
      subroutine read_and_alloc_udt_type_params(my_rank, istep, ucd)
...
!
      end subroutine read_and_alloc_udt_type_params
!
! -----------------------------------------------------------------------
!
      subroutine read_and_alloc_udt_type_file(my_rank, istep, ucd)

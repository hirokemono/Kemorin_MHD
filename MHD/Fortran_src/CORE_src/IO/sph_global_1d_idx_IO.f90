...
!
      ...
      write(id_file,'(a)') '!'
      write(id_file,'(3i15)') nidx_sph_IO(1),                           &
     &                        ist_sph_IO(1), ied_sph_IO(1)
      do i = 1, nidx_sph_IO(1)
        write(id_file,'(i15,1pE25.15e3)') idx_gl_1_IO(i), r_gl_1_IO(i)
      end do
!
      write(id_file,'(a)') '!'
      write(id_file,'(a)') '! num. start and end global grids'
      ...
      write(id_file,'(a)') '!'
      write(id_file,'(3i15)') nidx_sph_IO(2),                           &
...
!
     ...
     &      '! num. of start and end global grids and modes'
      ...
      write(id_file,'(a)') '!'
      write(id_file,'(3i15)') nidx_sph_IO(3),                           &

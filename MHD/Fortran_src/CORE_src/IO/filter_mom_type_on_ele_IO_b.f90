...
!
!      subroutine read_base_filter_info_type_b(id_file, filter_conf)
!      subroutine write_base_filter_info_type_b(id_file, filter_conf)
!        integer(kind = kint), intent(in) :: id_file
!        type(filter_config_type), intent(inout) ::  filter_conf
!
!      subroutine read_elen_ele_type_b(id_file, nele_fmom, elen_ele)
!      subroutine write_elen_ele_type_b(id_file, nele_fmom, elen_ele)
!        integer(kind = kint), intent(in) :: id_file, nele_fmom
!        type(ele_mom_diffs_type), intent(in) :: elen_ele
!
!      subroutine read_filter_moms_ele_type_b(id_file, nele_fmom,       &
!     &          mom_ele)
!      subroutine write_filter_moms_ele_type_b(id_file, nele_fmom,      &
!     &          mom_ele)
!        integer(kind = kint), intent(in) :: id_file, nele_fmom
...
!
!
      call read_ref_filter_param_b(id_file, filter_conf%nf_type,        &
...
!
!
      call read_elens_ele_b(id_file, nele_fmom,                         &
...
!
!
      call write_elens_ele_b(id_file, nele_fmom,                        &
     &    elen_ele%moms%f_x2, elen_ele%moms%f_y2, elen_ele%moms%f_z2,   &
     &    elen_ele%moms%f_xy, elen_ele%moms%f_yz, elen_ele%moms%f_zx,   &
     &    elen_ele%diff%df_x2, elen_ele%diff%df_y2,                     &
     &    elen_ele%diff%df_z2, elen_ele%diff%df_xy,                     &

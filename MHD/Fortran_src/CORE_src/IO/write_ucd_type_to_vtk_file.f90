!>@file   write_ucd_type_to_vtk_file.f90
!!@brief  module write_ucd_type_to_vtk_file
!!
!!@author H. Matsui
...
!!
!!@verbatim
!!      subroutine write_ucd_t_2_para_vtk_file(my_rank, nprocs,         &
!!     &          istep, ucd)
!!
!!      subroutine write_udt_type_2_vtk_file(my_rank, istep, ucd)
!!      subroutine write_udt_type_2_vtk_phys(my_rank, istep, ucd)
!!      subroutine write_udt_type_2_vtk_grid(my_rank, ucd)
...
!
      module write_ucd_type_to_vtk_file
!
      use m_precision
      use m_constants
...
!
      close(id_vtk_file)
!
      end subroutine write_ucd_t_2_para_vtk_file
!
!  ---------------------------------------------------------------------
!  ---------------------------------------------------------------------
!
...
!
!
      call set_parallel_ucd_file_name(ucd%header_name, iflag_vtk,       &
...
!
     ...
     &    ucd%d_ucd)
!
      end subroutine write_udt_type_2_vtk_file
!
! -----------------------------------------------------------------------
!
      subroutine write_udt_type_2_vtk_phys(my_rank, istep, ucd)
...
!
!
      call set_parallel_ucd_file_name(ucd%header_name, iflag_vtd,       &
     &    my_rank, istep, file_name)
!
      if(my_rank.eq.0 .or. i_debug .gt. 0) write(*,*)                   &
...
!
      end subroutine write_udt_type_2_vtk_phys
!
! -----------------------------------------------------------------------
!
      subroutine write_udt_type_2_vtk_grid(my_rank, ucd)
...
!
!
      call set_parallel_grd_file_name(ucd%header_name, iflag_vtd,       &
     &    my_rank, file_name)
!
      if(my_rank.eq.0 .or. i_debug .gt. 0) write(*,*)                   &
...
!
     ...
     &    ucd%nnod, ucd%nele, ucd%nnod_4_ele, ucd%xx, ucd%ie)
!
      end subroutine write_udt_type_2_vtk_grid
!
! -----------------------------------------------------------------------
!
      end module write_ucd_type_to_vtk_file

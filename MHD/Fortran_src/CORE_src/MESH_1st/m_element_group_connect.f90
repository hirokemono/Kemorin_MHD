...
!
      ...
      call alloc_num_other_grp(num_mat, ele_grp_data1%surf)
!
...
!
      ...
      call alloc_num_other_grp(num_mat, ele_grp_data1%edge)
!
...
!
      ...
      call alloc_num_other_grp(num_mat, ele_grp_data1%node)
!

...
!
     ...
     &   (node1%numnod, ele1%numele, nnod_4_ele, nnod_4_surf, ie,       &
...
!
      ...
      call set_all_surfaces(ele1%numele, numsurf, nnod_4_ele,           &
...
!
      ...
      call set_surf_rotation_flag(ele1%numele, numsurf, nnod_4_ele,     &
...
!
     ...
     &    ele1%numele, nnod_4_ele, nnod_4_surf, ie,                     &
     &    sf_ele_tbl%istack_hash, sf_ele_tbl%iend_hash,                 &
     &    sf_ele_tbl%id_hash, sf_ele_tbl%iflag_hash)
!
!   set surface data

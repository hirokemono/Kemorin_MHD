...
!
!
      call cal_tensor_vec_prod_no_coef_smp(np_smp, node1%numnod,        &
...
!
      call cal_scalar_mag_vector_prod_smp(np_smp, node1%numnod,         &
...
!
!
      call cal_vec_scalar_prod_w_coef_smp(np_smp, node1%numnod,         &

...
!
     ...
     &    sph_IO%numdir_sph, sph_IO%nidx_sph, gz_flags%ierr_IO)
      if(gz_flags%ierr_IO .gt. 0) return
!
      call gz_read_mul_integer_b(gz_flags%iflag_bin_swap,               &
     &    sph_IO%numdir_sph, sph_IO%ist_sph, gz_flags%ierr_IO)
      if(gz_flags%ierr_IO .gt. 0) return
!
      call gz_read_mul_integer_b(gz_flags%iflag_bin_swap,               &
     &    sph_IO%numdir_sph, sph_IO%ied_sph, gz_flags%ierr_IO)
      if(gz_flags%ierr_IO .gt. 0) return
!
!
...
!
      call gz_read_mul_integer_b(gz_flags%iflag_bin_swap,               &
     &    sph_IO%nidx_sph(1), sph_IO%idx_gl_1, gz_flags%ierr_IO)
      if(gz_flags%ierr_IO .gt. 0) return
!

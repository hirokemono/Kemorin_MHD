...
!      write(*,*) '! truncation level for spherical harmonics'
      call gz_read_gl_resolution_sph_b(gz_flags, sph_IO)
      if(gz_flags%ierr_IO .gt. 0) return
!      write(*,*) '! segment ID for each direction'
      call gz_read_rank_4_sph_b(gz_flags, sph_IO)
      if(gz_flags%ierr_IO .gt. 0) return
!
!      write(*,*) '! global ID for each direction'
      call gz_read_rtp_gl_1d_table_b(gz_flags, sph_IO)
      if(gz_flags%ierr_IO .gt. 0) return
!
...
!      write(*,*) '! Group data bc_rtp_grp_IO'
      call gz_read_group_data_b(gz_flags, sph_grps_IO%bc_rtp_grp)
      if(gz_flags%ierr_IO .gt. 0) return
!      write(*,*) '! Group data radial_rtp_grp_IO'
      call gz_read_group_data_b(gz_flags, sph_grps_IO%radial_rtp_grp)
      if(gz_flags%ierr_IO .gt. 0) return
!      write(*,*) '! Group data theta_rtp_grp_IO'
      call gz_read_group_data_b(gz_flags, sph_grps_IO%theta_rtp_grp)
      if(gz_flags%ierr_IO .gt. 0) return
!      write(*,*) '! Group data zonal_rtp_grp_IO'
      call gz_read_group_data_b(gz_flags, sph_grps_IO%zonal_rtp_grp)
!
...
!
!      write(*,*) '! global ID for each direction'
      call gz_read_rj_gl_1d_table_b(gz_flags, sph_IO)
      if(gz_flags%ierr_IO .gt. 0) return
!
...
!
!      write(*,*) '! Group data'
      call gz_read_group_data_b(gz_flags, sph_grps_IO%radial_rj_grp)
      if(gz_flags%ierr_IO .gt. 0) return
      call gz_read_group_data_b(gz_flags, sph_grps_IO%sphere_rj_grp)
!

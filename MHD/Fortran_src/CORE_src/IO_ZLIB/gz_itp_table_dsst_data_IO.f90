!>@file  gz_itp_table_dsst_data_IO.f90
!!       module gz_itp_table_dsst_data_IO
!!
!!@author H. Matsui
...
!!      subroutine write_gz_itp_idx_dest                                &
!!     &         (FPz_f, IO_itp_dest, IO_itp_c_dest, zbuf)
...
!!     &         (FPz_f, IO_itp_dest, IO_itp_c_dest, zbuf)
!!      subroutine read_gz_itp_idx_dest                                 &
!!     &         (FPz_f, IO_itp_dest, IO_itp_c_dest, zbuf)
!!        character, pointer, intent(in) :: FPz_f
...
!
      end subroutine write_gz_itp_idx_dest
!
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
!
...
!-----------------------------------------------------------------------
!
      end module gz_itp_table_dsst_data_IO

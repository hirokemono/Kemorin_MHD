...
!!
!!@verbatim
!!      subroutine write_gz_each_itp_coef_table_b(FPz_f, id_rank,       &
!!     &          itp_tbl_org_IO, itp_tbl_dest_IO, zbuf_itp)
!!      subroutine write_gz_each_itp_idx_table_b(FPz_f, id_rank,        &
!!     &          itp_tbl_org_IO, itp_tbl_dest_IO, zbuf_itp)
...
!!      subroutine read_gz_each_itp_coef_table_b(FPz_f, id_rank,        &
!!     &          itp_tbl_org_IO, itp_tbl_dest_IO, zbuf_itp)
!!      subroutine read_gz_each_itp_idx_table_b(FPz_f, id_rank,         &
!!     &          itp_tbl_org_IO, itp_tbl_dest_IO, zbuf_itp)
!!        character, pointer, intent(in) :: FPz_f
!!        integer, intent(in) :: id_rank
...
!
     ...
     &   (FPz_f, id_rank, itp_tbl_org_IO, itp_tbl_dest_IO, zbuf_itp)
      if(zbuf_itp%ierr_zlib .gt. 0) return
!
      call write_gz_itp_coefs_org_b(FPz_f, itp_tbl_org_IO, zbuf_itp)
!
...
!
     ...
     &   (FPz_f, id_rank, itp_tbl_dest_IO, zbuf_itp)
      if(zbuf_itp%ierr_zlib .gt. 0) return
!
      call write_gz_itp_table_org_b                                     &
     &    (FPz_f, id_rank, itp_tbl_org_IO, zbuf_itp)
      if(zbuf_itp%ierr_zlib .gt. 0) return
      call write_gz_itp_idx_org_b(FPz_f, itp_tbl_org_IO, zbuf_itp)
!
...
!
      call read_gz_itp_coefs_org_b(FPz_f, zbuf_itp, itp_tbl_org_IO)
!
...
!
     ...
     &   (FPz_f, zbuf_itp, n_rank_file, itp_tbl_dest_IO)
      if(zbuf_itp%ierr_zlib .gt. 0) return
!
      call read_gz_itp_table_dest_b(FPz_f, zbuf_itp, itp_tbl_dest_IO)
      if(zbuf_itp%ierr_zlib .ne. 0) return
!
      call read_gz_itp_domain_org_b                                     &
     &    (FPz_f, zbuf_itp, n_rank_file, itp_tbl_org_IO)
      if(zbuf_itp%ierr_zlib .gt. 0) return
!
      call read_gz_itp_table_org_b(FPz_f, zbuf_itp, itp_tbl_org_IO)
      if(zbuf_itp%ierr_zlib .ne. 0) return
!
      call read_gz_itp_idx_org_b(FPz_f, zbuf_itp, itp_tbl_org_IO)
      if(zbuf_itp%ierr_zlib .ne. 0) return

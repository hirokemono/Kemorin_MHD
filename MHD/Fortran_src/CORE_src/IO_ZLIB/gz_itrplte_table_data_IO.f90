...
!!
!!@verbatim
!!      subroutine gz_write_each_itp_coef_table_a(FPz_f, id_rank,       &
!!     &          itp_tbl_org_IO, itp_tbl_dest_IO, zbuf_itp)
!!      subroutine gz_write_each_itp_idx_table_a(FPz_f, id_rank,        &
!!     &          itp_tbl_org_IO, itp_tbl_dest_IO, zbuf_itp)
...
!!      subroutine gz_read_each_itp_coef_table_a(FPz_f, id_rank,        &
!!     &          itp_tbl_org_IO, itp_tbl_dest_IO, zbuf_itp, ierr)
!!      subroutine gz_read_each_itp_idx_table_a(FPz_f, id_rank,         &
!!     &          itp_tbl_org_IO, itp_tbl_dest_IO, zbuf_itp, ierr)
!!        character, pointer, intent(inout) :: FPz_f
!!        integer, intent(in) :: id_rank
...
!
     ...
     &   (FPz_f, id_rank, itp_tbl_org_IO, zbuf_itp)
      call write_gz_itp_coefs_org(FPz_f, itp_tbl_org_IO, zbuf_itp)
!
...
!        write(*,*) 'read_gz_itp_domain_dest'
     ...
     &   (FPz_f, n_rank_file, itp_tbl_dest_IO, zbuf_itp)
!        write(*,*) 'read_gz_itp_table_dest'
      call read_gz_itp_table_dest(FPz_f, itp_tbl_dest_IO, zbuf_itp)
!
!        write(*,*) 'read_gz_itp_domain_org'
      call read_gz_itp_domain_org                                       &
     &   (FPz_f, n_rank_file, itp_tbl_org_IO, zbuf_itp)
!        write(*,*) 'read_gz_itp_coefs_org'
      call read_gz_itp_table_org(FPz_f, itp_tbl_org_IO, zbuf_itp)
      call read_gz_itp_coefs_org(FPz_f, itp_tbl_org_IO, zbuf_itp)
!

...
!!
!!@verbatim
!!      subroutine gz_write_itp_table_coef_file_b(gzip_name, id_rank,   &
!!     &          itp_tbl_org_IO, itp_tbl_dest_IO, ierr)
!!      subroutine gz_write_itp_table_idx_file_b(gzip_name, id_rank,    &
!!     &          itp_tbl_org_IO, itp_tbl_dest_IO, ierr)
...
!!
!!      subroutine gz_read_itp_table_coef_file_b(gzip_name, id_rank,    &
!!     &          itp_tbl_org_IO, itp_tbl_dest_IO, ierr)
!!      subroutine gz_read_itp_table_idx_file_b(gzip_name, id_rank,     &
!!     &          itp_tbl_org_IO, itp_tbl_dest_IO, ierr)
!!        character(len=kchara), intent(in) :: gzip_name
!!        integer, intent(in) :: id_rank

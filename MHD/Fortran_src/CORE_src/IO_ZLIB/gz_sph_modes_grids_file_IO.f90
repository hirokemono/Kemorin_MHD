...
!
      ...
      call read_geom_rtp_data_gz(sph_file%my_rank_IO,                   &
...
!
      call open_rd_gzfile_f(file_name)
      call read_spectr_modes_rj_data_gz(sph_file%my_rank_IO,            &
     &    sph_file%comm_IO, sph_file%sph_IO, sph_file%sph_grp_IO)
      call close_gzfile_f
!
...
!
      ...
      call write_geom_rtp_data_gz(sph_file%my_rank_IO,                  &
     &    sph_file%comm_IO, sph_file%sph_IO, sph_file%sph_grp_IO)
      call close_gzfile_f
!
...
!
      call open_wt_gzfile_f(file_name)
      call write_spectr_modes_rj_data_gz(sph_file%my_rank_IO,           &
     &    sph_file%comm_IO, sph_file%sph_IO, sph_file%sph_grp_IO)
      call close_gzfile_f
!

...
!
     ...
     &                = rlm%idx_global_rlm(1:nnod_rlm,i)
      end do
!
...
!
     ...
     &       = sph_rtp1%idx_gl_1d_rtp_r(1:rtp%nidx_rtp(1))
      rtp%idx_gl_1d_rtp_t(1:rtp%nidx_rtp(2))                            &
     &       = sph_rtp1%idx_gl_1d_rtp_t(1:rtp%nidx_rtp(2))
      rtp%idx_gl_1d_rtp_p(1:rtp%nidx_rtp(3),1)                          &
     &       = sph_rtp1%idx_gl_1d_rtp_p(1:rtp%nidx_rtp(3),1)

...
!!
!!@verbatim
!!      subroutine copy_rtp_nod_grp_to_IO(bc_rtp_grp)
!!      subroutine copy_rtp_radial_grp_to_IO(radial_rtp_grp)
!!      subroutine copy_rtp_theta_grp_to_IO(theta_rtp_grp)
!!      subroutine copy_rtp_zonal_grp_to_IO(zonal_rtp_grp)
!!      subroutine copy_rj_radial_grp_to_IO(radial_rj_grp)
!!      subroutine copy_rj_sphere_grp_to_IO(sphere_rj_grp)
!!@endverbatim
!
...
!
!
      num_bc_grp_rtp_IO =  bc_rtp_grp%num_grp
      call allocate_rtp_nod_grp_IO_stack
!
      if (bc_rtp_grp%num_grp .gt. izero) then
!
        ntot_bc_grp_rtp_IO = bc_rtp_grp%num_item
...
!
!
      num_radial_grp_rtp_IO =  radial_rtp_grp%num_grp
      call allocate_rtp_r_grp_IO_stack
!
      if (radial_rtp_grp%num_grp .gt. izero) then
!
        ntot_radial_grp_rtp_IO = radial_rtp_grp%num_item
...
!
!
      num_theta_grp_rtp_IO =  theta_rtp_grp%num_grp
      call allocate_rtp_t_grp_IO_stack
!
      if (theta_rtp_grp%num_grp .gt. izero) then
!
        ntot_theta_grp_rtp_IO = theta_rtp_grp%num_item
...
!
!
      num_radial_grp_rj_IO =  radial_rj_grp%num_grp
      call allocate_rj_r_grp_IO_stack
!
      if (radial_rj_grp%num_grp .gt. izero) then
!
        ntot_radial_grp_rj_IO = radial_rj_grp%num_item
...
!
!
      num_sphere_grp_rj_IO =  sphere_rj_grp%num_grp
      call allocate_rj_j_grp_IO_stack
!
      if (sphere_rj_grp%num_grp .gt. izero) then
!
        ntot_sphere_grp_rj_IO = sphere_rj_grp%num_item

...
!
      call set_vect_sph_address(ipol%base%i_magne,                      &
     &    itor%base%i_magne, idpdr%base%i_magne)
...
!
      call set_vect_sph_address(ipol%filter_fld%i_velo,                 &
...
!
     ...
     &    itor%diffusion%i_vp_diffuse, idpdr%diffusion%i_vp_diffuse)

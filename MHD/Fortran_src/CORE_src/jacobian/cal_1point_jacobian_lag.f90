!>@file  cal_1point_jacobian_lag.f90
!!       module cal_1point_jacobian_lag
!!
!!@author H. Matsui
!!@date   Programmed on Dec., 2008
!!@n      Modified by H. Matsui on Aug., 2015
!
!> @brief  obtain jacobian at one gauss point for lagrandge element
!!
!!@verbatim
...
!
     ...
     &      :: dnxi_1(num_t_lag,ntot_int_3d)
      real(kind = kreal), intent(in)                                    &
     &      :: dnei_1(num_t_lag,ntot_int_3d)
      real(kind = kreal), intent(in)                                    &
     &      :: dnzi_1(num_t_lag,ntot_int_3d)
!
...
!-----------------------------------------------------------------------
!
      end module cal_1point_jacobian_lag

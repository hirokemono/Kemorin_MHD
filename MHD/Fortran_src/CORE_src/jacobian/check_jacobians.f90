...
!
!      subroutine check_jacobians_trilinear(id_rank)
!      subroutine check_jacobians_triquad(id_rank)
!
      module check_jacobians
!
      use m_precision
...
!
!
      write(50+id_rank,*) 'integration point, an'
      do ii = 1, jac_3d%ntot_int
          write(50+id_rank,'(i16,1p20e25.14)') ii,                    &
...
!
      do ii = 1, jac_3d%ntot_int
        do nd = 1, 3
          write(50+id_rank,*) 'iele, integration point, dnx', ii, nd
          do iele = 1, ele%numele
            write(50+id_rank,'(i16,1p20e25.14)') iele,                  &
     &           (jac_3d%dnx(iele,k1,ii,nd), k1 = 1, num_t_linear)
          end do
        end do
      end do
!
      write(50+id_rank,*) 'iele, jacobian'
      do iele = 1, ele%numele
          write(50+id_rank,'(i16,1p20e25.14)') iele,                    &
...
!
!
      write(50+id_rank,*) 'integration point, aw'
      do ii = 1, jac_3d%ntot_int
          write(50+id_rank,'(i16,1p20e25.14)') ii,                      &
...
!
      do ii = 1, jac_3d%ntot_int
        do nd = 1, 3
          write(50+id_rank,*) 'iele, integration point, dwx', ii, nd
          do iele = 1, ele%numele
            write(50+id_rank,'(i16,1p20e25.14)') iele,                  &

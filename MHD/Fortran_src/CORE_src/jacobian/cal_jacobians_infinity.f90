...
!
          ix = int_start3(i0) + ii
!
          call s_cal_jacobian_3d_inf_linear(xjac(1,ix), axjac(1,ix),    &
...
!
          ix = int_start3(i0) + ii
!
          call s_cal_jacobian_3d_inf_quad(xjac_q(1,ix), axjac_q(1,ix),  &
...
!
          ix = int_start3(i0) + ii
!
          call s_cal_jacobian_3d_inf_lag(xjac_q(1,ix), axjac_q(1,ix),   &
     &      dwx(1,1,ix,1), dwx(1,1,ix,2), dwx(1,1,ix,3),                &
     &      dxidx_20(1,ix,1,1), dxidx_20(1,ix,2,1), dxidx_20(1,ix,3,1), &
     &      dxidx_20(1,ix,1,2), dxidx_20(1,ix,2,2), dxidx_20(1,ix,3,2), &
     &      dxidx_20(1,ix,1,3), dxidx_20(1,ix,2,3), dxidx_20(1,ix,3,3), &
...
!
          ix = int_start3(i0) + ii
!
          call s_cal_jacobian_3d_inf_l_quad(xjac_lq(1,ix),              &
     &      axjac_lq(1,ix),dmx(1,1,ix,1), dmx(1,1,ix,2), dmx(1,1,ix,3), &

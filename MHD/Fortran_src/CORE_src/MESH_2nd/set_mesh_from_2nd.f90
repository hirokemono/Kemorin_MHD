...
!      subroutine set_geometry_data_from_2nd(mesh, group)
!
      module set_mesh_from_2nd
!
      use m_precision
...
!
!
      private :: set_geometry_data_from_2nd
...
!-----------------------------------------------------------------------
!
      subroutine s_set_mesh_from_2nd(mesh, group)
!
      use t_mesh_data
...
!
!
      call set_geometry_data_from_2nd(mesh)
      call s_set_group_data_from_2nd(group)
!
      end subroutine s_set_mesh_from_2nd
!
!  ---------------------------------------------------------------------
!
      subroutine set_geometry_data_from_2nd(mesh)
!
      use m_geometry_data
      use t_mesh_data
!
...
!
!
      call copy_node_comm_tbl_from_2nd(mesh%nod_comm)
!
      call copy_node_geometry_from_2nd(mesh%node)
!
      call copy_element_connect_from_2nd(mesh%ele)
...
!-----------------------------------------------------------------------
!
      subroutine copy_node_comm_tbl_from_2nd(nod_comm)
!
...
!-----------------------------------------------------------------------
!
      subroutine copy_node_geometry_from_2nd(node)
!
...
!------------------------------------------------------------------
!
      subroutine copy_element_connect_from_2nd(ele)
!
      use m_geometry_parameter
      use m_geometry_data
      use t_geometry_data

!
!      module set_2nd_nod_comm_tbl_4_IO
!
!     Written by H. Matsui on Aug., 2007
!
!      subroutine copy_2nd_node_comm_tbl_from_IO
!      subroutine copy_2nd_node_comm_tbl_to_IO(my_rank)
!
!      subroutine copy_2nd_node_import_from_IO
!      subroutine copy_2nd_node_import_to_IO(my_rank)
!
      module set_2nd_nod_comm_tbl_4_IO
!
      use m_precision
...
!
     ...
     &    item_import_2, item_export_2, item_import_IO, item_export_IO)
!
      call deallocate_comm_item_IO
!
      end subroutine copy_2nd_node_comm_tbl_from_IO
!
!-----------------------------------------------------------------------
!
      subroutine copy_2nd_node_comm_tbl_to_IO(my_rank)
...
!
     ...
     &    item_import_IO, item_export_IO, item_import_2, item_export_2)
!
      end subroutine copy_2nd_node_comm_tbl_to_IO
!
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
!
...
!
      ...
      call allocate_2nd_nod_export_num
!
      call copy_num_import(num_neib_2, id_neib_2,                     &
     &    istack_import_2, istack_export_2,                           &
     &    ntot_import_2, ntot_export_2,                               &
...
!
      call deallocate_comm_item_IO
!
      end subroutine copy_2nd_node_import_from_IO
!
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
!
...
!
     ...
     &    ntot_import_IO, ntot_export_IO, id_neib_2, istack_import_2)
!
      call allocate_comm_item_IO
!
      call copy_communication_item(ntot_import_IO, ntot_export_IO,      &
     &    item_import_IO, item_export_IO, item_import_2, item_export_2)
!
      end subroutine copy_2nd_node_import_to_IO
!
!-----------------------------------------------------------------------
!
      end module set_2nd_nod_comm_tbl_4_IO

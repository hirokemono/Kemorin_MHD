...
!
!
      num_neib_edge_2 = num_neib_domain_IO
!
      call allocate_2nd_edge_neib_id
      call allocate_2nd_edge_import_num
      call allocate_2nd_edge_export_num
!
      call copy_num_communication(num_neib_edge_2, id_neib_edge_2,      &
     &    istack_import_edge_2, istack_export_edge_2,                   &
     &    ntot_import_edge_2, ntot_export_edge_2,                       &
     &    id_neib_domain_IO, istack_import_IO, istack_export_IO)
      call copy_num_import_export(num_neib_edge_2,                      &
     &    num_import_edge_2, num_export_edge_2,                         &
     &    istack_import_edge_2, istack_export_edge_2)
!
      call allocate_2nd_edge_import_item
      call allocate_2nd_edge_export_item
!
      call copy_communication_item(ntot_import_edge_2,                  &
     &    ntot_export_edge_2, item_import_edge_2, item_export_edge_2,   &
...
!
      my_rank_IO = my_rank
      num_neib_domain_IO = num_neib_edge_2
!
...
!
     ...
     &    id_neib_edge_2, istack_import_edge_2, istack_export_edge_2)
!
      call allocate_comm_item_IO
!
      call copy_communication_item(ntot_import_IO, ntot_export_IO,      &
     &    item_import_IO, item_export_IO,                               &
     &    item_import_edge_2, item_export_edge_2)
!
...
!
      ...
      call allocate_2nd_edge_export_num
!
      call copy_num_import(num_neib_edge_2, id_neib_edge_2,             &
     &    istack_import_edge_2, istack_export_edge_2,                   &
     &    ntot_import_edge_2, ntot_export_edge_2,                       &
...
!
     ...
     &    ntot_import_IO, ntot_export_IO,                               &
     &    id_neib_edge_2, istack_import_edge_2)
!
      call allocate_comm_item_IO
!
      call copy_communication_item(ntot_import_IO, ntot_export_IO,      &

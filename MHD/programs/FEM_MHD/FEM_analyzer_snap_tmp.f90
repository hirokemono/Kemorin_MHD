...
!
     ...
     &     (iphys%i_SGS_div_m_flux, ifld_diff%i_mom_flux,               &
     &      ifld_diff%i_lorentz, MHD_step1%time_d%dt,                   &
     ...
     &      fem_int1%jacobians%jac_3d, fem_int1%jacobians%jac_sf_grp, rhs_tbl1, &
...
!
     ...
     &        'lead ', trim(fhd_SGS_vp_induct)
        call cal_sgs_uxb_2_monitor(icomp_sgs%i_induction,               &
     &      iphys_elediff%i_velo, MHD_step1%time_d%dt,                  &
     ...
     &      fem_int1%jacobians%jac_3d, rhs_tbl1, FEM1_elen, filtering1,         &
...
!
     ...
     &      iphys, fem_int1%jacobians%jac_3d, rhs_tbl1, mhd_fem1_wk, fem1_wk,   &
     &      f1_nl, nod_fld1)
      end if
!
!$omp parallel

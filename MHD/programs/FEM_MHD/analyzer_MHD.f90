...
!
     ...
     &    SGS_MHD_wk1%FEM_SGS_wk, MHD_CG1%MHD_mat, MHD_CG1%MGCG_WK,     &
...
!
      do
!  Time evolution
        call FEM_analyze_MHD(MHD_files1, femmesh1, ele_mesh1,           &
     &      MHD_step1, visval, retval, SGS_MHD_wk1, fem_ucd1, fem_sq1)
!
!     ---------------------
!
!  Visualization

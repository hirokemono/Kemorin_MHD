...
!
     ...
     &   (MHD_files1, MHD_step1, femmesh1, FEM_MHD1%ele_mesh, FEM_MHD1%iphys,   &
     &    FEM_MHD1%field, FEM_model1, MHD_CG1%ak_MHD, FEM_SGS1,         &
     &    SGS_MHD_wk1, range1, fem_ucd1, fem_sq1, FEM_MHD1%label_sim)
!
      call init_visualize(femmesh1, FEM_MHD1%ele_mesh, FEM_MHD1%field)
!
...
!  Read and generate fields
     ...
     &      femmesh1, FEM_MHD1%ele_mesh, FEM_MHD1%iphys, FEM_model1,            &
     &      MHD_CG1%ak_MHD, MHD_step1, visval, FEM_SGS1, SGS_MHD_wk1,   &
     &      FEM_MHD1%field, fem_ucd1, fem_sq1)
!
!  Visualization
        if (visval.eq.0) then

...
!
      ...
      call count_rectangle_shell_size(c_sphere1, csph_mesh1)
!
...
!
      call construct_rect_sphere_mesh(csph_mesh1, c_sphere1)
!
!   construct coarse grid
!
      call construct_coarse_rect_mesh(csph_mesh1, c_sphere1)
!

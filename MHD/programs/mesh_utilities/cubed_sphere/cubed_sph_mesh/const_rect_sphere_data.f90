...
!
     ...
     &     csph_p%num_hemi, csph_p%ncube_vertical,                      &
     &     rprm_csph, inod_start, csph_p, c_sphere)
!
        write(*,*) 'projection'
...
!
     ...
     &             csph_mesh%nnod_cb_sph, inod_start
         call set_center_rect_quad(id_q_mesh, csph_p%num_hemi,          &
     &       csph_p%ncube_vertical, csph_p%x_node, csph_p%x_edge,       &
     &       csph_p%v_node, csph_p%v_edge, inod_start, c_sphere)
!
...
!
     ...
     &      csph_p%ncube_vertical, rprm_csph, c_sphere)

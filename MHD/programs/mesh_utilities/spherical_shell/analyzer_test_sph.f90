...
!
     ...
     &     (sph1%sph_rtp%nnod_rtp, sph_rtm1%nnod_rtm,                   &
     &      sph_rlm1%nnod_rlm, sph1%sph_rj%nnod_rj)
      call allocate_real_sph_test                                       &
     &   (NB, sph1%sph_rtp%nnod_rtp, sph_rtm1%nnod_rtm,                 &
     &        sph_rlm1%nnod_rlm, sph1%sph_rj%nnod_rj)
!
...
!
     ...
     &     (itype, sph1%sph_rtp%nnod_rtp, sph_rtm1%nnod_rtm,            &
     &      sph_rlm1%nnod_rlm, sph1%sph_rj%nnod_rj,                     &
     &      sph1%sph_rtp%idx_global_rtp, sph_rtm1%idx_global_rtm,       &

...
!
     ...
     &           sph_rtp1%idx_global_rtp(inod,1:3),                     &
     &           sph_rtp1%idx_gl_1d_rtp_r(kr),                          &
     &           sph_rtp1%idx_gl_1d_rtp_t(lth),                         &
     &           sph_rtp1%idx_gl_1d_rtp_p(mphi,1:2)
            end if
          end do
        end do
      end do

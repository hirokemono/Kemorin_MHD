...
!
      ...
      call input_control_SPH_MHD_psf(MHD_files1, SPH_model1%bc_IO,      &
     &    DNS_MHD_ctl1, SPH_MHD1%sph, SPH_MHD1%comms, SPH_MHD1%groups,  &
     &    SPH_MHD1%fld, FEM_d1%field, MHD_step1,                        &
     &    SPH_model1%MHD_prop, SPH_model1%MHD_BC,                       &
...
!
      ...
      call init_visualize_surface(femmesh1, ele_mesh1, FEM_d1%field)
!

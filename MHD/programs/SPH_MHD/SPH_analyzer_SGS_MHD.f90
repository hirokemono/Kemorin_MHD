...
!!
!!@verbatim
!!      subroutine SPH_initialize_SGS_MHD(MHD_files, bc_IO, iphys,      &
!!     &          MHD_step, SPH_model, sph_MHD_bc, SPH_SGS, SPH_MHD)
...
!
     ...
     &   (SPH_SGS%SGS_par, SPH_MHD%sph, SPH_model%MHD_prop,             &
...
!*
     ...
     &    SPH_MHD%ipol, SPH_MHD%itor, trns_WK1,                         &
     &    SPH_SGS%SGS_par, SPH_SGS%dynamic, SPH_MHD%fld)
!
...
!*
     ...
     &     (SPH_SGS%SGS_par%model_p, SPH_MHD%sph,                       &
     &      SPH_MHD%comms, r_2nd, SPH_model%MHD_prop,                   &

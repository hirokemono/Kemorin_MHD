...
!!     &          sph_fst_IO, SPH_model, SPH_SGS, SPH_WK)
...
!!     &          MHD_step, sph_fst_IO, SPH_SGS, SPH_WK)
!!        type(MHD_file_IO_params), intent(in) :: MHD_files
...
!
     ...
     &   (MHD_files, SPH_model, SPH_SGS%sph, SPH_SGS%ipol, MHD_step,    &
     &    SPH_SGS%fld, sph_fst_IO)
...
!
     ...
     &    SPH_model%sph_MHD_bc, SPH_SGS%sph%sph_rj, SPH_WK%r_2nd,       &
...
!
     ...
     &   (SPH_SGS%sph%sph_rj, SPH_WK%r_2nd, SPH_model%MHD_prop,         &
...
!
      ...
      call sel_explicit_sph_SGS_MHD(i_step, MHD_step%time_d%dt,         &
     &    SPH_model%MHD_prop, SPH_model%sph_MHD_bc, SPH_SGS)
!*
...
!
     ...
     &   (MHD_step%time_d%dt, SPH_SGS%sph%sph_rj, SPH_WK%r_2nd,         &
     &    SPH_model%MHD_prop, SPH_model%sph_MHD_bc, SPH_WK%trans_p%leg, &
     &    SPH_SGS%ipol, SPH_WK%MHD_mats, SPH_SGS%fld)
      if(iflag_debug .gt. 0) write(*,*) 'rot_self_filter_buoyancy_sph'
      call rot_self_filter_buoyancy_sph                                 &
     &   (SPH_SGS%sph%sph_rj, SPH_SGS%ipol, SPH_model%MHD_prop,         &
     &    SPH_model%sph_MHD_bc%sph_bc_U, SPH_SGS%fld)
...
!*
     ...
     &      MHD_step%time_d, MHD_step%rst_step, SPH_SGS, sph_fst_IO)
      end if
!

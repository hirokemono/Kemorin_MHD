...
!!     &         (MHD_files, FEM_dat, MHD_step, sph_fst_IO, SPH_model,  &
...
!!      subroutine SPH_analyze_SGS_MHD(MHD_files, iflag_finish,         &
...
!
     ...
     &    SPH_model%sph_MHD_bc, SPH_MHD%sph, SPH_WK%r_2nd,              &
     &    SPH_WK%trans_p%leg, SPH_model%refs, SPH_WK%MHD_mats)
!*
...
!
      ...
      call sel_explicit_sph_SGS_MHD(MHD_step%time_d, SPH_SGS%SGS_par,   &
     &    SPH_MHD%sph, SPH_model%MHD_prop, SPH_model%sph_MHD_bc,        &
...
!*
     ...
     &   (MHD_step%time_d%i_time_step, SPH_WK%r_2nd, SPH_model,         &
     &    SPH_WK%trans_p, SPH_WK%trns_WK, SPH_SGS, SPH_MHD,             &
     &    m_SR%SR_sig, m_SR%SR_r)
...
!*
     ...
     &     (MHD_step%time_d%i_time_step, MHD_files, MHD_step%time_d,    &

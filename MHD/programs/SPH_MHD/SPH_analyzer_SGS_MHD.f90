...
!!     &          iphys, MHD_step, MHD_prop, sph_MHD_bc, SPH_SGS)
!!      subroutine SPH_analyze_SGS_MHD                                  &
!!     &         (i_step, MHD_files, MHD_prop, sph_MHD_bc, iflag_finish,&
!!     &          MHD_step, SPH_SGS)
...
!
     ...
     &   (SPH_SGS%SGS_par%model_p, MHD_prop, sph_MHD_bc,                &
...
!
     ...
     &    MHD_prop%ref_param_T, sph_MHD_bc%sph_bc_B,                    &
...
!*
     ...
     &    ipol, itor, trns_WK1, SPH_SGS%SGS_par, SPH_SGS%dynamic,       &
     &    rj_fld1)
!

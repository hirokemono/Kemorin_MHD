...
!
        ...
        call set_inod_4_newdomain_filter(nprocs_2nd, newfil_p, nod_d_grp,       &
     &      org_node, org_ele, newmesh%node, filter_node,                       &
...
!
     ...
     &    itl_nod_part, newmesh%nod_comm, filter_node, comm_part)
!
...
!      write(*,*) 'set_inod_4_newdomain_filter'
     ...
     &    newmesh%node, filter_node, itl_nod_part, fil_coef,            &
...
!
     ...
     &   (newfil_p%new_filter_coef_head, nprocs_2nd, itl_nod_part,      &
     &    newmesh%nod_comm, filter_node, comm_part)
!
      call dealloc_internal_4_part(itl_nod_part)
      call dealloc_num_4_subdomain(itl_nod_part)
      call dealloc_id_4_subdomain(itl_nod_part)

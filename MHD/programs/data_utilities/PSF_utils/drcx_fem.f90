...
!
          call set_xplane_graph_position(numnod_psf, numele_psf,        &
...
!
     ...
     &                + mod(id_comp_4_plot(iw),10)
            if (   id_comp_4_plot(iw) .eq. icomp_VECTOR                 &
              ...
              call set_xplane_vector(id_comp_4_plot(iw), numnod_psf,    &
...
!
              ...
              call set_zplane_scalar(nnod_pg, d_nod_psf(1,ist_comp),    &
     &            cont_pg)
!
...
!
     ...
     &               field_label_4_plot(iw))
            ...
            call drcap_xplane(npanel_window, iw, xx_psf(1,1) )
!
            if (   id_comp_4_plot(iw) .eq. icomp_VECTOR                 &
              .or. id_comp_4_plot(iw) .eq. icomp_SPH_VECTOR             &
              .or. id_comp_4_plot(iw) .eq. icomp_CYL_VECTOR) then

...
!
     ...
     &    SPH_SGS%sph%sph_rj, SPH_SGS%ipol,                             &
     &    SPH_SGS%fld, MHD_step%init_d)
      call copy_time_data(MHD_step%init_d, MHD_step%time_d)
!
      call back_trans_4_correlate(SPH_SGS%sph, SPH_SGS%comms,           &
     &    ref_rj_fld, SPH_SGS%fld, SPH_WK%trans_p,                      &
...
!
     ...
     &   SPH_SGS%sph%sph_params, SPH_WK%monitor%pwr)
!

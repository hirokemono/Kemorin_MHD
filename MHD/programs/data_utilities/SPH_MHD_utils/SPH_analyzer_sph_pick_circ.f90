...
!
     ...
     &   (isix, SPH_SGS%sph%sph_rtp%nnod_rtp)
!
...
!
     ...
     &   (SPH_SGS%sph%sph_params%l_truncation, SPH_SGS%sph%sph_rtp,     &
     &     SPH_SGS%sph%sph_rj, cdat)
!
...
!
     ...
     &    MHD_step1%rst_step, SPH_SGS%sph, SPH_SGS%ipol, SPH_SGS%fld,   &
     &    MHD_step1%init_d)
...
!*
      ...
      call set_MHD_evolved_boundaries(MHD_step1%time_d, SPH_SGS%sph,    &
     &    SPH_model%MHD_prop, SPH_model%sph_MHD_bc)
!
...
!*
     ...
     &   (SPH_SGS%sph%sph_rj, SPH_SGS%fld, cdat)

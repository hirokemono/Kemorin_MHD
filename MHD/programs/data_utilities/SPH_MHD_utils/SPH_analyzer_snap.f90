...
!!
!!@verbatim
!!      subroutine SPH_init_sph_snap(MHD_files, bc_IO,                  &
!!     &          iphys, SPH_model, sph_MHD_bc, SPH_SGS, SPH_MHD)
...
!
      call set_sph_SGS_MHD_sprctr_data(SPH_SGS%SGS_par, SPH_MHD%sph,    &
     &    SPH_model%MHD_prop, SPH_MHD%ipol, SPH_MHD%idpdr,              &

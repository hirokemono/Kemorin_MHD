...
!
      ...
      private :: alloc_tave_sph_spectr, dealloc_tave_sph_spectr
!
!   --------------------------------------------------------------------
!
      contains
...
!
      call alloc_tave_sph_spectr(sph_IN1, WK_tave1)
!
...
!
      call alloc_sph_espec_name(sph_IN2)
      call sel_read_sph_spectr_name(FPz_f1, id_read_rms, flag_gzip1,    &
     &    sph_IN2%nfield_sph_spec, sph_IN2%num_labels,                  &
     &    sph_IN2%ncomp_sph_spec, sph_IN2%ene_sph_spec_name, zbuf1)
...
!
      call dealloc_tave_sph_spectr(WK_tave1)
...
!   --------------------------------------------------------------------
!
      subroutine alloc_tave_sph_spectr(sph_IN, WK_tave)
!
      type(read_sph_spectr_data), intent(in) :: sph_IN
      type(vol_spectr_ave_sigma_work), intent(inout) :: WK_tave
...
!
      end subroutine alloc_tave_sph_spectr
!
!   --------------------------------------------------------------------
!
      subroutine dealloc_tave_sph_spectr(WK_tave)
!
      type(vol_spectr_ave_sigma_work), intent(inout) :: WK_tave
!
...
!
      end subroutine dealloc_tave_sph_spectr
!
!   --------------------------------------------------------------------
!
...
!
      ...
      do i = 1, sph_IN%ntot_sph_spec
        ...
        write(*,*) 'Mode, Time_average, Standard_deviation, R.M.S.'
        do l = 0, sph_IN%ltr_sph
          write(*,'(1p2e23.15e3,2a)') sph_IN%i_mode(l),                &

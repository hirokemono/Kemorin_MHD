...
!
       do ix = 1, c_size1%nx_all
         pcor1%x_out(ix) = mgd_mesh_pm%merged%node%xx(ix,1)
       end do
       do iy = 1, c_size1%ny_all
         pcor1%y_out(iy)                                                &
     &     = mgd_mesh_pm%merged%node%xx(c_size1%nx_all*iy,2)
       end do
...
!
     ...
     &    pcor1%x_out, pcor1%y_out, pcor1%z_out, pcor1%phys_d1,         &
     &    pcor1%ave_data, pcor1%rms_data, pcor1%sig_data,               &
     &    pcor1%phys_d2, pcor1%ave_data2, pcor1%rms_data2,              &
     &    pcor1%sig_data2, pcor1%crt_data, pcor1%rms_ratio)
!

...
!
     ...
     &       (id_ctl_4_MG_test, hd_MG_test_ctl, c_buf1)
...
!
      ...
      call init_platforms_labels(hd_platform, MGtest_plt%MGtest_plt)
...
!
      call calypso_mpi_bcast_one_int(test_MG_ctl%i_MG_test_ctl, 0)
!

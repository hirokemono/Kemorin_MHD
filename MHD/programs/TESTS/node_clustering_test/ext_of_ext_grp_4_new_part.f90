!>@file   ext_of_ext_grp_4_new_part.f90
!!@brief  module ext_of_ext_grp_4_new_part
!!
!!@author H. Matsui
...
!!@endverbatim
!
      module ext_of_ext_grp_4_new_part
!
      use m_precision
      use m_constants
      use t_geometry_data
...
!
     ...
     &                        :: external_name = 'new_ext_of_ext'
!
      private :: cnt_ext_of_ext_grp_4_new_part
      private :: set_ext_of_ext_grp_4_new_part
!
! ----------------------------------------------------------------------
!
      contains
...
! ----------------------------------------------------------------------
!
      subroutine const_ext_of_ext_grp_new_part(idomain_new, inod_new, &
     &          node, neib_nod, part_param, part_grp, ext_grp)
!
...
!
!
      call cnt_ext_of_ext_grp_4_new_part(idomain_new, inod_new, node, neib_nod, part_grp,      &
...
!
      end subroutine const_ext_of_ext_grp_new_part
!
! ----------------------------------------------------------------------
! ----------------------------------------------------------------------
!
...
!
      end subroutine cnt_ext_of_ext_grp_4_new_part
!
! ----------------------------------------------------------------------
!
...
!
      end subroutine set_ext_of_ext_grp_4_new_part
!
! ----------------------------------------------------------------------
!
      end module ext_of_ext_grp_4_new_part

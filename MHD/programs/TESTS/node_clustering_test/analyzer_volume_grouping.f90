...
!
     ...
     &    num_nod_grp_yz, idomain_nod_grp_yz, sub_x%n_block,            &
     &    yz_part_grp%num_grp, yz_part_grp%istack_grp,                  &
...
!
     ...
     &    istack_block_x, sub_x%istack_vol, part_grp%num_grp,           &
     &    part_grp%istack_grp)

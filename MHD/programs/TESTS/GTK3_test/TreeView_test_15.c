...
static GtkWidget *create_window(GtkWidget *tree_view, GtkWidget *window)
{
	GtkWidget *vbox;
	GtkWidget *hbox;
	GtkWidget *button;
...
static void create_tree_view_window(GtkButton *button, gpointer user_data)
{
	...
	create_field_tree_view(tree_view);
	/* ウィンドウ作成 */
	
	unused_field_tree_view = gtk_tree_view_new();
	
	create_unused_field_tree_view(unused_field_tree_view);
	...
	create_window(tree_view, window);

...
!
      ...
      type(legendre_polynomials), private :: leg_t
!
...
!
      j = l*(l+1) + m
      call init_sph_indices(l, leg_t, sph_t)
...
!
      ...
      do inum = 1, num
        ...
        call spheric_1point                                             &
     &     (node%theta(inod), node%phi(inod), leg_t, sph_t)
!
        inod_bc(inum) = inod
...
!
      ...
      call finalize_sph_indices(leg_t, sph_t)
!

!>@file   test_rtp_select_FFT.f90
!!@brief  module test_rtp_select_FFT
!!
!!@author H. Matsui
...
!! ----------------------------------------------------------------------
!!  begin FFT_test_ctl
!!    output_file_name    'rtp_FFT_test.dat'
!!
!!    FFT_length_ctl         128
!!    num_series_ctl          24
...
!
!
      write(*,'(a)') '-----  Test FFT with outer series loop -----'
!
...
!
      stop 'finish'
      end program test_rtp_select_FFT

...
!
!
      write(*,'(a)') '-----  Test rtp rocFFT and FFTPACK -----'
!
...
!
     ...
     & .and. ((fft_test_p1%iflag_FFT/10) .ne. (iflag_rocFFT/10))) then
      ...
      write(test_name,'(2a)') find_FFT_label(fft_test_p1%iflag_FFT),    &
     &                       '_FFTPACK5'
!
...
!   Initialize Fourier transform
      start = OMP_GET_WTIME()
      call init_pout_rocFFT_FFTPACK(ft1%nfld, Ncomp_GPU, Ncomp_CPU,     &
...
!
!   Forward transform
        call sel_pout_fwd_rocFFT_FFTPACK(fft_test_p1%iflag_FFT,         &
     &      ft1%nfld, fwd, WK_rocFFT, WK_FFTPACK_T, ft1%s_k(1,1),       &
     &      elapsed(2:5))
!
        start = OMP_GET_WTIME()
!$omp parallel workshare
...
!
!   Backword transform
        call sel_pout_bwd_rocFFT_FFTPACK(fft_test_p1%iflag_FFT,         &
     &      ft1%nfld, bwd, WK_rocFFT, WK_FFTPACK_T, ft1%f_x(1,1),       &
     &      elapsed(2:5))
...
!   Finalize
      start = OMP_GET_WTIME()
      call finalize_rocFFT_FFTPACK(fwd, bwd, WK_rocFFT, WK_FFTPACK_T)
...
!
      stop 'finish'
!
      end program test_rocFFT_FFTPACK_rtp
!
! mpif90 --offload-arch=gfx942 -mcmodel=medium -mcmodel=medium -O3 -g -fopenmp -fopenmp-target-fast  -I. -I/home/hrmatsui/src_kemo/work -I/opt/rocm-7.2.0/include/hipfort/amdgcn -DPNG_OUTPUT -DZLIB_IO -DFFTW3 -D_AMD_ROCM_ -o ./test_rocFFT_FFTPACK_rtp test_rocFFT_FFTPACK_rtp.f90 /home/hrmatsui/src_kemo/work/m_FFT_size.o /home/hrmatsui/src_kemo/work/t_fft_test_data.o -L/home/hrmatsui/src_kemo/work -lkemo_core -lkemo_c -lfftpack.5d -L/home/hrmatsui/local/amd/lib -lpng -L/home/hrmatsui/local/amd/lib -lz -L/home/hrmatsui/local/amd/lib -lfftw3 -L/opt/rocm-7.2.0/lib -lrocfft -lrocblas -lhipfort-amdgcn -lamdhip64

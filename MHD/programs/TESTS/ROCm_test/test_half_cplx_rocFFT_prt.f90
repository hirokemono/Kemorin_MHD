...
!
     ...
     &             :: file_name = 'prt_half_cplx_rocFFT_test.dat'
...
!   Initialize Fourier transform
      ...
      call init_pin_cplx_rocFFT_FFTPACK(n_field, Ncomp_GPU, Ncomp_CPU,  &
...
!
!   Forward transform
        call pin_fwd_cplx_rocFFT_FFTPACK(n_field, fwd, WK_rocFFT,       &
...
!
!   Backword transform
        call pin_bwd_cplx_rocFFT_FFTPACK(n_field, bwd, WK_rocFFT,       &

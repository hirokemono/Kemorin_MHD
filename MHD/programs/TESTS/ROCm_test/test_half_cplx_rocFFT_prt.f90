!>@file   test_half_cplx_rocFFT_prt.f90
!!@brief  program test_half_cplx_rocFFT_prt
!!
!!@author H. Matsui
...
!! ----------------------------------------------------------------------
!!  begin FFT_test_ctl
!!    output_file_name    'prt_complex_rocFFT_FFTPACK_test.dat'
!!
!!    FFT_length_ctl         128
!!    num_series_ctl          24
...
!! ----------------------------------------------------------------------
!!@endverbatim
      program test_half_cplx_rocFFT_prt
!
      use iso_c_binding
      use omp_lib
!
...
!
      ...
      use pin_cplx_rocFFT_FFTPACK
!
      implicit none
!
      character(len = kchara), parameter                                &
     &             :: test_name = 'prt_complex_rocFFT_FFTPACK'
      character(len = kchara), parameter                                &
     &             :: def_fname = 'prt_complex_rocFFT_FFTPACK_test.dat'
!
...
!
!
      write(*,'(a)') '-----  Test prt complex rocFFT and FFTPACK -----'
!
...
!   Initialize Fourier transform
      start = OMP_GET_WTIME()
      call init_pin_cplx_rocFFT_FFTPACK(ft1%nfld, Ncomp_GPU, Ncomp_CPU, &
...
!
!   Forward transform
        call pin_fwd_cplx_rocFFT_FFTPACK(ft1%nfld, Ncomp_CPU,           &
...
!
!   Backword transform
        call pin_bwd_cplx_rocFFT_FFTPACK(ft1%nfld, Ncomp_CPU,           &
...
!
      stop 'finish'
!
      end program test_half_cplx_rocFFT_prt
!
! mpif90 --offload-arch=gfx942 -mcmodel=medium -mcmodel=medium -O3 -g -fopenmp -fopenmp-target-fast  -I. -I/home/hrmatsui/src_kemo/work -I/opt/rocm-7.2.0/include/hipfort/amdgcn -DPNG_OUTPUT -DZLIB_IO -DFFTW3 -D_AMD_ROCM_ -o ./test_half_cplx_rocFFT_prt test_half_cplx_rocFFT_prt.f90 /home/hrmatsui/src_kemo/work/m_FFT_size.o /home/hrmatsui/src_kemo/work/t_fft_test_data.o -L/home/hrmatsui/src_kemo/work -lkemo_core -lkemo_c -lfftpack.5d -L/home/hrmatsui/local/amd/lib -lpng -L/home/hrmatsui/local/amd/lib -lz -L/home/hrmatsui/local/amd/lib -lfftw3 -L/opt/rocm-7.2.0/lib -lrocfft -lrocblas -lhipfort-amdgcn -lamdhip64

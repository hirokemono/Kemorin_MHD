...
!
!>@brief Test program of OpenMP rocFFT
...
!! ----------------------------------------------------------------------
!!  begin FFT_test_ctl
!!    output_file_name       'prt_OMP_rocFFT_test.dat'
!!
!!    FFT_length_ctl         128
!!    num_series_ctl          24
...
!
     ...
     &             :: test_name = 'prt_OpenMP_rocFFT'
      character(len = kchara), parameter                                &
     &             :: def_fname = 'prt_OMP_rocFFT_test.dat'
!
...
!
!   Forward transform
        call multi_pin_fwd_OMP_rocFFT(fwd, WK_fft, ft1%s_k(1,1),        &
     &                                elapsed(2), elapsed(3))
!
        start = OMP_GET_WTIME()
!$omp parallel workshare
...
!
!   Backword transform
        call multi_pin_bwd_OMP_rocFFT(bwd, WK_fft, ft1%f_x,             &
     &                                elapsed(2), elapsed(3))

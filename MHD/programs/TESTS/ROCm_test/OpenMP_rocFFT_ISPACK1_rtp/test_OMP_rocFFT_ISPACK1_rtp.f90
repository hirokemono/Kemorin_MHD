...
!   Initialize Fourier transform
      start = OMP_GET_WTIME()
      call init_pout_OMP_rocFFT_ISPACK1(ft1%nfld, Ncomp_GPU, Ncomp_CPU, &
...
!
!   Forward transform
        call pout_fwd_OMP_rocFFT_ISPACK1(ft1%nfld, fwd, WK_rocFFT,      &
...
!
!   Backword transform
        call pout_bwd_OMP_rocFFT_ISPACK1(ft1%nfld, bwd, WK_rocFFT,      &
...
!
! mpif90 --offload-arch=gfx942 -mcmodel=medium -mcmodel=medium -O3 -g -fopenmp -fopenmp-target-fast  -I. -I/home/hrmatsui/src_kemo/work -I/opt/rocm-7.2.0/include/hipfort/amdgcn -DPNG_OUTPUT -DZLIB_IO -DFFTW3 -D_AMD_ROCM_ -o ./test_OMP_rocFFT_ISPACK1_rtp test_OMP_rocFFT_ISPACK1_rtp.f90 -L/home/hrmatsui/src_kemo/work -lkemo_core -lkemo_c -lfftpack.5d -L/home/hrmatsui/local/amd/lib -lpng -L/home/hrmatsui/local/amd/lib -lz -L/home/hrmatsui/local/amd/lib -lfftw3 -L/opt/rocm-7.2.0/lib -lrocfft -lrocblas -lhipfort-amdgcn -lamdhip64

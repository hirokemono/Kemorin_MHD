...
!
     ...
     &             :: file_name = 'prt_half_real_rocFFT_test.dat'
...
!
      write(*,'(a)') '-----  Test prt shared real rocFFT  -----'
!
...
!   Initialize Fourier transform
      ...
      call init_pin_real_rocFFT_FFTPACK(n_field, Ncomp_GPU, Ncomp_CPU,  &
...
!
!   Forward transform
        call pin_fwd_real_rocFFT_FFTPACK(n_field, fwd, WK_rocFFT,       &
...
!
!   Backword transform
        call pin_bwd_real_rocFFT_FFTPACK(n_field, bwd, WK_rocFFT,       &
...
!
      stop 'finish'
!
      end program test_half_real_rocFFT_prt
!
! mpif90 --offload-arch=gfx942 -mcmodel=medium -mcmodel=medium -O3 -g -fopenmp -fopenmp-target-fast  -I. -I/home/hrmatsui/src_kemo/work -I/opt/rocm-7.2.0/include/hipfort/amdgcn -DPNG_OUTPUT -DZLIB_IO -DFFTW3 -D_AMD_ROCM_ -o ./test_half_real_rocFFT_prt test_half_real_rocFFT_prt.f90 /home/hrmatsui/src_kemo/work/m_FFT_size.o /home/hrmatsui/src_kemo/work/t_fft_test_data.o -L/home/hrmatsui/src_kemo/work -lkemo_core -lkemo_c -lfftpack.5d -L/home/hrmatsui/local/amd/lib -lpng -L/home/hrmatsui/local/amd/lib -lz -L/home/hrmatsui/local/amd/lib -lfftw3 -L/opt/rocm-7.2.0/lib -lrocfft -lrocblas -lhipfort-amdgcn -lamdhip64

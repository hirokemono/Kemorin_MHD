!>@file   test_sgl_real_rocFFT_rtp.f90
!!@brief  program test_sgl_real_rocFFT_rtp
!!
!!@author H. Matsui
!!@date Programmed in March, 2026
!
!> @brief Test program of real rocFFT with outer series array
!!
!!@verbatim
!! ----------------------------------------------------------------------
...
!! ----------------------------------------------------------------------
!!  begin FFT_test_ctl
!!    output_file_name    'rtp_single_real_rocFFT.dat'
!!
!!    FFT_length_ctl         128
!!    num_series_ctl          24

!
      program test_OMP_rocFFT_ISPACK3_prt
!
      use iso_c_binding
      use omp_lib
!
...
!
!   Forward transform
        call pin_fwd_OMP_rocFFT_ISPACK3(ft1%nfld, fwd, WK_rocFFT,       &
     &      WK_ISPACK3, ft1%s_k(1,1), elapsed(2:5))
!
        start = OMP_GET_WTIME()
!$omp parallel workshare
...
!
!   Backword transform
        call pin_bwd_OMP_rocFFT_ISPACK3(ft1%nfld, bwd, WK_rocFFT,       &
     &      WK_ISPACK3, ft1%f_x(1,1), elapsed(2:5))
...
!
      stop 'finish'
!
      end program test_OMP_rocFFT_ISPACK3_prt
!
! mpif90 --offload-arch=gfx942 -mcmodel=medium -mcmodel=medium -O3 -g -fopenmp -fopenmp-target-fast  -I. -I/home/hrmatsui/src_kemo/work -I/opt/rocm-7.2.0/include/hipfort/amdgcn -DPNG_OUTPUT -DZLIB_IO -DFFTW3 -D_AMD_ROCM_ -o ./test_OMP_rocFFT_ISPACK3_prt test_OMP_rocFFT_ISPACK3_prt.f90 /home/hrmatsui/src_kemo/work/m_FFT_size.o /home/hrmatsui/src_kemo/work/t_fft_test_data.o -L/home/hrmatsui/src_kemo/work -lkemo_core -lkemo_c -lfftpack.5d -L/home/hrmatsui/local/amd/lib -lpng -L/home/hrmatsui/local/amd/lib -lz -L/home/hrmatsui/local/amd/lib -lfftw3 -L/opt/rocm-7.2.0/lib -lrocfft -lrocblas -lhipfort-amdgcn -lamdhip64

!!>@file   test_real_rocFFT_rtp.f90
!!@brief  program test_real_rocFFT_rtp
!!
!!@author H. Matsui
...
!! ----------------------------------------------------------------------
!!  begin FFT_test_ctl
!!    output_file_name       'rtp_real_rocFFT_test.dat'
!!
!!    FFT_length_ctl         128
!!    num_series_ctl          24
...
!
     ...
     &             :: test_name = 'rtp_real_rocFFT'
      character(len = kchara), parameter                                &
     &             :: def_fname = 'rtp_real_rocFFT_test.dat'
!
...
!
!   Forward transform
        call multi_pout_fwd_rocFFT_r2r(ft1%nfld, fwd, WK_fft,           &
...
!
!   Backword transform
        call multi_pout_bwd_rocFFT_r2r(ft1%nfld, bwd, WK_fft,           &

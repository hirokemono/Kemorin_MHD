!>@file   pin_cplx_rocFFT_FFTPACK.f90
!!@brief  module pin_cplx_rocFFT_FFTPACK
!!
!!@author H. Matsui
!!@date Programmed in Aug., 2026
!!
!!
!>@brief  FFT by complex rocFFT and FFTPACK5 with innermost data series
!!
!!@verbatim
!!      subroutine init_pin_cplx_rocFFT_FFTPACK                         &
...
!!
!!      subroutine pin_fwd_cplx_rocFFT_FFTPACK(Ncomp, Ncomp_CPU,        &
...
!!      subroutine pin_bwd_cplx_rocFFT_FFTPACK(Ncomp, Ncomp_CPU,        &
...
!
      end subroutine init_pin_cplx_rocFFT_FFTPACK
!
! ------------------------------------------------------------------
!
...
! ------------------------------------------------------------------
!
      end module pin_cplx_rocFFT_FFTPACK
!

!>@file   test_rocFFT_cpu_FFTs_prt.f90
!!@brief  program test_rocFFT_cpu_FFTs_prt
!!
!!@author H. Matsui
...
!! ----------------------------------------------------------------------
!!  begin FFT_test_ctl
!!    output_file_name       'prt_rocFFT_CPU_FFTs_test.dat'
!!
!!    FFT_length_ctl         128
!!    num_series_ctl          24
...
!! ----------------------------------------------------------------------
!!@endverbatim
      program test_rocFFT_cpu_FFTs_prt
!
      use iso_c_binding
      use omp_lib
!
...
!
     ...
     &             :: def_fname = 'prt_rocFFT_CPU_FFTs_test.dat'
!

!>@file   sel_pin_rocFFT_CPU_FFT.f90
!!@brief  module sel_pin_rocFFT_CPU_FFT
!!
!!@author H. Matsui
...
!!
!!      subroutine sel_pin_fwd_rocFFT_FFTs                              &
...
!!      subroutine sel_pin_bwd_rocFFT_FFTs                              &
!!     &         (iflag_GPU_FFT, iflag_CPU_FFT, Ncomp, Ncomp_CPU,       &
...
!
     ...
     &    int(WK_rocFFT%Nfft_r), WK_rocFFT%X_rocFFT(1))
      call sel_swap_pin_field_to_FFT(iflag_CPU_FFT, Ncomp_CPU,          &
...
!
     ...
     &   (iflag_GPU_FFT, fwd_rocFFT, WK_rocFFT, ione, Ncomp, X(1,1))
      call sel_swap_prt_spectr_from_FFT(iflag_CPU_FFT, WK_FFTs,         &
     &    Ncomp_CPU, int(fwd_rocFFT%Nfft), X(1,fwd_rocFFT%Ncomp+1))
      elapsed(2) = elapsed(2) + OMP_GET_WTIME() - start
!
      end subroutine sel_pin_fwd_rocFFT_FFTs
!
! ------------------------------------------------------------------
!
      subroutine sel_pin_bwd_rocFFT_FFTs                                &
...
!
     ...
     &                                X(1,1), bwd_rocFFT, WK_rocFFT)
      call sel_swap_pin_spectr_to_FFT(iflag_CPU_FFT, Ncomp_CPU,         &
...
! ------------------------------------------------------------------
!
      end module sel_pin_rocFFT_CPU_FFT

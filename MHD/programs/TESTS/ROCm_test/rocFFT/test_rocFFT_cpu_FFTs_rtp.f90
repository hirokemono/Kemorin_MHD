...
!
!
      write(*,'(a)') '-----  Test rtp rocFFT and CPU FFT -----'
!
...
!   Finalize
      start = OMP_GET_WTIME()
      call finalize_rocFFT_FFTs(fft_test_p1%iflag_CPU_FFT, np_smp,      &
     &                          fwd, bwd, WK_rocFFT, WK_FFTs1)
...
!
! mpif90 --offload-arch=gfx942 -mcmodel=medium -mcmodel=medium -O3 -g -fopenmp -fopenmp-target-fast  -I. -I/home/hrmatsui/src_kemo/work -I/opt/rocm-7.2.0/include/hipfort/amdgcn -DPNG_OUTPUT -DZLIB_IO -DFFTW3 -D_AMD_ROCM_ -o ./test_rocFFT_cpu_FFTs_rtp test_rocFFT_cpu_FFTs_rtp.f90 -L/home/hrmatsui/src_kemo/work -lkemo_core -lkemo_c -L/home/hrmatsui/local/amd/lib -lpng -L/home/hrmatsui/local/amd/lib -lz -L/home/hrmatsui/local/amd/lib -lfftw3 -L/opt/rocm-7.2.0/lib -lrocfft -lrocblas -lhipfort-amdgcn -lamdhip64

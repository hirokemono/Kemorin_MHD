!!>@file   test_OMP_rocFFT_rtp.f90
!!@brief  program test_OMP_rocFFT_rtp
!!
!!@author H. Matsui
!!@date Programmed in March, 2026
!
!>@brief Test program of OopenMP rocFFT
...
!! ----------------------------------------------------------------------
!!  begin FFT_test_ctl
!!    output_file_name       'rtp_OMP_rocFFT_test.dat'
!!
!!    FFT_length_ctl         128
!!    num_series_ctl          24
...
!
      ...
      use multi_pout_OpenMP_rocFFT
!
      implicit none
!
      character(len = kchara), parameter                                &
     &             :: test_name = 'rtp_OpenMP_rocFFT'
      character(len = kchara), parameter                                &
     &             :: def_fname = 'rtp_OMP_rocFFT_test.dat'
!
...
!
!
      write(*,'(a)') '-----  Test rtp OpenMP rocFFT  -----'
!
...
!
!   Forward transform
        call multi_pout_fwd_OMP_rocFFT(ft1%nfld, fwd, WK_fft,           &
...
!
!   Backword transform
        call multi_pout_bwd_OMP_rocFFT(ft1%nfld, bwd, WK_fft,           &

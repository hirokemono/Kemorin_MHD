!>@file   test_OMP_rocFFT_FFTPACK_rtp.f90
!!@brief  program test_OMP_rocFFT_FFTPACK_rtp
!!
!!@author H. Matsui
...
!! ----------------------------------------------------------------------
!!  begin FFT_test_ctl
!!    output_file_name    'rtp_OMP_rocFFT_FFTPACK_test.dat'
!!
!!    FFT_length_ctl         128
!!    num_series_ctl          24
...
!! ----------------------------------------------------------------------
!!@endverbatim
      program test_OMP_rocFFT_FFTPACK_rtp
!
      use iso_c_binding
      use omp_lib
!
...
!
     ...
     &             :: test_name = 'rtp_OpenMP_rocFFT_FFTPACK'
      character(len = kchara), parameter                                &
     &             :: def_fname = 'rtp_OMP_rocFFT_FFTPACK_test.dat'
!
...
!   Initialize Fourier transform
      start = OMP_GET_WTIME()
      call init_pout_OMP_rocFFT_FFTPACK                                 &
...
!
      stop 'finish'
!
      end program test_OMP_rocFFT_FFTPACK_rtp
!
! mpif90 --offload-arch=gfx942 -mcmodel=medium -mcmodel=medium -O3 -g -fopenmp -fopenmp-target-fast  -I. -I/home/hrmatsui/src_kemo/work -I/opt/rocm-7.2.0/include/hipfort/amdgcn -DPNG_OUTPUT -DZLIB_IO -DFFTW3 -D_AMD_ROCM_ -o ./test_OMP_rocFFT_FFTPACK_rtp test_OMP_rocFFT_FFTPACK_rtp.f90 -L/home/hrmatsui/src_kemo/work -lkemo_core -lkemo_c -lfftpack.5d -L/home/hrmatsui/local/amd/lib -lpng -L/home/hrmatsui/local/amd/lib -lz -L/home/hrmatsui/local/amd/lib -lfftw3 -L/opt/rocm-7.2.0/lib -lrocfft -lrocblas -lhipfort-amdgcn -lamdhip64

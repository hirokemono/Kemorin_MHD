!>@file   test_half_real_rocFFT_rtp.f90
!!@brief  program test_half_real_rocFFT_rtp
!!
!!@author H. Matsui
...
!! ----------------------------------------------------------------------
!!@endverbatim
      program test_half_real_rocFFT_rtp
!
      use iso_c_binding
      use omp_lib
!
...
!
      stop 'finish'
!
      end program test_half_real_rocFFT_rtp
!
! mpif90 --offload-arch=gfx942 -mcmodel=medium -mcmodel=medium -O3 -g -fopenmp -fopenmp-target-fast  -I. -I/home/hrmatsui/src_kemo/work -I/opt/rocm-7.2.0/include/hipfort/amdgcn -DPNG_OUTPUT -DZLIB_IO -DFFTW3 -D_AMD_ROCM_ -o ./test_half_real_rocFFT_rtp test_half_real_rocFFT_rtp.f90 -L/home/hrmatsui/src_kemo/work -lkemo_core -lkemo_c -lfftpack.5d -L/home/hrmatsui/local/amd/lib -lpng -L/home/hrmatsui/local/amd/lib -lz -L/home/hrmatsui/local/amd/lib -lfftw3 -L/opt/rocm-7.2.0/lib -lrocfft -lrocblas -lhipfort-amdgcn -lamdhip64

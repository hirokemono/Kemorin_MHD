!!>@file   test_OMP_rocFFT_FFTW3_rtp.f90
!!@brief  program test_OMP_rocFFT_FFTW3_rtp
!!
!!@author H. Matsui
...
!! ----------------------------------------------------------------------
!!  begin FFT_test_ctl
!!    output_file_name       'rtp_OpenMP_rocFFT_ISPACK3_test.dat'
!!
!!    FFT_length_ctl         128
!!    num_series_ctl          24
...
!
      ...
      use pout_OMP_rocFFT_ISPACK3
!
      implicit none
!
      character(len = kchara), parameter                                &
     &             :: test_name = 'rtp_OpenMP_rocFFT_ISPACK3'
      character(len = kchara), parameter                                &
     &             :: def_fname = 'rtp_OpenMP_rocFFT_ISPACK3_test.dat'
!
...
!
!   Forward transform
        call pout_fwd_OMP_rocFFT_ISPACK3(ft1%nfld, fwd, WK_rocFFT,      &
...
!
!   Backword transform
        call pout_bwd_OMP_rocFFT_ISPACK3(ft1%nfld, bwd, WK_rocFFT,      &

...
!   Initialize Fourier transform
      start = OMP_GET_WTIME()
      call init_pout_OMP_rocFFT_FFTW3                                   &
...
!
!   Forward transform
        call pout_fwd_OMP_rocFFT_FFTW3(ft1%nfld, fft_test_p1%nfld_CPU,  &
...
!
!   Backword transform
        call pout_bwd_OMP_rocFFT_FFTW3(ft1%nfld, fft_test_p1%nfld_CPU,  &

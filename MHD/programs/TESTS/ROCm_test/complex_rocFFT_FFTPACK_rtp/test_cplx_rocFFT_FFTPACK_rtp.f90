!>@file   test_cpx_rocFFT_FFTPACK_rtp.f90
!!@brief  program test_cpx_rocFFT_FFTPACK_rtp
!!
!!@author H. Matsui
...
!! ----------------------------------------------------------------------
!!@endverbatim
      program test_cpx_rocFFT_FFTPACK_rtp
!
      use iso_c_binding
      use omp_lib
!
...
!
!
      write(*,'(a)') '-----  Test rtp complex rocFFT and FFTPACK -----'
!
...
!   Initialize Fourier transform
      start = OMP_GET_WTIME()
      call init_pout_cplx_rocFFT_FFTPACK                                &
     &   (ft1%nfld, fft_test_p%nfld_GPU, fft_test_p1%nfld_CPU,          &
     &    nft1%ngrd, p_smp, fwd, bwd, WK_rocFFT, WK_FFTPACK_T)
...
!
!   Forward transform
        call pout_fwd_cplx_rocFFT_FFTPACK(ft1%nfld, fwd, WK_rocFFT,     &
...
!
!   Backword transform
        call pout_bwd_cplx_rocFFT_FFTPACK(ft1%nfld, bwd, WK_rocFFT,     &
...
!
      stop 'finish'
!
      end program test_cpx_rocFFT_FFTPACK_rtp
!
! mpif90 --offload-arch=gfx942 -mcmodel=medium -mcmodel=medium -O3 -g -fopenmp -fopenmp-target-fast  -I. -I/home/hrmatsui/src_kemo/work -I/opt/rocm-7.2.0/include/hipfort/amdgcn -DPNG_OUTPUT -DZLIB_IO -DFFTW3 -D_AMD_ROCM_ -o ./test_cpx_rocFFT_FFTPACK_rtp test_cpx_rocFFT_FFTPACK_rtp.f90 -L/home/hrmatsui/src_kemo/work -lkemo_core -lkemo_c -lfftpack.5d -L/home/hrmatsui/local/amd/lib -lpng -L/home/hrmatsui/local/amd/lib -lz -L/home/hrmatsui/local/amd/lib -lfftw3 -L/opt/rocm-7.2.0/lib -lrocfft -lrocblas -lhipfort-amdgcn -lamdhip64

...
!
      if ( SGS_param%iflag_SGS_uxb .ne. id_SGS_none) then
        iphys_sph%SGS_term%i_SGS_induction = 16
        iphys_sph%rot_SGS%i_SGS_induction = 19
        sph_fld%num_phys =   7
...
!
     ...
     &    itp_FEM_2_SPH, mesh_fem, mesh_sph, fem_fld, sph_fld)
      call interpolate_vector_type(iphys%SGS_term%i_SGS_induction,      &
...
!
     ...
     &    iphys_sph%SGS_term%i_SGS_induction,                           &
     &    frc_hbd_rtp(1,f_hbd_trns%SGS_term%i_SGS_induction))
!
...
!
     ...
     &    rj_fld)
      call const_sph_rotation_uxb(sph%sph_rj, SPH_WK%r_2nd, sph_bc_B,   &
     &    g_sph_rj, ipol%SGS_term%i_SGS_induction,                      &
...
!
     ...
     &    rj_fld, n_WS, WS)
      if (SGS_param%iflag_SGS_uxb .ne. id_SGS_none) then
        call sel_sph_rj_vector_to_send(ncomp_rj_2_xyz,                  &
     &      ipol%rot_SGS%i_SGS_induction, b_hbd_trns%i_SGS_induction,   &
     &      rj_fld, n_WS, WS)
      end if
!
...
!
     ...
     &    iphys_sph%rot_SGS%i_SGS_induction, mesh_sph%node, sph_fld)
      end if
!
!
      call interpolate_vector_type                                      &
     ...
     &    itp_SPH_2_FEM, mesh_sph, mesh_fem, sph_fld, fem_fld)
      if ( SGS_param%iflag_SGS_uxb .ne. id_SGS_none) then
        call interpolate_vector_type                                    &
     &   (iphys_sph%rot_SGS%i_SGS_induction,                            &

...
!
     ...
     &    label_sim, FEM_MHD%v_sol, SR_sig, SR_r, SR_i, SR_il)
!
...
!
     ...
     &    FEM_MHD%field, MHD_IO%rst_IO, FEM_MHD%v_sol, SR_sig, SR_r)
      if(iflag_MHD_time) call end_elapsed_time(ist_elapsed_MHD+3)
!

...
!
     ...
     &      filtering1, wide_filtering, m1_lump,                        &
...
!
     ...
     &      iphys, nod_fld1, jacobians1%jac_3d, jacobians1%jac_3d_l, fem1_wk, flex_data)
      end if
!
!
!    Open monitor files
...
!
     ...
     &      nod_fld1, jacobians1%jac_3d, jacobians1%jac_3d_l, fem1_wk, flex_data,         &
     &      flex_p1, MHD_step1%time_d)
      end if
!
!     ========  Data output

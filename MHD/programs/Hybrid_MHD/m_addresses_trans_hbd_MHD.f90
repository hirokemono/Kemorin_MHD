...
!    SGS magnetic induction flag
      if(SGS_param%iflag_SGS_uxb .gt. id_SGS_none) then
        nvector_rj_2_xyz = nvector_rj_2_xyz + 1
        b_hbd_trns%rot_SGS%i_SGS_vp_induct = 3*nvector_rj_2_xyz - 2
      end if
...
!
     ...
     &        idpdr%forces%i_induction
      if(b_hbd_trns%rot_SGS%i_SGS_vp_induct .gt. 0) write(*,*)          &
     &     'b_hbd_trns%i_SGS_vp_induct ',                               &
     &      b_hbd_trns%rot_SGS%i_SGS_vp_induct,                         &
     &      ipol%rot_SGS%i_SGS_vp_induct, itor%rot_SGS%i_SGS_vp_induct, &
     &      idpdr%rot_SGS%i_SGS_vp_induct
      write(*,*)
!
